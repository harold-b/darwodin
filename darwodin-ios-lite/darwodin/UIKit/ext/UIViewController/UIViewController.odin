...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.allowedChildViewControllersForUnwindingFromSource != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("allowedChildViewControllersForUnwindingFromSource:"), auto_cast allowedChildViewControllersForUnwindingFromSource, "^void@:@") do panic("Failed to register objC method.")
    }
    ...
    if vt.previewActionItems != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("previewActionItems"), auto_cast previewActionItems, "^void@:") do panic("Failed to register objC method.")
    }
    ...
    if vt.setToolbarItems_animated != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("setToolbarItems:animated:"), auto_cast setToolbarItems_animated, "v@:^voidB") do panic("Failed to register objC method.")
    }
    if vt.toolbarItems != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("toolbarItems"), auto_cast toolbarItems, "^void@:") do panic("Failed to register objC method.")
    }
    if vt.setToolbarItems_ != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("setToolbarItems:"), auto_cast setToolbarItems_, "v@:^void") do panic("Failed to register objC method.")
    }
