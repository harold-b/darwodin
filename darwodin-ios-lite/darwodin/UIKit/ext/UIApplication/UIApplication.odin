...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.openURL_options_completionHandler != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("openURL:options:completionHandler:"), auto_cast openURL_options_completionHandler, "v@:@^void?") do panic("Failed to register objC method.")
    }
    if vt.sendEvent != nil {
    ...
    if vt.connectedScenes != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("connectedScenes"), auto_cast connectedScenes, "^void@:") do panic("Failed to register objC method.")
    }
    if vt.openSessions != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("openSessions"), auto_cast openSessions, "^void@:") do panic("Failed to register objC method.")
    }
    ...
    if vt.scheduledLocalNotifications != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("scheduledLocalNotifications"), auto_cast scheduledLocalNotifications, "^void@:") do panic("Failed to register objC method.")
    }
    if vt.setScheduledLocalNotifications != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("setScheduledLocalNotifications:"), auto_cast setScheduledLocalNotifications, "v@:^void") do panic("Failed to register objC method.")
    }
    ...
    if vt.shortcutItems != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("shortcutItems"), auto_cast shortcutItems, "^void@:") do panic("Failed to register objC method.")
    }
