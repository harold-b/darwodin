...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Value,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Value,
    alloc: proc() -> ^NS.Value,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Value {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Value {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Value {
