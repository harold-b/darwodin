...
foreign lib {
    ...
    Mesh_initBoxWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [3]cffi.uint, inwardNormals: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initSphereWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, inwardNormals: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initHemisphereWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, inwardNormals: bool, cap: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initCylinderWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, inwardNormals: bool, topCap: bool, bottomCap: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initCapsuleWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, hemisphereSegments: cffi.int, inwardNormals: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initConeWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, inwardNormals: bool, cap: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---

    @(objc_type=Mesh, objc_selector="initPlaneWithExtent:segments:geometryType:allocator:", objc_name="initPlaneWithExtent")
    Mesh_initPlaneWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, segments: #by_ptr [2]cffi.uint, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_initIcosahedronWithExtent :: proc(self: ^Mesh, extent: #by_ptr vector_float3, inwardNormals: bool, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newBoxWithDimensions :: proc(dimensions: #by_ptr vector_float3, segments: #by_ptr [3]cffi.uint, geometryType: GeometryType, inwardNormals: bool, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newEllipsoidWithRadii :: proc(radii: #by_ptr vector_float3, radialSegments: NS.UInteger, verticalSegments: NS.UInteger, geometryType: GeometryType, inwardNormals: bool, hemisphere: bool, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newCylinderWithHeight :: proc(height: cffi.float, radii: #by_ptr vector_float2, radialSegments: NS.UInteger, verticalSegments: NS.UInteger, geometryType: GeometryType, inwardNormals: bool, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newCapsuleWithHeight :: proc(height: cffi.float, radii: #by_ptr vector_float2, radialSegments: NS.UInteger, verticalSegments: NS.UInteger, hemisphereSegments: NS.UInteger, geometryType: GeometryType, inwardNormals: bool, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newEllipticalConeWithHeight :: proc(height: cffi.float, radii: #by_ptr vector_float2, radialSegments: NS.UInteger, verticalSegments: NS.UInteger, geometryType: GeometryType, inwardNormals: bool, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_newPlaneWithDimensions :: proc(dimensions: #by_ptr vector_float2, segments: #by_ptr [2]cffi.uint, geometryType: GeometryType, allocator: ^MeshBufferAllocator) -> ^Mesh ---
    ...
    Mesh_generateAmbientOcclusionTextureWithSize :: proc(self: ^Mesh, textureSize: #by_ptr [2]cffi.int, raysPerSample: NS.Integer, attenuationFactor: cffi.float, objectsToConsider: ^NS.Array, vertexAttributeName: ^NS.String, materialPropertyName: ^NS.String) -> bool ---
    ...
    Mesh_generateLightMapTextureWithTextureSize :: proc(self: ^Mesh, textureSize: #by_ptr [2]cffi.int, lightsToConsider: ^NS.Array, objectsToConsider: ^NS.Array, vertexAttributeName: ^NS.String, materialPropertyName: ^NS.String) -> bool ---
