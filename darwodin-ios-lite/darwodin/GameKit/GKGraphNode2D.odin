...
foreign lib {
    ...
    GraphNode2D_nodeWithPoint :: proc(#by_ptr point: vector_float2) -> ^GraphNode2D ---

    @(objc_type=GraphNode2D, objc_selector="initWithPoint:", objc_name="initWithPoint")
    GraphNode2D_initWithPoint :: proc(self: ^GraphNode2D, #by_ptr point: vector_float2) -> ^GraphNode2D ---
    ...
    GraphNode2D_setPosition :: proc(self: ^GraphNode2D, #by_ptr position: vector_float2) ---
}
