...
foreign lib {
    ...
    Quadtree_addElement_withPoint :: proc(self: ^Quadtree, element: id, point: #by_ptr vector_float2) -> ^QuadtreeNode ---
    ...
    Quadtree_elementsAtPoint :: proc(self: ^Quadtree, point: #by_ptr vector_float2) -> ^NS.Array ---
