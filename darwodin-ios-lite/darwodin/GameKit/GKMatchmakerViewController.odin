...
@(objc_type=MatchmakerViewController, objc_name="setHostedPlayerReady")
MatchmakerViewController_setHostedPlayerReady :: #force_inline proc "c" (self: ^MatchmakerViewController, playerID: ^NS.String) {
    msgSend(nil, self, "setHostedPlayerReady:", playerID)
}
@(objc_type=MatchmakerViewController, objc_name="attemptRotationToDeviceOrientation", objc_is_class_method=true)
MatchmakerViewController_attemptRotationToDeviceOrientation :: #force_inline proc "c" () {
    msgSend(nil, MatchmakerViewController, "attemptRotationToDeviceOrientation")
}
@(objc_type=MatchmakerViewController, objc_name="clearTextInputContextIdentifier", objc_is_class_method=true)
MatchmakerViewController_clearTextInputContextIdentifier :: #force_inline proc "c" (identifier: ^NS.String) {
    msgSend(nil, MatchmakerViewController, "clearTextInputContextIdentifier:", identifier)
}
