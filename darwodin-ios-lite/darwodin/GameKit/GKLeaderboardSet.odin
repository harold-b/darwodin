...
LeaderboardSet_loadImageWithCompletionHandler :: #force_inline proc "c" (self: ^LeaderboardSet, completionHandler: ^Objc_Block(proc "c" (image: ^UI.Image, error: ^NS.Error))) {
