...
foreign lib {
    ...
    PolygonObstacle_obstacleWithPoints :: proc(points: ^#by_ptr vector_float2, numPoints: cffi.size_t) -> ^PolygonObstacle ---

    @(objc_type=PolygonObstacle, objc_selector="initWithPoints:count:", objc_name="initWithPoints")
    PolygonObstacle_initWithPoints :: proc(self: ^PolygonObstacle, points: ^#by_ptr vector_float2, numPoints: cffi.size_t) -> ^PolygonObstacle ---
