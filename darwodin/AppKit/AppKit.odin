...
@require foreign import AppKit "system:AppKit.framework"
...
/// NSRangePointer
RangePointer :: distinct ^NS._NSRange

/// NSPoint
Point :: distinct CG.Point

/// NSPointPointer
PointPointer :: distinct ^CG.Point

/// NSPointArray
PointArray :: distinct ^CG.Point

/// NSSizePointer
SizePointer :: distinct ^NS.Size

/// NSRectPointer
RectPointer :: distinct ^NS.Rect
...
/// NSPrinterTypeName
PrinterTypeName :: distinct ^NS.String

/// NSPrinterPaperName
PrinterPaperName :: distinct ^NS.String

/// NSPrintInfoAttributeKey
PrintInfoAttributeKey :: distinct ^NS.String

/// NSPrintJobDispositionValue
PrintJobDispositionValue :: distinct ^NS.String

/// NSPrintInfoSettingKey
PrintInfoSettingKey :: distinct ^NS.String
...
/// NSImageHintKey
ImageHintKey :: distinct ^NS.String
...
PrintPanelJobStyleHint :: distinct ^NS.String

/// NSPrintPanelAccessorySummaryKey
PrintPanelAccessorySummaryKey :: distinct ^NS.String
...
/// NSTouchTypeMask
TouchTypeMaskFlags :: enum cffi.ulong {
    Direct = 0,
    Indirect = 1,
}
TouchTypeMask :: bit_set[TouchTypeMaskFlags; cffi.ulong]
...
/// NSEventMask
EventMaskFlags :: enum cffi.ulonglong {
    LeftMouseDown = 1,
    LeftMouseUp = 2,
    RightMouseDown = 3,
    RightMouseUp = 4,
...
EventMask :: bit_set[EventMaskFlags; cffi.ulonglong]

/// NSEventModifierFlags
EventModifierFlagsFlags :: enum cffi.ulong {
    CapsLock = 16,
    Shift = 17,
    Control = 18,
    Option = 19,
...
EventModifierFlags :: bit_set[EventModifierFlagsFlags; cffi.ulong]
...
/// NSEventButtonMask
EventButtonMaskFlags :: enum cffi.ulong {
    PenTip = 0,
    PenLowerSide = 1,
    PenUpperSide = 2,
}
EventButtonMask :: bit_set[EventButtonMaskFlags; cffi.ulong]
...
/// NSCellStyleMask
CellStyleMaskFlags :: enum cffi.ulong {
    NoCellMask = 0,
    ContentsCellMask = 0,
    PushInCellMask = 1,
...
CellStyleMask :: bit_set[CellStyleMaskFlags; cffi.ulong]
...
/// NSFontTraitMask
FontTraitMaskFlags :: enum cffi.ulong {
    ItalicFontMask = 0,
    BoldFontMask = 1,
    UnboldFontMask = 2,
...
FontTraitMask :: bit_set[FontTraitMaskFlags; cffi.ulong]
...
/// NSWindowStyleMask
WindowStyleMaskFlags :: enum cffi.ulong {
    Borderless = 0,
    Titled = 0,
    Closable = 1,
    Miniaturizable = 2,
...
WindowStyleMask :: bit_set[WindowStyleMaskFlags; cffi.ulong]
...
/// NSFontPanelModeMask
FontPanelModeMaskFlags :: enum cffi.ulong {
    Face = 0,
    Size = 1,
    Collection = 2,
    UnderlineEffect = 8,
...
FontPanelModeMask :: bit_set[FontPanelModeMaskFlags; cffi.ulong]
...
DatePickerElementFlagsFlags :: enum cffi.ulong {
    HourMinute = 3,
    HourMinuteSecond = 3,
    TimeZone = 4,
    YearMonth = 7,
...
DatePickerElementFlags :: bit_set[DatePickerElementFlagsFlags; cffi.ulong]
