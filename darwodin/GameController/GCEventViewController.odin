...
@(objc_type=EventViewController, objc_name="poseAsClass", objc_is_class_method=true)
EventViewController_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, EventViewController, "poseAsClass:", aClass)
}
...
@(objc_type=EventViewController, objc_name="setKeys", objc_is_class_method=true)
EventViewController_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, EventViewController, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=EventViewController, objc_name="exposeBinding", objc_is_class_method=true)
EventViewController_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, EventViewController, "exposeBinding:", binding)
}
@(objc_type=EventViewController, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
EventViewController_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, EventViewController, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=EventViewController, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
EventViewController_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, EventViewController, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
