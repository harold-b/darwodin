...
@(objc_type=Transaction, objc_name="batch", objc_is_class_method=true)
Transaction_batch :: #force_inline proc "c" () {
    msgSend(nil, Transaction, "batch")
}
...
@(objc_type=Transaction, objc_name="poseAsClass", objc_is_class_method=true)
Transaction_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Transaction, "poseAsClass:", aClass)
}
...
@(objc_type=Transaction, objc_name="setKeys", objc_is_class_method=true)
Transaction_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Transaction, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
