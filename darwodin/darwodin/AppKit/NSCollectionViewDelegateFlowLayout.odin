...
CollectionViewDelegateFlowLayout_VTable :: struct {
    collectionView_layout_sizeForItemAtIndexPath: proc(self: ^CollectionViewDelegateFlowLayout, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, indexPath: ^NS.IndexPath) -> NS.Size,
    collectionView_layout_insetForSectionAtIndex: proc(self: ^CollectionViewDelegateFlowLayout, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.EdgeInsets,
    ...
    collectionView_layout_referenceSizeForHeaderInSection: proc(self: ^CollectionViewDelegateFlowLayout, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.Size,
    collectionView_layout_referenceSizeForFooterInSection: proc(self: ^CollectionViewDelegateFlowLayout, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.Size,
}
...
CollectionViewDelegateFlowLayout_odin_extend :: proc(cls: Class, vt: ^CollectionViewDelegateFlowLayout_VTable) {
    ...
    if vt.collectionView_layout_sizeForItemAtIndexPath != nil {
        collectionView_layout_sizeForItemAtIndexPath :: proc "c" (self: ^CollectionViewDelegateFlowLayout, _: SEL, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, indexPath: ^NS.IndexPath) -> NS.Size {
    ...
    if vt.collectionView_layout_insetForSectionAtIndex != nil {
        collectionView_layout_insetForSectionAtIndex :: proc "c" (self: ^CollectionViewDelegateFlowLayout, _: SEL, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.EdgeInsets {
    ...
    if vt.collectionView_layout_referenceSizeForHeaderInSection != nil {
        collectionView_layout_referenceSizeForHeaderInSection :: proc "c" (self: ^CollectionViewDelegateFlowLayout, _: SEL, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.Size {
    ...
    if vt.collectionView_layout_referenceSizeForFooterInSection != nil {
        collectionView_layout_referenceSizeForFooterInSection :: proc "c" (self: ^CollectionViewDelegateFlowLayout, _: SEL, collectionView: ^CollectionView, collectionViewLayout: ^CollectionViewLayout, section: NS.Integer) -> NS.Size {
