...
@(objc_type=Mouse, objc_name="poseAsClass", objc_is_class_method=true)
Mouse_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Mouse, "poseAsClass:", aClass)
}
...
@(objc_type=Mouse, objc_name="setKeys", objc_is_class_method=true)
Mouse_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Mouse, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Mouse, objc_name="exposeBinding", objc_is_class_method=true)
Mouse_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Mouse, "exposeBinding:", binding)
}
@(objc_type=Mouse, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Mouse_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Mouse, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Mouse, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Mouse_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Mouse, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
