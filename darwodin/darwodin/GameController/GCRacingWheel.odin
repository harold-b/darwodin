...
@(objc_type=RacingWheel, objc_name="poseAsClass", objc_is_class_method=true)
RacingWheel_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RacingWheel, "poseAsClass:", aClass)
}
...
@(objc_type=RacingWheel, objc_name="setKeys", objc_is_class_method=true)
RacingWheel_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RacingWheel, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=RacingWheel, objc_name="exposeBinding", objc_is_class_method=true)
RacingWheel_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, RacingWheel, "exposeBinding:", binding)
}
@(objc_type=RacingWheel, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
RacingWheel_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, RacingWheel, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=RacingWheel, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
RacingWheel_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, RacingWheel, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
