...
@(objc_type=RacingWheelInput, objc_name="poseAsClass", objc_is_class_method=true)
RacingWheelInput_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RacingWheelInput, "poseAsClass:", aClass)
}
...
@(objc_type=RacingWheelInput, objc_name="setKeys", objc_is_class_method=true)
RacingWheelInput_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RacingWheelInput, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=RacingWheelInput, objc_name="exposeBinding", objc_is_class_method=true)
RacingWheelInput_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, RacingWheelInput, "exposeBinding:", binding)
}
@(objc_type=RacingWheelInput, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
RacingWheelInput_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, RacingWheelInput, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=RacingWheelInput, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
RacingWheelInput_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, RacingWheelInput, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
