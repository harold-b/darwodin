...
@(objc_type=ControllerInputState, objc_name="poseAsClass", objc_is_class_method=true)
ControllerInputState_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerInputState, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerInputState, objc_name="setKeys", objc_is_class_method=true)
ControllerInputState_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerInputState, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerInputState, objc_name="exposeBinding", objc_is_class_method=true)
ControllerInputState_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerInputState, "exposeBinding:", binding)
}
@(objc_type=ControllerInputState, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerInputState_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerInputState, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerInputState, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerInputState_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerInputState, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
