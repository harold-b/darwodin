...
@(objc_type=SteeringWheelElement, objc_name="poseAsClass", objc_is_class_method=true)
SteeringWheelElement_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SteeringWheelElement, "poseAsClass:", aClass)
}
...
@(objc_type=SteeringWheelElement, objc_name="setKeys", objc_is_class_method=true)
SteeringWheelElement_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SteeringWheelElement, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=SteeringWheelElement, objc_name="exposeBinding", objc_is_class_method=true)
SteeringWheelElement_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, SteeringWheelElement, "exposeBinding:", binding)
}
@(objc_type=SteeringWheelElement, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
SteeringWheelElement_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, SteeringWheelElement, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=SteeringWheelElement, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
SteeringWheelElement_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, SteeringWheelElement, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
