...
@(objc_type=AccelerationStructurePassDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructurePassDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructurePassDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructurePassDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructurePassDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructurePassDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
