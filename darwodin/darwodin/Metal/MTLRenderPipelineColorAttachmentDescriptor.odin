...
@(objc_type=RenderPipelineColorAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPipelineColorAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPipelineColorAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPipelineColorAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPipelineColorAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPipelineColorAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
