...
@(objc_type=VertexBufferLayoutDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
VertexBufferLayoutDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VertexBufferLayoutDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=VertexBufferLayoutDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
VertexBufferLayoutDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VertexBufferLayoutDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
