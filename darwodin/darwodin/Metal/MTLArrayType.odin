...
@(objc_type=ArrayType, objc_name="poseAsClass", objc_is_class_method=true)
ArrayType_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ArrayType, "poseAsClass:", aClass)
}
...
@(objc_type=ArrayType, objc_name="setKeys", objc_is_class_method=true)
ArrayType_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ArrayType, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
