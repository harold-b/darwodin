...
@(objc_type=StageInputOutputDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
StageInputOutputDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, StageInputOutputDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=StageInputOutputDescriptor, objc_name="setKeys", objc_is_class_method=true)
StageInputOutputDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, StageInputOutputDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
