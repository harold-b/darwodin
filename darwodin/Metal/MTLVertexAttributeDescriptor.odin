...
@(objc_type=VertexAttributeDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
VertexAttributeDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VertexAttributeDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=VertexAttributeDescriptor, objc_name="setKeys", objc_is_class_method=true)
VertexAttributeDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VertexAttributeDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
