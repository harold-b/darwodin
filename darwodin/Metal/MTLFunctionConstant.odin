...
@(objc_type=FunctionConstant, objc_name="poseAsClass", objc_is_class_method=true)
FunctionConstant_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionConstant, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionConstant, objc_name="setKeys", objc_is_class_method=true)
FunctionConstant_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionConstant, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
