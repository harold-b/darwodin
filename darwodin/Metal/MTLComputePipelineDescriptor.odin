...
@(objc_type=ComputePipelineDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
ComputePipelineDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ComputePipelineDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=ComputePipelineDescriptor, objc_name="setKeys", objc_is_class_method=true)
ComputePipelineDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ComputePipelineDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
