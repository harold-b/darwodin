...
DataProviderGetBytePointerCallback :: distinct proc "c" (info: rawptr) -> rawptr

/// CGDataProviderReleaseBytePointerCallback
DataProviderReleaseBytePointerCallback :: distinct proc "c" (info: rawptr, pointer: rawptr)
