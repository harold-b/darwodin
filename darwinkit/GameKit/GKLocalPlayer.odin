...
foreign lib {
    ...
    LocalPlayer_presentFriendRequestCreatorFromViewController :: proc(self: ^LocalPlayer, viewController: ^AKViewController, error: ^^NS.Error) -> bool ---
    ...
    LocalPlayer_presentFriendRequestCreatorFromWindow :: proc(self: ^LocalPlayer, window: ^AKWindow, error: ^^NS.Error) -> bool ---
