...
foreign lib {
	...
	LocalPlayer_presentFriendRequestCreatorFromViewController :: proc(self: ^LocalPlayer, viewController: ^UI_ViewController, error: ^^NS.Error) -> bool ---
	...
	LocalPlayer_presentFriendRequestCreatorFromWindow :: proc(self: ^LocalPlayer, window: ^UI_Window, error: ^^NS.Error) -> bool ---
