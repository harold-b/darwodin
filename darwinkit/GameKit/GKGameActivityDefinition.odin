...
foreign lib {
	...
	GameActivityDefinition_loadImageWithCompletionHandler :: proc(self: ^GameActivityDefinition, completionHandler: ^Objc_Block(proc "c" ( image: ^UI_Image, error: ^NS.Error ))) ---
