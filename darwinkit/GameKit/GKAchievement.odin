...
foreign lib {
	...
	Achievement_challengeComposeControllerWithPlayers :: proc(self: ^Achievement, playerIDs: ^NS.Array, message: ^NS.String, completionHandler: ChallengeComposeCompletionBlock) -> ^UI_ViewController ---
}
