...
foreign lib {
	when ODIN_PLATFORM_SUBTARGET == .Default {
		@(link_name="kSecPropertyKeyType")
		kSecPropertyKeyType: CF.StringRef

		@(link_name="kSecPropertyKeyLabel")
		kSecPropertyKeyLabel: CF.StringRef

		@(link_name="kSecPropertyKeyLocalizedLabel")
		kSecPropertyKeyLocalizedLabel: CF.StringRef

		@(link_name="kSecPropertyKeyValue")
		kSecPropertyKeyValue: CF.StringRef

		@(link_name="kSecPropertyTypeWarning")
		kSecPropertyTypeWarning: CF.StringRef

		@(link_name="kSecPropertyTypeSuccess")
		kSecPropertyTypeSuccess: CF.StringRef

		@(link_name="kSecPropertyTypeSection")
		kSecPropertyTypeSection: CF.StringRef

		@(link_name="kSecPropertyTypeData")
		kSecPropertyTypeData: CF.StringRef

		@(link_name="kSecPropertyTypeString")
		kSecPropertyTypeString: CF.StringRef

		@(link_name="kSecPropertyTypeURL")
		kSecPropertyTypeURL: CF.StringRef

		@(link_name="kSecPropertyTypeDate")
		kSecPropertyTypeDate: CF.StringRef

		@(link_name="kSecPropertyTypeArray")
		kSecPropertyTypeArray: CF.StringRef

		@(link_name="kSecPropertyTypeNumber")
		kSecPropertyTypeNumber: CF.StringRef

		@(link_name="kSecIdentityDomainDefault")
		kSecIdentityDomainDefault: CF.StringRef

		@(link_name="kSecIdentityDomainKerberosKDC")
		kSecIdentityDomainKerberosKDC: CF.StringRef
	}

	@(link_name="kSecClass")
	kSecClass: CF.StringRef

	@(link_name="kSecClassInternetPassword")
	kSecClassInternetPassword: CF.StringRef

	@(link_name="kSecClassGenericPassword")
	kSecClassGenericPassword: CF.StringRef

	@(link_name="kSecClassCertificate")
	kSecClassCertificate: CF.StringRef

	@(link_name="kSecClassKey")
	kSecClassKey: CF.StringRef

	@(link_name="kSecClassIdentity")
	kSecClassIdentity: CF.StringRef

	@(link_name="kSecAttrAccessible")
	kSecAttrAccessible: CF.StringRef

	@(link_name="kSecAttrAccess")
	kSecAttrAccess: CF.StringRef

	@(link_name="kSecAttrAccessControl")
	kSecAttrAccessControl: CF.StringRef

	@(link_name="kSecAttrAccessGroup")
	kSecAttrAccessGroup: CF.StringRef

	@(link_name="kSecAttrSynchronizable")
	kSecAttrSynchronizable: CF.StringRef

	@(link_name="kSecAttrSynchronizableAny")
	kSecAttrSynchronizableAny: CF.StringRef

	@(link_name="kSecAttrCreationDate")
	kSecAttrCreationDate: CF.StringRef

	@(link_name="kSecAttrModificationDate")
	kSecAttrModificationDate: CF.StringRef

	@(link_name="kSecAttrDescription")
	kSecAttrDescription: CF.StringRef

	@(link_name="kSecAttrComment")
	kSecAttrComment: CF.StringRef

	@(link_name="kSecAttrCreator")
	kSecAttrCreator: CF.StringRef

	@(link_name="kSecAttrType")
	kSecAttrType: CF.StringRef

	@(link_name="kSecAttrLabel")
	kSecAttrLabel: CF.StringRef

	@(link_name="kSecAttrIsInvisible")
	kSecAttrIsInvisible: CF.StringRef

	@(link_name="kSecAttrIsNegative")
	kSecAttrIsNegative: CF.StringRef

	@(link_name="kSecAttrAccount")
	kSecAttrAccount: CF.StringRef

	@(link_name="kSecAttrService")
	kSecAttrService: CF.StringRef

	@(link_name="kSecAttrGeneric")
	kSecAttrGeneric: CF.StringRef

	@(link_name="kSecAttrSecurityDomain")
	kSecAttrSecurityDomain: CF.StringRef

	@(link_name="kSecAttrServer")
	kSecAttrServer: CF.StringRef

	@(link_name="kSecAttrProtocol")
	kSecAttrProtocol: CF.StringRef

	@(link_name="kSecAttrAuthenticationType")
	kSecAttrAuthenticationType: CF.StringRef

	@(link_name="kSecAttrPort")
	kSecAttrPort: CF.StringRef

	@(link_name="kSecAttrPath")
	kSecAttrPath: CF.StringRef

	@(link_name="kSecAttrSubject")
	kSecAttrSubject: CF.StringRef

	@(link_name="kSecAttrIssuer")
	kSecAttrIssuer: CF.StringRef

	@(link_name="kSecAttrSerialNumber")
	kSecAttrSerialNumber: CF.StringRef

	@(link_name="kSecAttrSubjectKeyID")
	kSecAttrSubjectKeyID: CF.StringRef

	@(link_name="kSecAttrPublicKeyHash")
	kSecAttrPublicKeyHash: CF.StringRef

	@(link_name="kSecAttrCertificateType")
	kSecAttrCertificateType: CF.StringRef

	@(link_name="kSecAttrCertificateEncoding")
	kSecAttrCertificateEncoding: CF.StringRef

	@(link_name="kSecAttrKeyClass")
	kSecAttrKeyClass: CF.StringRef

	@(link_name="kSecAttrApplicationLabel")
	kSecAttrApplicationLabel: CF.StringRef

	@(link_name="kSecAttrIsPermanent")
	kSecAttrIsPermanent: CF.StringRef

	@(link_name="kSecAttrIsSensitive")
	kSecAttrIsSensitive: CF.StringRef

	@(link_name="kSecAttrIsExtractable")
	kSecAttrIsExtractable: CF.StringRef

	@(link_name="kSecAttrApplicationTag")
	kSecAttrApplicationTag: CF.StringRef

	@(link_name="kSecAttrKeyType")
	kSecAttrKeyType: CF.StringRef

	@(link_name="kSecAttrPRF")
	kSecAttrPRF: CF.StringRef

	@(link_name="kSecAttrSalt")
	kSecAttrSalt: CF.StringRef

	@(link_name="kSecAttrRounds")
	kSecAttrRounds: CF.StringRef

	@(link_name="kSecAttrKeySizeInBits")
	kSecAttrKeySizeInBits: CF.StringRef

	@(link_name="kSecAttrEffectiveKeySize")
	kSecAttrEffectiveKeySize: CF.StringRef

	@(link_name="kSecAttrCanEncrypt")
	kSecAttrCanEncrypt: CF.StringRef

	@(link_name="kSecAttrCanDecrypt")
	kSecAttrCanDecrypt: CF.StringRef

	@(link_name="kSecAttrCanDerive")
	kSecAttrCanDerive: CF.StringRef

	@(link_name="kSecAttrCanSign")
	kSecAttrCanSign: CF.StringRef

	@(link_name="kSecAttrCanVerify")
	kSecAttrCanVerify: CF.StringRef

	@(link_name="kSecAttrCanWrap")
	kSecAttrCanWrap: CF.StringRef

	@(link_name="kSecAttrCanUnwrap")
	kSecAttrCanUnwrap: CF.StringRef

	@(link_name="kSecAttrSyncViewHint")
	kSecAttrSyncViewHint: CF.StringRef

	@(link_name="kSecAttrTokenID")
	kSecAttrTokenID: CF.StringRef

	@(link_name="kSecAttrPersistantReference")
	kSecAttrPersistantReference: CF.StringRef

	@(link_name="kSecAttrPersistentReference")
	kSecAttrPersistentReference: CF.StringRef

	@(link_name="kSecAttrAccessibleWhenUnlocked")
	kSecAttrAccessibleWhenUnlocked: CF.StringRef

	@(link_name="kSecAttrAccessibleAfterFirstUnlock")
	kSecAttrAccessibleAfterFirstUnlock: CF.StringRef

	@(link_name="kSecAttrAccessibleAlways")
	kSecAttrAccessibleAlways: CF.StringRef

	@(link_name="kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly")
	kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly: CF.StringRef

	@(link_name="kSecAttrAccessibleWhenUnlockedThisDeviceOnly")
	kSecAttrAccessibleWhenUnlockedThisDeviceOnly: CF.StringRef

	@(link_name="kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly")
	kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly: CF.StringRef

	@(link_name="kSecAttrAccessibleAlwaysThisDeviceOnly")
	kSecAttrAccessibleAlwaysThisDeviceOnly: CF.StringRef

	@(link_name="kSecAttrProtocolFTP")
	kSecAttrProtocolFTP: CF.StringRef

	@(link_name="kSecAttrProtocolFTPAccount")
	kSecAttrProtocolFTPAccount: CF.StringRef

	@(link_name="kSecAttrProtocolHTTP")
	kSecAttrProtocolHTTP: CF.StringRef

	@(link_name="kSecAttrProtocolIRC")
	kSecAttrProtocolIRC: CF.StringRef

	@(link_name="kSecAttrProtocolNNTP")
	kSecAttrProtocolNNTP: CF.StringRef

	@(link_name="kSecAttrProtocolPOP3")
	kSecAttrProtocolPOP3: CF.StringRef

	@(link_name="kSecAttrProtocolSMTP")
	kSecAttrProtocolSMTP: CF.StringRef

	@(link_name="kSecAttrProtocolSOCKS")
	kSecAttrProtocolSOCKS: CF.StringRef

	@(link_name="kSecAttrProtocolIMAP")
	kSecAttrProtocolIMAP: CF.StringRef

	@(link_name="kSecAttrProtocolLDAP")
	kSecAttrProtocolLDAP: CF.StringRef

	@(link_name="kSecAttrProtocolAppleTalk")
	kSecAttrProtocolAppleTalk: CF.StringRef

	@(link_name="kSecAttrProtocolAFP")
	kSecAttrProtocolAFP: CF.StringRef

	@(link_name="kSecAttrProtocolTelnet")
	kSecAttrProtocolTelnet: CF.StringRef

	@(link_name="kSecAttrProtocolSSH")
	kSecAttrProtocolSSH: CF.StringRef

	@(link_name="kSecAttrProtocolFTPS")
	kSecAttrProtocolFTPS: CF.StringRef

	@(link_name="kSecAttrProtocolHTTPS")
	kSecAttrProtocolHTTPS: CF.StringRef

	@(link_name="kSecAttrProtocolHTTPProxy")
	kSecAttrProtocolHTTPProxy: CF.StringRef

	@(link_name="kSecAttrProtocolHTTPSProxy")
	kSecAttrProtocolHTTPSProxy: CF.StringRef

	@(link_name="kSecAttrProtocolFTPProxy")
	kSecAttrProtocolFTPProxy: CF.StringRef

	@(link_name="kSecAttrProtocolSMB")
	kSecAttrProtocolSMB: CF.StringRef

	@(link_name="kSecAttrProtocolRTSP")
	kSecAttrProtocolRTSP: CF.StringRef

	@(link_name="kSecAttrProtocolRTSPProxy")
	kSecAttrProtocolRTSPProxy: CF.StringRef

	@(link_name="kSecAttrProtocolDAAP")
	kSecAttrProtocolDAAP: CF.StringRef

	@(link_name="kSecAttrProtocolEPPC")
	kSecAttrProtocolEPPC: CF.StringRef

	@(link_name="kSecAttrProtocolIPP")
	kSecAttrProtocolIPP: CF.StringRef

	@(link_name="kSecAttrProtocolNNTPS")
	kSecAttrProtocolNNTPS: CF.StringRef

	@(link_name="kSecAttrProtocolLDAPS")
	kSecAttrProtocolLDAPS: CF.StringRef

	@(link_name="kSecAttrProtocolTelnetS")
	kSecAttrProtocolTelnetS: CF.StringRef

	@(link_name="kSecAttrProtocolIMAPS")
	kSecAttrProtocolIMAPS: CF.StringRef

	@(link_name="kSecAttrProtocolIRCS")
	kSecAttrProtocolIRCS: CF.StringRef

	@(link_name="kSecAttrProtocolPOP3S")
	kSecAttrProtocolPOP3S: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeNTLM")
	kSecAttrAuthenticationTypeNTLM: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeMSN")
	kSecAttrAuthenticationTypeMSN: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeDPA")
	kSecAttrAuthenticationTypeDPA: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeRPA")
	kSecAttrAuthenticationTypeRPA: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeHTTPBasic")
	kSecAttrAuthenticationTypeHTTPBasic: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeHTTPDigest")
	kSecAttrAuthenticationTypeHTTPDigest: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeHTMLForm")
	kSecAttrAuthenticationTypeHTMLForm: CF.StringRef

	@(link_name="kSecAttrAuthenticationTypeDefault")
	kSecAttrAuthenticationTypeDefault: CF.StringRef

	@(link_name="kSecAttrKeyClassPublic")
	kSecAttrKeyClassPublic: CF.StringRef

	@(link_name="kSecAttrKeyClassPrivate")
	kSecAttrKeyClassPrivate: CF.StringRef

	@(link_name="kSecAttrKeyClassSymmetric")
	kSecAttrKeyClassSymmetric: CF.StringRef

	@(link_name="kSecAttrKeyTypeRSA")
	kSecAttrKeyTypeRSA: CF.StringRef

	@(link_name="kSecAttrKeyTypeDSA")
	kSecAttrKeyTypeDSA: CF.StringRef

	@(link_name="kSecAttrKeyTypeAES")
	kSecAttrKeyTypeAES: CF.StringRef

	@(link_name="kSecAttrKeyTypeDES")
	kSecAttrKeyTypeDES: CF.StringRef

	@(link_name="kSecAttrKeyType3DES")
	kSecAttrKeyType3DES: CF.StringRef

	@(link_name="kSecAttrKeyTypeRC4")
	kSecAttrKeyTypeRC4: CF.StringRef

	@(link_name="kSecAttrKeyTypeRC2")
	kSecAttrKeyTypeRC2: CF.StringRef

	@(link_name="kSecAttrKeyTypeCAST")
	kSecAttrKeyTypeCAST: CF.StringRef

	@(link_name="kSecAttrKeyTypeECDSA")
	kSecAttrKeyTypeECDSA: CF.StringRef

	@(link_name="kSecAttrKeyTypeEC")
	kSecAttrKeyTypeEC: CF.StringRef

	@(link_name="kSecAttrKeyTypeECSECPrimeRandom")
	kSecAttrKeyTypeECSECPrimeRandom: CF.StringRef

	@(link_name="kSecAttrPRFHmacAlgSHA1")
	kSecAttrPRFHmacAlgSHA1: CF.StringRef

	@(link_name="kSecAttrPRFHmacAlgSHA224")
	kSecAttrPRFHmacAlgSHA224: CF.StringRef

	@(link_name="kSecAttrPRFHmacAlgSHA256")
	kSecAttrPRFHmacAlgSHA256: CF.StringRef

	@(link_name="kSecAttrPRFHmacAlgSHA384")
	kSecAttrPRFHmacAlgSHA384: CF.StringRef

	@(link_name="kSecAttrPRFHmacAlgSHA512")
	kSecAttrPRFHmacAlgSHA512: CF.StringRef

	@(link_name="kSecMatchPolicy")
	kSecMatchPolicy: CF.StringRef

	@(link_name="kSecMatchItemList")
	kSecMatchItemList: CF.StringRef

	@(link_name="kSecMatchSearchList")
	kSecMatchSearchList: CF.StringRef

	@(link_name="kSecMatchIssuers")
	kSecMatchIssuers: CF.StringRef

	@(link_name="kSecMatchEmailAddressIfPresent")
	kSecMatchEmailAddressIfPresent: CF.StringRef

	@(link_name="kSecMatchSubjectContains")
	kSecMatchSubjectContains: CF.StringRef

	@(link_name="kSecMatchHostOrSubdomainOfHost")
	kSecMatchHostOrSubdomainOfHost: CF.StringRef

	@(link_name="kSecMatchSubjectStartsWith")
	kSecMatchSubjectStartsWith: CF.StringRef

	@(link_name="kSecMatchSubjectEndsWith")
	kSecMatchSubjectEndsWith: CF.StringRef

	@(link_name="kSecMatchSubjectWholeString")
	kSecMatchSubjectWholeString: CF.StringRef

	@(link_name="kSecMatchCaseInsensitive")
	kSecMatchCaseInsensitive: CF.StringRef

	@(link_name="kSecMatchDiacriticInsensitive")
	kSecMatchDiacriticInsensitive: CF.StringRef

	@(link_name="kSecMatchWidthInsensitive")
	kSecMatchWidthInsensitive: CF.StringRef

	@(link_name="kSecMatchTrustedOnly")
	kSecMatchTrustedOnly: CF.StringRef

	@(link_name="kSecMatchValidOnDate")
	kSecMatchValidOnDate: CF.StringRef

	@(link_name="kSecMatchLimit")
	kSecMatchLimit: CF.StringRef

	@(link_name="kSecMatchLimitOne")
	kSecMatchLimitOne: CF.StringRef

	@(link_name="kSecMatchLimitAll")
	kSecMatchLimitAll: CF.StringRef

	@(link_name="kSecReturnData")
	kSecReturnData: CF.StringRef

	@(link_name="kSecReturnAttributes")
	kSecReturnAttributes: CF.StringRef

	@(link_name="kSecReturnRef")
	kSecReturnRef: CF.StringRef

	@(link_name="kSecReturnPersistentRef")
	kSecReturnPersistentRef: CF.StringRef

	@(link_name="kSecValueData")
	kSecValueData: CF.StringRef

	@(link_name="kSecValueRef")
	kSecValueRef: CF.StringRef

	@(link_name="kSecValuePersistentRef")
	kSecValuePersistentRef: CF.StringRef

	@(link_name="kSecUseItemList")
	kSecUseItemList: CF.StringRef

	@(link_name="kSecUseKeychain")
	kSecUseKeychain: CF.StringRef

	@(link_name="kSecUseOperationPrompt")
	kSecUseOperationPrompt: CF.StringRef

	@(link_name="kSecUseNoAuthenticationUI")
	kSecUseNoAuthenticationUI: CF.StringRef

	@(link_name="kSecUseAuthenticationUI")
	kSecUseAuthenticationUI: CF.StringRef

	@(link_name="kSecUseAuthenticationContext")
	kSecUseAuthenticationContext: CF.StringRef

	@(link_name="kSecUseDataProtectionKeychain")
	kSecUseDataProtectionKeychain: CF.StringRef

	@(link_name="kSecUseUserIndependentKeychain")
	kSecUseUserIndependentKeychain: CF.StringRef

	@(link_name="kSecUseAuthenticationUIAllow")
	kSecUseAuthenticationUIAllow: CF.StringRef

	@(link_name="kSecUseAuthenticationUIFail")
	kSecUseAuthenticationUIFail: CF.StringRef

	@(link_name="kSecUseAuthenticationUISkip")
	kSecUseAuthenticationUISkip: CF.StringRef

	@(link_name="kSecAttrTokenIDSecureEnclave")
	kSecAttrTokenIDSecureEnclave: CF.StringRef

	@(link_name="kSecAttrAccessGroupToken")
	kSecAttrAccessGroupToken: CF.StringRef

	when ODIN_PLATFORM_SUBTARGET == .Default {
		@(link_name="kSecACLAuthorizationAny")
		kSecACLAuthorizationAny: CF.StringRef

		@(link_name="kSecACLAuthorizationLogin")
		kSecACLAuthorizationLogin: CF.StringRef

		@(link_name="kSecACLAuthorizationGenKey")
		kSecACLAuthorizationGenKey: CF.StringRef

		@(link_name="kSecACLAuthorizationDelete")
		kSecACLAuthorizationDelete: CF.StringRef

		@(link_name="kSecACLAuthorizationExportWrapped")
		kSecACLAuthorizationExportWrapped: CF.StringRef

		@(link_name="kSecACLAuthorizationExportClear")
		kSecACLAuthorizationExportClear: CF.StringRef

		@(link_name="kSecACLAuthorizationImportWrapped")
		kSecACLAuthorizationImportWrapped: CF.StringRef

		@(link_name="kSecACLAuthorizationImportClear")
		kSecACLAuthorizationImportClear: CF.StringRef

		@(link_name="kSecACLAuthorizationSign")
		kSecACLAuthorizationSign: CF.StringRef

		@(link_name="kSecACLAuthorizationEncrypt")
		kSecACLAuthorizationEncrypt: CF.StringRef

		@(link_name="kSecACLAuthorizationDecrypt")
		kSecACLAuthorizationDecrypt: CF.StringRef

		@(link_name="kSecACLAuthorizationMAC")
		kSecACLAuthorizationMAC: CF.StringRef

		@(link_name="kSecACLAuthorizationDerive")
		kSecACLAuthorizationDerive: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainCreate")
		kSecACLAuthorizationKeychainCreate: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainDelete")
		kSecACLAuthorizationKeychainDelete: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainItemRead")
		kSecACLAuthorizationKeychainItemRead: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainItemInsert")
		kSecACLAuthorizationKeychainItemInsert: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainItemModify")
		kSecACLAuthorizationKeychainItemModify: CF.StringRef

		@(link_name="kSecACLAuthorizationKeychainItemDelete")
		kSecACLAuthorizationKeychainItemDelete: CF.StringRef

		@(link_name="kSecACLAuthorizationChangeACL")
		kSecACLAuthorizationChangeACL: CF.StringRef

		@(link_name="kSecACLAuthorizationChangeOwner")
		kSecACLAuthorizationChangeOwner: CF.StringRef

		@(link_name="kSecACLAuthorizationPartitionID")
		kSecACLAuthorizationPartitionID: CF.StringRef

		@(link_name="kSecACLAuthorizationIntegrity")
		kSecACLAuthorizationIntegrity: CF.StringRef
	}

	@(link_name="kSecPrivateKeyAttrs")
	kSecPrivateKeyAttrs: CF.StringRef

	@(link_name="kSecPublicKeyAttrs")
	kSecPublicKeyAttrs: CF.StringRef

	@(link_name="kSecKeyAlgorithmRSASignatureRaw")
	kSecKeyAlgorithmRSASignatureRaw: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15Raw")
	kSecKeyAlgorithmRSASignatureDigestPKCS1v15Raw: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA1")
	kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA224")
	kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA224: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA256")
	kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA256: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA384")
	kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA384: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPKCS1v15SHA512")
	...
	@(link_name="kSecKeyAlgorithmRSASignatureMessagePKCS1v15SHA224")
	...
	@(link_name="kSecKeyAlgorithmRSASignatureDigestPSSSHA1")
	kSecKeyAlgorithmRSASignatureDigestPSSSHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPSSSHA224")
	kSecKeyAlgorithmRSASignatureDigestPSSSHA224: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPSSSHA256")
	kSecKeyAlgorithmRSASignatureDigestPSSSHA256: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPSSSHA384")
	kSecKeyAlgorithmRSASignatureDigestPSSSHA384: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSASignatureDigestPSSSHA512")
	...
	@(link_name="kSecKeyAlgorithmRSASignatureMessagePSSSHA224")
	...
	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962")
	kSecKeyAlgorithmECDSASignatureDigestX962: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962SHA1")
	kSecKeyAlgorithmECDSASignatureDigestX962SHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962SHA224")
	kSecKeyAlgorithmECDSASignatureDigestX962SHA224: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962SHA256")
	kSecKeyAlgorithmECDSASignatureDigestX962SHA256: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962SHA384")
	kSecKeyAlgorithmECDSASignatureDigestX962SHA384: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureDigestX962SHA512")
	kSecKeyAlgorithmECDSASignatureDigestX962SHA512: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureMessageX962SHA1")
	kSecKeyAlgorithmECDSASignatureMessageX962SHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDSASignatureMessageX962SHA224")
	...
	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA224")
	...
	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA1AESGCM")
	kSecKeyAlgorithmRSAEncryptionOAEPSHA1AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA224AESGCM")
	kSecKeyAlgorithmRSAEncryptionOAEPSHA224AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA256AESGCM")
	kSecKeyAlgorithmRSAEncryptionOAEPSHA256AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA384AESGCM")
	kSecKeyAlgorithmRSAEncryptionOAEPSHA384AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmRSAEncryptionOAEPSHA512AESGCM")
	kSecKeyAlgorithmRSAEncryptionOAEPSHA512AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardX963SHA1AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardX963SHA1AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardX963SHA224AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardX963SHA224AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardX963SHA256AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardX963SHA256AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardX963SHA384AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardX963SHA384AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardX963SHA512AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardX963SHA512AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorX963SHA1AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorX963SHA1AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorX963SHA224AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorX963SHA224AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorX963SHA256AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorX963SHA256AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorX963SHA384AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorX963SHA384AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorX963SHA512AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorX963SHA512AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA224AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA224AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA256AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA256AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA384AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA384AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA512AESGCM")
	kSecKeyAlgorithmECIESEncryptionStandardVariableIVX963SHA512AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA224AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA224AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA256AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA256AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA384AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA384AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA512AESGCM")
	kSecKeyAlgorithmECIESEncryptionCofactorVariableIVX963SHA512AESGCM: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandard")
	kSecKeyAlgorithmECDHKeyExchangeStandard: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA1")
	kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA224")
	kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA224: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA256")
	kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA256: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA384")
	kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA384: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA512")
	kSecKeyAlgorithmECDHKeyExchangeStandardX963SHA512: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactor")
	kSecKeyAlgorithmECDHKeyExchangeCofactor: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA1")
	kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA1: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA224")
	kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA224: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA256")
	kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA256: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA384")
	kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA384: SecKeyAlgorithm

	@(link_name="kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA512")
	kSecKeyAlgorithmECDHKeyExchangeCofactorX963SHA512: SecKeyAlgorithm

	@(link_name="kSecKeyKeyExchangeParameterRequestedSize")
	kSecKeyKeyExchangeParameterRequestedSize: SecKeyKeyExchangeParameter

	@(link_name="kSecKeyKeyExchangeParameterSharedInfo")
	kSecKeyKeyExchangeParameterSharedInfo: SecKeyKeyExchangeParameter

	@(link_name="kSecPolicyAppleX509Basic")
	kSecPolicyAppleX509Basic: CF.StringRef

	@(link_name="kSecPolicyAppleSSL")
	kSecPolicyAppleSSL: CF.StringRef

	@(link_name="kSecPolicyAppleSMIME")
	kSecPolicyAppleSMIME: CF.StringRef

	@(link_name="kSecPolicyAppleEAP")
	kSecPolicyAppleEAP: CF.StringRef

	@(link_name="kSecPolicyAppleIPsec")
	kSecPolicyAppleIPsec: CF.StringRef

	when ODIN_PLATFORM_SUBTARGET == .Default {
		@(link_name="kSecPolicyAppleiChat")
		kSecPolicyAppleiChat: CF.StringRef
	}

	@(link_name="kSecPolicyApplePKINITClient")
	kSecPolicyApplePKINITClient: CF.StringRef

	@(link_name="kSecPolicyApplePKINITServer")
	kSecPolicyApplePKINITServer: CF.StringRef

	@(link_name="kSecPolicyAppleCodeSigning")
	kSecPolicyAppleCodeSigning: CF.StringRef

	@(link_name="kSecPolicyMacAppStoreReceipt")
	kSecPolicyMacAppStoreReceipt: CF.StringRef

	@(link_name="kSecPolicyAppleIDValidation")
	kSecPolicyAppleIDValidation: CF.StringRef

	@(link_name="kSecPolicyAppleTimeStamping")
	kSecPolicyAppleTimeStamping: CF.StringRef

	@(link_name="kSecPolicyAppleRevocation")
	kSecPolicyAppleRevocation: CF.StringRef

	@(link_name="kSecPolicyApplePassbookSigning")
	kSecPolicyApplePassbookSigning: CF.StringRef

	@(link_name="kSecPolicyApplePayIssuerEncryption")
	kSecPolicyApplePayIssuerEncryption: CF.StringRef

	@(link_name="kSecPolicyAppleSSLServer")
	kSecPolicyAppleSSLServer: CF.StringRef

	@(link_name="kSecPolicyAppleSSLClient")
	kSecPolicyAppleSSLClient: CF.StringRef

	@(link_name="kSecPolicyAppleEAPServer")
	kSecPolicyAppleEAPServer: CF.StringRef

	@(link_name="kSecPolicyAppleEAPClient")
	kSecPolicyAppleEAPClient: CF.StringRef

	@(link_name="kSecPolicyAppleIPSecServer")
	kSecPolicyAppleIPSecServer: CF.StringRef

	@(link_name="kSecPolicyAppleIPSecClient")
	kSecPolicyAppleIPSecClient: CF.StringRef

	@(link_name="kSecPolicyOid")
	kSecPolicyOid: CF.StringRef

	@(link_name="kSecPolicyName")
	kSecPolicyName: CF.StringRef

	@(link_name="kSecPolicyClient")
	kSecPolicyClient: CF.StringRef

	@(link_name="kSecPolicyRevocationFlags")
	kSecPolicyRevocationFlags: CF.StringRef

	@(link_name="kSecPolicyTeamIdentifier")
	kSecPolicyTeamIdentifier: CF.StringRef

	when ODIN_PLATFORM_SUBTARGET == .Default {
		@(link_name="kSecPolicyKU_DigitalSignature")
		kSecPolicyKU_DigitalSignature: CF.StringRef

		@(link_name="kSecPolicyKU_NonRepudiation")
		kSecPolicyKU_NonRepudiation: CF.StringRef

		@(link_name="kSecPolicyKU_KeyEncipherment")
		kSecPolicyKU_KeyEncipherment: CF.StringRef

		@(link_name="kSecPolicyKU_DataEncipherment")
		kSecPolicyKU_DataEncipherment: CF.StringRef

		@(link_name="kSecPolicyKU_KeyAgreement")
		kSecPolicyKU_KeyAgreement: CF.StringRef

		@(link_name="kSecPolicyKU_KeyCertSign")
		kSecPolicyKU_KeyCertSign: CF.StringRef

		@(link_name="kSecPolicyKU_CRLSign")
		kSecPolicyKU_CRLSign: CF.StringRef

		@(link_name="kSecPolicyKU_EncipherOnly")
		kSecPolicyKU_EncipherOnly: CF.StringRef

		@(link_name="kSecPolicyKU_DecipherOnly")
		kSecPolicyKU_DecipherOnly: CF.StringRef
	}

	@(link_name="kSecRandomDefault")
	kSecRandomDefault: SecRandomRef

	@(link_name="kSecImportExportPassphrase")
	kSecImportExportPassphrase: CF.StringRef

	@(link_name="kSecImportExportKeychain")
	kSecImportExportKeychain: CF.StringRef

	@(link_name="kSecImportExportAccess")
	kSecImportExportAccess: CF.StringRef

	@(link_name="kSecImportToMemoryOnly")
	kSecImportToMemoryOnly: CF.StringRef

	@(link_name="kSecImportItemLabel")
	kSecImportItemLabel: CF.StringRef

	@(link_name="kSecImportItemKeyID")
	kSecImportItemKeyID: CF.StringRef

	@(link_name="kSecImportItemTrust")
	kSecImportItemTrust: CF.StringRef

	@(link_name="kSecImportItemCertChain")
	kSecImportItemCertChain: CF.StringRef

	@(link_name="kSecImportItemIdentity")
	kSecImportItemIdentity: CF.StringRef

	@(link_name="kSecPropertyTypeTitle")
	kSecPropertyTypeTitle: CF.StringRef

	@(link_name="kSecPropertyTypeError")
	kSecPropertyTypeError: CF.StringRef

	@(link_name="kSecTrustEvaluationDate")
	kSecTrustEvaluationDate: CF.StringRef

	@(link_name="kSecTrustExtendedValidation")
	kSecTrustExtendedValidation: CF.StringRef

	@(link_name="kSecTrustOrganizationName")
	kSecTrustOrganizationName: CF.StringRef

	@(link_name="kSecTrustResultValue")
	kSecTrustResultValue: CF.StringRef

	@(link_name="kSecTrustRevocationChecked")
	kSecTrustRevocationChecked: CF.StringRef

	@(link_name="kSecTrustRevocationValidUntilDate")
	kSecTrustRevocationValidUntilDate: CF.StringRef

	@(link_name="kSecTrustCertificateTransparency")
	kSecTrustCertificateTransparency: CF.StringRef

	@(link_name="kSecTrustCertificateTransparencyWhiteList")
	kSecTrustCertificateTransparencyWhiteList: CF.StringRef

	@(link_name="kSecTrustQCStatements")
	kSecTrustQCStatements: CF.StringRef

	@(link_name="kSecTrustQWACValidation")
	kSecTrustQWACValidation: CF.StringRef

	@(link_name="kSecSharedPassword")
	kSecSharedPassword: CF.StringRef

	when ODIN_PLATFORM_SUBTARGET == .Default {
		@(link_name="kSecOIDADC_CERT_POLICY")
		kSecOIDADC_CERT_POLICY: CF.StringRef

		@(link_name="kSecOIDAPPLE_CERT_POLICY")
		kSecOIDAPPLE_CERT_POLICY: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_CODE_SIGNING")
		kSecOIDAPPLE_EKU_CODE_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_CODE_SIGNING_DEV")
		kSecOIDAPPLE_EKU_CODE_SIGNING_DEV: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_ICHAT_ENCRYPTION")
		kSecOIDAPPLE_EKU_ICHAT_ENCRYPTION: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_ICHAT_SIGNING")
		kSecOIDAPPLE_EKU_ICHAT_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_RESOURCE_SIGNING")
		kSecOIDAPPLE_EKU_RESOURCE_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EKU_SYSTEM_IDENTITY")
		kSecOIDAPPLE_EKU_SYSTEM_IDENTITY: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION")
		kSecOIDAPPLE_EXTENSION: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_ADC_APPLE_SIGNING")
		kSecOIDAPPLE_EXTENSION_ADC_APPLE_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_ADC_DEV_SIGNING")
		kSecOIDAPPLE_EXTENSION_ADC_DEV_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_APPLE_SIGNING")
		kSecOIDAPPLE_EXTENSION_APPLE_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_CODE_SIGNING")
		kSecOIDAPPLE_EXTENSION_CODE_SIGNING: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_INTERMEDIATE_MARKER")
		kSecOIDAPPLE_EXTENSION_INTERMEDIATE_MARKER: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_WWDR_INTERMEDIATE")
		kSecOIDAPPLE_EXTENSION_WWDR_INTERMEDIATE: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_ITMS_INTERMEDIATE")
		kSecOIDAPPLE_EXTENSION_ITMS_INTERMEDIATE: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_AAI_INTERMEDIATE")
		kSecOIDAPPLE_EXTENSION_AAI_INTERMEDIATE: CF.StringRef

		@(link_name="kSecOIDAPPLE_EXTENSION_APPLEID_INTERMEDIATE")
		kSecOIDAPPLE_EXTENSION_APPLEID_INTERMEDIATE: CF.StringRef

		@(link_name="kSecOIDAuthorityInfoAccess")
		kSecOIDAuthorityInfoAccess: CF.StringRef

		@(link_name="kSecOIDAuthorityKeyIdentifier")
		kSecOIDAuthorityKeyIdentifier: CF.StringRef

		@(link_name="kSecOIDBasicConstraints")
		kSecOIDBasicConstraints: CF.StringRef

		@(link_name="kSecOIDBiometricInfo")
		kSecOIDBiometricInfo: CF.StringRef

		@(link_name="kSecOIDCSSMKeyStruct")
		kSecOIDCSSMKeyStruct: CF.StringRef

		@(link_name="kSecOIDCertIssuer")
		kSecOIDCertIssuer: CF.StringRef

		@(link_name="kSecOIDCertificatePolicies")
		kSecOIDCertificatePolicies: CF.StringRef

		@(link_name="kSecOIDClientAuth")
		kSecOIDClientAuth: CF.StringRef

		@(link_name="kSecOIDCollectiveStateProvinceName")
		kSecOIDCollectiveStateProvinceName: CF.StringRef

		@(link_name="kSecOIDCollectiveStreetAddress")
		kSecOIDCollectiveStreetAddress: CF.StringRef

		@(link_name="kSecOIDCommonName")
		kSecOIDCommonName: CF.StringRef

		@(link_name="kSecOIDCountryName")
		kSecOIDCountryName: CF.StringRef

		@(link_name="kSecOIDCrlDistributionPoints")
		kSecOIDCrlDistributionPoints: CF.StringRef

		@(link_name="kSecOIDCrlNumber")
		kSecOIDCrlNumber: CF.StringRef

		@(link_name="kSecOIDCrlReason")
		kSecOIDCrlReason: CF.StringRef

		@(link_name="kSecOIDDOTMAC_CERT_EMAIL_ENCRYPT")
		kSecOIDDOTMAC_CERT_EMAIL_ENCRYPT: CF.StringRef

		@(link_name="kSecOIDDOTMAC_CERT_EMAIL_SIGN")
		kSecOIDDOTMAC_CERT_EMAIL_SIGN: CF.StringRef

		@(link_name="kSecOIDDOTMAC_CERT_EXTENSION")
		kSecOIDDOTMAC_CERT_EXTENSION: CF.StringRef

		@(link_name="kSecOIDDOTMAC_CERT_IDENTITY")
		kSecOIDDOTMAC_CERT_IDENTITY: CF.StringRef

		@(link_name="kSecOIDDOTMAC_CERT_POLICY")
		kSecOIDDOTMAC_CERT_POLICY: CF.StringRef

		@(link_name="kSecOIDDeltaCrlIndicator")
		kSecOIDDeltaCrlIndicator: CF.StringRef

		@(link_name="kSecOIDDescription")
		kSecOIDDescription: CF.StringRef

		@(link_name="kSecOIDEKU_IPSec")
		kSecOIDEKU_IPSec: CF.StringRef

		@(link_name="kSecOIDEmailAddress")
		kSecOIDEmailAddress: CF.StringRef

		@(link_name="kSecOIDEmailProtection")
		kSecOIDEmailProtection: CF.StringRef

		@(link_name="kSecOIDExtendedKeyUsage")
		kSecOIDExtendedKeyUsage: CF.StringRef

		@(link_name="kSecOIDExtendedKeyUsageAny")
		kSecOIDExtendedKeyUsageAny: CF.StringRef

		@(link_name="kSecOIDExtendedUseCodeSigning")
		kSecOIDExtendedUseCodeSigning: CF.StringRef

		@(link_name="kSecOIDGivenName")
		kSecOIDGivenName: CF.StringRef

		@(link_name="kSecOIDHoldInstructionCode")
		kSecOIDHoldInstructionCode: CF.StringRef

		@(link_name="kSecOIDInvalidityDate")
		kSecOIDInvalidityDate: CF.StringRef

		@(link_name="kSecOIDIssuerAltName")
		kSecOIDIssuerAltName: CF.StringRef

		@(link_name="kSecOIDIssuingDistributionPoint")
		kSecOIDIssuingDistributionPoint: CF.StringRef

		@(link_name="kSecOIDIssuingDistributionPoints")
		kSecOIDIssuingDistributionPoints: CF.StringRef

		@(link_name="kSecOIDKERBv5_PKINIT_KP_CLIENT_AUTH")
		kSecOIDKERBv5_PKINIT_KP_CLIENT_AUTH: CF.StringRef

		@(link_name="kSecOIDKERBv5_PKINIT_KP_KDC")
		kSecOIDKERBv5_PKINIT_KP_KDC: CF.StringRef

		@(link_name="kSecOIDKeyUsage")
		kSecOIDKeyUsage: CF.StringRef

		@(link_name="kSecOIDLocalityName")
		kSecOIDLocalityName: CF.StringRef

		@(link_name="kSecOIDMS_NTPrincipalName")
		kSecOIDMS_NTPrincipalName: CF.StringRef

		@(link_name="kSecOIDMicrosoftSGC")
		kSecOIDMicrosoftSGC: CF.StringRef

		@(link_name="kSecOIDNameConstraints")
		kSecOIDNameConstraints: CF.StringRef

		@(link_name="kSecOIDNetscapeCertSequence")
		kSecOIDNetscapeCertSequence: CF.StringRef

		@(link_name="kSecOIDNetscapeCertType")
		kSecOIDNetscapeCertType: CF.StringRef

		@(link_name="kSecOIDNetscapeSGC")
		kSecOIDNetscapeSGC: CF.StringRef

		@(link_name="kSecOIDOCSPSigning")
		kSecOIDOCSPSigning: CF.StringRef

		@(link_name="kSecOIDOrganizationName")
		kSecOIDOrganizationName: CF.StringRef

		@(link_name="kSecOIDOrganizationalUnitName")
		kSecOIDOrganizationalUnitName: CF.StringRef

		@(link_name="kSecOIDPolicyConstraints")
		kSecOIDPolicyConstraints: CF.StringRef

		@(link_name="kSecOIDPolicyMappings")
		kSecOIDPolicyMappings: CF.StringRef

		@(link_name="kSecOIDPrivateKeyUsagePeriod")
		kSecOIDPrivateKeyUsagePeriod: CF.StringRef

		@(link_name="kSecOIDQC_Statements")
		kSecOIDQC_Statements: CF.StringRef

		@(link_name="kSecOIDSerialNumber")
		kSecOIDSerialNumber: CF.StringRef

		@(link_name="kSecOIDServerAuth")
		kSecOIDServerAuth: CF.StringRef

		@(link_name="kSecOIDStateProvinceName")
		kSecOIDStateProvinceName: CF.StringRef

		@(link_name="kSecOIDStreetAddress")
		kSecOIDStreetAddress: CF.StringRef

		@(link_name="kSecOIDSubjectAltName")
		kSecOIDSubjectAltName: CF.StringRef

		@(link_name="kSecOIDSubjectDirectoryAttributes")
		kSecOIDSubjectDirectoryAttributes: CF.StringRef

		@(link_name="kSecOIDSubjectEmailAddress")
		kSecOIDSubjectEmailAddress: CF.StringRef

		@(link_name="kSecOIDSubjectInfoAccess")
		kSecOIDSubjectInfoAccess: CF.StringRef

		@(link_name="kSecOIDSubjectKeyIdentifier")
		kSecOIDSubjectKeyIdentifier: CF.StringRef

		@(link_name="kSecOIDSubjectPicture")
		kSecOIDSubjectPicture: CF.StringRef

		@(link_name="kSecOIDSubjectSignatureBitmap")
		kSecOIDSubjectSignatureBitmap: CF.StringRef

		@(link_name="kSecOIDSurname")
		kSecOIDSurname: CF.StringRef

		@(link_name="kSecOIDTimeStamping")
		kSecOIDTimeStamping: CF.StringRef

		@(link_name="kSecOIDTitle")
		kSecOIDTitle: CF.StringRef

		@(link_name="kSecOIDUseExemptions")
		kSecOIDUseExemptions: CF.StringRef

		@(link_name="kSecOIDX509V1CertificateIssuerUniqueId")
		kSecOIDX509V1CertificateIssuerUniqueId: CF.StringRef

		@(link_name="kSecOIDX509V1CertificateSubjectUniqueId")
		kSecOIDX509V1CertificateSubjectUniqueId: CF.StringRef

		@(link_name="kSecOIDX509V1IssuerName")
		kSecOIDX509V1IssuerName: CF.StringRef

		@(link_name="kSecOIDX509V1IssuerNameCStruct")
		kSecOIDX509V1IssuerNameCStruct: CF.StringRef

		@(link_name="kSecOIDX509V1IssuerNameLDAP")
		kSecOIDX509V1IssuerNameLDAP: CF.StringRef

		@(link_name="kSecOIDX509V1IssuerNameStd")
		kSecOIDX509V1IssuerNameStd: CF.StringRef

		@(link_name="kSecOIDX509V1SerialNumber")
		kSecOIDX509V1SerialNumber: CF.StringRef

		@(link_name="kSecOIDX509V1Signature")
		kSecOIDX509V1Signature: CF.StringRef

		@(link_name="kSecOIDX509V1SignatureAlgorithm")
		kSecOIDX509V1SignatureAlgorithm: CF.StringRef

		@(link_name="kSecOIDX509V1SignatureAlgorithmParameters")
		kSecOIDX509V1SignatureAlgorithmParameters: CF.StringRef

		@(link_name="kSecOIDX509V1SignatureAlgorithmTBS")
		kSecOIDX509V1SignatureAlgorithmTBS: CF.StringRef

		@(link_name="kSecOIDX509V1SignatureCStruct")
		kSecOIDX509V1SignatureCStruct: CF.StringRef

		@(link_name="kSecOIDX509V1SignatureStruct")
		kSecOIDX509V1SignatureStruct: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectName")
		kSecOIDX509V1SubjectName: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectNameCStruct")
		kSecOIDX509V1SubjectNameCStruct: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectNameLDAP")
		kSecOIDX509V1SubjectNameLDAP: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectNameStd")
		kSecOIDX509V1SubjectNameStd: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectPublicKey")
		kSecOIDX509V1SubjectPublicKey: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectPublicKeyAlgorithm")
		kSecOIDX509V1SubjectPublicKeyAlgorithm: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectPublicKeyAlgorithmParameters")
		kSecOIDX509V1SubjectPublicKeyAlgorithmParameters: CF.StringRef

		@(link_name="kSecOIDX509V1SubjectPublicKeyCStruct")
		kSecOIDX509V1SubjectPublicKeyCStruct: CF.StringRef

		@(link_name="kSecOIDX509V1ValidityNotAfter")
		kSecOIDX509V1ValidityNotAfter: CF.StringRef

		@(link_name="kSecOIDX509V1ValidityNotBefore")
		kSecOIDX509V1ValidityNotBefore: CF.StringRef

		@(link_name="kSecOIDX509V1Version")
		kSecOIDX509V1Version: CF.StringRef

		@(link_name="kSecOIDX509V3Certificate")
		kSecOIDX509V3Certificate: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateCStruct")
		kSecOIDX509V3CertificateCStruct: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionCStruct")
		kSecOIDX509V3CertificateExtensionCStruct: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionCritical")
		kSecOIDX509V3CertificateExtensionCritical: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionId")
		kSecOIDX509V3CertificateExtensionId: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionStruct")
		kSecOIDX509V3CertificateExtensionStruct: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionType")
		kSecOIDX509V3CertificateExtensionType: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionValue")
		kSecOIDX509V3CertificateExtensionValue: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionsCStruct")
		kSecOIDX509V3CertificateExtensionsCStruct: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateExtensionsStruct")
		kSecOIDX509V3CertificateExtensionsStruct: CF.StringRef

		@(link_name="kSecOIDX509V3CertificateNumberOfExtensions")
		kSecOIDX509V3CertificateNumberOfExtensions: CF.StringRef

		@(link_name="kSecOIDX509V3SignedCertificate")
		kSecOIDX509V3SignedCertificate: CF.StringRef

		@(link_name="kSecOIDX509V3SignedCertificateCStruct")
		kSecOIDX509V3SignedCertificateCStruct: CF.StringRef

		@(link_name="kSecOIDSRVName")
		kSecOIDSRVName: CF.StringRef

		@(link_name="kSecCFErrorArchitecture")
		kSecCFErrorArchitecture: CF.StringRef

		@(link_name="kSecCFErrorPattern")
		kSecCFErrorPattern: CF.StringRef

		@(link_name="kSecCFErrorResourceSeal")
		kSecCFErrorResourceSeal: CF.StringRef

		@(link_name="kSecCFErrorResourceAdded")
		kSecCFErrorResourceAdded: CF.StringRef

		@(link_name="kSecCFErrorResourceAltered")
		kSecCFErrorResourceAltered: CF.StringRef

		@(link_name="kSecCFErrorResourceMissing")
		kSecCFErrorResourceMissing: CF.StringRef

		@(link_name="kSecCFErrorResourceSideband")
		kSecCFErrorResourceSideband: CF.StringRef

		@(link_name="kSecCFErrorResourceRecursive")
		kSecCFErrorResourceRecursive: CF.StringRef

		@(link_name="kSecCFErrorInfoPlist")
		kSecCFErrorInfoPlist: CF.StringRef

		@(link_name="kSecCFErrorGuestAttributes")
		kSecCFErrorGuestAttributes: CF.StringRef

		@(link_name="kSecCFErrorRequirementSyntax")
		kSecCFErrorRequirementSyntax: CF.StringRef

		@(link_name="kSecCFErrorPath")
		kSecCFErrorPath: CF.StringRef

		@(link_name="kSecCodeAttributeArchitecture")
		kSecCodeAttributeArchitecture: CF.StringRef

		@(link_name="kSecCodeAttributeSubarchitecture")
		kSecCodeAttributeSubarchitecture: CF.StringRef

		@(link_name="kSecCodeAttributeUniversalFileOffset")
		kSecCodeAttributeUniversalFileOffset: CF.StringRef

		@(link_name="kSecCodeAttributeBundleVersion")
		kSecCodeAttributeBundleVersion: CF.StringRef

		@(link_name="kSecGuestAttributeCanonical")
		kSecGuestAttributeCanonical: CF.StringRef

		@(link_name="kSecGuestAttributeHash")
		kSecGuestAttributeHash: CF.StringRef

		@(link_name="kSecGuestAttributeMachPort")
		kSecGuestAttributeMachPort: CF.StringRef

		@(link_name="kSecGuestAttributePid")
		kSecGuestAttributePid: CF.StringRef

		@(link_name="kSecGuestAttributeAudit")
		kSecGuestAttributeAudit: CF.StringRef

		@(link_name="kSecGuestAttributeDynamicCode")
		kSecGuestAttributeDynamicCode: CF.StringRef

		@(link_name="kSecGuestAttributeDynamicCodeInfoPlist")
		kSecGuestAttributeDynamicCodeInfoPlist: CF.StringRef

		@(link_name="kSecGuestAttributeArchitecture")
		kSecGuestAttributeArchitecture: CF.StringRef

		@(link_name="kSecGuestAttributeSubarchitecture")
		kSecGuestAttributeSubarchitecture: CF.StringRef

		@(link_name="kSecCodeInfoCertificates")
		kSecCodeInfoCertificates: CF.StringRef

		@(link_name="kSecCodeInfoChangedFiles")
		kSecCodeInfoChangedFiles: CF.StringRef

		@(link_name="kSecCodeInfoCMS")
		kSecCodeInfoCMS: CF.StringRef

		@(link_name="kSecCodeInfoDesignatedRequirement")
		kSecCodeInfoDesignatedRequirement: CF.StringRef

		@(link_name="kSecCodeInfoEntitlements")
		kSecCodeInfoEntitlements: CF.StringRef

		@(link_name="kSecCodeInfoEntitlementsDict")
		kSecCodeInfoEntitlementsDict: CF.StringRef

		@(link_name="kSecCodeInfoFlags")
		kSecCodeInfoFlags: CF.StringRef

		@(link_name="kSecCodeInfoFormat")
		kSecCodeInfoFormat: CF.StringRef

		@(link_name="kSecCodeInfoDigestAlgorithm")
		kSecCodeInfoDigestAlgorithm: CF.StringRef

		@(link_name="kSecCodeInfoDigestAlgorithms")
		kSecCodeInfoDigestAlgorithms: CF.StringRef

		@(link_name="kSecCodeInfoPlatformIdentifier")
		kSecCodeInfoPlatformIdentifier: CF.StringRef

		@(link_name="kSecCodeInfoIdentifier")
		kSecCodeInfoIdentifier: CF.StringRef

		@(link_name="kSecCodeInfoImplicitDesignatedRequirement")
		kSecCodeInfoImplicitDesignatedRequirement: CF.StringRef

		@(link_name="kSecCodeInfoDefaultDesignatedLightweightCodeRequirement")
		kSecCodeInfoDefaultDesignatedLightweightCodeRequirement: CF.StringRef

		@(link_name="kSecCodeInfoMainExecutable")
		kSecCodeInfoMainExecutable: CF.StringRef

		@(link_name="kSecCodeInfoPList")
		kSecCodeInfoPList: CF.StringRef

		@(link_name="kSecCodeInfoRequirements")
		kSecCodeInfoRequirements: CF.StringRef

		@(link_name="kSecCodeInfoRequirementData")
		kSecCodeInfoRequirementData: CF.StringRef

		@(link_name="kSecCodeInfoSource")
		kSecCodeInfoSource: CF.StringRef

		@(link_name="kSecCodeInfoStatus")
		kSecCodeInfoStatus: CF.StringRef

		@(link_name="kSecCodeInfoTeamIdentifier")
		kSecCodeInfoTeamIdentifier: CF.StringRef

		@(link_name="kSecCodeInfoTime")
		kSecCodeInfoTime: CF.StringRef

		@(link_name="kSecCodeInfoTimestamp")
		kSecCodeInfoTimestamp: CF.StringRef

		@(link_name="kSecCodeInfoTrust")
		kSecCodeInfoTrust: CF.StringRef

		@(link_name="kSecCodeInfoUnique")
		kSecCodeInfoUnique: CF.StringRef

		@(link_name="kSecCodeInfoCdHashes")
		kSecCodeInfoCdHashes: CF.StringRef

		@(link_name="kSecCodeInfoRuntimeVersion")
		kSecCodeInfoRuntimeVersion: CF.StringRef

		@(link_name="kSecCodeInfoStapledNotarizationTicket")
		kSecCodeInfoStapledNotarizationTicket: CF.StringRef

		@(link_name="kSecTransformErrorDomain")
		kSecTransformErrorDomain: CF.StringRef

		@(link_name="kSecTransformPreviousErrorKey")
		kSecTransformPreviousErrorKey: CF.StringRef

		@(link_name="kSecTransformAbortOriginatorKey")
		kSecTransformAbortOriginatorKey: CF.StringRef

		@(link_name="kSecTransformInputAttributeName")
		kSecTransformInputAttributeName: CF.StringRef

		@(link_name="kSecTransformOutputAttributeName")
		kSecTransformOutputAttributeName: CF.StringRef

		@(link_name="kSecTransformDebugAttributeName")
		kSecTransformDebugAttributeName: CF.StringRef

		@(link_name="kSecTransformTransformName")
		kSecTransformTransformName: CF.StringRef

		@(link_name="kSecTransformAbortAttributeName")
		kSecTransformAbortAttributeName: CF.StringRef

		@(link_name="kSecTransformActionCanExecute")
		kSecTransformActionCanExecute: CF.StringRef

		@(link_name="kSecTransformActionStartingExecution")
		kSecTransformActionStartingExecution: CF.StringRef

		@(link_name="kSecTransformActionFinalize")
		kSecTransformActionFinalize: CF.StringRef

		@(link_name="kSecTransformActionExternalizeExtraData")
		kSecTransformActionExternalizeExtraData: CF.StringRef

		@(link_name="kSecTransformActionProcessData")
		kSecTransformActionProcessData: CF.StringRef

		@(link_name="kSecTransformActionInternalizeExtraData")
		kSecTransformActionInternalizeExtraData: CF.StringRef

		@(link_name="kSecTransformActionAttributeNotification")
		kSecTransformActionAttributeNotification: CF.StringRef

		@(link_name="kSecTransformActionAttributeValidation")
		kSecTransformActionAttributeValidation: CF.StringRef

		@(link_name="kSecBase64Encoding")
		kSecBase64Encoding: CF.StringRef

		@(link_name="kSecBase32Encoding")
		kSecBase32Encoding: CF.StringRef

		@(link_name="kSecZLibEncoding")
		kSecZLibEncoding: CF.StringRef

		@(link_name="kSecEncodeTypeAttribute")
		kSecEncodeTypeAttribute: CF.StringRef

		@(link_name="kSecLineLength64")
		kSecLineLength64: CF.StringRef

		@(link_name="kSecLineLength76")
		kSecLineLength76: CF.StringRef

		@(link_name="kSecEncodeLineLengthAttribute")
		kSecEncodeLineLengthAttribute: CF.StringRef

		@(link_name="kSecCompressionRatio")
		kSecCompressionRatio: CF.StringRef

		@(link_name="kSecDecodeTypeAttribute")
		kSecDecodeTypeAttribute: CF.StringRef

		@(link_name="kSecDigestMD2")
		kSecDigestMD2: CF.StringRef

		@(link_name="kSecDigestMD4")
		kSecDigestMD4: CF.StringRef

		@(link_name="kSecDigestMD5")
		kSecDigestMD5: CF.StringRef

		@(link_name="kSecDigestSHA1")
		kSecDigestSHA1: CF.StringRef

		@(link_name="kSecDigestSHA2")
		kSecDigestSHA2: CF.StringRef

		@(link_name="kSecDigestHMACMD5")
		kSecDigestHMACMD5: CF.StringRef

		@(link_name="kSecDigestHMACSHA1")
		kSecDigestHMACSHA1: CF.StringRef

		@(link_name="kSecDigestHMACSHA2")
		kSecDigestHMACSHA2: CF.StringRef

		@(link_name="kSecDigestTypeAttribute")
		kSecDigestTypeAttribute: CF.StringRef

		@(link_name="kSecDigestLengthAttribute")
		kSecDigestLengthAttribute: CF.StringRef

		@(link_name="kSecDigestHMACKeyAttribute")
		kSecDigestHMACKeyAttribute: CF.StringRef

		@(link_name="kSecPaddingNoneKey")
		kSecPaddingNoneKey: CF.StringRef

		@(link_name="kSecPaddingPKCS1Key")
		kSecPaddingPKCS1Key: CF.StringRef

		@(link_name="kSecPaddingPKCS5Key")
		kSecPaddingPKCS5Key: CF.StringRef

		@(link_name="kSecPaddingPKCS7Key")
		kSecPaddingPKCS7Key: CF.StringRef

		@(link_name="kSecPaddingOAEPKey")
		kSecPaddingOAEPKey: CF.StringRef

		@(link_name="kSecModeNoneKey")
		kSecModeNoneKey: CF.StringRef

		@(link_name="kSecModeECBKey")
		kSecModeECBKey: CF.StringRef

		@(link_name="kSecModeCBCKey")
		kSecModeCBCKey: CF.StringRef

		@(link_name="kSecModeCFBKey")
		kSecModeCFBKey: CF.StringRef

		@(link_name="kSecModeOFBKey")
		kSecModeOFBKey: CF.StringRef

		@(link_name="kSecEncryptKey")
		kSecEncryptKey: CF.StringRef

		@(link_name="kSecPaddingKey")
		kSecPaddingKey: CF.StringRef

		@(link_name="kSecIVKey")
		kSecIVKey: CF.StringRef

		@(link_name="kSecEncryptionMode")
		kSecEncryptionMode: CF.StringRef

		@(link_name="kSecOAEPMessageLengthAttributeName")
		kSecOAEPMessageLengthAttributeName: CF.StringRef

		@(link_name="kSecOAEPEncodingParametersAttributeName")
		kSecOAEPEncodingParametersAttributeName: CF.StringRef

		@(link_name="kSecOAEPMGF1DigestAlgorithmAttributeName")
		kSecOAEPMGF1DigestAlgorithmAttributeName: CF.StringRef

		@(link_name="kSecKeyAttributeName")
		kSecKeyAttributeName: CF.StringRef

		@(link_name="kSecSignatureAttributeName")
		kSecSignatureAttributeName: CF.StringRef

		@(link_name="kSecInputIsAttributeName")
		kSecInputIsAttributeName: CF.StringRef

		@(link_name="kSecInputIsPlainText")
		kSecInputIsPlainText: CF.StringRef

		@(link_name="kSecInputIsDigest")
		kSecInputIsDigest: CF.StringRef

		@(link_name="kSecInputIsRaw")
		kSecInputIsRaw: CF.StringRef
	}
