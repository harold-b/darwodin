...
foreign lib {
	...
	when ODIN_PLATFORM_SUBTARGET == .Default {
		...
		@(link_name="CMSDecoderCreate")
		SDecoderCreate :: proc(cmsDecoderOut: ^SDecoderRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderUpdateMessage")
		SDecoderUpdateMessage :: proc(cmsDecoder: SDecoderRef, msgBytes: rawptr, msgBytesLen: cffi.size_t) -> CF.OSStatus ---

		@(link_name="CMSDecoderFinalizeMessage")
		SDecoderFinalizeMessage :: proc(cmsDecoder: SDecoderRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderSetDetachedContent")
		SDecoderSetDetachedContent :: proc(cmsDecoder: SDecoderRef, detachedContent: CF.DataRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopyDetachedContent")
		SDecoderCopyDetachedContent :: proc(cmsDecoder: SDecoderRef, detachedContentOut: ^CF.DataRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderSetSearchKeychain")
		SDecoderSetSearchKeychain :: proc(cmsDecoder: SDecoderRef, keychainOrArray: CF.TypeRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderGetNumSigners")
		SDecoderGetNumSigners :: proc(cmsDecoder: SDecoderRef, numSignersOut: ^cffi.size_t) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerStatus")
		SDecoderCopySignerStatus :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, policyOrArray: CF.TypeRef, evaluateSecTrust: CF.Boolean, signerStatusOut: ^SSignerStatus, secTrustOut: ^Sec.SecTrustRef, certVerifyResultCodeOut: ^CF.OSStatus) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerEmailAddress")
		SDecoderCopySignerEmailAddress :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, signerEmailAddressOut: ^CF.StringRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerCert")
		SDecoderCopySignerCert :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, signerCertOut: ^Sec.SecCertificateRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderIsContentEncrypted")
		SDecoderIsContentEncrypted :: proc(cmsDecoder: SDecoderRef, isEncryptedOut: ^CF.Boolean) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopyEncapsulatedContentType")
		SDecoderCopyEncapsulatedContentType :: proc(cmsDecoder: SDecoderRef, eContentTypeOut: ^CF.DataRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopyAllCerts")
		SDecoderCopyAllCerts :: proc(cmsDecoder: SDecoderRef, certsOut: ^CF.ArrayRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopyContent")
		SDecoderCopyContent :: proc(cmsDecoder: SDecoderRef, contentOut: ^CF.DataRef) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerSigningTime")
		SDecoderCopySignerSigningTime :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, signingTime: ^CF.CFAbsoluteTime) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerTimestamp")
		SDecoderCopySignerTimestamp :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, timestamp: ^CF.CFAbsoluteTime) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerTimestampWithPolicy")
		SDecoderCopySignerTimestampWithPolicy :: proc(cmsDecoder: SDecoderRef, timeStampPolicy: CF.TypeRef, signerIndex: cffi.size_t, timestamp: ^CF.CFAbsoluteTime) -> CF.OSStatus ---

		@(link_name="CMSDecoderCopySignerTimestampCertificates")
		SDecoderCopySignerTimestampCertificates :: proc(cmsDecoder: SDecoderRef, signerIndex: cffi.size_t, certificateRefs: ^CF.ArrayRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderGetTypeID")
		SEncoderGetTypeID :: proc() -> CF.TypeID ---

		@(link_name="CMSEncoderCreate")
		SEncoderCreate :: proc(cmsEncoderOut: ^SEncoderRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderSetSignerAlgorithm")
		SEncoderSetSignerAlgorithm :: proc(cmsEncoder: SEncoderRef, digestAlgorithm: CF.StringRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderAddSigners")
		SEncoderAddSigners :: proc(cmsEncoder: SEncoderRef, signerOrArray: CF.TypeRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderCopySigners")
		SEncoderCopySigners :: proc(cmsEncoder: SEncoderRef, signersOut: ^CF.ArrayRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderAddRecipients")
		SEncoderAddRecipients :: proc(cmsEncoder: SEncoderRef, recipientOrArray: CF.TypeRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderCopyRecipients")
		SEncoderCopyRecipients :: proc(cmsEncoder: SEncoderRef, recipientsOut: ^CF.ArrayRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderSetHasDetachedContent")
		SEncoderSetHasDetachedContent :: proc(cmsEncoder: SEncoderRef, detachedContent: CF.Boolean) -> CF.OSStatus ---

		@(link_name="CMSEncoderGetHasDetachedContent")
		...
		@(link_name="CMSEncoderCopyEncapsulatedContentType")
		SEncoderCopyEncapsulatedContentType :: proc(cmsEncoder: SEncoderRef, eContentTypeOut: ^CF.DataRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderAddSupportingCerts")
		SEncoderAddSupportingCerts :: proc(cmsEncoder: SEncoderRef, certOrArray: CF.TypeRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderCopySupportingCerts")
		SEncoderCopySupportingCerts :: proc(cmsEncoder: SEncoderRef, certsOut: ^CF.ArrayRef) -> CF.OSStatus ---

		@(link_name="CMSEncoderAddSignedAttributes")
		SEncoderAddSignedAttributes :: proc(cmsEncoder: SEncoderRef, signedAttributes: SSignedAttributes) -> CF.OSStatus ---

		@(link_name="CMSEncoderSetCertificateChainMode")
		SEncoderSetCertificateChainMode :: proc(cmsEncoder: SEncoderRef, chainMode: SCertificateChainMode) -> CF.OSStatus ---

		@(link_name="CMSEncoderGetCertificateChainMode")
		SEncoderGetCertificateChainMode :: proc(cmsEncoder: SEncoderRef, chainModeOut: ^SCertificateChainMode) -> CF.OSStatus ---

		@(link_name="CMSEncoderUpdateContent")
		SEncoderUpdateContent :: proc(cmsEncoder: SEncoderRef, content: rawptr, contentLen: cffi.size_t) -> CF.OSStatus ---

		@(link_name="CMSEncoderCopyEncodedContent")
		...
		@(link_name="CMSEncoderCopySignerTimestamp")
		SEncoderCopySignerTimestamp :: proc(cmsEncoder: SEncoderRef, signerIndex: cffi.size_t, timestamp: ^CF.CFAbsoluteTime) -> CF.OSStatus ---

		@(link_name="CMSEncoderCopySignerTimestampWithPolicy")
		SEncoderCopySignerTimestampWithPolicy :: proc(cmsEncoder: SEncoderRef, timeStampPolicy: CF.TypeRef, signerIndex: cffi.size_t, timestamp: ^CF.CFAbsoluteTime) -> CF.OSStatus ---
	}
	...
	when ODIN_PLATFORM_SUBTARGET == .Default {
		...
		@(link_name="CMAudioDeviceClockCreateFromAudioDeviceID")
		AudioDeviceClockCreateFromAudioDeviceID :: proc(allocator: CF.AllocatorRef, deviceID: AT.DeviceID, clockOut: ^ClockRef) -> CF.OSStatus ---

		@(link_name="CMAudioDeviceClockSetAudioDeviceUID")
		AudioDeviceClockSetAudioDeviceUID :: proc(clock: ClockRef, deviceUID: CF.StringRef) -> CF.OSStatus ---

		@(link_name="CMAudioDeviceClockSetAudioDeviceID")
		AudioDeviceClockSetAudioDeviceID :: proc(clock: ClockRef, deviceID: AT.DeviceID) -> CF.OSStatus ---

		@(link_name="CMAudioDeviceClockGetAudioDevice")
		AudioDeviceClockGetAudioDevice :: proc(clock: ClockRef, deviceUIDOut: ^CF.StringRef, deviceIDOut: ^AT.DeviceID, trackingDefaultDeviceOut: ^CF.Boolean) -> CF.OSStatus ---
	}
}
...
when ODIN_PLATFORM_SUBTARGET == .Default {
	...
	_2Header :: struct #align (2) {
		size:                   CF.UInt32,
		CMMType:                CF.OSType,
		profileVersion:         CF.UInt32,
		profileClass:           CF.OSType,
		dataColorSpace:         CF.OSType,
		profileConnectionSpace: CF.OSType,
		dateTime:               DateTime,
		CS2profileSignature:    CF.OSType,
		platform:               CF.OSType,
		flags:                  CF.UInt32,
		deviceManufacturer:     CF.OSType,
		deviceModel:            CF.UInt32,
		deviceAttributes:       [2]CF.UInt32,
	...
	Lut16Type :: struct #align (2) {
		typeDescriptor:     CF.OSType,
		reserved:           CF.UInt32,
		inputChannels:      CF.UInt8,
		outputChannels:     CF.UInt8,
		gridPoints:         CF.UInt8,
		reserved2:          CF.UInt8,
		_matrix:            [3][3]cffi.int,
		inputTableEntries:  CF.UInt16,
	...
	MultiFunctLutType :: struct #align (2) {
		...
		outputChannels: CF.UInt8,
		reserved2:      CF.UInt16,
		offsetBcurves:  CF.UInt32,
		offsetMatrix:   CF.UInt32,
		offsetMcurves:  CF.UInt32,
		offsetCLUT:     CF.UInt32,
		offsetAcurves:  CF.UInt32,
		data:           [1]CF.UInt8,
	}

	MultiFunctCLUTType :: struct #packed {
	...
	MeasurementType :: struct #align (2) {
		typeDescriptor:   CF.OSType,
		reserved:         CF.UInt32,
		standardObserver: CF.UInt32,
		backingXYZ:       FixedXYZColor,
		geometry:         CF.UInt32,
		flare:            CF.UInt32,
	...
	NamedColor2Type :: struct #align (2) {
		...
		vendorFlag:         CF.UInt32,
		count:              CF.UInt32,
		deviceChannelCount: CF.UInt32,
		prefixName:         [32]CF.UInt8,
	...
	NativeDisplayInfo :: struct #align (2) {
		...
		greenPhosphor:   FixedXYColor,
		bluePhosphor:    FixedXYColor,
		whitePoint:      FixedXYColor,
		redGammaValue:   cffi.int,
		greenGammaValue: cffi.int,
		blueGammaValue:  cffi.int,
		gammaChannels:   CF.UInt16,
		gammaEntryCount: CF.UInt16,
	...
	MakeAndModel :: struct #align (2) {
		...
		model:           CF.UInt32,
		serialNumber:    CF.UInt32,
		manufactureDate: CF.UInt32,
		reserved1:       CF.UInt32,
		reserved2:       CF.UInt32,
		reserved3:       CF.UInt32,
		reserved4:       CF.UInt32,
	...
	Multichannel5Color :: struct #packed {
		components: [5]CF.UInt8,
	}

	Multichannel6Color :: struct #packed {
		components: [6]CF.UInt8,
	}

	Multichannel7Color :: struct #packed {
		components: [7]CF.UInt8,
	}

	Multichannel8Color :: struct #packed {
	...
	MInfo :: struct #align (8) {
		...
		CMMType:          CF.OSType,
		CMMMfr:           CF.OSType,
		CMMVersion:       CF.UInt32,
		ASCIIName:        [32]cffi.uchar,
		ASCIIDesc:        [256]cffi.uchar,
		UniCodeNameCount: CF.UniCharCount,
		UniCodeName:      [32]CF.UniChar,
	...
	Bitmap :: struct #align (8) {
		...
		width:     cffi.size_t,
		height:    cffi.size_t,
		rowBytes:  cffi.size_t,
		pixelSize: cffi.size_t,
		space:     BitmapColorSpace,
		user1:     CF.UInt32,
		user2:     CF.UInt32,
	}
	...
	ProfileIterateData :: struct #align (8) {
		...
		uniCodeNameCount: CF.UniCharCount,
		uniCodeName:      ^CF.UniChar,
		asciiName:        ^cffi.uchar,
		makeAndModel:     ^MakeAndModel,
		digest:           ^ProfileMD5,
	}
	...
	FloatBitmap :: struct #align (8) {
		...
		height:    cffi.size_t,
		width:     cffi.size_t,
		rowStride: cffi.ptrdiff_t,
		colStride: cffi.ptrdiff_t,
		space:     CF.OSType,
	...
	DeviceInfo :: struct #align (8) {
		...
		defaultProfileID: DeviceProfileID,
		deviceName:       ^CF.DictionaryRef,
...
when ODIN_PLATFORM_SUBTARGET == .Default {
	...
	Color :: struct #raw_union #align (4) {
		...
		cmy:        CMYColor,
		gray:       GrayColor,
		mc5:        Multichannel5Color,
		mc6:        Multichannel6Color,
		mc7:        Multichannel7Color,
