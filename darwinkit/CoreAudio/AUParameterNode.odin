...
/// AUParameterNode
///
@(objc_class="AUParameterNode", objc_superclass=NSObject)
AUParameterNode :: struct { using _: NSObject, }

@(default_calling_convention="c")
foreign lib {
    @(objc_type=AUParameterNode, objc_selector="displayNameWithLength:", objc_name="displayNameWithLength")
    AUParameterNode_displayNameWithLength :: proc(self: ^AUParameterNode, maximumLength: NSInteger) -> ^NSString ---
    ...
    AUParameterNode_identifier :: proc(self: ^AUParameterNode) -> ^NSString ---

    @(objc_type=AUParameterNode, objc_selector="keyPath", objc_name="keyPath")
    AUParameterNode_keyPath :: proc(self: ^AUParameterNode) -> ^NSString ---

    @(objc_type=AUParameterNode, objc_selector="displayName", objc_name="displayName")
    AUParameterNode_displayName :: proc(self: ^AUParameterNode) -> ^NSString ---
