...
/// AUAudioUnitBusArray
///
@(objc_class="AUAudioUnitBusArray", objc_superclass=NSObject)
AUAudioUnitBusArray :: struct { using _: NSObject, 
    using _: NSFastEnumeration,
}
...
foreign lib {
    ...
    AUAudioUnitBusArray_initWithAudioUnit_busType_busses :: proc(self: ^AUAudioUnitBusArray, owner: ^AUAudioUnit, busType: AUAudioUnitBusType, busArray: ^NSArray) -> instancetype ---
    ...
    AUAudioUnitBusArray_objectAtIndexedSubscript :: proc(self: ^AUAudioUnitBusArray, index: NSUInteger) -> ^AUAudioUnitBus ---

    @(objc_type=AUAudioUnitBusArray, objc_selector="setBusCount:error:", objc_name="setBusCount")
    AUAudioUnitBusArray_setBusCount :: proc(self: ^AUAudioUnitBusArray, count: NSUInteger, outError: ^^NSError) -> bool ---
    ...
    AUAudioUnitBusArray_addObserverToAllBusses :: proc(self: ^AUAudioUnitBusArray, observer: ^NSObject, keyPath: ^NSString, options: NSKeyValueObservingOptions, _context: rawptr) ---
    ...
    AUAudioUnitBusArray_removeObserverFromAllBusses :: proc(self: ^AUAudioUnitBusArray, observer: ^NSObject, keyPath: ^NSString, _context: rawptr) ---

    @(objc_type=AUAudioUnitBusArray, objc_selector="count", objc_name="count")
    AUAudioUnitBusArray_count :: proc(self: ^AUAudioUnitBusArray) -> NSUInteger ---
    ...
    AUAudioUnitBusArray_replaceBusses :: proc(self: ^AUAudioUnitBusArray, busArray: ^NSArray) ---
}
