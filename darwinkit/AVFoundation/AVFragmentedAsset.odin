...
foreign lib {
	...
	FragmentedAsset_loadTrackWithTrackID :: proc(self: ^FragmentedAsset, trackID: CM.PersistentTrackID, completionHandler: ^Objc_Block(proc "c" ( _0: ^FragmentedAssetTrack, _1: ^NS.Error ))) ---
	...
	FragmentedAsset_loadTracksWithMediaType :: proc(self: ^FragmentedAsset, mediaType: ^NS.String, completionHandler: ^Objc_Block(proc "c" ( _0: ^NS.Array, _1: ^NS.Error ))) ---
	...
	FragmentedAsset_loadTracksWithMediaCharacteristic :: proc(self: ^FragmentedAsset, mediaCharacteristic: ^NS.String, completionHandler: ^Objc_Block(proc "c" ( _0: ^NS.Array, _1: ^NS.Error ))) ---
}
