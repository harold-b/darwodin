...
///
@(objc_class="UIWritingToolsCoordinatorDelegate")
...
foreign lib {
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsContextsForScope_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, scope: WritingToolsCoordinatorContextScope, completion: ^Objc_Block(proc "c" ( _0: ^NS.Array ))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsBoundingBezierPathsForRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ( _0: ^NS.Array ))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsUnderlinePathsForRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ( _0: ^NS.Array ))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsPreviewForTextAnimation_ofRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, textAnimation: WritingToolsCoordinatorTextAnimation, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ( _0: ^TargetedPreview ))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsDecorationContainerViewForRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ( _0: ^View ))) ---
