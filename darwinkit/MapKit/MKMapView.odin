...
@(objc_class="MKMapView", objc_superclass=UI_View)
MapView :: struct {
	using _: UI_View,
	using _: NS.Coding,
}
...
foreign lib {
	...
	when ODIN_PLATFORM_SUBTARGET == .Default {
		...
		@(objc_type=MapView, objc_selector="setVisibleMapRect:edgePadding:animated:", objc_name="setVisibleMapRect_edgePadding_animated")
		MapView_setVisibleMapRect_edgePadding_animated :: proc(self: ^MapView, mapRect: MapRect, insets: UI_EdgeInsets, animate: bool) ---

		@(objc_type=MapView, objc_selector="mapRectThatFits:edgePadding:", objc_name="mapRectThatFits_edgePadding")
		MapView_mapRectThatFits_edgePadding :: proc(self: ^MapView, mapRect: MapRect, insets: UI_EdgeInsets) -> MapRect ---
	}
	...
	MapView_convertCoordinate :: proc(self: ^MapView, coordinate: CL.LocationCoordinate2D, view: ^UI_View) -> CG.Point ---

	@(objc_type=MapView, objc_selector="convertPoint:toCoordinateFromView:", objc_name="convertPoint")
	MapView_convertPoint :: proc(self: ^MapView, point: CG.Point, view: ^UI_View) -> CL.LocationCoordinate2D ---

	@(objc_type=MapView, objc_selector="convertRegion:toRectToView:", objc_name="convertRegion")
	MapView_convertRegion :: proc(self: ^MapView, region: CoordinateRegion, view: ^UI_View) -> CG.Rect ---

	@(objc_type=MapView, objc_selector="convertRect:toRegionFromView:", objc_name="convertRect")
	MapView_convertRect :: proc(self: ^MapView, rect: CG.Rect, view: ^UI_View) -> CoordinateRegion ---
