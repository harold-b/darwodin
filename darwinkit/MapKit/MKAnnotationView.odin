...
@(objc_class="MKAnnotationView", objc_superclass=UI_View)
AnnotationView :: struct { using _: UI_View}
...
foreign lib {
	...
	AnnotationView_image :: proc(self: ^AnnotationView) -> ^UI_Image ---

	@(objc_type=AnnotationView, objc_selector="setImage:", objc_name="setImage")
	AnnotationView_setImage :: proc(self: ^AnnotationView, image: ^UI_Image) ---
	...
	AnnotationView_leftCalloutAccessoryView :: proc(self: ^AnnotationView) -> ^UI_View ---

	@(objc_type=AnnotationView, objc_selector="setLeftCalloutAccessoryView:", objc_name="setLeftCalloutAccessoryView")
	AnnotationView_setLeftCalloutAccessoryView :: proc(self: ^AnnotationView, leftCalloutAccessoryView: ^UI_View) ---

	@(objc_type=AnnotationView, objc_selector="rightCalloutAccessoryView", objc_name="rightCalloutAccessoryView")
	AnnotationView_rightCalloutAccessoryView :: proc(self: ^AnnotationView) -> ^UI_View ---

	@(objc_type=AnnotationView, objc_selector="setRightCalloutAccessoryView:", objc_name="setRightCalloutAccessoryView")
	AnnotationView_setRightCalloutAccessoryView :: proc(self: ^AnnotationView, rightCalloutAccessoryView: ^UI_View) ---

	@(objc_type=AnnotationView, objc_selector="detailCalloutAccessoryView", objc_name="detailCalloutAccessoryView")
	AnnotationView_detailCalloutAccessoryView :: proc(self: ^AnnotationView) -> ^UI_View ---

	@(objc_type=AnnotationView, objc_selector="setDetailCalloutAccessoryView:", objc_name="setDetailCalloutAccessoryView")
	AnnotationView_setDetailCalloutAccessoryView :: proc(self: ^AnnotationView, detailCalloutAccessoryView: ^UI_View) ---
