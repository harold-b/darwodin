...
foreign lib {
	...
	StringMakeConstantString :: proc "c" ( c: cstring ) -> StringRef ---
}

STR :: StringMakeConstantString

StringCopyToOdinString :: proc( theString: StringRef, allocator := context.allocator ) -> (str: string, ok: bool) #optional_ok {
