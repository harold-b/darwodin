...
foreign lib {
    ...
    Image_imageWithSystemSymbolName_accessibilityDescription :: proc(name: ^NS.String, description: ^NS.String) -> instancetype ---
    ...
    Image_imageWithSystemSymbolName_variableValue_accessibilityDescription :: proc(name: ^NS.String, value: cffi.double, description: ^NS.String) -> instancetype ---
    ...
    Image_imageWithSymbolName_variableValue :: proc(name: ^NS.String, value: cffi.double) -> instancetype ---
    ...
    Image_imageWithSymbolName_bundle_variableValue :: proc(name: ^NS.String, bundle: ^NS.Bundle, value: cffi.double) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithSize:", objc_name="initWithSize")
    Image_initWithSize :: proc(self: ^Image, size: NS.Size) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithCoder:", objc_name="initWithCoder")
    Image_initWithCoder :: proc(self: ^Image, coder: ^NS.Coder) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithData:", objc_name="initWithData")
    Image_initWithData :: proc(self: ^Image, data: ^NS.Data) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithContentsOfFile:", objc_name="initWithContentsOfFile")
    Image_initWithContentsOfFile :: proc(self: ^Image, fileName: ^NS.String) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithContentsOfURL:", objc_name="initWithContentsOfURL")
    Image_initWithContentsOfURL :: proc(self: ^Image, url: ^NS.URL) -> instancetype ---

    @(objc_type=Image, objc_selector="initByReferencingFile:", objc_name="initByReferencingFile")
    Image_initByReferencingFile :: proc(self: ^Image, fileName: ^NS.String) -> instancetype ---

    @(objc_type=Image, objc_selector="initByReferencingURL:", objc_name="initByReferencingURL")
    Image_initByReferencingURL :: proc(self: ^Image, url: ^NS.URL) -> instancetype ---

    @(objc_type=Image, objc_selector="initWithPasteboard:", objc_name="initWithPasteboard")
    Image_initWithPasteboard :: proc(self: ^Image, pasteboard: ^Pasteboard) -> instancetype ---
    ...
    Image_drawAtPoint :: proc(self: ^Image, point: CG.Point, fromRect: NS.Rect, op: CompositingOperation, delta: CG.Float) ---

    @(objc_type=Image, objc_selector="drawInRect:fromRect:operation:fraction:", objc_name="drawInRect_fromRect_operation_fraction")
    Image_drawInRect_fromRect_operation_fraction :: proc(self: ^Image, rect: NS.Rect, fromRect: NS.Rect, op: CompositingOperation, delta: CG.Float) ---
    ...
    Image_drawInRect_fromRect_operation_fraction_respectFlipped_hints :: proc(self: ^Image, dstSpacePortionRect: NS.Rect, srcSpacePortionRect: NS.Rect, op: CompositingOperation, requestedAlpha: CG.Float, respectContextIsFlipped: bool, hints: ^NS.Dictionary) ---

    @(objc_type=Image, objc_selector="drawRepresentation:inRect:", objc_name="drawRepresentation")
    Image_drawRepresentation :: proc(self: ^Image, imageRep: ^ImageRep, rect: NS.Rect) -> bool ---

    @(objc_type=Image, objc_selector="drawInRect:", objc_name="drawInRect_")
    Image_drawInRect_ :: proc(self: ^Image, rect: NS.Rect) ---
    ...
    Image_initWithCGImage :: proc(self: ^Image, cgImage: CG.ImageRef, size: NS.Size) -> instancetype ---

    @(objc_type=Image, objc_selector="CGImageForProposedRect:context:hints:", objc_name="CGImageForProposedRect")
    Image_CGImageForProposedRect :: proc(self: ^Image, proposedDestRect: ^NS.Rect, referenceContext: ^GraphicsContext, hints: ^NS.Dictionary) -> CG.ImageRef ---

    @(objc_type=Image, objc_selector="bestRepresentationForRect:context:hints:", objc_name="bestRepresentationForRect")
    Image_bestRepresentationForRect :: proc(self: ^Image, rect: NS.Rect, referenceContext: ^GraphicsContext, hints: ^NS.Dictionary) -> ^ImageRep ---

    @(objc_type=Image, objc_selector="hitTestRect:withImageDestinationRect:context:hints:flipped:", objc_name="hitTestRect")
    Image_hitTestRect :: proc(self: ^Image, testRectDestSpace: NS.Rect, imageRectDestSpace: NS.Rect, _context: ^GraphicsContext, hints: ^NS.Dictionary, flipped: bool) -> bool ---
    ...
    Image_size :: proc(self: ^Image) -> NS.Size ---

    @(objc_type=Image, objc_selector="setSize:", objc_name="setSize")
    Image_setSize :: proc(self: ^Image, size: NS.Size) ---
    ...
    Image_alignmentRect :: proc(self: ^Image) -> NS.Rect ---

    @(objc_type=Image, objc_selector="setAlignmentRect:", objc_name="setAlignmentRect")
    Image_setAlignmentRect :: proc(self: ^Image, alignmentRect: NS.Rect) ---
    ...
    Image_capInsets :: proc(self: ^Image) -> NS.EdgeInsets ---

    @(objc_type=Image, objc_selector="setCapInsets:", objc_name="setCapInsets")
    Image_setCapInsets :: proc(self: ^Image, capInsets: NS.EdgeInsets) ---
    ...
    Image_dissolveToPoint_fromRect_fraction :: proc(self: ^Image, point: CG.Point, rect: NS.Rect, fraction: CG.Float) ---
    ...
    Image_compositeToPoint_fromRect_operation :: proc(self: ^Image, point: CG.Point, rect: NS.Rect, operation: CompositingOperation) ---
    ...
    Image_compositeToPoint_fromRect_operation_fraction :: proc(self: ^Image, point: CG.Point, rect: NS.Rect, operation: CompositingOperation, fraction: CG.Float) ---
