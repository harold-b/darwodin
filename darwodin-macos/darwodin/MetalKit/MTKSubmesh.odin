...
@(objc_type=Submesh, objc_name="exposeBinding", objc_is_class_method=true)
Submesh_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Submesh, "exposeBinding:", binding)
}
@(objc_type=Submesh, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Submesh_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Submesh, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Submesh, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Submesh_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Submesh, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
