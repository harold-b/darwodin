...
@(objc_type=MeshBufferAllocator, objc_name="poseAsClass", objc_is_class_method=true)
MeshBufferAllocator_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshBufferAllocator, "poseAsClass:", aClass)
}
...
@(objc_type=MeshBufferAllocator, objc_name="setKeys", objc_is_class_method=true)
MeshBufferAllocator_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshBufferAllocator, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=MeshBufferAllocator, objc_name="exposeBinding", objc_is_class_method=true)
MeshBufferAllocator_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, MeshBufferAllocator, "exposeBinding:", binding)
}
@(objc_type=MeshBufferAllocator, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
MeshBufferAllocator_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, MeshBufferAllocator, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=MeshBufferAllocator, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
MeshBufferAllocator_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, MeshBufferAllocator, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
