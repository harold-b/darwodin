...
@(objc_type=Mesh, objc_name="exposeBinding", objc_is_class_method=true)
Mesh_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Mesh, "exposeBinding:", binding)
}
@(objc_type=Mesh, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Mesh_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Mesh, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Mesh, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Mesh_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Mesh, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
