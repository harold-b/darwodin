...
@(objc_type=MeshBuffer, objc_name="poseAsClass", objc_is_class_method=true)
MeshBuffer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshBuffer, "poseAsClass:", aClass)
}
...
@(objc_type=MeshBuffer, objc_name="setKeys", objc_is_class_method=true)
MeshBuffer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshBuffer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=MeshBuffer, objc_name="exposeBinding", objc_is_class_method=true)
MeshBuffer_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, MeshBuffer, "exposeBinding:", binding)
}
@(objc_type=MeshBuffer, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
MeshBuffer_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, MeshBuffer, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=MeshBuffer, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
MeshBuffer_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, MeshBuffer, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
