...
foreign lib {
    ...
    CheckerboardTexture_initWithDivisions :: proc(self: ^CheckerboardTexture, divisions: cffi.float, name: ^NS.String, #by_ptr dimensions: [2]cffi.int, channelCount: cffi.int, channelEncoding: TextureChannelEncoding, color1: CG.ColorRef, color2: CG.ColorRef) -> ^CheckerboardTexture ---
