...
AreaLight_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AreaLight, "poseAsClass:", aClass)
}
...
AreaLight_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AreaLight, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
