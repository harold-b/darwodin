...
foreign lib {
    ...
    SkyCubeTexture_initWithName_channelEncoding_textureDimensions_turbidity_sunElevation_sunAzimuth_upperAtmosphereScattering_groundAlbedo :: proc(self: ^SkyCubeTexture, name: ^NS.String, channelEncoding: TextureChannelEncoding, textureDimensions: ^[2]cffi.int, turbidity: cffi.float, sunElevation: cffi.float, sunAzimuth: cffi.float, upperAtmosphereScattering: cffi.float, groundAlbedo: cffi.float) -> instancetype ---
    ...
    SkyCubeTexture_setHighDynamicRangeCompression :: proc(self: ^SkyCubeTexture, highDynamicRangeCompression: ^vector_float2) ---
}
