...
AnimatedQuaternion_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AnimatedQuaternion, "poseAsClass:", aClass)
}
...
AnimatedQuaternion_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AnimatedQuaternion, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
