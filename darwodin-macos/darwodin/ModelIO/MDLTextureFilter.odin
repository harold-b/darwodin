...
@(objc_type=TextureFilter, objc_name="poseAsClass", objc_is_class_method=true)
TextureFilter_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TextureFilter, "poseAsClass:", aClass)
}
...
@(objc_type=TextureFilter, objc_name="setKeys", objc_is_class_method=true)
TextureFilter_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TextureFilter, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
