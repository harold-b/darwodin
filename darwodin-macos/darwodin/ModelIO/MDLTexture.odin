...
Texture_initWithData :: #force_inline proc "c" (self: ^Texture, pixelData: ^NS.Data, topLeftOrigin: cffi.bool, name: ^NS.String, dimensions: [2]cffi.int, rowStride: cffi.long, channelCount: cffi.ulong, channelEncoding: TextureChannelEncoding, isCube: cffi.bool) -> ^Texture {
...
Texture_writeToURL_ :: #force_inline proc "c" (self: ^Texture, _URL: ^NS.URL) -> cffi.bool {
    return msgSend(cffi.bool, self, "writeToURL:", _URL)
}
@(objc_type=Texture, objc_name="writeToURL_level")
Texture_writeToURL_level :: #force_inline proc "c" (self: ^Texture, _URL: ^NS.URL, level: cffi.ulong) -> cffi.bool {
    return msgSend(cffi.bool, self, "writeToURL:level:", _URL, level)
}
@(objc_type=Texture, objc_name="writeToURL_type")
Texture_writeToURL_type :: #force_inline proc "c" (self: ^Texture, nsurl: ^NS.URL, type: ^CF.__CFString) -> cffi.bool {
    return msgSend(cffi.bool, self, "writeToURL:type:", nsurl, type)
}
@(objc_type=Texture, objc_name="writeToURL_type_level")
Texture_writeToURL_type_level :: #force_inline proc "c" (self: ^Texture, nsurl: ^NS.URL, type: ^CF.__CFString, level: cffi.ulong) -> cffi.bool {
    return msgSend(cffi.bool, self, "writeToURL:type:level:", nsurl, type, level)
}
@(objc_type=Texture, objc_name="imageFromTexture")
Texture_imageFromTexture :: #force_inline proc "c" (self: ^Texture) -> ^CG.Image {
    return msgSend(^CG.Image, self, "imageFromTexture")
}
@(objc_type=Texture, objc_name="imageFromTextureAtLevel")
Texture_imageFromTextureAtLevel :: #force_inline proc "c" (self: ^Texture, level: cffi.ulong) -> ^CG.Image {
    return msgSend(^CG.Image, self, "imageFromTextureAtLevel:", level)
}
...
Texture_texelDataWithTopLeftOriginAtMipLevel :: #force_inline proc "c" (self: ^Texture, level: cffi.long, create: cffi.bool) -> ^NS.Data {
...
Texture_texelDataWithBottomLeftOriginAtMipLevel :: #force_inline proc "c" (self: ^Texture, level: cffi.long, create: cffi.bool) -> ^NS.Data {
...
Texture_rowStride :: #force_inline proc "c" (self: ^Texture) -> cffi.long {
    return msgSend(cffi.long, self, "rowStride")
}
@(objc_type=Texture, objc_name="channelCount")
Texture_channelCount :: #force_inline proc "c" (self: ^Texture) -> cffi.ulong {
    return msgSend(cffi.ulong, self, "channelCount")
}
@(objc_type=Texture, objc_name="mipLevelCount")
Texture_mipLevelCount :: #force_inline proc "c" (self: ^Texture) -> cffi.ulong {
    return msgSend(cffi.ulong, self, "mipLevelCount")
}
...
Texture_isCube :: #force_inline proc "c" (self: ^Texture) -> cffi.bool {
    return msgSend(cffi.bool, self, "isCube")
}
@(objc_type=Texture, objc_name="setIsCube")
Texture_setIsCube :: #force_inline proc "c" (self: ^Texture, isCube: cffi.bool) {
    msgSend(nil, self, "setIsCube:", isCube)
}
@(objc_type=Texture, objc_name="hasAlphaValues")
Texture_hasAlphaValues :: #force_inline proc "c" (self: ^Texture) -> cffi.bool {
    return msgSend(cffi.bool, self, "hasAlphaValues")
}
@(objc_type=Texture, objc_name="setHasAlphaValues")
Texture_setHasAlphaValues :: #force_inline proc "c" (self: ^Texture, hasAlphaValues: cffi.bool) {
...
Texture_instancesRespondToSelector :: #force_inline proc "c" (aSelector: SEL) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "instancesRespondToSelector:", aSelector)
}
@(objc_type=Texture, objc_name="conformsToProtocol", objc_is_class_method=true)
Texture_conformsToProtocol :: #force_inline proc "c" (protocol: ^Protocol) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "conformsToProtocol:", protocol)
}
@(objc_type=Texture, objc_name="instanceMethodForSelector", objc_is_class_method=true)
Texture_instanceMethodForSelector :: #force_inline proc "c" (aSelector: SEL) -> proc "c" (aSelector: SEL) {
    return msgSend(proc "c" (aSelector: SEL), Texture, "instanceMethodForSelector:", aSelector)
}
...
Texture_isSubclassOfClass :: #force_inline proc "c" (aClass: Class) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "isSubclassOfClass:", aClass)
}
@(objc_type=Texture, objc_name="resolveClassMethod", objc_is_class_method=true)
Texture_resolveClassMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "resolveClassMethod:", sel)
}
@(objc_type=Texture, objc_name="resolveInstanceMethod", objc_is_class_method=true)
Texture_resolveInstanceMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "resolveInstanceMethod:", sel)
}
@(objc_type=Texture, objc_name="hash", objc_is_class_method=true)
Texture_hash :: #force_inline proc "c" () -> cffi.ulong {
    return msgSend(cffi.ulong, Texture, "hash")
}
...
Texture_version :: #force_inline proc "c" () -> cffi.long {
    return msgSend(cffi.long, Texture, "version")
}
@(objc_type=Texture, objc_name="setVersion", objc_is_class_method=true)
Texture_setVersion :: #force_inline proc "c" (aVersion: cffi.long) {
    msgSend(nil, Texture, "setVersion:", aVersion)
}
@(objc_type=Texture, objc_name="poseAsClass", objc_is_class_method=true)
Texture_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Texture, "poseAsClass:", aClass)
}
...
Texture_accessInstanceVariablesDirectly :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, Texture, "accessInstanceVariablesDirectly")
}
@(objc_type=Texture, objc_name="useStoredAccessor", objc_is_class_method=true)
Texture_useStoredAccessor :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, Texture, "useStoredAccessor")
}
...
Texture_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> cffi.bool {
    return msgSend(cffi.bool, Texture, "automaticallyNotifiesObserversForKey:", key)
}
@(objc_type=Texture, objc_name="setKeys", objc_is_class_method=true)
Texture_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Texture, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
