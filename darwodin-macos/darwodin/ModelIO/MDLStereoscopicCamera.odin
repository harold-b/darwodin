...
StereoscopicCamera_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, StereoscopicCamera, "poseAsClass:", aClass)
}
...
StereoscopicCamera_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, StereoscopicCamera, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
