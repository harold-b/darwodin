...
MeshBufferMap_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshBufferMap, "poseAsClass:", aClass)
}
...
MeshBufferMap_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshBufferMap, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
