...
@(objc_type=NormalMapTexture, objc_name="poseAsClass", objc_is_class_method=true)
NormalMapTexture_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NormalMapTexture, "poseAsClass:", aClass)
}
...
@(objc_type=NormalMapTexture, objc_name="setKeys", objc_is_class_method=true)
NormalMapTexture_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NormalMapTexture, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
