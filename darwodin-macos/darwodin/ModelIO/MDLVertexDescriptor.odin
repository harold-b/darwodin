...
VertexDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VertexDescriptor, "poseAsClass:", aClass)
}
...
VertexDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VertexDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
