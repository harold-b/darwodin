...
TransformTranslateOp_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TransformTranslateOp, "poseAsClass:", aClass)
}
...
TransformTranslateOp_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TransformTranslateOp, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
