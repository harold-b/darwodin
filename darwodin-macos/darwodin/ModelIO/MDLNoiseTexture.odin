...
foreign lib {
    ...
    NoiseTexture_initScalarNoiseWithSmoothness :: proc(self: ^NoiseTexture, smoothness: cffi.float, name: ^NS.String, textureDimensions: ^[2]cffi.int, channelCount: cffi.int, channelEncoding: TextureChannelEncoding, grayscale: bool) -> instancetype ---
