...
@(objc_type=AnimatedVector4, objc_name="poseAsClass", objc_is_class_method=true)
AnimatedVector4_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AnimatedVector4, "poseAsClass:", aClass)
}
...
@(objc_type=AnimatedVector4, objc_name="setKeys", objc_is_class_method=true)
AnimatedVector4_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AnimatedVector4, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
