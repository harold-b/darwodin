...
ScatteringFunction_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ScatteringFunction, "poseAsClass:", aClass)
}
...
ScatteringFunction_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ScatteringFunction, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
