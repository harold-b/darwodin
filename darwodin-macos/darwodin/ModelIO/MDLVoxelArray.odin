...
VoxelArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VoxelArray, "poseAsClass:", aClass)
}
...
VoxelArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VoxelArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
