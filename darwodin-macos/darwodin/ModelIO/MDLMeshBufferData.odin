...
@(objc_type=MeshBufferData, objc_name="poseAsClass", objc_is_class_method=true)
MeshBufferData_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshBufferData, "poseAsClass:", aClass)
}
...
@(objc_type=MeshBufferData, objc_name="setKeys", objc_is_class_method=true)
MeshBufferData_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshBufferData, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
