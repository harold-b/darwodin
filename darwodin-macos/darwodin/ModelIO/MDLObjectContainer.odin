...
ObjectContainer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ObjectContainer, "poseAsClass:", aClass)
}
...
ObjectContainer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ObjectContainer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
