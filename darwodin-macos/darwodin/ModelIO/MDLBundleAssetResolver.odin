...
BundleAssetResolver_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, BundleAssetResolver, "poseAsClass:", aClass)
}
...
BundleAssetResolver_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, BundleAssetResolver, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
