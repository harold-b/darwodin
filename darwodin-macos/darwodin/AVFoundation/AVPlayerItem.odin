...
foreign lib {
    ...
    @(objc_type=PlayerItem, objc_selector="cancelContentAuthorizationRequest", objc_name="cancelContentAuthorizationRequest")
    PlayerItem_cancelContentAuthorizationRequest :: proc(self: ^PlayerItem) ---

    @(objc_type=PlayerItem, objc_selector="isAuthorizationRequiredForPlayback", objc_name="isAuthorizationRequiredForPlayback")
    PlayerItem_isAuthorizationRequiredForPlayback :: proc(self: ^PlayerItem) -> bool ---

    @(objc_type=PlayerItem, objc_selector="isApplicationAuthorizedForPlayback", objc_name="isApplicationAuthorizedForPlayback")
    PlayerItem_isApplicationAuthorizedForPlayback :: proc(self: ^PlayerItem) -> bool ---

    @(objc_type=PlayerItem, objc_selector="isContentAuthorizedForPlayback", objc_name="isContentAuthorizedForPlayback")
    PlayerItem_isContentAuthorizedForPlayback :: proc(self: ^PlayerItem) -> bool ---

    @(objc_type=PlayerItem, objc_selector="contentAuthorizationRequestStatus", objc_name="contentAuthorizationRequestStatus")
    PlayerItem_contentAuthorizationRequestStatus :: proc(self: ^PlayerItem) -> ContentAuthorizationStatus ---
