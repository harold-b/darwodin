...
LeaderboardEntry_challengeComposeControllerWithMessage_players_completionHandler :: #force_inline proc "c" (self: ^LeaderboardEntry, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeCompletionBlock) -> ^AK.ViewController {
    return msgSend(^AK.ViewController, self, "challengeComposeControllerWithMessage:players:completionHandler:", message, players, completionHandler)
}
@(objc_type=LeaderboardEntry, objc_name="challengeComposeControllerWithMessage_players_completion")
LeaderboardEntry_challengeComposeControllerWithMessage_players_completion :: #force_inline proc "c" (self: ^LeaderboardEntry, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeHandler) -> ^AK.ViewController {
    return msgSend(^AK.ViewController, self, "challengeComposeControllerWithMessage:players:completion:", message, players, completionHandler)
}
...
@(objc_type=LeaderboardEntry, objc_name="poseAsClass", objc_is_class_method=true)
LeaderboardEntry_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LeaderboardEntry, "poseAsClass:", aClass)
}
...
@(objc_type=LeaderboardEntry, objc_name="setKeys", objc_is_class_method=true)
LeaderboardEntry_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LeaderboardEntry, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=LeaderboardEntry, objc_name="exposeBinding", objc_is_class_method=true)
LeaderboardEntry_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, LeaderboardEntry, "exposeBinding:", binding)
}
@(objc_type=LeaderboardEntry, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
LeaderboardEntry_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, LeaderboardEntry, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=LeaderboardEntry, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
LeaderboardEntry_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, LeaderboardEntry, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
