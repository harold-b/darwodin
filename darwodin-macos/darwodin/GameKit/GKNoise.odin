...
foreign lib {
    ...
    Noise_valueAtPosition :: proc(self: ^Noise, #by_ptr position: vector_float2) -> cffi.float ---
    ...
    Noise_moveBy :: proc(self: ^Noise, #by_ptr delta: vector_double3) ---

    @(objc_type=Noise, objc_selector="scaleBy:", objc_name="scaleBy")
    Noise_scaleBy :: proc(self: ^Noise, #by_ptr factor: vector_double3) ---

    @(objc_type=Noise, objc_selector="rotateBy:", objc_name="rotateBy")
    Noise_rotateBy :: proc(self: ^Noise, #by_ptr radians: vector_double3) ---
