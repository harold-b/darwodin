...
@(objc_type=Noise, objc_name="poseAsClass", objc_is_class_method=true)
Noise_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Noise, "poseAsClass:", aClass)
}
...
@(objc_type=Noise, objc_name="setKeys", objc_is_class_method=true)
Noise_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Noise, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Noise, objc_name="exposeBinding", objc_is_class_method=true)
Noise_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Noise, "exposeBinding:", binding)
}
@(objc_type=Noise, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Noise_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Noise, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Noise, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Noise_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Noise, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
