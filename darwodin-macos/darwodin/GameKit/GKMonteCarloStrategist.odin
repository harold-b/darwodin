...
@(objc_type=MonteCarloStrategist, objc_name="poseAsClass", objc_is_class_method=true)
MonteCarloStrategist_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MonteCarloStrategist, "poseAsClass:", aClass)
}
...
@(objc_type=MonteCarloStrategist, objc_name="setKeys", objc_is_class_method=true)
MonteCarloStrategist_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MonteCarloStrategist, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=MonteCarloStrategist, objc_name="exposeBinding", objc_is_class_method=true)
MonteCarloStrategist_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, MonteCarloStrategist, "exposeBinding:", binding)
}
@(objc_type=MonteCarloStrategist, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
MonteCarloStrategist_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, MonteCarloStrategist, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=MonteCarloStrategist, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
MonteCarloStrategist_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, MonteCarloStrategist, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
