...
@(objc_type=LocalPlayer, objc_name="presentFriendRequestCreatorFromWindow")
LocalPlayer_presentFriendRequestCreatorFromWindow :: #force_inline proc "c" (self: ^LocalPlayer, window: ^AK.Window, error: ^^NS.Error) -> bool {
    return msgSend(bool, self, "presentFriendRequestCreatorFromWindow:error:", window, error)
}
...
@(objc_type=LocalPlayer, objc_name="poseAsClass", objc_is_class_method=true)
LocalPlayer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LocalPlayer, "poseAsClass:", aClass)
}
...
@(objc_type=LocalPlayer, objc_name="setKeys", objc_is_class_method=true)
LocalPlayer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LocalPlayer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=LocalPlayer, objc_name="exposeBinding", objc_is_class_method=true)
LocalPlayer_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, LocalPlayer, "exposeBinding:", binding)
}
@(objc_type=LocalPlayer, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
LocalPlayer_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, LocalPlayer, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=LocalPlayer, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
LocalPlayer_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, LocalPlayer, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
