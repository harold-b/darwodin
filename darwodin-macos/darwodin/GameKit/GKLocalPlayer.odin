...
foreign lib {
    ...
    LocalPlayer_presentFriendRequestCreatorFromViewController :: proc(self: ^LocalPlayer, viewController: ^NS.ViewController, error: ^^NS.Error) -> bool ---
    ...
    LocalPlayer_presentFriendRequestCreatorFromWindow :: proc(self: ^LocalPlayer, window: ^NS.Window, error: ^^NS.Error) -> bool ---
