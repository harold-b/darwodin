...
@(objc_type=TurnBasedMatch, objc_name="poseAsClass", objc_is_class_method=true)
TurnBasedMatch_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TurnBasedMatch, "poseAsClass:", aClass)
}
...
@(objc_type=TurnBasedMatch, objc_name="setKeys", objc_is_class_method=true)
TurnBasedMatch_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TurnBasedMatch, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=TurnBasedMatch, objc_name="exposeBinding", objc_is_class_method=true)
TurnBasedMatch_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, TurnBasedMatch, "exposeBinding:", binding)
}
@(objc_type=TurnBasedMatch, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
TurnBasedMatch_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, TurnBasedMatch, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=TurnBasedMatch, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
TurnBasedMatch_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, TurnBasedMatch, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
