...
@(objc_type=SavedGame, objc_name="poseAsClass", objc_is_class_method=true)
SavedGame_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SavedGame, "poseAsClass:", aClass)
}
...
@(objc_type=SavedGame, objc_name="setKeys", objc_is_class_method=true)
SavedGame_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SavedGame, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=SavedGame, objc_name="exposeBinding", objc_is_class_method=true)
SavedGame_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, SavedGame, "exposeBinding:", binding)
}
@(objc_type=SavedGame, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
SavedGame_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, SavedGame, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=SavedGame, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
SavedGame_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, SavedGame, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
