...
AchievementDescription_loadImageWithCompletionHandler :: #force_inline proc "c" (self: ^AchievementDescription, completionHandler: ^Objc_Block(proc "c" (image: ^NS.Image, error: ^NS.Error))) {
...
@(objc_type=AchievementDescription, objc_name="poseAsClass", objc_is_class_method=true)
AchievementDescription_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AchievementDescription, "poseAsClass:", aClass)
}
...
@(objc_type=AchievementDescription, objc_name="setKeys", objc_is_class_method=true)
AchievementDescription_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AchievementDescription, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=AchievementDescription, objc_name="exposeBinding", objc_is_class_method=true)
AchievementDescription_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, AchievementDescription, "exposeBinding:", binding)
}
@(objc_type=AchievementDescription, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
AchievementDescription_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, AchievementDescription, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=AchievementDescription, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
AchievementDescription_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, AchievementDescription, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
