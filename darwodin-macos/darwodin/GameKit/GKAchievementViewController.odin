...
@(objc_type=AchievementViewController, objc_name="allowedClassesForRestorableStateKeyPath", objc_is_class_method=true)
AchievementViewController_allowedClassesForRestorableStateKeyPath :: #force_inline proc "c" (keyPath: ^NS.String) -> ^NS.Array {
    return msgSend(^NS.Array, AchievementViewController, "allowedClassesForRestorableStateKeyPath:", keyPath)
}
@(objc_type=AchievementViewController, objc_name="restorableStateKeyPaths", objc_is_class_method=true)
AchievementViewController_restorableStateKeyPaths :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, AchievementViewController, "restorableStateKeyPaths")
}
...
@(objc_type=AchievementViewController, objc_name="poseAsClass", objc_is_class_method=true)
AchievementViewController_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AchievementViewController, "poseAsClass:", aClass)
}
...
@(objc_type=AchievementViewController, objc_name="setKeys", objc_is_class_method=true)
AchievementViewController_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AchievementViewController, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=AchievementViewController, objc_name="exposeBinding", objc_is_class_method=true)
AchievementViewController_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, AchievementViewController, "exposeBinding:", binding)
}
@(objc_type=AchievementViewController, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
AchievementViewController_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, AchievementViewController, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=AchievementViewController, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
AchievementViewController_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, AchievementViewController, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
