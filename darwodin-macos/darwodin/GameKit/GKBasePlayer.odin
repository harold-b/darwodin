...
@(objc_type=BasePlayer, objc_name="poseAsClass", objc_is_class_method=true)
BasePlayer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, BasePlayer, "poseAsClass:", aClass)
}
...
@(objc_type=BasePlayer, objc_name="setKeys", objc_is_class_method=true)
BasePlayer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, BasePlayer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=BasePlayer, objc_name="exposeBinding", objc_is_class_method=true)
BasePlayer_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, BasePlayer, "exposeBinding:", binding)
}
@(objc_type=BasePlayer, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
BasePlayer_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, BasePlayer, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=BasePlayer, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
BasePlayer_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, BasePlayer, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
