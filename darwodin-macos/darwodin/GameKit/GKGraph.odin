...
@(objc_type=Graph, objc_name="poseAsClass", objc_is_class_method=true)
Graph_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Graph, "poseAsClass:", aClass)
}
...
@(objc_type=Graph, objc_name="setKeys", objc_is_class_method=true)
Graph_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Graph, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Graph, objc_name="exposeBinding", objc_is_class_method=true)
Graph_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Graph, "exposeBinding:", binding)
}
@(objc_type=Graph, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Graph_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Graph, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Graph, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Graph_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Graph, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
