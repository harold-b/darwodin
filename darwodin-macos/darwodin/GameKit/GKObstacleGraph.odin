...
@(objc_type=ObstacleGraph, objc_name="poseAsClass", objc_is_class_method=true)
ObstacleGraph_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ObstacleGraph, "poseAsClass:", aClass)
}
...
@(objc_type=ObstacleGraph, objc_name="setKeys", objc_is_class_method=true)
ObstacleGraph_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ObstacleGraph, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ObstacleGraph, objc_name="exposeBinding", objc_is_class_method=true)
ObstacleGraph_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ObstacleGraph, "exposeBinding:", binding)
}
@(objc_type=ObstacleGraph, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ObstacleGraph_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ObstacleGraph, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ObstacleGraph, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ObstacleGraph_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ObstacleGraph, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
