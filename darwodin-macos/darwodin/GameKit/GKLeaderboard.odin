...
Leaderboard_loadImageWithCompletionHandler :: #force_inline proc "c" (self: ^Leaderboard, completionHandler: ^Objc_Block(proc "c" (image: ^NS.Image, error: ^NS.Error))) {
...
@(objc_type=Leaderboard, objc_name="poseAsClass", objc_is_class_method=true)
Leaderboard_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Leaderboard, "poseAsClass:", aClass)
}
...
@(objc_type=Leaderboard, objc_name="setKeys", objc_is_class_method=true)
Leaderboard_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Leaderboard, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Leaderboard, objc_name="exposeBinding", objc_is_class_method=true)
Leaderboard_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Leaderboard, "exposeBinding:", binding)
}
@(objc_type=Leaderboard, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Leaderboard_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Leaderboard, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Leaderboard, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Leaderboard_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Leaderboard, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
