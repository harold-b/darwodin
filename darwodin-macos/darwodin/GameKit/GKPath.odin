...
@(objc_type=Path, objc_name="poseAsClass", objc_is_class_method=true)
Path_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Path, "poseAsClass:", aClass)
}
...
@(objc_type=Path, objc_name="setKeys", objc_is_class_method=true)
Path_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Path, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Path, objc_name="exposeBinding", objc_is_class_method=true)
Path_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Path, "exposeBinding:", binding)
}
@(objc_type=Path, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Path_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Path, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Path, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Path_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Path, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
