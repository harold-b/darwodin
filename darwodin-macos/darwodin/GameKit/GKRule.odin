...
@(objc_type=Rule, objc_name="poseAsClass", objc_is_class_method=true)
Rule_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Rule, "poseAsClass:", aClass)
}
...
@(objc_type=Rule, objc_name="setKeys", objc_is_class_method=true)
Rule_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Rule, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Rule, objc_name="exposeBinding", objc_is_class_method=true)
Rule_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Rule, "exposeBinding:", binding)
}
@(objc_type=Rule, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Rule_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Rule, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Rule, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Rule_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Rule, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
