...
@(objc_type=State, objc_name="poseAsClass", objc_is_class_method=true)
State_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, State, "poseAsClass:", aClass)
}
...
@(objc_type=State, objc_name="setKeys", objc_is_class_method=true)
State_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, State, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=State, objc_name="exposeBinding", objc_is_class_method=true)
State_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, State, "exposeBinding:", binding)
}
@(objc_type=State, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
State_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, State, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=State, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
State_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, State, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
