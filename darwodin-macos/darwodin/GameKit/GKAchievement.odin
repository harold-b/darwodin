...
Achievement_challengeComposeControllerWithMessage_players_completionHandler :: #force_inline proc "c" (self: ^Achievement, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeCompletionBlock) -> ^AK.ViewController {
...
Achievement_challengeComposeControllerWithMessage_players_completion :: #force_inline proc "c" (self: ^Achievement, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeHandler) -> ^AK.ViewController {
...
@(objc_type=Achievement, objc_name="poseAsClass", objc_is_class_method=true)
Achievement_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Achievement, "poseAsClass:", aClass)
}
...
@(objc_type=Achievement, objc_name="setKeys", objc_is_class_method=true)
Achievement_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Achievement, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Achievement, objc_name="exposeBinding", objc_is_class_method=true)
Achievement_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Achievement, "exposeBinding:", binding)
}
@(objc_type=Achievement, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Achievement_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Achievement, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Achievement, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Achievement_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Achievement, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
