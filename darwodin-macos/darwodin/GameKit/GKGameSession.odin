...
@(objc_type=GameSession, objc_name="poseAsClass", objc_is_class_method=true)
GameSession_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GameSession, "poseAsClass:", aClass)
}
...
@(objc_type=GameSession, objc_name="setKeys", objc_is_class_method=true)
GameSession_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GameSession, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=GameSession, objc_name="exposeBinding", objc_is_class_method=true)
GameSession_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GameSession, "exposeBinding:", binding)
}
@(objc_type=GameSession, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GameSession_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GameSession, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GameSession, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GameSession_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GameSession, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
