...
@(objc_type=ScoreChallenge, objc_name="poseAsClass", objc_is_class_method=true)
ScoreChallenge_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ScoreChallenge, "poseAsClass:", aClass)
}
...
@(objc_type=ScoreChallenge, objc_name="setKeys", objc_is_class_method=true)
ScoreChallenge_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ScoreChallenge, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ScoreChallenge, objc_name="exposeBinding", objc_is_class_method=true)
ScoreChallenge_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ScoreChallenge, "exposeBinding:", binding)
}
@(objc_type=ScoreChallenge, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ScoreChallenge_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ScoreChallenge, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ScoreChallenge, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ScoreChallenge_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ScoreChallenge, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
