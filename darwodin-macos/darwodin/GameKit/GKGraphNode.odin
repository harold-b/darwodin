...
@(objc_type=GraphNode, objc_name="poseAsClass", objc_is_class_method=true)
GraphNode_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GraphNode, "poseAsClass:", aClass)
}
...
@(objc_type=GraphNode, objc_name="setKeys", objc_is_class_method=true)
GraphNode_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GraphNode, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=GraphNode, objc_name="exposeBinding", objc_is_class_method=true)
GraphNode_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GraphNode, "exposeBinding:", binding)
}
@(objc_type=GraphNode, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GraphNode_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GraphNode, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GraphNode, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GraphNode_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GraphNode, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
