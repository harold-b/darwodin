...
@(objc_type=Behavior, objc_name="poseAsClass", objc_is_class_method=true)
Behavior_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Behavior, "poseAsClass:", aClass)
}
...
@(objc_type=Behavior, objc_name="setKeys", objc_is_class_method=true)
Behavior_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Behavior, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Behavior, objc_name="exposeBinding", objc_is_class_method=true)
Behavior_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Behavior, "exposeBinding:", binding)
}
@(objc_type=Behavior, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Behavior_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Behavior, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Behavior, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Behavior_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Behavior, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
