...
@(objc_type=Goal, objc_name="poseAsClass", objc_is_class_method=true)
Goal_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Goal, "poseAsClass:", aClass)
}
...
@(objc_type=Goal, objc_name="setKeys", objc_is_class_method=true)
Goal_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Goal, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Goal, objc_name="exposeBinding", objc_is_class_method=true)
Goal_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Goal, "exposeBinding:", binding)
}
@(objc_type=Goal, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Goal_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Goal, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Goal, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Goal_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Goal, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
