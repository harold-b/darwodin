...
@(objc_type=VoiceChatService, objc_name="poseAsClass", objc_is_class_method=true)
VoiceChatService_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VoiceChatService, "poseAsClass:", aClass)
}
...
@(objc_type=VoiceChatService, objc_name="setKeys", objc_is_class_method=true)
VoiceChatService_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VoiceChatService, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=VoiceChatService, objc_name="exposeBinding", objc_is_class_method=true)
VoiceChatService_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, VoiceChatService, "exposeBinding:", binding)
}
@(objc_type=VoiceChatService, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
VoiceChatService_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, VoiceChatService, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=VoiceChatService, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
VoiceChatService_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, VoiceChatService, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
