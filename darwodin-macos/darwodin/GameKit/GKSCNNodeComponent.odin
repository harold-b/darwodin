...
@(objc_type=SCNNodeComponent, objc_name="poseAsClass", objc_is_class_method=true)
SCNNodeComponent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SCNNodeComponent, "poseAsClass:", aClass)
}
...
@(objc_type=SCNNodeComponent, objc_name="setKeys", objc_is_class_method=true)
SCNNodeComponent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SCNNodeComponent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=SCNNodeComponent, objc_name="exposeBinding", objc_is_class_method=true)
SCNNodeComponent_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, SCNNodeComponent, "exposeBinding:", binding)
}
@(objc_type=SCNNodeComponent, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
SCNNodeComponent_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, SCNNodeComponent, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=SCNNodeComponent, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
SCNNodeComponent_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, SCNNodeComponent, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
