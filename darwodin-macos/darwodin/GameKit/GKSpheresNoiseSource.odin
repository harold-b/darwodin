...
@(objc_type=SpheresNoiseSource, objc_name="poseAsClass", objc_is_class_method=true)
SpheresNoiseSource_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SpheresNoiseSource, "poseAsClass:", aClass)
}
...
@(objc_type=SpheresNoiseSource, objc_name="setKeys", objc_is_class_method=true)
SpheresNoiseSource_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SpheresNoiseSource, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=SpheresNoiseSource, objc_name="exposeBinding", objc_is_class_method=true)
SpheresNoiseSource_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, SpheresNoiseSource, "exposeBinding:", binding)
}
@(objc_type=SpheresNoiseSource, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
SpheresNoiseSource_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, SpheresNoiseSource, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=SpheresNoiseSource, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
SpheresNoiseSource_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, SpheresNoiseSource, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
