...
@(objc_type=LeaderboardViewController, objc_name="allowedClassesForRestorableStateKeyPath", objc_is_class_method=true)
LeaderboardViewController_allowedClassesForRestorableStateKeyPath :: #force_inline proc "c" (keyPath: ^NS.String) -> ^NS.Array {
    return msgSend(^NS.Array, LeaderboardViewController, "allowedClassesForRestorableStateKeyPath:", keyPath)
}
@(objc_type=LeaderboardViewController, objc_name="restorableStateKeyPaths", objc_is_class_method=true)
LeaderboardViewController_restorableStateKeyPaths :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, LeaderboardViewController, "restorableStateKeyPaths")
}
...
@(objc_type=LeaderboardViewController, objc_name="poseAsClass", objc_is_class_method=true)
LeaderboardViewController_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LeaderboardViewController, "poseAsClass:", aClass)
}
...
@(objc_type=LeaderboardViewController, objc_name="setKeys", objc_is_class_method=true)
LeaderboardViewController_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LeaderboardViewController, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=LeaderboardViewController, objc_name="exposeBinding", objc_is_class_method=true)
LeaderboardViewController_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, LeaderboardViewController, "exposeBinding:", binding)
}
@(objc_type=LeaderboardViewController, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
LeaderboardViewController_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, LeaderboardViewController, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=LeaderboardViewController, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
LeaderboardViewController_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, LeaderboardViewController, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
