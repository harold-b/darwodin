...
foreign lib {
    ...
    @(objc_type=AUAudioUnit, objc_selector="deviceInputLatency", objc_name="deviceInputLatency")
    AUAudioUnit_deviceInputLatency :: proc(self: ^AUAudioUnit) -> NS.TimeInterval ---

    @(objc_type=AUAudioUnit, objc_selector="deviceOutputLatency", objc_name="deviceOutputLatency")
    AUAudioUnit_deviceOutputLatency :: proc(self: ^AUAudioUnit) -> NS.TimeInterval ---
