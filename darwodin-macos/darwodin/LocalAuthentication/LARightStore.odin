...
@(objc_type=RightStore, objc_name="poseAsClass", objc_is_class_method=true)
RightStore_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RightStore, "poseAsClass:", aClass)
}
...
@(objc_type=RightStore, objc_name="setKeys", objc_is_class_method=true)
RightStore_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RightStore, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
