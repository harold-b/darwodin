...
@(objc_type=EnvironmentMechanismCompanion, objc_name="poseAsClass", objc_is_class_method=true)
EnvironmentMechanismCompanion_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, EnvironmentMechanismCompanion, "poseAsClass:", aClass)
}
...
@(objc_type=EnvironmentMechanismCompanion, objc_name="setKeys", objc_is_class_method=true)
EnvironmentMechanismCompanion_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, EnvironmentMechanismCompanion, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
