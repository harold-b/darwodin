...
PrivateKey_signData :: #force_inline proc "c" (self: ^PrivateKey, data: ^NS.Data, algorithm: SecKeyAlgorithm, handler: ^Objc_Block(proc "c" (_: ^NS.Data, _1: ^NS.Error))) {
...
PrivateKey_decryptData :: #force_inline proc "c" (self: ^PrivateKey, data: ^NS.Data, algorithm: SecKeyAlgorithm, handler: ^Objc_Block(proc "c" (_: ^NS.Data, _1: ^NS.Error))) {
...
PrivateKey_exchangeKeysWithPublicKey :: #force_inline proc "c" (self: ^PrivateKey, publicKey: ^NS.Data, algorithm: SecKeyAlgorithm, parameters: ^NS.Dictionary, handler: ^Objc_Block(proc "c" (_: ^NS.Data, _1: ^NS.Error))) {
...
@(objc_type=PrivateKey, objc_name="poseAsClass", objc_is_class_method=true)
PrivateKey_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PrivateKey, "poseAsClass:", aClass)
}
...
@(objc_type=PrivateKey, objc_name="setKeys", objc_is_class_method=true)
PrivateKey_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PrivateKey, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
