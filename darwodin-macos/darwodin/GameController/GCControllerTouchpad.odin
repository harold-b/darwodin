...
@(objc_type=ControllerTouchpad, objc_name="poseAsClass", objc_is_class_method=true)
ControllerTouchpad_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerTouchpad, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerTouchpad, objc_name="setKeys", objc_is_class_method=true)
ControllerTouchpad_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerTouchpad, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerTouchpad, objc_name="exposeBinding", objc_is_class_method=true)
ControllerTouchpad_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerTouchpad, "exposeBinding:", binding)
}
@(objc_type=ControllerTouchpad, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerTouchpad_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerTouchpad, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerTouchpad, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerTouchpad_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerTouchpad, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
