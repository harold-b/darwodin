...
@(objc_type=ControllerAxisInput, objc_name="poseAsClass", objc_is_class_method=true)
ControllerAxisInput_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerAxisInput, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerAxisInput, objc_name="setKeys", objc_is_class_method=true)
ControllerAxisInput_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerAxisInput, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerAxisInput, objc_name="exposeBinding", objc_is_class_method=true)
ControllerAxisInput_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerAxisInput, "exposeBinding:", binding)
}
@(objc_type=ControllerAxisInput, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerAxisInput_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerAxisInput, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerAxisInput, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerAxisInput_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerAxisInput, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
