...
@(objc_type=ExtendedGamepadSnapshot, objc_name="poseAsClass", objc_is_class_method=true)
ExtendedGamepadSnapshot_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ExtendedGamepadSnapshot, "poseAsClass:", aClass)
}
...
@(objc_type=ExtendedGamepadSnapshot, objc_name="setKeys", objc_is_class_method=true)
ExtendedGamepadSnapshot_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ExtendedGamepadSnapshot, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ExtendedGamepadSnapshot, objc_name="exposeBinding", objc_is_class_method=true)
ExtendedGamepadSnapshot_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ExtendedGamepadSnapshot, "exposeBinding:", binding)
}
@(objc_type=ExtendedGamepadSnapshot, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ExtendedGamepadSnapshot_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ExtendedGamepadSnapshot, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ExtendedGamepadSnapshot, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ExtendedGamepadSnapshot_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ExtendedGamepadSnapshot, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
