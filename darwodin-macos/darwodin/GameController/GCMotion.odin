...
@(objc_type=Motion, objc_name="poseAsClass", objc_is_class_method=true)
Motion_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Motion, "poseAsClass:", aClass)
}
...
@(objc_type=Motion, objc_name="setKeys", objc_is_class_method=true)
Motion_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Motion, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Motion, objc_name="exposeBinding", objc_is_class_method=true)
Motion_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Motion, "exposeBinding:", binding)
}
@(objc_type=Motion, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Motion_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Motion, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Motion, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Motion_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Motion, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
