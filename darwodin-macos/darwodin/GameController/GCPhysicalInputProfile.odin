...
@(objc_type=PhysicalInputProfile, objc_name="poseAsClass", objc_is_class_method=true)
PhysicalInputProfile_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PhysicalInputProfile, "poseAsClass:", aClass)
}
...
@(objc_type=PhysicalInputProfile, objc_name="setKeys", objc_is_class_method=true)
PhysicalInputProfile_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PhysicalInputProfile, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=PhysicalInputProfile, objc_name="exposeBinding", objc_is_class_method=true)
PhysicalInputProfile_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, PhysicalInputProfile, "exposeBinding:", binding)
}
@(objc_type=PhysicalInputProfile, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
PhysicalInputProfile_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, PhysicalInputProfile, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=PhysicalInputProfile, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
PhysicalInputProfile_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, PhysicalInputProfile, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
