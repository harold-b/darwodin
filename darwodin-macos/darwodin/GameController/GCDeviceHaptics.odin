...
@(objc_type=DeviceHaptics, objc_name="poseAsClass", objc_is_class_method=true)
DeviceHaptics_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DeviceHaptics, "poseAsClass:", aClass)
}
...
@(objc_type=DeviceHaptics, objc_name="setKeys", objc_is_class_method=true)
DeviceHaptics_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DeviceHaptics, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=DeviceHaptics, objc_name="exposeBinding", objc_is_class_method=true)
DeviceHaptics_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, DeviceHaptics, "exposeBinding:", binding)
}
@(objc_type=DeviceHaptics, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
DeviceHaptics_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, DeviceHaptics, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=DeviceHaptics, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
DeviceHaptics_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, DeviceHaptics, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
