...
@(objc_type=RacingWheelInputState, objc_name="poseAsClass", objc_is_class_method=true)
RacingWheelInputState_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RacingWheelInputState, "poseAsClass:", aClass)
}
...
@(objc_type=RacingWheelInputState, objc_name="setKeys", objc_is_class_method=true)
RacingWheelInputState_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RacingWheelInputState, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=RacingWheelInputState, objc_name="exposeBinding", objc_is_class_method=true)
RacingWheelInputState_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, RacingWheelInputState, "exposeBinding:", binding)
}
@(objc_type=RacingWheelInputState, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
RacingWheelInputState_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, RacingWheelInputState, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=RacingWheelInputState, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
RacingWheelInputState_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, RacingWheelInputState, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
