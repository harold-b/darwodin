...
OrderedCollectionDifference_odin_extend :: proc(cls: Class, vt: ^OrderedCollectionDifference_VTable) {
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^OrderedCollectionDifference_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^OrderedCollectionDifference_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
