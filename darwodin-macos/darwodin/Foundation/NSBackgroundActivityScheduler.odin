...
foreign lib {
    ...
    BackgroundActivityScheduler_identifier :: proc(self: ^BackgroundActivityScheduler) -> ^String ---

    @(objc_type=BackgroundActivityScheduler, objc_selector="qualityOfService", objc_name="qualityOfService")
    BackgroundActivityScheduler_qualityOfService :: proc(self: ^BackgroundActivityScheduler) -> QualityOfService ---

    @(objc_type=BackgroundActivityScheduler, objc_selector="setQualityOfService:", objc_name="setQualityOfService")
    BackgroundActivityScheduler_setQualityOfService :: proc(self: ^BackgroundActivityScheduler, qualityOfService: QualityOfService) ---
    ...
    BackgroundActivityScheduler_interval :: proc(self: ^BackgroundActivityScheduler) -> TimeInterval ---

    @(objc_type=BackgroundActivityScheduler, objc_selector="setInterval:", objc_name="setInterval")
    BackgroundActivityScheduler_setInterval :: proc(self: ^BackgroundActivityScheduler, interval: TimeInterval) ---

    @(objc_type=BackgroundActivityScheduler, objc_selector="tolerance", objc_name="tolerance")
    BackgroundActivityScheduler_tolerance :: proc(self: ^BackgroundActivityScheduler) -> TimeInterval ---

    @(objc_type=BackgroundActivityScheduler, objc_selector="setTolerance:", objc_name="setTolerance")
    BackgroundActivityScheduler_setTolerance :: proc(self: ^BackgroundActivityScheduler, tolerance: TimeInterval) ---
