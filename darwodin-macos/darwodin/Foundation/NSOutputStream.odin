...
@(objc_type=OutputStream, objc_name="getStreamsToHost", objc_is_class_method=true)
OutputStream_getStreamsToHost :: #force_inline proc "c" (host: ^Host, port: Integer, inputStream: ^^InputStream, outputStream: ^^OutputStream) {
    msgSend(nil, OutputStream, "getStreamsToHost:port:inputStream:outputStream:", host, port, inputStream, outputStream)
}
...
@(objc_type=OutputStream, objc_name="poseAsClass", objc_is_class_method=true)
OutputStream_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, OutputStream, "poseAsClass:", aClass)
}
...
@(objc_type=OutputStream, objc_name="setKeys", objc_is_class_method=true)
OutputStream_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, OutputStream, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
