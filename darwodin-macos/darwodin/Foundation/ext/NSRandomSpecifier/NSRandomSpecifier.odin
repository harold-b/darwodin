package darwodin_NSRandomSpecifier_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.RandomSpecifier,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.RandomSpecifier,
    alloc: proc() -> ^NS.RandomSpecifier,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.RandomSpecifier {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.RandomSpecifier {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.RandomSpecifier {
