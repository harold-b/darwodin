...
VTable :: struct {
    ...
    resourceDataUsingCache: proc(self: ^NS.URL, shouldUseCache: bool) -> ^NS.Data,
    loadResourceDataNotifyingClient: proc(self: ^NS.URL, client: id, shouldUseCache: bool),
    propertyForKey: proc(self: ^NS.URL, propertyKey: ^NS.String) -> id,
    setResourceData: proc(self: ^NS.URL, data: ^NS.Data) -> bool,
    setProperty: proc(self: ^NS.URL, property: id, propertyKey: ^NS.String) -> bool,
    _URLHandleUsingCache: proc(self: ^NS.URL, shouldUseCache: bool) -> ^NS.URLHandle,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.resourceDataUsingCache != nil {
        resourceDataUsingCache :: proc "c" (self: ^NS.URL, _: SEL, shouldUseCache: bool) -> ^NS.Data {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).resourceDataUsingCache(self, shouldUseCache)
        }
    ...
    if vt.loadResourceDataNotifyingClient != nil {
        loadResourceDataNotifyingClient :: proc "c" (self: ^NS.URL, _: SEL, client: id, shouldUseCache: bool) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).loadResourceDataNotifyingClient(self, client, shouldUseCache)
        }
    ...
    if vt.propertyForKey != nil {
        propertyForKey :: proc "c" (self: ^NS.URL, _: SEL, propertyKey: ^NS.String) -> id {
    ...
    if vt.setResourceData != nil {
        setResourceData :: proc "c" (self: ^NS.URL, _: SEL, data: ^NS.Data) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).setResourceData(self, data)
        }
    ...
    if vt.setProperty != nil {
        setProperty :: proc "c" (self: ^NS.URL, _: SEL, property: id, propertyKey: ^NS.String) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).setProperty(self, property, propertyKey)
        }
    ...
    if vt._URLHandleUsingCache != nil {
        _URLHandleUsingCache :: proc "c" (self: ^NS.URL, _: SEL, shouldUseCache: bool) -> ^NS.URLHandle {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt)._URLHandleUsingCache(self, shouldUseCache)
        }
