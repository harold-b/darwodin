...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ScriptWhoseTest,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ScriptWhoseTest,
    alloc: proc() -> ^NS.ScriptWhoseTest,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.isTrue != nil {
        isTrue :: proc "c" (self: ^NS.ScriptWhoseTest, _: SEL) -> bool {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptWhoseTest {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ScriptWhoseTest {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptWhoseTest {
