...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.PositionalSpecifier,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.PositionalSpecifier,
    alloc: proc() -> ^NS.PositionalSpecifier,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.PositionalSpecifier {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.PositionalSpecifier {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.PositionalSpecifier {
