...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.WhoseSpecifier,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.WhoseSpecifier,
    alloc: proc() -> ^NS.WhoseSpecifier,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.WhoseSpecifier {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.WhoseSpecifier {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.WhoseSpecifier {
