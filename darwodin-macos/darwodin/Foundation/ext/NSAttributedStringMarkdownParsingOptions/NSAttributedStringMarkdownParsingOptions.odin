...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.AttributedStringMarkdownParsingOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.AttributedStringMarkdownParsingOptions,
    alloc: proc() -> ^NS.AttributedStringMarkdownParsingOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.AttributedStringMarkdownParsingOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.AttributedStringMarkdownParsingOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.AttributedStringMarkdownParsingOptions {
