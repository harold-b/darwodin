package darwodin_NSCloseCommand_Ext
...
VTable :: struct {
    ...
    saveOptions: proc(self: ^NS.CloseCommand) -> NS.SaveOptions,
    currentCommand: proc() -> ^NS.ScriptCommand,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.CloseCommand,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.CloseCommand,
    alloc: proc() -> ^NS.CloseCommand,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.saveOptions != nil {
        saveOptions :: proc "c" (self: ^NS.CloseCommand, _: SEL) -> NS.SaveOptions {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.CloseCommand {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.CloseCommand {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.CloseCommand {
