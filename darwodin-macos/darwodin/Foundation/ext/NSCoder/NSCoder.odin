...
VTable :: struct {
    ...
    encodePropertyList: proc(self: ^NS.Coder, aPropertyList: id),
    decodePropertyList: proc(self: ^NS.Coder) -> id,
    ...
    encodeNXObject: proc(self: ^NS.Coder, object: id),
    decodeNXObject: proc(self: ^NS.Coder) -> id,
    decodeValueOfObjCType_at: proc(self: ^NS.Coder, type: cstring, data: rawptr),
    encodePoint_: proc(self: ^NS.Coder, point: CG.Point),
    decodePoint: proc(self: ^NS.Coder) -> CG.Point,
    encodeSize_: proc(self: ^NS.Coder, size: NS.Size),
    decodeSize: proc(self: ^NS.Coder) -> NS.Size,
    encodeRect_: proc(self: ^NS.Coder, rect: NS.Rect),
    decodeRect: proc(self: ^NS.Coder) -> NS.Rect,
    encodePoint_forKey: proc(self: ^NS.Coder, point: CG.Point, key: ^NS.String),
    encodeSize_forKey: proc(self: ^NS.Coder, size: NS.Size, key: ^NS.String),
    encodeRect_forKey: proc(self: ^NS.Coder, rect: NS.Rect, key: ^NS.String),
    decodePointForKey: proc(self: ^NS.Coder, key: ^NS.String) -> CG.Point,
    decodeSizeForKey: proc(self: ^NS.Coder, key: ^NS.String) -> NS.Size,
    decodeRectForKey: proc(self: ^NS.Coder, key: ^NS.String) -> NS.Rect,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.encodePropertyList != nil {
        encodePropertyList :: proc "c" (self: ^NS.Coder, _: SEL, aPropertyList: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodePropertyList(self, aPropertyList)
        }
    ...
    if vt.decodePropertyList != nil {
        decodePropertyList :: proc "c" (self: ^NS.Coder, _: SEL) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodePropertyList(self)
        }
    ...
    if vt.encodeNXObject != nil {
        encodeNXObject :: proc "c" (self: ^NS.Coder, _: SEL, object: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodeNXObject(self, object)
        }
    ...
    if vt.decodeNXObject != nil {
        decodeNXObject :: proc "c" (self: ^NS.Coder, _: SEL) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodeNXObject(self)
        }
    ...
    if vt.encodePoint_ != nil {
        encodePoint_ :: proc "c" (self: ^NS.Coder, _: SEL, point: CG.Point) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodePoint_(self, point)
        }
    ...
    if vt.decodePoint != nil {
        decodePoint :: proc "c" (self: ^NS.Coder, _: SEL) -> CG.Point {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodePoint(self)
        }
    ...
    if vt.encodeSize_ != nil {
        encodeSize_ :: proc "c" (self: ^NS.Coder, _: SEL, size: NS.Size) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodeSize_(self, size)
        }
    ...
    if vt.decodeSize != nil {
        decodeSize :: proc "c" (self: ^NS.Coder, _: SEL) -> NS.Size {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodeSize(self)
        }
    ...
    if vt.encodeRect_ != nil {
        encodeRect_ :: proc "c" (self: ^NS.Coder, _: SEL, rect: NS.Rect) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodeRect_(self, rect)
        }
    ...
    if vt.decodeRect != nil {
        decodeRect :: proc "c" (self: ^NS.Coder, _: SEL) -> NS.Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodeRect(self)
        }
    ...
    if vt.encodePoint_forKey != nil {
        encodePoint_forKey :: proc "c" (self: ^NS.Coder, _: SEL, point: CG.Point, key: ^NS.String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodePoint_forKey(self, point, key)
        }
    ...
    if vt.encodeSize_forKey != nil {
        encodeSize_forKey :: proc "c" (self: ^NS.Coder, _: SEL, size: NS.Size, key: ^NS.String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodeSize_forKey(self, size, key)
        }
    ...
    if vt.encodeRect_forKey != nil {
        encodeRect_forKey :: proc "c" (self: ^NS.Coder, _: SEL, rect: NS.Rect, key: ^NS.String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).encodeRect_forKey(self, rect, key)
        }
    ...
    if vt.decodePointForKey != nil {
        decodePointForKey :: proc "c" (self: ^NS.Coder, _: SEL, key: ^NS.String) -> CG.Point {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodePointForKey(self, key)
        }
    ...
    if vt.decodeSizeForKey != nil {
        decodeSizeForKey :: proc "c" (self: ^NS.Coder, _: SEL, key: ^NS.String) -> NS.Size {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodeSizeForKey(self, key)
        }
    ...
    if vt.decodeRectForKey != nil {
        decodeRectForKey :: proc "c" (self: ^NS.Coder, _: SEL, key: ^NS.String) -> NS.Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decodeRectForKey(self, key)
        }
