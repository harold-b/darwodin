...
VTable :: struct {
    ...
    scheduleWithBlock: proc(self: ^NS.BackgroundActivityScheduler, block: proc "c" (completionHandler: NS.BackgroundActivityCompletionHandler)),
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.BackgroundActivityScheduler,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.BackgroundActivityScheduler,
    alloc: proc() -> ^NS.BackgroundActivityScheduler,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.scheduleWithBlock != nil {
        scheduleWithBlock :: proc "c" (self: ^NS.BackgroundActivityScheduler, _: SEL, block: proc "c" (completionHandler: NS.BackgroundActivityCompletionHandler)) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.BackgroundActivityScheduler {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.BackgroundActivityScheduler {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.BackgroundActivityScheduler {
