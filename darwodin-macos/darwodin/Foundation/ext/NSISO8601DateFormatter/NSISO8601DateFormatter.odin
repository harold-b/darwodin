...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ISO8601DateFormatter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ISO8601DateFormatter,
    alloc: proc() -> ^NS.ISO8601DateFormatter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ISO8601DateFormatter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ISO8601DateFormatter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ISO8601DateFormatter {
