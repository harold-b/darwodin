...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ScriptCommandDescription,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ScriptCommandDescription,
    alloc: proc() -> ^NS.ScriptCommandDescription,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptCommandDescription {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ScriptCommandDescription {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptCommandDescription {
