package darwodin_NSConstantString_Ext
...
import "../NSSimpleCString"

VTable :: struct {
    super: NSSimpleCString.VTable,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ConstantString,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ConstantString,
    alloc: proc() -> ^NS.ConstantString,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    NSSimpleCString.extend(cls, &vt.super)
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ConstantString {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ConstantString {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ConstantString {
