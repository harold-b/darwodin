...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.UUID,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.UUID,
    alloc: proc() -> ^NS.UUID,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.UUID {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.UUID {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.UUID {
