...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.AppleScript,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.AppleScript,
    alloc: proc() -> ^NS.AppleScript,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.AppleScript {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.AppleScript {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.AppleScript {
