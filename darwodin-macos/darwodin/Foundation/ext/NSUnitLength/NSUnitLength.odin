package darwodin_NSUnitLength_Ext
...
VTable :: struct {
    ...
    megameters: proc() -> ^NS.UnitLength,
    kilometers: proc() -> ^NS.UnitLength,
    hectometers: proc() -> ^NS.UnitLength,
    decameters: proc() -> ^NS.UnitLength,
    meters: proc() -> ^NS.UnitLength,
    decimeters: proc() -> ^NS.UnitLength,
    centimeters: proc() -> ^NS.UnitLength,
    millimeters: proc() -> ^NS.UnitLength,
    micrometers: proc() -> ^NS.UnitLength,
    nanometers: proc() -> ^NS.UnitLength,
    picometers: proc() -> ^NS.UnitLength,
    inches: proc() -> ^NS.UnitLength,
    feet: proc() -> ^NS.UnitLength,
    yards: proc() -> ^NS.UnitLength,
    miles: proc() -> ^NS.UnitLength,
    scandinavianMiles: proc() -> ^NS.UnitLength,
    lightyears: proc() -> ^NS.UnitLength,
    nauticalMiles: proc() -> ^NS.UnitLength,
    fathoms: proc() -> ^NS.UnitLength,
    furlongs: proc() -> ^NS.UnitLength,
    astronomicalUnits: proc() -> ^NS.UnitLength,
    parsecs: proc() -> ^NS.UnitLength,
    supportsSecureCoding: proc() -> bool,
    baseUnit: proc() -> ^NS.Dimension,
    new: proc() -> ^NS.UnitLength,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.UnitLength,
    alloc: proc() -> ^NS.UnitLength,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.megameters != nil {
        megameters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).megameters()
        }
    ...
    if vt.kilometers != nil {
        kilometers :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).kilometers()
        }
    ...
    if vt.hectometers != nil {
        hectometers :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).hectometers()
        }
    ...
    if vt.decameters != nil {
        decameters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decameters()
        }
    ...
    if vt.meters != nil {
        meters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).meters()
        }
    ...
    if vt.decimeters != nil {
        decimeters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).decimeters()
        }
    ...
    if vt.centimeters != nil {
        centimeters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).centimeters()
        }
    ...
    if vt.millimeters != nil {
        millimeters :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).millimeters()
        }
    ...
    if vt.micrometers != nil {
        micrometers :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).micrometers()
        }
    ...
    if vt.nanometers != nil {
        nanometers :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).nanometers()
        }
    ...
    if vt.picometers != nil {
        picometers :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).picometers()
        }
    ...
    if vt.scandinavianMiles != nil {
        scandinavianMiles :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).scandinavianMiles()
        }
    ...
    if vt.lightyears != nil {
        lightyears :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).lightyears()
        }
    ...
    if vt.nauticalMiles != nil {
        nauticalMiles :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).nauticalMiles()
        }
    ...
    if vt.fathoms != nil {
        fathoms :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).fathoms()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("fathoms"), auto_cast fathoms, "@#:") do panic("Failed to register objC method.")
    }
    if vt.furlongs != nil {
        furlongs :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).furlongs()
        }
    ...
    if vt.astronomicalUnits != nil {
        astronomicalUnits :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).astronomicalUnits()
        }
    ...
    if vt.parsecs != nil {
        parsecs :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).parsecs()
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.UnitLength {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.UnitLength {
