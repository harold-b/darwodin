...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.URLConnection,
    alloc: proc() -> ^NS.URLConnection,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.URLConnection {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.URLConnection {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.URLConnection {
