...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ScriptSuiteRegistry,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ScriptSuiteRegistry,
    alloc: proc() -> ^NS.ScriptSuiteRegistry,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptSuiteRegistry {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ScriptSuiteRegistry {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ScriptSuiteRegistry {
