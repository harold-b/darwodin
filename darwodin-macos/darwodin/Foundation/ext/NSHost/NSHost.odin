...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Host,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Host,
    alloc: proc() -> ^NS.Host,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Host {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Host {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Host {
