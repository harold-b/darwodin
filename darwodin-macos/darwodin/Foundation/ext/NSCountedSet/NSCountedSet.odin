...
VTable :: struct {
    ...
    initWithCapacity: proc(self: ^NS.CountedSet, numItems: NS.UInteger) -> ^NS.CountedSet,
    initWithArray: proc(self: ^NS.CountedSet, array: ^NS.Array) -> ^NS.CountedSet,
    initWithSet: proc(self: ^NS.CountedSet, set: ^NS.Set) -> ^NS.CountedSet,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.CountedSet,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.CountedSet,
    alloc: proc() -> ^NS.CountedSet,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithCapacity != nil {
        initWithCapacity :: proc "c" (self: ^NS.CountedSet, _: SEL, numItems: NS.UInteger) -> ^NS.CountedSet {
    ...
    if vt.initWithArray != nil {
        initWithArray :: proc "c" (self: ^NS.CountedSet, _: SEL, array: ^NS.Array) -> ^NS.CountedSet {
    ...
    if vt.initWithSet != nil {
        initWithSet :: proc "c" (self: ^NS.CountedSet, _: SEL, set: ^NS.Set) -> ^NS.CountedSet {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.CountedSet {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.CountedSet {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.CountedSet {
