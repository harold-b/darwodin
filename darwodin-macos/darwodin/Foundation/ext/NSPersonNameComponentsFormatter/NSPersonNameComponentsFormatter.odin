...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.PersonNameComponentsFormatter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.PersonNameComponentsFormatter,
    alloc: proc() -> ^NS.PersonNameComponentsFormatter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.PersonNameComponentsFormatter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.PersonNameComponentsFormatter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.PersonNameComponentsFormatter {
