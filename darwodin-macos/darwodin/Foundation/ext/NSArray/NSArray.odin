...
VTable :: struct {
    ...
    sortedArrayUsingFunction_context: proc(self: ^NS.Array, comparator: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr) -> ^NS.Array,
    sortedArrayUsingFunction_context_hint: proc(self: ^NS.Array, comparator: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr, hint: ^NS.Data) -> ^NS.Array,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.sortedArrayUsingFunction_context != nil {
        sortedArrayUsingFunction_context :: proc "c" (self: ^NS.Array, _: SEL, comparator: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr) -> ^NS.Array {
    ...
    if vt.sortedArrayUsingFunction_context_hint != nil {
        sortedArrayUsingFunction_context_hint :: proc "c" (self: ^NS.Array, _: SEL, comparator: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr, hint: ^NS.Data) -> ^NS.Array {
