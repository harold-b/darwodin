...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Stream,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Stream,
    alloc: proc() -> ^NS.Stream,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Stream {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Stream {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Stream {
