...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.HTTPURLResponse,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.HTTPURLResponse,
    alloc: proc() -> ^NS.HTTPURLResponse,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.HTTPURLResponse {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.HTTPURLResponse {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.HTTPURLResponse {
