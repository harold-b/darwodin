...
VTable :: struct {
    ...
    alloc: proc() -> ^NS.DistantObject,
    allocWithZone: proc(zone: ^NS.Zone) -> ^NS.DistantObject,
    class: proc() -> Class,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DistantObject {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS.Zone) -> ^NS.DistantObject {
