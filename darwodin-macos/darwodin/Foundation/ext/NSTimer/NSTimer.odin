...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Timer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Timer,
    alloc: proc() -> ^NS.Timer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Timer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Timer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Timer {
