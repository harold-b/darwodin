...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.Measurement,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Measurement,
    alloc: proc() -> ^NS.Measurement,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^NS.Measurement, _: SEL) -> ^NS.Measurement {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Measurement {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Measurement {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Measurement {
