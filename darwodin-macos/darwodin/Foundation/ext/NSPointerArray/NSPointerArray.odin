...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.PointerArray,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.PointerArray,
    alloc: proc() -> ^NS.PointerArray,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.pointerArrayWithStrongObjects != nil {
        pointerArrayWithStrongObjects :: proc "c" (self: Class, _: SEL) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).pointerArrayWithStrongObjects()
        }
    ...
    if vt.pointerArrayWithWeakObjects != nil {
        pointerArrayWithWeakObjects :: proc "c" (self: Class, _: SEL) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).pointerArrayWithWeakObjects()
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.PointerArray {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.PointerArray {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.PointerArray {
