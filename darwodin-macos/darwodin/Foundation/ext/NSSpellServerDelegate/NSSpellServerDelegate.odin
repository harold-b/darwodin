...
VTable :: struct {
    spellServer_findMisspelledWordInString_language_wordCount_countOnly: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, stringToCheck: ^NS.String, language: ^NS.String, wordCount: ^NS.Integer, countOnly: bool) -> NS._NSRange,
    spellServer_suggestGuessesForWord_inLanguage: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, word: ^NS.String, language: ^NS.String) -> ^NS.Array,
    spellServer_didLearnWord_inLanguage: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, word: ^NS.String, language: ^NS.String),
    spellServer_didForgetWord_inLanguage: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, word: ^NS.String, language: ^NS.String),
    spellServer_suggestCompletionsForPartialWordRange_inString_language: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, range: NS._NSRange, string: ^NS.String, language: ^NS.String) -> ^NS.Array,
    spellServer_checkGrammarInString_language_details: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, stringToCheck: ^NS.String, language: ^NS.String, details: ^^NS.Array) -> NS._NSRange,
    spellServer_checkString_offset_types_options_orthography_wordCount: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, stringToCheck: ^NS.String, offset: NS.UInteger, checkingTypes: NS.TextCheckingTypes, options: ^NS.Dictionary, orthography: ^NS.Orthography, wordCount: ^NS.Integer) -> ^NS.Array,
    spellServer_recordResponse_toCorrection_forWord_language: proc(self: ^NS.SpellServerDelegate, sender: ^NS.SpellServer, response: NS.UInteger, correction: ^NS.String, word: ^NS.String, language: ^NS.String),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.spellServer_findMisspelledWordInString_language_wordCount_countOnly != nil {
        spellServer_findMisspelledWordInString_language_wordCount_countOnly :: proc "c" (self: ^NS.SpellServerDelegate, _: SEL, sender: ^NS.SpellServer, stringToCheck: ^NS.String, language: ^NS.String, wordCount: ^NS.Integer, countOnly: bool) -> NS._NSRange {
    ...
    if vt.spellServer_suggestGuessesForWord_inLanguage != nil {
        spellServer_suggestGuessesForWord_inLanguage :: proc "c" (self: ^NS.SpellServerDelegate, _: SEL, sender: ^NS.SpellServer, word: ^NS.String, language: ^NS.String) -> ^NS.Array {
    ...
    if vt.spellServer_didForgetWord_inLanguage != nil {
        spellServer_didForgetWord_inLanguage :: proc "c" (self: ^NS.SpellServerDelegate, _: SEL, sender: ^NS.SpellServer, word: ^NS.String, language: ^NS.String) {
    ...
    if vt.spellServer_suggestCompletionsForPartialWordRange_inString_language != nil {
        spellServer_suggestCompletionsForPartialWordRange_inString_language :: proc "c" (self: ^NS.SpellServerDelegate, _: SEL, sender: ^NS.SpellServer, range: NS._NSRange, string: ^NS.String, language: ^NS.String) -> ^NS.Array {
    ...
    if vt.spellServer_checkString_offset_types_options_orthography_wordCount != nil {
        spellServer_checkString_offset_types_options_orthography_wordCount :: proc "c" (self: ^NS.SpellServerDelegate, _: SEL, sender: ^NS.SpellServer, stringToCheck: ^NS.String, offset: NS.UInteger, checkingTypes: NS.TextCheckingTypes, options: ^NS.Dictionary, orthography: ^NS.Orthography, wordCount: ^NS.Integer) -> ^NS.Array {
