...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.RelativeDateTimeFormatter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.RelativeDateTimeFormatter,
    alloc: proc() -> ^NS.RelativeDateTimeFormatter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.RelativeDateTimeFormatter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.RelativeDateTimeFormatter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.RelativeDateTimeFormatter {
