...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.NetServiceBrowser,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.NetServiceBrowser,
    alloc: proc() -> ^NS.NetServiceBrowser,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.NetServiceBrowser {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.NetServiceBrowser {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.NetServiceBrowser {
