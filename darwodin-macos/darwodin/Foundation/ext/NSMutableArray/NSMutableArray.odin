...
VTable :: struct {
    ...
    sortUsingFunction: proc(self: ^NS.MutableArray, compare: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr),
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.sortUsingFunction != nil {
        sortUsingFunction :: proc "c" (self: ^NS.MutableArray, _: SEL, compare: proc "c" ( _0: id, _1: id, _2: rawptr ) -> NS.Integer, _context: rawptr) {
