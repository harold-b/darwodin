package darwodin_NSCountCommand_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.CountCommand,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.CountCommand,
    alloc: proc() -> ^NS.CountCommand,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.CountCommand {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.CountCommand {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.CountCommand {
