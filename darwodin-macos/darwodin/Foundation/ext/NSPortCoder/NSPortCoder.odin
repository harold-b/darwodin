...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.PortCoder,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.PortCoder,
    alloc: proc() -> ^NS.PortCoder,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.PortCoder {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.PortCoder {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.PortCoder {
