...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.DistributedNotificationCenter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.DistributedNotificationCenter,
    alloc: proc() -> ^NS.DistributedNotificationCenter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.DistributedNotificationCenter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.DistributedNotificationCenter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DistributedNotificationCenter {
