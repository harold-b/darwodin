...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.DistantObjectRequest,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.DistantObjectRequest,
    alloc: proc() -> ^NS.DistantObjectRequest,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.DistantObjectRequest {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.DistantObjectRequest {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DistantObjectRequest {
