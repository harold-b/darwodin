...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.MorphologyCustomPronoun,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.MorphologyCustomPronoun,
    alloc: proc() -> ^NS.MorphologyCustomPronoun,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.MorphologyCustomPronoun {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.MorphologyCustomPronoun {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.MorphologyCustomPronoun {
