package darwodin_NSExistsCommand_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.ExistsCommand,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.ExistsCommand,
    alloc: proc() -> ^NS.ExistsCommand,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.ExistsCommand {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.ExistsCommand {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.ExistsCommand {
