package darwodin_NSDataDetector_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.DataDetector,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.DataDetector,
    alloc: proc() -> ^NS.DataDetector,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    NSRegularExpression.extend(cls, &vt.super)

    if vt.dataDetectorWithTypes != nil {
        dataDetectorWithTypes :: proc "c" (self: Class, _: SEL, checkingTypes: NS.TextCheckingTypes, error: ^^NS.Error) -> ^NS.DataDetector {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).dataDetectorWithTypes( checkingTypes, error)
        }
    ...
    if vt.initWithTypes != nil {
        initWithTypes :: proc "c" (self: ^NS.DataDetector, _: SEL, checkingTypes: NS.TextCheckingTypes, error: ^^NS.Error) -> ^NS.DataDetector {
            ...
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).initWithTypes(self, checkingTypes, error)
        }
    ...
    if vt.checkingTypes != nil {
        checkingTypes :: proc "c" (self: ^NS.DataDetector, _: SEL) -> NS.TextCheckingTypes {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).checkingTypes(self)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.DataDetector {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.DataDetector {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DataDetector {
