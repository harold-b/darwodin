...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.UserAutomatorTask,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.UserAutomatorTask,
    alloc: proc() -> ^NS.UserAutomatorTask,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.UserAutomatorTask {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.UserAutomatorTask {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.UserAutomatorTask {
