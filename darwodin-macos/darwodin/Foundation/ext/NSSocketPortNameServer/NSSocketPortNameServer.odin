...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.SocketPortNameServer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.SocketPortNameServer,
    alloc: proc() -> ^NS.SocketPortNameServer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.SocketPortNameServer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.SocketPortNameServer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.SocketPortNameServer {
