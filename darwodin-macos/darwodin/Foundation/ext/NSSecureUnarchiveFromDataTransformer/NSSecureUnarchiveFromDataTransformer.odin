...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.SecureUnarchiveFromDataTransformer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.SecureUnarchiveFromDataTransformer,
    alloc: proc() -> ^NS.SecureUnarchiveFromDataTransformer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.SecureUnarchiveFromDataTransformer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.SecureUnarchiveFromDataTransformer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.SecureUnarchiveFromDataTransformer {
