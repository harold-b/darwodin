...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.FileProviderService,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.FileProviderService,
    alloc: proc() -> ^NS.FileProviderService,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.FileProviderService {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.FileProviderService {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.FileProviderService {
