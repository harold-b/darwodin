...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.XMLDTD,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.XMLDTD,
    alloc: proc() -> ^NS.XMLDTD,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.XMLDTD {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.XMLDTD {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.XMLDTD {
