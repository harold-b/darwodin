...
foreign lib {
    ...
    URLSessionTaskDelegate_URLSession_task_willPerformHTTPRedirection_newRequest_completionHandler :: proc(self: ^URLSessionTaskDelegate, session: ^URLSession, task: ^URLSessionTask, response: ^HTTPURLResponse, request: ^URLRequest, completionHandler: ^Objc_Block(proc "c" ( _0: ^URLRequest ))) ---
