...
@(objc_type=Date, objc_name="dateWithNaturalLanguageString_locale", objc_is_class_method=true)
Date_dateWithNaturalLanguageString_locale :: #force_inline proc "c" (string: ^String, locale: id) -> id {
    return msgSend(id, Date, "dateWithNaturalLanguageString:locale:", string, locale)
}
@(objc_type=Date, objc_name="dateWithNaturalLanguageString_", objc_is_class_method=true)
Date_dateWithNaturalLanguageString_ :: #force_inline proc "c" (string: ^String) -> id {
    return msgSend(id, Date, "dateWithNaturalLanguageString:", string)
}
@(objc_type=Date, objc_name="dateWithString", objc_is_class_method=true)
Date_dateWithString :: #force_inline proc "c" (aString: ^String) -> id {
    return msgSend(id, Date, "dateWithString:", aString)
}
@(objc_type=Date, objc_name="dateWithCalendarFormat")
Date_dateWithCalendarFormat :: #force_inline proc "c" (self: ^Date, format: ^String, aTimeZone: ^TimeZone) -> ^CalendarDate {
    return msgSend(^CalendarDate, self, "dateWithCalendarFormat:timeZone:", format, aTimeZone)
}
@(objc_type=Date, objc_name="descriptionWithCalendarFormat")
Date_descriptionWithCalendarFormat :: #force_inline proc "c" (self: ^Date, format: ^String, aTimeZone: ^TimeZone, locale: id) -> ^String {
    return msgSend(^String, self, "descriptionWithCalendarFormat:timeZone:locale:", format, aTimeZone, locale)
}
@(objc_type=Date, objc_name="initWithString")
Date_initWithString :: #force_inline proc "c" (self: ^Date, description: ^String) -> id {
...
@(objc_type=Date, objc_name="poseAsClass", objc_is_class_method=true)
Date_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Date, "poseAsClass:", aClass)
}
...
@(objc_type=Date, objc_name="setKeys", objc_is_class_method=true)
Date_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, Date, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
Date_VTable :: struct {
    ...
    dateWithString: proc(aString: ^String) -> id,
    dateWithCalendarFormat: proc(self: ^Date, format: ^String, aTimeZone: ^TimeZone) -> ^CalendarDate,
    descriptionWithCalendarFormat: proc(self: ^Date, format: ^String, aTimeZone: ^TimeZone, locale: id) -> ^String,
    initWithString: proc(self: ^Date, description: ^String) -> id,
...
Date_odin_extend :: proc(cls: Class, vt: ^Date_VTable) {
    ...
    if vt.dateWithNaturalLanguageString_locale != nil {
        dateWithNaturalLanguageString_locale :: proc "c" (self: Class, _: SEL, string: ^String, locale: id) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).dateWithNaturalLanguageString_locale( string, locale)
        }
    ...
    if vt.dateWithNaturalLanguageString_ != nil {
        dateWithNaturalLanguageString_ :: proc "c" (self: Class, _: SEL, string: ^String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).dateWithNaturalLanguageString_( string)
        }
    ...
    if vt.dateWithString != nil {
        dateWithString :: proc "c" (self: Class, _: SEL, aString: ^String) -> id {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).dateWithString( aString)
        }
    ...
    if vt.dateWithCalendarFormat != nil {
        dateWithCalendarFormat :: proc "c" (self: ^Date, _: SEL, format: ^String, aTimeZone: ^TimeZone) -> ^CalendarDate {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).dateWithCalendarFormat(self, format, aTimeZone)
        }
    ...
    if vt.descriptionWithCalendarFormat != nil {
        descriptionWithCalendarFormat :: proc "c" (self: ^Date, _: SEL, format: ^String, aTimeZone: ^TimeZone, locale: id) -> ^String {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).descriptionWithCalendarFormat(self, format, aTimeZone, locale)
        }
    ...
    if vt.initWithString != nil {
        initWithString :: proc "c" (self: ^Date, _: SEL, description: ^String) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Date_VTable)vt_ctx.super_vt).initWithString(self, description)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Date_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Date_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
