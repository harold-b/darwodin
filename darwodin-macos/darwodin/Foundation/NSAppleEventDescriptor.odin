...
foreign lib {
    ...
    AppleEventDescriptor_descriptorWithDescriptorType_bytes_length :: proc(descriptorType: DescType, bytes: rawptr, byteCount: UInteger) -> ^AppleEventDescriptor ---
    ...
    AppleEventDescriptor_descriptorWithDescriptorType_data :: proc(descriptorType: DescType, data: ^Data) -> ^AppleEventDescriptor ---
    ...
    AppleEventDescriptor_descriptorWithBoolean :: proc(boolean: CF.Boolean) -> ^AppleEventDescriptor ---
    ...
    AppleEventDescriptor_descriptorWithString :: proc(string: ^String) -> ^AppleEventDescriptor ---

    @(objc_type=AppleEventDescriptor, objc_selector="descriptorWithDate:", objc_name="descriptorWithDate", objc_is_class_method=true)
    AppleEventDescriptor_descriptorWithDate :: proc(date: ^Date) -> ^AppleEventDescriptor ---
    ...
    AppleEventDescriptor_descriptorWithFileURL :: proc(fileURL: ^URL) -> ^AppleEventDescriptor ---
    ...
    AppleEventDescriptor_sendEventWithOptions :: proc(self: ^AppleEventDescriptor, sendOptions: AppleEventSendOptions, timeoutInSeconds: TimeInterval, error: ^^Error) -> ^AppleEventDescriptor ---

    @(objc_type=AppleEventDescriptor, objc_selector="insertDescriptor:atIndex:", objc_name="insertDescriptor")
    AppleEventDescriptor_insertDescriptor :: proc(self: ^AppleEventDescriptor, descriptor: ^AppleEventDescriptor, index: Integer) ---

    @(objc_type=AppleEventDescriptor, objc_selector="descriptorAtIndex:", objc_name="descriptorAtIndex")
    AppleEventDescriptor_descriptorAtIndex :: proc(self: ^AppleEventDescriptor, index: Integer) -> ^AppleEventDescriptor ---

    @(objc_type=AppleEventDescriptor, objc_selector="removeDescriptorAtIndex:", objc_name="removeDescriptorAtIndex")
    AppleEventDescriptor_removeDescriptorAtIndex :: proc(self: ^AppleEventDescriptor, index: Integer) ---
    ...
    AppleEventDescriptor_keywordForDescriptorAtIndex :: proc(self: ^AppleEventDescriptor, index: Integer) -> AEKeyword ---
    ...
    AppleEventDescriptor_data :: proc(self: ^AppleEventDescriptor) -> ^Data ---

    @(objc_type=AppleEventDescriptor, objc_selector="booleanValue", objc_name="booleanValue")
    AppleEventDescriptor_booleanValue :: proc(self: ^AppleEventDescriptor) -> CF.Boolean ---
    ...
    AppleEventDescriptor_stringValue :: proc(self: ^AppleEventDescriptor) -> ^String ---

    @(objc_type=AppleEventDescriptor, objc_selector="dateValue", objc_name="dateValue")
    AppleEventDescriptor_dateValue :: proc(self: ^AppleEventDescriptor) -> ^Date ---

    @(objc_type=AppleEventDescriptor, objc_selector="fileURLValue", objc_name="fileURLValue")
    AppleEventDescriptor_fileURLValue :: proc(self: ^AppleEventDescriptor) -> ^URL ---
    ...
    AppleEventDescriptor_numberOfItems :: proc(self: ^AppleEventDescriptor) -> Integer ---
}
