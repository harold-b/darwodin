...
foreign lib {
    ...
    @(objc_type=URL, objc_selector="loadResourceDataNotifyingClient:usingCache:", objc_name="loadResourceDataNotifyingClient")
    URL_loadResourceDataNotifyingClient :: proc(self: ^URL, client: id, shouldUseCache: bool) ---

    @(objc_type=URL, objc_selector="propertyForKey:", objc_name="propertyForKey")
    URL_propertyForKey :: proc(self: ^URL, propertyKey: ^String) -> id ---

    @(objc_type=URL, objc_selector="setResourceData:", objc_name="setResourceData")
    URL_setResourceData :: proc(self: ^URL, data: ^Data) -> bool ---

    @(objc_type=URL, objc_selector="setProperty:forKey:", objc_name="setProperty")
    URL_setProperty :: proc(self: ^URL, property: id, propertyKey: ^String) -> bool ---

    @(objc_type=URL, objc_selector="URLHandleUsingCache:", objc_name="URLHandleUsingCache")
