...
URL_VTable :: struct {
    ...
    resourceDataUsingCache: proc(self: ^URL, shouldUseCache: bool) -> ^Data,
    loadResourceDataNotifyingClient: proc(self: ^URL, client: id, shouldUseCache: bool),
    propertyForKey: proc(self: ^URL, propertyKey: ^String) -> id,
    setResourceData: proc(self: ^URL, data: ^Data) -> bool,
    setProperty: proc(self: ^URL, property: id, propertyKey: ^String) -> bool,
    _URLHandleUsingCache: proc(self: ^URL, shouldUseCache: bool) -> ^URLHandle,
...
URL_odin_extend :: proc(cls: Class, vt: ^URL_VTable) {
    ...
    if vt.resourceDataUsingCache != nil {
        resourceDataUsingCache :: proc "c" (self: ^URL, _: SEL, shouldUseCache: bool) -> ^Data {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^URL_VTable)vt_ctx.super_vt).resourceDataUsingCache(self, shouldUseCache)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("resourceDataUsingCache:"), auto_cast resourceDataUsingCache, "@@:B") do panic("Failed to register objC method.")
    }
    if vt.loadResourceDataNotifyingClient != nil {
        loadResourceDataNotifyingClient :: proc "c" (self: ^URL, _: SEL, client: id, shouldUseCache: bool) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^URL_VTable)vt_ctx.super_vt).loadResourceDataNotifyingClient(self, client, shouldUseCache)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("loadResourceDataNotifyingClient:usingCache:"), auto_cast loadResourceDataNotifyingClient, "v@:@B") do panic("Failed to register objC method.")
    }
    if vt.propertyForKey != nil {
        propertyForKey :: proc "c" (self: ^URL, _: SEL, propertyKey: ^String) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^URL_VTable)vt_ctx.super_vt).propertyForKey(self, propertyKey)
        }
    ...
    if vt.setResourceData != nil {
        setResourceData :: proc "c" (self: ^URL, _: SEL, data: ^Data) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^URL_VTable)vt_ctx.super_vt).setResourceData(self, data)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("setResourceData:"), auto_cast setResourceData, "B@:@") do panic("Failed to register objC method.")
    }
    if vt.setProperty != nil {
        setProperty :: proc "c" (self: ^URL, _: SEL, property: id, propertyKey: ^String) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^URL_VTable)vt_ctx.super_vt).setProperty(self, property, propertyKey)
        }
    ...
    if vt._URLHandleUsingCache != nil {
        _URLHandleUsingCache :: proc "c" (self: ^URL, _: SEL, shouldUseCache: bool) -> ^URLHandle {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^URL_VTable)vt_ctx.super_vt)._URLHandleUsingCache(self, shouldUseCache)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("URLHandleUsingCache:"), auto_cast _URLHandleUsingCache, "@@:B") do panic("Failed to register objC method.")
    }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^URL_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^URL_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
