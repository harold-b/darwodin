...
@(objc_type=InputStream, objc_name="getStreamsToHost", objc_is_class_method=true)
InputStream_getStreamsToHost :: #force_inline proc "c" (host: ^Host, port: Integer, inputStream: ^^InputStream, outputStream: ^^OutputStream) {
    msgSend(nil, InputStream, "getStreamsToHost:port:inputStream:outputStream:", host, port, inputStream, outputStream)
}
...
@(objc_type=InputStream, objc_name="poseAsClass", objc_is_class_method=true)
InputStream_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, InputStream, "poseAsClass:", aClass)
}
...
@(objc_type=InputStream, objc_name="setKeys", objc_is_class_method=true)
InputStream_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, InputStream, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
InputStream_odin_extend :: proc(cls: Class, vt: ^InputStream_VTable) {
    ...
    if vt.getStreamsToHost != nil {
        getStreamsToHost :: proc "c" (self: Class, _: SEL, host: ^Host, port: Integer, inputStream: ^^InputStream, outputStream: ^^OutputStream) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^InputStream_VTable)vt_ctx.super_vt).getStreamsToHost( host, port, inputStream, outputStream)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^InputStream_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^InputStream_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
