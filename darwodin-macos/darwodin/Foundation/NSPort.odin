...
foreign lib {
    ...
    @(objc_type=Port, objc_selector="addConnection:toRunLoop:forMode:", objc_name="addConnection")
    Port_addConnection :: proc(self: ^Port, conn: ^Connection, runLoop: ^RunLoop, mode: ^String) ---

    @(objc_type=Port, objc_selector="removeConnection:fromRunLoop:forMode:", objc_name="removeConnection")
    Port_removeConnection :: proc(self: ^Port, conn: ^Connection, runLoop: ^RunLoop, mode: ^String) ---
