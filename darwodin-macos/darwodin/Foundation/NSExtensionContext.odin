...
@(objc_type=ExtensionContext, objc_name="poseAsClass", objc_is_class_method=true)
ExtensionContext_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ExtensionContext, "poseAsClass:", aClass)
}
...
@(objc_type=ExtensionContext, objc_name="setKeys", objc_is_class_method=true)
ExtensionContext_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, ExtensionContext, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
ExtensionContext_odin_extend :: proc(cls: Class, vt: ^ExtensionContext_VTable) {
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^ExtensionContext_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^ExtensionContext_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
