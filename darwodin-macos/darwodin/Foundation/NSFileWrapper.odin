...
foreign lib {
    ...
    @(objc_type=FileWrapper, objc_selector="initSymbolicLinkWithDestination:", objc_name="initSymbolicLinkWithDestination")
    FileWrapper_initSymbolicLinkWithDestination :: proc(self: ^FileWrapper, path: ^String) -> id ---

    @(objc_type=FileWrapper, objc_selector="needsToBeUpdatedFromPath:", objc_name="needsToBeUpdatedFromPath")
    FileWrapper_needsToBeUpdatedFromPath :: proc(self: ^FileWrapper, path: ^String) -> bool ---

    @(objc_type=FileWrapper, objc_selector="updateFromPath:", objc_name="updateFromPath")
    FileWrapper_updateFromPath :: proc(self: ^FileWrapper, path: ^String) -> bool ---

    @(objc_type=FileWrapper, objc_selector="writeToFile:atomically:updateFilenames:", objc_name="writeToFile")
    FileWrapper_writeToFile :: proc(self: ^FileWrapper, path: ^String, atomicFlag: bool, updateFilenamesFlag: bool) -> bool ---

    @(objc_type=FileWrapper, objc_selector="addFileWithPath:", objc_name="addFileWithPath")
    FileWrapper_addFileWithPath :: proc(self: ^FileWrapper, path: ^String) -> ^String ---

    @(objc_type=FileWrapper, objc_selector="addSymbolicLinkWithDestination:preferredFilename:", objc_name="addSymbolicLinkWithDestination")
    FileWrapper_addSymbolicLinkWithDestination :: proc(self: ^FileWrapper, path: ^String, filename: ^String) -> ^String ---

    @(objc_type=FileWrapper, objc_selector="symbolicLinkDestination", objc_name="symbolicLinkDestination")
