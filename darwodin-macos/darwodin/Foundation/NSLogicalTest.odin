...
LogicalTest_VTable :: struct {
    ...
    initAndTestWithTests: proc(self: ^LogicalTest, subTests: ^Array) -> ^LogicalTest,
    initOrTestWithTests: proc(self: ^LogicalTest, subTests: ^Array) -> ^LogicalTest,
    initNotTestWithTest: proc(self: ^LogicalTest, subTest: ^ScriptWhoseTest) -> ^LogicalTest,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^LogicalTest,
    allocWithZone: proc(zone: ^_NSZone) -> ^LogicalTest,
...
LogicalTest_odin_extend :: proc(cls: Class, vt: ^LogicalTest_VTable) {
    ...
    if vt.initAndTestWithTests != nil {
        initAndTestWithTests :: proc "c" (self: ^LogicalTest, _: SEL, subTests: ^Array) -> ^LogicalTest {
    ...
    if vt.initOrTestWithTests != nil {
        initOrTestWithTests :: proc "c" (self: ^LogicalTest, _: SEL, subTests: ^Array) -> ^LogicalTest {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^_NSZone) -> ^LogicalTest {
