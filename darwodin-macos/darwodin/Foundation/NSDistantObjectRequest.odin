...
DistantObjectRequest_VTable :: struct {
    super: Object_VTable,
    replyWithException: proc(self: ^DistantObjectRequest, exception: ^Exception),
    invocation: proc(self: ^DistantObjectRequest) -> ^Invocation,
    connection: proc(self: ^DistantObjectRequest) -> ^Connection,
    conversation: proc(self: ^DistantObjectRequest) -> id,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^DistantObjectRequest,
    allocWithZone: proc(zone: ^_NSZone) -> ^DistantObjectRequest,
...
DistantObjectRequest_odin_extend :: proc(cls: Class, vt: ^DistantObjectRequest_VTable) {
    ...
    if vt.replyWithException != nil {
        replyWithException :: proc "c" (self: ^DistantObjectRequest, _: SEL, exception: ^Exception) {
    ...
    if vt.invocation != nil {
        invocation :: proc "c" (self: ^DistantObjectRequest, _: SEL) -> ^Invocation {
    ...
    if vt.connection != nil {
        connection :: proc "c" (self: ^DistantObjectRequest, _: SEL) -> ^Connection {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^_NSZone) -> ^DistantObjectRequest {
