...
foreign lib {
    ...
    DistantObject_initWithTarget :: proc(self: ^DistantObject, target: id, connection: ^Connection) -> instancetype ---
    ...
    DistantObject_initWithLocal :: proc(self: ^DistantObject, target: id, connection: ^Connection) -> instancetype ---

    @(objc_type=DistantObject, objc_selector="initWithCoder:", objc_name="initWithCoder")
    DistantObject_initWithCoder :: proc(self: ^DistantObject, inCoder: ^Coder) -> instancetype ---
