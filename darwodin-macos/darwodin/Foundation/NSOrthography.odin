...
@(objc_type=Orthography, objc_name="poseAsClass", objc_is_class_method=true)
Orthography_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Orthography, "poseAsClass:", aClass)
}
...
@(objc_type=Orthography, objc_name="setKeys", objc_is_class_method=true)
Orthography_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, Orthography, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
