...
MachBootstrapServer_VTable :: struct {
    ...
    portForName_: proc(self: ^MachBootstrapServer, name: ^String) -> ^Port,
    portForName_host: proc(self: ^MachBootstrapServer, name: ^String, host: ^String) -> ^Port,
    registerPort: proc(self: ^MachBootstrapServer, port: ^Port, name: ^String) -> bool,
    servicePortWithName: proc(self: ^MachBootstrapServer, name: ^String) -> ^Port,
    systemDefaultPortNameServer: proc() -> ^PortNameServer,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^MachBootstrapServer,
    allocWithZone: proc(zone: ^_NSZone) -> ^MachBootstrapServer,
...
MachBootstrapServer_odin_extend :: proc(cls: Class, vt: ^MachBootstrapServer_VTable) {
    ...
    if vt.portForName_ != nil {
        portForName_ :: proc "c" (self: ^MachBootstrapServer, _: SEL, name: ^String) -> ^Port {
    ...
    if vt.portForName_host != nil {
        portForName_host :: proc "c" (self: ^MachBootstrapServer, _: SEL, name: ^String, host: ^String) -> ^Port {
    ...
    if vt.registerPort != nil {
        registerPort :: proc "c" (self: ^MachBootstrapServer, _: SEL, port: ^Port, name: ^String) -> bool {
    ...
    if vt.servicePortWithName != nil {
        servicePortWithName :: proc "c" (self: ^MachBootstrapServer, _: SEL, name: ^String) -> ^Port {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^_NSZone) -> ^MachBootstrapServer {
