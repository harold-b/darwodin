...
DateFormatter_VTable :: struct {
    ...
    initWithDateFormat: proc(self: ^DateFormatter, format: ^String, flag: bool) -> id,
    allowsNaturalLanguage: proc(self: ^DateFormatter) -> bool,
    load: proc(),
    initialize: proc(),
...
DateFormatter_odin_extend :: proc(cls: Class, vt: ^DateFormatter_VTable) {
    ...
    if vt.initWithDateFormat != nil {
        initWithDateFormat :: proc "c" (self: ^DateFormatter, _: SEL, format: ^String, flag: bool) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^DateFormatter_VTable)vt_ctx.super_vt).initWithDateFormat(self, format, flag)
        }
    ...
    if vt.allowsNaturalLanguage != nil {
        allowsNaturalLanguage :: proc "c" (self: ^DateFormatter, _: SEL) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^DateFormatter_VTable)vt_ctx.super_vt).allowsNaturalLanguage(self)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^DateFormatter_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^DateFormatter_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
