...
@(objc_type=HapticDynamicParameter, objc_name="poseAsClass", objc_is_class_method=true)
HapticDynamicParameter_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, HapticDynamicParameter, "poseAsClass:", aClass)
}
