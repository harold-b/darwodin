...
@(objc_type=HapticParameterCurve, objc_name="poseAsClass", objc_is_class_method=true)
HapticParameterCurve_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, HapticParameterCurve, "poseAsClass:", aClass)
}
