...
foreign lib {
    ...
    HapticPattern_initWithEvents_parameters_error :: proc(self: ^HapticPattern, events: ^NS.Array, parameters: ^NS.Array, outError: ^^NS.Error) -> instancetype ---
    ...
    HapticPattern_initWithEvents_parameterCurves_error :: proc(self: ^HapticPattern, events: ^NS.Array, parameterCurves: ^NS.Array, outError: ^^NS.Error) -> instancetype ---

    @(objc_type=HapticPattern, objc_selector="initWithDictionary:error:", objc_name="initWithDictionary")
    HapticPattern_initWithDictionary :: proc(self: ^HapticPattern, patternDict: ^NS.Dictionary, outError: ^^NS.Error) -> instancetype ---

    @(objc_type=HapticPattern, objc_selector="initWithContentsOfURL:error:", objc_name="initWithContentsOfURL")
    HapticPattern_initWithContentsOfURL :: proc(self: ^HapticPattern, ahapURL: ^NS.URL, outError: ^^NS.Error) -> instancetype ---
