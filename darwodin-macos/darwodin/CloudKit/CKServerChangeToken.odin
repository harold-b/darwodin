...
@(objc_type=ServerChangeToken, objc_name="poseAsClass", objc_is_class_method=true)
ServerChangeToken_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ServerChangeToken, "poseAsClass:", aClass)
}
...
@(objc_type=ServerChangeToken, objc_name="setKeys", objc_is_class_method=true)
ServerChangeToken_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ServerChangeToken, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
