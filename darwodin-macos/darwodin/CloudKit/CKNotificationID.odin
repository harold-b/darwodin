...
@(objc_type=NotificationID, objc_name="poseAsClass", objc_is_class_method=true)
NotificationID_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NotificationID, "poseAsClass:", aClass)
}
...
@(objc_type=NotificationID, objc_name="setKeys", objc_is_class_method=true)
NotificationID_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NotificationID, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
