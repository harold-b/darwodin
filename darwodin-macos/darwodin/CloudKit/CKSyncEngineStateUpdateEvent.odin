...
@(objc_type=SyncEngineStateUpdateEvent, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineStateUpdateEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineStateUpdateEvent, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineStateUpdateEvent, objc_name="setKeys", objc_is_class_method=true)
SyncEngineStateUpdateEvent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineStateUpdateEvent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
