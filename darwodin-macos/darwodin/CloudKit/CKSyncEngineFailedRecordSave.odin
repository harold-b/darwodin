...
@(objc_type=SyncEngineFailedRecordSave, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineFailedRecordSave_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineFailedRecordSave, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineFailedRecordSave, objc_name="setKeys", objc_is_class_method=true)
SyncEngineFailedRecordSave_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineFailedRecordSave, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
