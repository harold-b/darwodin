...
@(objc_type=FetchRecordZonesOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchRecordZonesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchRecordZonesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchRecordZonesOperation, objc_name="setKeys", objc_is_class_method=true)
FetchRecordZonesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchRecordZonesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
