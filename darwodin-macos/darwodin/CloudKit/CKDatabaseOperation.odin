...
@(objc_type=DatabaseOperation, objc_name="poseAsClass", objc_is_class_method=true)
DatabaseOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DatabaseOperation, "poseAsClass:", aClass)
}
...
@(objc_type=DatabaseOperation, objc_name="setKeys", objc_is_class_method=true)
DatabaseOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DatabaseOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
