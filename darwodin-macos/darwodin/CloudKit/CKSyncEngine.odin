...
@(objc_type=SyncEngine, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngine_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngine, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngine, objc_name="setKeys", objc_is_class_method=true)
SyncEngine_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngine, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
