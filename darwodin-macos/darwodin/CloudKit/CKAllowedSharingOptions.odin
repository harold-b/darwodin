...
@(objc_type=AllowedSharingOptions, objc_name="poseAsClass", objc_is_class_method=true)
AllowedSharingOptions_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AllowedSharingOptions, "poseAsClass:", aClass)
}
...
@(objc_type=AllowedSharingOptions, objc_name="setKeys", objc_is_class_method=true)
AllowedSharingOptions_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AllowedSharingOptions, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
