...
@(objc_type=FetchNotificationChangesOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchNotificationChangesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchNotificationChangesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchNotificationChangesOperation, objc_name="setKeys", objc_is_class_method=true)
FetchNotificationChangesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchNotificationChangesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
