...
@(objc_type=FetchShareParticipantsOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchShareParticipantsOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchShareParticipantsOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchShareParticipantsOperation, objc_name="setKeys", objc_is_class_method=true)
FetchShareParticipantsOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchShareParticipantsOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
