...
@(objc_type=RecordZoneID, objc_name="poseAsClass", objc_is_class_method=true)
RecordZoneID_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RecordZoneID, "poseAsClass:", aClass)
}
...
@(objc_type=RecordZoneID, objc_name="setKeys", objc_is_class_method=true)
RecordZoneID_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RecordZoneID, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
