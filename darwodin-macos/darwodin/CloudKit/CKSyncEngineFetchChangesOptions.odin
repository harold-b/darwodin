...
@(objc_type=SyncEngineFetchChangesOptions, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineFetchChangesOptions_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineFetchChangesOptions, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineFetchChangesOptions, objc_name="setKeys", objc_is_class_method=true)
SyncEngineFetchChangesOptions_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineFetchChangesOptions, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
