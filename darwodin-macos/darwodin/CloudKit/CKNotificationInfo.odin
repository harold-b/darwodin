...
@(objc_type=NotificationInfo, objc_name="poseAsClass", objc_is_class_method=true)
NotificationInfo_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NotificationInfo, "poseAsClass:", aClass)
}
...
@(objc_type=NotificationInfo, objc_name="setKeys", objc_is_class_method=true)
NotificationInfo_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NotificationInfo, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
