...
@(objc_type=Container, objc_name="poseAsClass", objc_is_class_method=true)
Container_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Container, "poseAsClass:", aClass)
}
...
@(objc_type=Container, objc_name="setKeys", objc_is_class_method=true)
Container_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Container, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
