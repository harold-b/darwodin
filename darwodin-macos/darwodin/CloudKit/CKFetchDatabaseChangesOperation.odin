...
@(objc_type=FetchDatabaseChangesOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchDatabaseChangesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchDatabaseChangesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchDatabaseChangesOperation, objc_name="setKeys", objc_is_class_method=true)
FetchDatabaseChangesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchDatabaseChangesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
