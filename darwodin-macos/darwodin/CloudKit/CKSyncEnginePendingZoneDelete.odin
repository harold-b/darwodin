...
@(objc_type=SyncEnginePendingZoneDelete, objc_name="poseAsClass", objc_is_class_method=true)
SyncEnginePendingZoneDelete_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEnginePendingZoneDelete, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEnginePendingZoneDelete, objc_name="setKeys", objc_is_class_method=true)
SyncEnginePendingZoneDelete_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEnginePendingZoneDelete, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
