...
@(objc_type=MarkNotificationsReadOperation, objc_name="poseAsClass", objc_is_class_method=true)
MarkNotificationsReadOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MarkNotificationsReadOperation, "poseAsClass:", aClass)
}
...
@(objc_type=MarkNotificationsReadOperation, objc_name="setKeys", objc_is_class_method=true)
MarkNotificationsReadOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MarkNotificationsReadOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
