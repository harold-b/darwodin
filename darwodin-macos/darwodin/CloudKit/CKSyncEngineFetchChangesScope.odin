...
@(objc_type=SyncEngineFetchChangesScope, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineFetchChangesScope_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineFetchChangesScope, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineFetchChangesScope, objc_name="setKeys", objc_is_class_method=true)
SyncEngineFetchChangesScope_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineFetchChangesScope, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
