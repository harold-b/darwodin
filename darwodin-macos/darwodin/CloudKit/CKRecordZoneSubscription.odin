...
@(objc_type=RecordZoneSubscription, objc_name="poseAsClass", objc_is_class_method=true)
RecordZoneSubscription_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RecordZoneSubscription, "poseAsClass:", aClass)
}
...
@(objc_type=RecordZoneSubscription, objc_name="setKeys", objc_is_class_method=true)
RecordZoneSubscription_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RecordZoneSubscription, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
