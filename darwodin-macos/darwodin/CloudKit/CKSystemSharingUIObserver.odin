...
@(objc_type=SystemSharingUIObserver, objc_name="poseAsClass", objc_is_class_method=true)
SystemSharingUIObserver_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SystemSharingUIObserver, "poseAsClass:", aClass)
}
...
@(objc_type=SystemSharingUIObserver, objc_name="setKeys", objc_is_class_method=true)
SystemSharingUIObserver_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SystemSharingUIObserver, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
