...
@(objc_type=Query, objc_name="poseAsClass", objc_is_class_method=true)
Query_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Query, "poseAsClass:", aClass)
}
...
@(objc_type=Query, objc_name="setKeys", objc_is_class_method=true)
Query_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Query, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
