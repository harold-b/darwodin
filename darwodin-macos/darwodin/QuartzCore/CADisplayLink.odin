...
@(objc_type=DisplayLink, objc_name="poseAsClass", objc_is_class_method=true)
DisplayLink_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DisplayLink, "poseAsClass:", aClass)
}
...
@(objc_type=DisplayLink, objc_name="setKeys", objc_is_class_method=true)
DisplayLink_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DisplayLink, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
DisplayLink_odin_extend :: proc(cls: Class, vt: ^DisplayLink_VTable) {
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^DisplayLink_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^DisplayLink_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
