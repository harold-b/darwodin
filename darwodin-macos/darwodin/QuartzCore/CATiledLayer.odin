...
TiledLayer_levelsOfDetail :: #force_inline proc "c" (self: ^TiledLayer) -> cffi.uint {
    return msgSend(cffi.uint, self, "levelsOfDetail")
}
@(objc_type=TiledLayer, objc_name="setLevelsOfDetail")
TiledLayer_setLevelsOfDetail :: #force_inline proc "c" (self: ^TiledLayer, levelsOfDetail: cffi.uint) {
    msgSend(nil, self, "setLevelsOfDetail:", levelsOfDetail)
}
@(objc_type=TiledLayer, objc_name="levelsOfDetailBias")
TiledLayer_levelsOfDetailBias :: #force_inline proc "c" (self: ^TiledLayer) -> cffi.uint {
    return msgSend(cffi.uint, self, "levelsOfDetailBias")
}
@(objc_type=TiledLayer, objc_name="setLevelsOfDetailBias")
TiledLayer_setLevelsOfDetailBias :: #force_inline proc "c" (self: ^TiledLayer, levelsOfDetailBias: cffi.uint) {
