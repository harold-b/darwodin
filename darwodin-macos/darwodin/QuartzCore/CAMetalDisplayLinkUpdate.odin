...
@(objc_type=MetalDisplayLinkUpdate, objc_name="poseAsClass", objc_is_class_method=true)
MetalDisplayLinkUpdate_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MetalDisplayLinkUpdate, "poseAsClass:", aClass)
}
...
@(objc_type=MetalDisplayLinkUpdate, objc_name="setKeys", objc_is_class_method=true)
MetalDisplayLinkUpdate_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MetalDisplayLinkUpdate, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
MetalDisplayLinkUpdate_odin_extend :: proc(cls: Class, vt: ^MetalDisplayLinkUpdate_VTable) {
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^MetalDisplayLinkUpdate_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^MetalDisplayLinkUpdate_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
