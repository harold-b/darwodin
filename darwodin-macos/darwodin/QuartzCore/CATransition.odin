...
@(objc_type=Transition, objc_name="filter")
Transition_filter :: #force_inline proc "c" (self: ^Transition) -> id {
    return msgSend(id, self, "filter")
}
@(objc_type=Transition, objc_name="setFilter")
Transition_setFilter :: #force_inline proc "c" (self: ^Transition, filter: id) {
    msgSend(nil, self, "setFilter:", filter)
}
...
@(objc_type=Transition, objc_name="poseAsClass", objc_is_class_method=true)
Transition_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Transition, "poseAsClass:", aClass)
}
...
@(objc_type=Transition, objc_name="setKeys", objc_is_class_method=true)
Transition_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Transition, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
Transition_VTable :: struct {
    ...
    filter: proc(self: ^Transition) -> id,
    setFilter: proc(self: ^Transition, filter: id),
...
Transition_odin_extend :: proc(cls: Class, vt: ^Transition_VTable) {
    ...
    if vt.filter != nil {
        filter :: proc "c" (self: ^Transition, _: SEL) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Transition_VTable)vt_ctx.super_vt).filter(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("filter"), auto_cast filter, "@@:") do panic("Failed to register objC method.")
    }
    if vt.setFilter != nil {
        setFilter :: proc "c" (self: ^Transition, _: SEL, filter: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Transition_VTable)vt_ctx.super_vt).setFilter(self, filter)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Transition_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Transition_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
