...
VTable :: struct {
    ...
    initWithServerPort: proc(self: ^CA.RemoteLayerClient, port: CF.mach_port_t) -> ^CA.RemoteLayerClient,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.RemoteLayerClient,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.RemoteLayerClient,
    alloc: proc() -> ^CA.RemoteLayerClient,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithServerPort != nil {
        initWithServerPort :: proc "c" (self: ^CA.RemoteLayerClient, _: SEL, port: CF.mach_port_t) -> ^CA.RemoteLayerClient {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.RemoteLayerClient {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.RemoteLayerClient {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.RemoteLayerClient {
