...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.ConstraintLayoutManager,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.ConstraintLayoutManager,
    alloc: proc() -> ^CA.ConstraintLayoutManager,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.ConstraintLayoutManager {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.ConstraintLayoutManager {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.ConstraintLayoutManager {
