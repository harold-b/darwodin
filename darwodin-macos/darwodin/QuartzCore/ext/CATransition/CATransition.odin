...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.Transition,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.Transition,
    alloc: proc() -> ^CA.Transition,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.Transition {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.Transition {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.Transition {
