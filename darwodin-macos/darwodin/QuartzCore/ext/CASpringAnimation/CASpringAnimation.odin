...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.SpringAnimation,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.SpringAnimation,
    alloc: proc() -> ^CA.SpringAnimation,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.SpringAnimation {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.SpringAnimation {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.SpringAnimation {
