...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.MetalDisplayLink,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.MetalDisplayLink,
    alloc: proc() -> ^CA.MetalDisplayLink,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.MetalDisplayLink {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.MetalDisplayLink {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.MetalDisplayLink {
