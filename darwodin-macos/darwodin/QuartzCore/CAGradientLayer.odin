...
@(objc_type=GradientLayer, objc_name="layerWithRemoteClientId", objc_is_class_method=true)
GradientLayer_layerWithRemoteClientId :: #force_inline proc "c" (client_id: cffi.uint32_t) -> ^Layer {
    return msgSend(^Layer, GradientLayer, "layerWithRemoteClientId:", client_id)
}
...
@(objc_type=GradientLayer, objc_name="poseAsClass", objc_is_class_method=true)
GradientLayer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GradientLayer, "poseAsClass:", aClass)
}
...
@(objc_type=GradientLayer, objc_name="setKeys", objc_is_class_method=true)
GradientLayer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GradientLayer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
GradientLayer_odin_extend :: proc(cls: Class, vt: ^GradientLayer_VTable) {
    ...
    if vt.layerWithRemoteClientId != nil {
        layerWithRemoteClientId :: proc "c" (self: Class, _: SEL, client_id: cffi.uint32_t) -> ^Layer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GradientLayer_VTable)vt_ctx.super_vt).layerWithRemoteClientId( client_id)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GradientLayer_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GradientLayer_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
