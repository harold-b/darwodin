...
Task_launchAndReturnError :: #force_inline proc "c" (self: ^Task, error: ^^NS.Error) -> bool {
...
Task_executableURL :: #force_inline proc "c" (self: ^Task) -> ^NS.URL {
    return msgSend(^NS.URL, self, "executableURL")
}
@(objc_type=Task, objc_name="setExecutableURL")
Task_setExecutableURL :: #force_inline proc "c" (self: ^Task, executableURL: ^NS.URL) {
    msgSend(nil, self, "setExecutableURL:", executableURL)
}
@(objc_type=Task, objc_name="arguments")
Task_arguments :: #force_inline proc "c" (self: ^Task) -> ^NS.Array {
    return msgSend(^NS.Array, self, "arguments")
}
@(objc_type=Task, objc_name="setArguments")
Task_setArguments :: #force_inline proc "c" (self: ^Task, arguments: ^NS.Array) {
    msgSend(nil, self, "setArguments:", arguments)
}
@(objc_type=Task, objc_name="environment")
Task_environment :: #force_inline proc "c" (self: ^Task) -> ^NS.Dictionary {
    return msgSend(^NS.Dictionary, self, "environment")
}
@(objc_type=Task, objc_name="setEnvironment")
Task_setEnvironment :: #force_inline proc "c" (self: ^Task, environment: ^NS.Dictionary) {
    msgSend(nil, self, "setEnvironment:", environment)
}
@(objc_type=Task, objc_name="currentDirectoryURL")
Task_currentDirectoryURL :: #force_inline proc "c" (self: ^Task) -> ^NS.URL {
    return msgSend(^NS.URL, self, "currentDirectoryURL")
}
@(objc_type=Task, objc_name="setCurrentDirectoryURL")
Task_setCurrentDirectoryURL :: #force_inline proc "c" (self: ^Task, currentDirectoryURL: ^NS.URL) {
...
Task_qualityOfService :: #force_inline proc "c" (self: ^Task) -> NS.QualityOfService {
    return msgSend(NS.QualityOfService, self, "qualityOfService")
}
@(objc_type=Task, objc_name="setQualityOfService")
Task_setQualityOfService :: #force_inline proc "c" (self: ^Task, qualityOfService: NS.QualityOfService) {
...
Task_launchedTaskWithExecutableURL :: #force_inline proc "c" (url: ^NS.URL, arguments: ^NS.Array, error: ^^NS.Error, terminationHandler: proc "c" (_arg_0: ^Task)) -> ^Task {
...
Task_launchedTaskWithLaunchPath :: #force_inline proc "c" (path: ^NS.String, arguments: ^NS.Array) -> ^Task {
    return msgSend(^Task, Task, "launchedTaskWithLaunchPath:arguments:", path, arguments)
}
@(objc_type=Task, objc_name="launchPath")
Task_launchPath :: #force_inline proc "c" (self: ^Task) -> ^NS.String {
    return msgSend(^NS.String, self, "launchPath")
}
@(objc_type=Task, objc_name="setLaunchPath")
Task_setLaunchPath :: #force_inline proc "c" (self: ^Task, launchPath: ^NS.String) {
    msgSend(nil, self, "setLaunchPath:", launchPath)
}
@(objc_type=Task, objc_name="currentDirectoryPath")
Task_currentDirectoryPath :: #force_inline proc "c" (self: ^Task) -> ^NS.String {
    return msgSend(^NS.String, self, "currentDirectoryPath")
}
@(objc_type=Task, objc_name="setCurrentDirectoryPath")
Task_setCurrentDirectoryPath :: #force_inline proc "c" (self: ^Task, currentDirectoryPath: ^NS.String) {
...
Task_allocWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> ^Task {
...
Task_copyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
    return msgSend(id, Task, "copyWithZone:", zone)
}
@(objc_type=Task, objc_name="mutableCopyWithZone", objc_is_class_method=true)
Task_mutableCopyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
Task_instanceMethodSignatureForSelector :: #force_inline proc "c" (aSelector: SEL) -> ^NS.MethodSignature {
    return msgSend(^NS.MethodSignature, Task, "instanceMethodSignatureForSelector:", aSelector)
}
...
Task_hash :: #force_inline proc "c" () -> NS.UInteger {
    return msgSend(NS.UInteger, Task, "hash")
}
...
Task_description :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, Task, "description")
}
@(objc_type=Task, objc_name="debugDescription", objc_is_class_method=true)
Task_debugDescription :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, Task, "debugDescription")
}
@(objc_type=Task, objc_name="version", objc_is_class_method=true)
Task_version :: #force_inline proc "c" () -> NS.Integer {
    return msgSend(NS.Integer, Task, "version")
}
@(objc_type=Task, objc_name="setVersion", objc_is_class_method=true)
Task_setVersion :: #force_inline proc "c" (aVersion: NS.Integer) {
...
Task_keyPathsForValuesAffectingValueForKey :: #force_inline proc "c" (key: ^NS.String) -> ^NS.Set {
    return msgSend(^NS.Set, Task, "keyPathsForValuesAffectingValueForKey:", key)
}
@(objc_type=Task, objc_name="automaticallyNotifiesObserversForKey", objc_is_class_method=true)
Task_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> bool {
...
Task_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
...
Task_classFallbacksForKeyedArchiver :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, Task, "classFallbacksForKeyedArchiver")
}
...
@(objc_type=Task, objc_name="exposeBinding", objc_is_class_method=true)
Task_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Task, "exposeBinding:", binding)
}
@(objc_type=Task, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Task_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Task, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Task, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Task_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Task, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
...
Task_VTable :: struct {
    ...
    launchAndReturnError: proc(self: ^Task, error: ^^NS.Error) -> bool,
    interrupt: proc(self: ^Task),
    terminate: proc(self: ^Task),
    suspend: proc(self: ^Task) -> bool,
    resume: proc(self: ^Task) -> bool,
    executableURL: proc(self: ^Task) -> ^NS.URL,
    setExecutableURL: proc(self: ^Task, executableURL: ^NS.URL),
    arguments: proc(self: ^Task) -> ^NS.Array,
    setArguments: proc(self: ^Task, arguments: ^NS.Array),
    environment: proc(self: ^Task) -> ^NS.Dictionary,
    setEnvironment: proc(self: ^Task, environment: ^NS.Dictionary),
    currentDirectoryURL: proc(self: ^Task) -> ^NS.URL,
    setCurrentDirectoryURL: proc(self: ^Task, currentDirectoryURL: ^NS.URL),
    ...
    qualityOfService: proc(self: ^Task) -> NS.QualityOfService,
    setQualityOfService: proc(self: ^Task, qualityOfService: NS.QualityOfService),
    launchedTaskWithExecutableURL: proc(url: ^NS.URL, arguments: ^NS.Array, error: ^^NS.Error, terminationHandler: proc "c" (_arg_0: ^Task)) -> ^Task,
    waitUntilExit: proc(self: ^Task),
    launch: proc(self: ^Task),
    launchedTaskWithLaunchPath: proc(path: ^NS.String, arguments: ^NS.Array) -> ^Task,
    launchPath: proc(self: ^Task) -> ^NS.String,
    setLaunchPath: proc(self: ^Task, launchPath: ^NS.String),
    currentDirectoryPath: proc(self: ^Task) -> ^NS.String,
    setCurrentDirectoryPath: proc(self: ^Task, currentDirectoryPath: ^NS.String),
    load: proc(),
    initialize: proc(),
    new: proc() -> ^Task,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^Task,
    alloc: proc() -> ^Task,
...
Task_odin_extend :: proc(cls: Class, vt: ^Task_VTable) {
    ...
    if vt.launchAndReturnError != nil {
        launchAndReturnError :: proc "c" (self: ^Task, _: SEL, error: ^^NS.Error) -> bool {
    ...
    if vt.executableURL != nil {
        executableURL :: proc "c" (self: ^Task, _: SEL) -> ^NS.URL {
    ...
    if vt.setExecutableURL != nil {
        setExecutableURL :: proc "c" (self: ^Task, _: SEL, executableURL: ^NS.URL) {
    ...
    if vt.arguments != nil {
        arguments :: proc "c" (self: ^Task, _: SEL) -> ^NS.Array {
    ...
    if vt.setArguments != nil {
        setArguments :: proc "c" (self: ^Task, _: SEL, arguments: ^NS.Array) {
    ...
    if vt.environment != nil {
        environment :: proc "c" (self: ^Task, _: SEL) -> ^NS.Dictionary {
    ...
    if vt.setEnvironment != nil {
        setEnvironment :: proc "c" (self: ^Task, _: SEL, environment: ^NS.Dictionary) {
    ...
    if vt.currentDirectoryURL != nil {
        currentDirectoryURL :: proc "c" (self: ^Task, _: SEL) -> ^NS.URL {
    ...
    if vt.setCurrentDirectoryURL != nil {
        setCurrentDirectoryURL :: proc "c" (self: ^Task, _: SEL, currentDirectoryURL: ^NS.URL) {
    ...
    if vt.qualityOfService != nil {
        qualityOfService :: proc "c" (self: ^Task, _: SEL) -> NS.QualityOfService {
    ...
    if vt.setQualityOfService != nil {
        setQualityOfService :: proc "c" (self: ^Task, _: SEL, qualityOfService: NS.QualityOfService) {
    ...
    if vt.launchedTaskWithExecutableURL != nil {
        launchedTaskWithExecutableURL :: proc "c" (self: Class, _: SEL, url: ^NS.URL, arguments: ^NS.Array, error: ^^NS.Error, terminationHandler: proc "c" (_arg_0: ^Task)) -> ^Task {
    ...
    if vt.launchedTaskWithLaunchPath != nil {
        launchedTaskWithLaunchPath :: proc "c" (self: Class, _: SEL, path: ^NS.String, arguments: ^NS.Array) -> ^Task {
    ...
    if vt.launchPath != nil {
        launchPath :: proc "c" (self: ^Task, _: SEL) -> ^NS.String {
    ...
    if vt.setLaunchPath != nil {
        setLaunchPath :: proc "c" (self: ^Task, _: SEL, launchPath: ^NS.String) {
    ...
    if vt.currentDirectoryPath != nil {
        currentDirectoryPath :: proc "c" (self: ^Task, _: SEL) -> ^NS.String {
    ...
    if vt.setCurrentDirectoryPath != nil {
        setCurrentDirectoryPath :: proc "c" (self: ^Task, _: SEL, currentDirectoryPath: ^NS.String) {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^Task {
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Task_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Task_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Task_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
