...
AccessibilityCustomRotorItemResult_VTable :: struct {
    ...
    init: proc(self: ^AccessibilityCustomRotorItemResult) -> ^AccessibilityCustomRotorItemResult,
    initWithTargetElement: proc(self: ^AccessibilityCustomRotorItemResult, targetElement: ^AccessibilityElementProtocol) -> ^AccessibilityCustomRotorItemResult,
    initWithItemLoadingToken: proc(self: ^AccessibilityCustomRotorItemResult, itemLoadingToken: ^id, customLabel: ^NS.String) -> ^AccessibilityCustomRotorItemResult,
    targetElement: proc(self: ^AccessibilityCustomRotorItemResult) -> ^AccessibilityElementProtocol,
    itemLoadingToken: proc(self: ^AccessibilityCustomRotorItemResult) -> ^id,
    targetRange: proc(self: ^AccessibilityCustomRotorItemResult) -> NS._NSRange,
    setTargetRange: proc(self: ^AccessibilityCustomRotorItemResult, targetRange: NS._NSRange),
    customLabel: proc(self: ^AccessibilityCustomRotorItemResult) -> ^NS.String,
    setCustomLabel: proc(self: ^AccessibilityCustomRotorItemResult, customLabel: ^NS.String),
    load: proc(),
    initialize: proc(),
...
AccessibilityCustomRotorItemResult_odin_extend :: proc(cls: Class, vt: ^AccessibilityCustomRotorItemResult_VTable) {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL) -> ^AccessibilityCustomRotorItemResult {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).init(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("init"), auto_cast init, "@@:") do panic("Failed to register objC method.")
    }
    if vt.initWithTargetElement != nil {
        initWithTargetElement :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL, targetElement: ^AccessibilityElementProtocol) -> ^AccessibilityCustomRotorItemResult {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).initWithTargetElement(self, targetElement)
        }
    ...
    if vt.initWithItemLoadingToken != nil {
        initWithItemLoadingToken :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL, itemLoadingToken: ^id, customLabel: ^NS.String) -> ^AccessibilityCustomRotorItemResult {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).initWithItemLoadingToken(self, itemLoadingToken, customLabel)
        }
    ...
    if vt.targetElement != nil {
        targetElement :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL) -> ^AccessibilityElementProtocol {
    ...
    if vt.itemLoadingToken != nil {
        itemLoadingToken :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL) -> ^id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).itemLoadingToken(self)
        }
    ...
    if vt.targetRange != nil {
        targetRange :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL) -> NS._NSRange {
    ...
    if vt.setTargetRange != nil {
        setTargetRange :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL, targetRange: NS._NSRange) {
    ...
    if vt.customLabel != nil {
        customLabel :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL) -> ^NS.String {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).customLabel(self)
        }
    ...
    if vt.setCustomLabel != nil {
        setCustomLabel :: proc "c" (self: ^AccessibilityCustomRotorItemResult, _: SEL, customLabel: ^NS.String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).setCustomLabel(self, customLabel)
        }
    ...
    if vt.version != nil {
        version :: proc "c" (self: Class, _: SEL) -> NS.Integer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).version()
        }
    ...
    if vt.setVersion != nil {
        setVersion :: proc "c" (self: Class, _: SEL, aVersion: NS.Integer) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).setVersion( aVersion)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_selector_object != nil {
        cancelPreviousPerformRequestsWithTarget_selector_object :: proc "c" (self: Class, _: SEL, aTarget: id, aSelector: SEL, anArgument: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_selector_object( aTarget, aSelector, anArgument)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_ != nil {
        cancelPreviousPerformRequestsWithTarget_ :: proc "c" (self: Class, _: SEL, aTarget: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_( aTarget)
        }
    ...
    if vt.accessInstanceVariablesDirectly != nil {
        accessInstanceVariablesDirectly :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).accessInstanceVariablesDirectly()
        }
    ...
    if vt.useStoredAccessor != nil {
        useStoredAccessor :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).useStoredAccessor()
        }
    ...
    if vt.keyPathsForValuesAffectingValueForKey != nil {
        keyPathsForValuesAffectingValueForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> ^NS.Set {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).keyPathsForValuesAffectingValueForKey( key)
        }
    ...
    if vt.automaticallyNotifiesObserversForKey != nil {
        automaticallyNotifiesObserversForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).automaticallyNotifiesObserversForKey( key)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
    ...
    if vt.classFallbacksForKeyedArchiver != nil {
        classFallbacksForKeyedArchiver :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).classFallbacksForKeyedArchiver()
        }
    ...
    if vt.classForKeyedUnarchiver != nil {
        classForKeyedUnarchiver :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).classForKeyedUnarchiver()
        }
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AccessibilityCustomRotorItemResult_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
