...
DistantObject_proxyWithTarget :: #force_inline proc "c" (target: id, connection: ^NS.Connection) -> id {
...
DistantObject_initWithTarget :: #force_inline proc "c" (self: ^DistantObject, target: id, connection: ^NS.Connection) -> ^DistantObject {
...
DistantObject_proxyWithLocal :: #force_inline proc "c" (target: id, connection: ^NS.Connection) -> id {
...
DistantObject_initWithLocal :: #force_inline proc "c" (self: ^DistantObject, target: id, connection: ^NS.Connection) -> ^DistantObject {
...
DistantObject_initWithCoder :: #force_inline proc "c" (self: ^DistantObject, inCoder: ^NS.Coder) -> ^DistantObject {
...
DistantObject_connectionForProxy :: #force_inline proc "c" (self: ^DistantObject) -> ^NS.Connection {
    return msgSend(^NS.Connection, self, "connectionForProxy")
}
...
DistantObject_allocWithZone :: #force_inline proc "c" (zone: ^NS.Zone) -> ^DistantObject {
...
DistantObject_VTable :: struct {
    ...
    initWithTarget: proc(self: ^DistantObject, target: id, connection: ^NS.Connection) -> ^DistantObject,
    proxyWithLocal: proc(target: id, connection: ^NS.Connection) -> id,
    initWithLocal: proc(self: ^DistantObject, target: id, connection: ^NS.Connection) -> ^DistantObject,
    initWithCoder: proc(self: ^DistantObject, inCoder: ^NS.Coder) -> ^DistantObject,
    setProtocolForProxy: proc(self: ^DistantObject, proto: ^Protocol),
    connectionForProxy: proc(self: ^DistantObject) -> ^NS.Connection,
    alloc: proc() -> ^DistantObject,
    allocWithZone: proc(zone: ^NS.Zone) -> ^DistantObject,
    class: proc() -> Class,
...
DistantObject_odin_extend :: proc(cls: Class, vt: ^DistantObject_VTable) {
    ...
    NS.Proxy_odin_extend(cls, &vt.super)
    ...
    if vt.initWithTarget != nil {
        initWithTarget :: proc "c" (self: ^DistantObject, _: SEL, target: id, connection: ^NS.Connection) -> ^DistantObject {
    ...
    if vt.initWithLocal != nil {
        initWithLocal :: proc "c" (self: ^DistantObject, _: SEL, target: id, connection: ^NS.Connection) -> ^DistantObject {
    ...
    if vt.initWithCoder != nil {
        initWithCoder :: proc "c" (self: ^DistantObject, _: SEL, inCoder: ^NS.Coder) -> ^DistantObject {
    ...
    if vt.connectionForProxy != nil {
        connectionForProxy :: proc "c" (self: ^DistantObject, _: SEL) -> ^NS.Connection {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS.Zone) -> ^DistantObject {
