...
Button_keyEquivalentModifierMask :: #force_inline proc "c" (self: ^Button) -> EventModifierFlag {
    return msgSend(EventModifierFlag, self, "keyEquivalentModifierMask")
}
@(objc_type=Button, objc_name="setKeyEquivalentModifierMask")
Button_setKeyEquivalentModifierMask :: #force_inline proc "c" (self: ^Button, keyEquivalentModifierMask: EventModifierFlag) {
...
Button_VTable :: struct {
    ...
    keyEquivalentModifierMask: proc(self: ^Button) -> EventModifierFlag,
    setKeyEquivalentModifierMask: proc(self: ^Button, keyEquivalentModifierMask: EventModifierFlag),
    activeCompressionOptions: proc(self: ^Button) -> ^UserInterfaceCompressionOptions,
    setTitleWithMnemonic: proc(self: ^Button, stringWithAmpersand: ^NS.String),
...
Button_odin_extend :: proc(cls: Class, vt: ^Button_VTable) {
    ...
    if vt.keyEquivalentModifierMask != nil {
        keyEquivalentModifierMask :: proc "c" (self: ^Button, _: SEL) -> EventModifierFlag {
    ...
    if vt.setKeyEquivalentModifierMask != nil {
        setKeyEquivalentModifierMask :: proc "c" (self: ^Button, _: SEL, keyEquivalentModifierMask: EventModifierFlag) {
    ...
    if vt.setTitleWithMnemonic != nil {
        setTitleWithMnemonic :: proc "c" (self: ^Button, _: SEL, stringWithAmpersand: ^NS.String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).setTitleWithMnemonic(self, stringWithAmpersand)
        }
    ...
    if vt.cellClass != nil {
        cellClass :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Button_VTable)vt_ctx.super_vt).cellClass()
        }
    ...
    if vt.setCellClass != nil {
        setCellClass :: proc "c" (self: Class, _: SEL, cellClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).setCellClass( cellClass)
        }
    ...
    if vt.defaultFocusRingType != nil {
        defaultFocusRingType :: proc "c" (self: Class, _: SEL) -> FocusRingType {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Button_VTable)vt_ctx.super_vt).defaultFocusRingType()
        }
    ...
    if vt.allowedClassesForRestorableStateKeyPath != nil {
        allowedClassesForRestorableStateKeyPath :: proc "c" (self: Class, _: SEL, keyPath: ^NS.String) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Button_VTable)vt_ctx.super_vt).allowedClassesForRestorableStateKeyPath( keyPath)
        }
    ...
    if vt.restorableStateKeyPaths != nil {
        restorableStateKeyPaths :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Button_VTable)vt_ctx.super_vt).restorableStateKeyPaths()
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Button_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Button_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
