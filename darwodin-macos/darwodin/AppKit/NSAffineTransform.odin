...
@(objc_type=AffineTransform, objc_name="transformBezierPath")
AffineTransform_transformBezierPath :: #force_inline proc "c" (self: ^AffineTransform, path: ^BezierPath) -> ^BezierPath {
    return msgSend(^BezierPath, self, "transformBezierPath:", path)
}
@(objc_type=AffineTransform, objc_name="set")
AffineTransform_set :: #force_inline proc "c" (self: ^AffineTransform) {
    msgSend(nil, self, "set")
}
@(objc_type=AffineTransform, objc_name="concat")
AffineTransform_concat :: #force_inline proc "c" (self: ^AffineTransform) {
    msgSend(nil, self, "concat")
}
...
AffineTransform_allocWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> ^AffineTransform {
...
AffineTransform_copyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
AffineTransform_mutableCopyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
AffineTransform_instanceMethodSignatureForSelector :: #force_inline proc "c" (aSelector: SEL) -> ^NS.MethodSignature {
    return msgSend(^NS.MethodSignature, AffineTransform, "instanceMethodSignatureForSelector:", aSelector)
}
...
AffineTransform_hash :: #force_inline proc "c" () -> NS.UInteger {
    return msgSend(NS.UInteger, AffineTransform, "hash")
}
...
AffineTransform_description :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, AffineTransform, "description")
}
@(objc_type=AffineTransform, objc_name="debugDescription", objc_is_class_method=true)
AffineTransform_debugDescription :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, AffineTransform, "debugDescription")
}
@(objc_type=AffineTransform, objc_name="version", objc_is_class_method=true)
AffineTransform_version :: #force_inline proc "c" () -> NS.Integer {
    return msgSend(NS.Integer, AffineTransform, "version")
}
@(objc_type=AffineTransform, objc_name="setVersion", objc_is_class_method=true)
AffineTransform_setVersion :: #force_inline proc "c" (aVersion: NS.Integer) {
...
AffineTransform_keyPathsForValuesAffectingValueForKey :: #force_inline proc "c" (key: ^NS.String) -> ^NS.Set {
    return msgSend(^NS.Set, AffineTransform, "keyPathsForValuesAffectingValueForKey:", key)
}
@(objc_type=AffineTransform, objc_name="automaticallyNotifiesObserversForKey", objc_is_class_method=true)
AffineTransform_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> bool {
...
AffineTransform_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
...
AffineTransform_classFallbacksForKeyedArchiver :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, AffineTransform, "classFallbacksForKeyedArchiver")
}
...
@(objc_type=AffineTransform, objc_name="exposeBinding", objc_is_class_method=true)
AffineTransform_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, AffineTransform, "exposeBinding:", binding)
}
@(objc_type=AffineTransform, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
AffineTransform_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, AffineTransform, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=AffineTransform, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
AffineTransform_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, AffineTransform, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
...
AffineTransform_VTable :: struct {
    ...
    transformBezierPath: proc(self: ^AffineTransform, path: ^BezierPath) -> ^BezierPath,
    set: proc(self: ^AffineTransform),
    concat: proc(self: ^AffineTransform),
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AffineTransform,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AffineTransform,
...
AffineTransform_odin_extend :: proc(cls: Class, vt: ^AffineTransform_VTable) {
    ...
    if vt.transformBezierPath != nil {
        transformBezierPath :: proc "c" (self: ^AffineTransform, _: SEL, path: ^BezierPath) -> ^BezierPath {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AffineTransform_VTable)vt_ctx.super_vt).transformBezierPath(self, path)
        }
    ...
    if vt.set != nil {
        set :: proc "c" (self: ^AffineTransform, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AffineTransform_VTable)vt_ctx.super_vt).set(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("set"), auto_cast set, "v@:") do panic("Failed to register objC method.")
    }
    if vt.concat != nil {
        concat :: proc "c" (self: ^AffineTransform, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AffineTransform_VTable)vt_ctx.super_vt).concat(self)
        }
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AffineTransform {
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AffineTransform_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^AffineTransform_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^AffineTransform_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
