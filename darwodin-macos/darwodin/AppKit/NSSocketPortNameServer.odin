...
SocketPortNameServer_portForName_ :: #force_inline proc "c" (self: ^SocketPortNameServer, name: ^NS.String) -> ^NS.Port {
    return msgSend(^NS.Port, self, "portForName:", name)
}
@(objc_type=SocketPortNameServer, objc_name="portForName_host")
SocketPortNameServer_portForName_host :: #force_inline proc "c" (self: ^SocketPortNameServer, name: ^NS.String, host: ^NS.String) -> ^NS.Port {
    return msgSend(^NS.Port, self, "portForName:host:", name, host)
}
@(objc_type=SocketPortNameServer, objc_name="registerPort_name")
SocketPortNameServer_registerPort_name :: #force_inline proc "c" (self: ^SocketPortNameServer, port: ^NS.Port, name: ^NS.String) -> bool {
    return msgSend(bool, self, "registerPort:name:", port, name)
}
@(objc_type=SocketPortNameServer, objc_name="removePortForName")
SocketPortNameServer_removePortForName :: #force_inline proc "c" (self: ^SocketPortNameServer, name: ^NS.String) -> bool {
...
SocketPortNameServer_portForName_host_nameServerPortNumber :: #force_inline proc "c" (self: ^SocketPortNameServer, name: ^NS.String, host: ^NS.String, portNumber: cffi.uint16_t) -> ^NS.Port {
    return msgSend(^NS.Port, self, "portForName:host:nameServerPortNumber:", name, host, portNumber)
}
@(objc_type=SocketPortNameServer, objc_name="registerPort_name_nameServerPortNumber")
SocketPortNameServer_registerPort_name_nameServerPortNumber :: #force_inline proc "c" (self: ^SocketPortNameServer, port: ^NS.Port, name: ^NS.String, portNumber: cffi.uint16_t) -> bool {
...
SocketPortNameServer_allocWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> ^SocketPortNameServer {
...
SocketPortNameServer_copyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
SocketPortNameServer_mutableCopyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
SocketPortNameServer_instanceMethodSignatureForSelector :: #force_inline proc "c" (aSelector: SEL) -> ^NS.MethodSignature {
    return msgSend(^NS.MethodSignature, SocketPortNameServer, "instanceMethodSignatureForSelector:", aSelector)
}
...
SocketPortNameServer_hash :: #force_inline proc "c" () -> NS.UInteger {
    return msgSend(NS.UInteger, SocketPortNameServer, "hash")
}
...
SocketPortNameServer_description :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, SocketPortNameServer, "description")
}
@(objc_type=SocketPortNameServer, objc_name="debugDescription", objc_is_class_method=true)
SocketPortNameServer_debugDescription :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, SocketPortNameServer, "debugDescription")
}
@(objc_type=SocketPortNameServer, objc_name="version", objc_is_class_method=true)
SocketPortNameServer_version :: #force_inline proc "c" () -> NS.Integer {
    return msgSend(NS.Integer, SocketPortNameServer, "version")
}
@(objc_type=SocketPortNameServer, objc_name="setVersion", objc_is_class_method=true)
SocketPortNameServer_setVersion :: #force_inline proc "c" (aVersion: NS.Integer) {
...
SocketPortNameServer_keyPathsForValuesAffectingValueForKey :: #force_inline proc "c" (key: ^NS.String) -> ^NS.Set {
    return msgSend(^NS.Set, SocketPortNameServer, "keyPathsForValuesAffectingValueForKey:", key)
}
@(objc_type=SocketPortNameServer, objc_name="automaticallyNotifiesObserversForKey", objc_is_class_method=true)
SocketPortNameServer_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> bool {
...
SocketPortNameServer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
...
SocketPortNameServer_classFallbacksForKeyedArchiver :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, SocketPortNameServer, "classFallbacksForKeyedArchiver")
}
...
@(objc_type=SocketPortNameServer, objc_name="exposeBinding", objc_is_class_method=true)
SocketPortNameServer_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, SocketPortNameServer, "exposeBinding:", binding)
}
@(objc_type=SocketPortNameServer, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
SocketPortNameServer_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, SocketPortNameServer, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=SocketPortNameServer, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
SocketPortNameServer_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, SocketPortNameServer, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
...
SocketPortNameServer_VTable :: struct {
    ...
    portForName_: proc(self: ^SocketPortNameServer, name: ^NS.String) -> ^NS.Port,
    portForName_host: proc(self: ^SocketPortNameServer, name: ^NS.String, host: ^NS.String) -> ^NS.Port,
    registerPort_name: proc(self: ^SocketPortNameServer, port: ^NS.Port, name: ^NS.String) -> bool,
    removePortForName: proc(self: ^SocketPortNameServer, name: ^NS.String) -> bool,
    portForName_host_nameServerPortNumber: proc(self: ^SocketPortNameServer, name: ^NS.String, host: ^NS.String, portNumber: cffi.uint16_t) -> ^NS.Port,
    registerPort_name_nameServerPortNumber: proc(self: ^SocketPortNameServer, port: ^NS.Port, name: ^NS.String, portNumber: cffi.uint16_t) -> bool,
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^SocketPortNameServer,
...
SocketPortNameServer_odin_extend :: proc(cls: Class, vt: ^SocketPortNameServer_VTable) {
    ...
    if vt.portForName_ != nil {
        portForName_ :: proc "c" (self: ^SocketPortNameServer, _: SEL, name: ^NS.String) -> ^NS.Port {
    ...
    if vt.portForName_host != nil {
        portForName_host :: proc "c" (self: ^SocketPortNameServer, _: SEL, name: ^NS.String, host: ^NS.String) -> ^NS.Port {
    ...
    if vt.registerPort_name != nil {
        registerPort_name :: proc "c" (self: ^SocketPortNameServer, _: SEL, port: ^NS.Port, name: ^NS.String) -> bool {
    ...
    if vt.removePortForName != nil {
        removePortForName :: proc "c" (self: ^SocketPortNameServer, _: SEL, name: ^NS.String) -> bool {
    ...
    if vt.portForName_host_nameServerPortNumber != nil {
        portForName_host_nameServerPortNumber :: proc "c" (self: ^SocketPortNameServer, _: SEL, name: ^NS.String, host: ^NS.String, portNumber: cffi.uint16_t) -> ^NS.Port {
    ...
    if vt.registerPort_name_nameServerPortNumber != nil {
        registerPort_name_nameServerPortNumber :: proc "c" (self: ^SocketPortNameServer, _: SEL, port: ^NS.Port, name: ^NS.String, portNumber: cffi.uint16_t) -> bool {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^SocketPortNameServer {
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^SocketPortNameServer_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^SocketPortNameServer_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^SocketPortNameServer_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
