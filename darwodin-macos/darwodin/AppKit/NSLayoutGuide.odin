...
foreign lib {
    @(objc_type=LayoutGuide, objc_selector="constraintsAffectingLayoutForOrientation:", objc_name="constraintsAffectingLayoutForOrientation")
    LayoutGuide_constraintsAffectingLayoutForOrientation :: proc(self: ^LayoutGuide, orientation: LayoutConstraintOrientation) -> ^NS.Array ---

    @(objc_type=LayoutGuide, objc_selector="frame", objc_name="frame")
    LayoutGuide_frame :: proc(self: ^LayoutGuide) -> NS.Rect ---
    ...
    LayoutGuide_leadingAnchor :: proc(self: ^LayoutGuide) -> ^LayoutXAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="trailingAnchor", objc_name="trailingAnchor")
    LayoutGuide_trailingAnchor :: proc(self: ^LayoutGuide) -> ^LayoutXAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="leftAnchor", objc_name="leftAnchor")
    LayoutGuide_leftAnchor :: proc(self: ^LayoutGuide) -> ^LayoutXAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="rightAnchor", objc_name="rightAnchor")
    LayoutGuide_rightAnchor :: proc(self: ^LayoutGuide) -> ^LayoutXAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="topAnchor", objc_name="topAnchor")
    LayoutGuide_topAnchor :: proc(self: ^LayoutGuide) -> ^LayoutYAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="bottomAnchor", objc_name="bottomAnchor")
    LayoutGuide_bottomAnchor :: proc(self: ^LayoutGuide) -> ^LayoutYAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="widthAnchor", objc_name="widthAnchor")
    LayoutGuide_widthAnchor :: proc(self: ^LayoutGuide) -> ^LayoutDimension ---

    @(objc_type=LayoutGuide, objc_selector="heightAnchor", objc_name="heightAnchor")
    LayoutGuide_heightAnchor :: proc(self: ^LayoutGuide) -> ^LayoutDimension ---

    @(objc_type=LayoutGuide, objc_selector="centerXAnchor", objc_name="centerXAnchor")
    LayoutGuide_centerXAnchor :: proc(self: ^LayoutGuide) -> ^LayoutXAxisAnchor ---

    @(objc_type=LayoutGuide, objc_selector="centerYAnchor", objc_name="centerYAnchor")
    LayoutGuide_centerYAnchor :: proc(self: ^LayoutGuide) -> ^LayoutYAxisAnchor ---
