...
URLDownloadDelegate_download_willSendRequest_redirectResponse :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, request: ^NS.URLRequest, redirectResponse: ^NS.URLResponse) -> ^NS.URLRequest {
    return msgSend(^NS.URLRequest, self, "download:willSendRequest:redirectResponse:", download, request, redirectResponse)
}
@(objc_type=URLDownloadDelegate, objc_name="download_canAuthenticateAgainstProtectionSpace")
URLDownloadDelegate_download_canAuthenticateAgainstProtectionSpace :: #force_inline proc "c" (self: ^URLDownloadDelegate, connection: ^URLDownload, protectionSpace: ^NS.URLProtectionSpace) -> bool {
...
URLDownloadDelegate_download_didReceiveAuthenticationChallenge :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge) {
...
URLDownloadDelegate_download_didCancelAuthenticationChallenge :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge) {
...
URLDownloadDelegate_download_didReceiveResponse :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, response: ^NS.URLResponse) {
...
URLDownloadDelegate_download_willResumeWithResponse_fromByte :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, response: ^NS.URLResponse, startingByte: cffi.longlong) {
...
URLDownloadDelegate_download_didReceiveDataOfLength :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, length: NS.UInteger) {
...
URLDownloadDelegate_download_shouldDecodeSourceDataOfMIMEType :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, encodingType: ^NS.String) -> bool {
...
URLDownloadDelegate_download_decideDestinationWithSuggestedFilename :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, filename: ^NS.String) {
...
URLDownloadDelegate_download_didCreateDestination :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, path: ^NS.String) {
...
URLDownloadDelegate_download_didFailWithError :: #force_inline proc "c" (self: ^URLDownloadDelegate, download: ^URLDownload, error: ^NS.Error) {
...
URLDownloadDelegate_VTable :: struct {
    ...
    download_willSendRequest_redirectResponse: proc(self: ^URLDownloadDelegate, download: ^URLDownload, request: ^NS.URLRequest, redirectResponse: ^NS.URLResponse) -> ^NS.URLRequest,
    download_canAuthenticateAgainstProtectionSpace: proc(self: ^URLDownloadDelegate, connection: ^URLDownload, protectionSpace: ^NS.URLProtectionSpace) -> bool,
    download_didReceiveAuthenticationChallenge: proc(self: ^URLDownloadDelegate, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge),
    download_didCancelAuthenticationChallenge: proc(self: ^URLDownloadDelegate, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge),
    downloadShouldUseCredentialStorage: proc(self: ^URLDownloadDelegate, download: ^URLDownload) -> bool,
    download_didReceiveResponse: proc(self: ^URLDownloadDelegate, download: ^URLDownload, response: ^NS.URLResponse),
    download_willResumeWithResponse_fromByte: proc(self: ^URLDownloadDelegate, download: ^URLDownload, response: ^NS.URLResponse, startingByte: cffi.longlong),
    download_didReceiveDataOfLength: proc(self: ^URLDownloadDelegate, download: ^URLDownload, length: NS.UInteger),
    download_shouldDecodeSourceDataOfMIMEType: proc(self: ^URLDownloadDelegate, download: ^URLDownload, encodingType: ^NS.String) -> bool,
    download_decideDestinationWithSuggestedFilename: proc(self: ^URLDownloadDelegate, download: ^URLDownload, filename: ^NS.String),
    download_didCreateDestination: proc(self: ^URLDownloadDelegate, download: ^URLDownload, path: ^NS.String),
    downloadDidFinish: proc(self: ^URLDownloadDelegate, download: ^URLDownload),
    download_didFailWithError: proc(self: ^URLDownloadDelegate, download: ^URLDownload, error: ^NS.Error),
}
...
URLDownloadDelegate_odin_extend :: proc(cls: Class, vt: ^URLDownloadDelegate_VTable) {
    ...
    if vt.download_willSendRequest_redirectResponse != nil {
        download_willSendRequest_redirectResponse :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, request: ^NS.URLRequest, redirectResponse: ^NS.URLResponse) -> ^NS.URLRequest {
    ...
    if vt.download_canAuthenticateAgainstProtectionSpace != nil {
        download_canAuthenticateAgainstProtectionSpace :: proc "c" (self: ^URLDownloadDelegate, _: SEL, connection: ^URLDownload, protectionSpace: ^NS.URLProtectionSpace) -> bool {
    ...
    if vt.download_didReceiveAuthenticationChallenge != nil {
        download_didReceiveAuthenticationChallenge :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge) {
    ...
    if vt.download_didCancelAuthenticationChallenge != nil {
        download_didCancelAuthenticationChallenge :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, challenge: ^NS.URLAuthenticationChallenge) {
    ...
    if vt.download_didReceiveResponse != nil {
        download_didReceiveResponse :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, response: ^NS.URLResponse) {
    ...
    if vt.download_willResumeWithResponse_fromByte != nil {
        download_willResumeWithResponse_fromByte :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, response: ^NS.URLResponse, startingByte: cffi.longlong) {
    ...
    if vt.download_didReceiveDataOfLength != nil {
        download_didReceiveDataOfLength :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, length: NS.UInteger) {
    ...
    if vt.download_shouldDecodeSourceDataOfMIMEType != nil {
        download_shouldDecodeSourceDataOfMIMEType :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, encodingType: ^NS.String) -> bool {
    ...
    if vt.download_decideDestinationWithSuggestedFilename != nil {
        download_decideDestinationWithSuggestedFilename :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, filename: ^NS.String) {
    ...
    if vt.download_didCreateDestination != nil {
        download_didCreateDestination :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, path: ^NS.String) {
    ...
    if vt.download_didFailWithError != nil {
        download_didFailWithError :: proc "c" (self: ^URLDownloadDelegate, _: SEL, download: ^URLDownload, error: ^NS.Error) {
