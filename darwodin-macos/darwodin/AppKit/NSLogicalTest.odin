...
foreign lib {
    ...
    LogicalTest_initAndTestWithTests :: proc(self: ^LogicalTest, subTests: ^NS.Array) -> ^LogicalTest ---

    @(objc_type=LogicalTest, objc_selector="initOrTestWithTests:", objc_name="initOrTestWithTests")
    LogicalTest_initOrTestWithTests :: proc(self: ^LogicalTest, subTests: ^NS.Array) -> ^LogicalTest ---
