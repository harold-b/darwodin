...
foreign lib {
    ...
    TextAttachmentLayout_imageForBounds :: proc(self: ^TextAttachmentLayout, bounds: CG.Rect, attributes: ^NS.Dictionary, location: ^TextLocation, textContainer: ^TextContainer) -> ^Image ---
