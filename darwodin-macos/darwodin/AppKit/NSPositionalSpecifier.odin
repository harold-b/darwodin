...
///
@(objc_class="NSPositionalSpecifier", objc_superclass=NS.Object)
...
foreign lib {
    ...
    PositionalSpecifier_insertionKey :: proc(self: ^PositionalSpecifier) -> ^NS.String ---

    @(objc_type=PositionalSpecifier, objc_selector="insertionIndex", objc_name="insertionIndex")
    PositionalSpecifier_insertionIndex :: proc(self: ^PositionalSpecifier) -> NS.Integer ---
