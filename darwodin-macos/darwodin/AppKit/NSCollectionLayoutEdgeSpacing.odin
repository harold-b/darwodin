...
CollectionLayoutEdgeSpacing_VTable :: struct {
    ...
    spacingForLeading: proc(leading: ^CollectionLayoutSpacing, top: ^CollectionLayoutSpacing, trailing: ^CollectionLayoutSpacing, bottom: ^CollectionLayoutSpacing) -> ^CollectionLayoutEdgeSpacing,
    init: proc(self: ^CollectionLayoutEdgeSpacing) -> ^CollectionLayoutEdgeSpacing,
    new: proc() -> ^CollectionLayoutEdgeSpacing,
    leading: proc(self: ^CollectionLayoutEdgeSpacing) -> ^CollectionLayoutSpacing,
    top: proc(self: ^CollectionLayoutEdgeSpacing) -> ^CollectionLayoutSpacing,
    trailing: proc(self: ^CollectionLayoutEdgeSpacing) -> ^CollectionLayoutSpacing,
    bottom: proc(self: ^CollectionLayoutEdgeSpacing) -> ^CollectionLayoutSpacing,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CollectionLayoutEdgeSpacing,
    alloc: proc() -> ^CollectionLayoutEdgeSpacing,
...
CollectionLayoutEdgeSpacing_odin_extend :: proc(cls: Class, vt: ^CollectionLayoutEdgeSpacing_VTable) {
    assert(vt != nil);
    ...
    if vt.spacingForLeading != nil {
        spacingForLeading :: proc "c" (self: Class, _: SEL, leading: ^CollectionLayoutSpacing, top: ^CollectionLayoutSpacing, trailing: ^CollectionLayoutSpacing, bottom: ^CollectionLayoutSpacing) -> ^CollectionLayoutEdgeSpacing {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).spacingForLeading( leading, top, trailing, bottom)
        }
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^CollectionLayoutEdgeSpacing, _: SEL) -> ^CollectionLayoutEdgeSpacing {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).init(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("init"), auto_cast init, "@@:") do panic("Failed to register objC method.")
    }
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CollectionLayoutEdgeSpacing {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).new()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("new"), auto_cast new, "@#:") do panic("Failed to register objC method.")
    }
    if vt.leading != nil {
        leading :: proc "c" (self: ^CollectionLayoutEdgeSpacing, _: SEL) -> ^CollectionLayoutSpacing {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).leading(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("leading"), auto_cast leading, "@@:") do panic("Failed to register objC method.")
    }
    if vt.top != nil {
        top :: proc "c" (self: ^CollectionLayoutEdgeSpacing, _: SEL) -> ^CollectionLayoutSpacing {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).top(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("top"), auto_cast top, "@@:") do panic("Failed to register objC method.")
    }
    if vt.trailing != nil {
        trailing :: proc "c" (self: ^CollectionLayoutEdgeSpacing, _: SEL) -> ^CollectionLayoutSpacing {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).trailing(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("trailing"), auto_cast trailing, "@@:") do panic("Failed to register objC method.")
    }
    if vt.bottom != nil {
        bottom :: proc "c" (self: ^CollectionLayoutEdgeSpacing, _: SEL) -> ^CollectionLayoutSpacing {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).bottom(self)
        }
    ...
    if vt.load != nil {
        load :: proc "c" (self: Class, _: SEL) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).load()
        }
    ...
    if vt.initialize != nil {
        initialize :: proc "c" (self: Class, _: SEL) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).initialize()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("initialize"), auto_cast initialize, "v#:") do panic("Failed to register objC method.")
    }
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CollectionLayoutEdgeSpacing {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).allocWithZone( zone)
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("allocWithZone:"), auto_cast allocWithZone, "@#:^void") do panic("Failed to register objC method.")
    }
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CollectionLayoutEdgeSpacing {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).alloc()
        }
    ...
    if vt.copyWithZone != nil {
        copyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).copyWithZone( zone)
        }
    ...
    if vt.mutableCopyWithZone != nil {
        mutableCopyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).mutableCopyWithZone( zone)
        }
    ...
    if vt.instancesRespondToSelector != nil {
        instancesRespondToSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).instancesRespondToSelector( aSelector)
        }
    ...
    if vt.conformsToProtocol != nil {
        conformsToProtocol :: proc "c" (self: Class, _: SEL, protocol: ^Protocol) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).conformsToProtocol( protocol)
        }
    ...
    if vt.instanceMethodForSelector != nil {
        instanceMethodForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> IMP {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).instanceMethodForSelector( aSelector)
        }
    ...
    if vt.instanceMethodSignatureForSelector != nil {
        instanceMethodSignatureForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> ^NS.MethodSignature {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).instanceMethodSignatureForSelector( aSelector)
        }
    ...
    if vt.isSubclassOfClass != nil {
        isSubclassOfClass :: proc "c" (self: Class, _: SEL, aClass: Class) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).isSubclassOfClass( aClass)
        }
    ...
    if vt.resolveClassMethod != nil {
        resolveClassMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).resolveClassMethod( sel)
        }
    ...
    if vt.resolveInstanceMethod != nil {
        resolveInstanceMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).resolveInstanceMethod( sel)
        }
    ...
    if vt.hash != nil {
        hash :: proc "c" (self: Class, _: SEL) -> NS.UInteger {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).hash()
        }
    ...
    if vt.superclass != nil {
        superclass :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).superclass()
        }
    ...
    if vt.class != nil {
        class :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).class()
        }
    ...
    if vt.description != nil {
        description :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).description()
        }
    ...
    if vt.debugDescription != nil {
        debugDescription :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).debugDescription()
        }
    ...
    if vt.version != nil {
        version :: proc "c" (self: Class, _: SEL) -> NS.Integer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).version()
        }
    ...
    if vt.setVersion != nil {
        setVersion :: proc "c" (self: Class, _: SEL, aVersion: NS.Integer) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).setVersion( aVersion)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_selector_object != nil {
        cancelPreviousPerformRequestsWithTarget_selector_object :: proc "c" (self: Class, _: SEL, aTarget: id, aSelector: SEL, anArgument: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_selector_object( aTarget, aSelector, anArgument)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_ != nil {
        cancelPreviousPerformRequestsWithTarget_ :: proc "c" (self: Class, _: SEL, aTarget: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_( aTarget)
        }
    ...
    if vt.accessInstanceVariablesDirectly != nil {
        accessInstanceVariablesDirectly :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).accessInstanceVariablesDirectly()
        }
    ...
    if vt.useStoredAccessor != nil {
        useStoredAccessor :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).useStoredAccessor()
        }
    ...
    if vt.keyPathsForValuesAffectingValueForKey != nil {
        keyPathsForValuesAffectingValueForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> ^NS.Set {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).keyPathsForValuesAffectingValueForKey( key)
        }
    ...
    if vt.automaticallyNotifiesObserversForKey != nil {
        automaticallyNotifiesObserversForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).automaticallyNotifiesObserversForKey( key)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
    ...
    if vt.classFallbacksForKeyedArchiver != nil {
        classFallbacksForKeyedArchiver :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).classFallbacksForKeyedArchiver()
        }
    ...
    if vt.classForKeyedUnarchiver != nil {
        classForKeyedUnarchiver :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).classForKeyedUnarchiver()
        }
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionLayoutEdgeSpacing_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
