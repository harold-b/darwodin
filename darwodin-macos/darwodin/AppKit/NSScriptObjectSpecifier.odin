...
foreign lib {
    ...
    ScriptObjectSpecifier_initWithContainerSpecifier :: proc(self: ^ScriptObjectSpecifier, container: ^ScriptObjectSpecifier, property: ^NS.String) -> ^ScriptObjectSpecifier ---
    ...
    ScriptObjectSpecifier_initWithContainerClassDescription :: proc(self: ^ScriptObjectSpecifier, classDesc: ^ScriptClassDescription, container: ^ScriptObjectSpecifier, property: ^NS.String) -> ^ScriptObjectSpecifier ---

    @(objc_type=ScriptObjectSpecifier, objc_selector="initWithCoder:", objc_name="initWithCoder")
    ScriptObjectSpecifier_initWithCoder :: proc(self: ^ScriptObjectSpecifier, inCoder: ^NS.Coder) -> ^ScriptObjectSpecifier ---
    ...
    ScriptObjectSpecifier_indicesOfObjectsByEvaluatingWithContainer :: proc(self: ^ScriptObjectSpecifier, container: id, count: ^NS.Integer) -> ^NS.Integer ---
    ...
    ScriptObjectSpecifier_key :: proc(self: ^ScriptObjectSpecifier) -> ^NS.String ---

    @(objc_type=ScriptObjectSpecifier, objc_selector="setKey:", objc_name="setKey")
    ScriptObjectSpecifier_setKey :: proc(self: ^ScriptObjectSpecifier, key: ^NS.String) ---
    ...
    ScriptObjectSpecifier_evaluationErrorNumber :: proc(self: ^ScriptObjectSpecifier) -> NS.Integer ---

    @(objc_type=ScriptObjectSpecifier, objc_selector="setEvaluationErrorNumber:", objc_name="setEvaluationErrorNumber")
    ScriptObjectSpecifier_setEvaluationErrorNumber :: proc(self: ^ScriptObjectSpecifier, evaluationErrorNumber: NS.Integer) ---
