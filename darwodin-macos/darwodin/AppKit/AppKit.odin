...
foreign lib {
    ...
    OpenGLSetOption :: proc(pname: OpenGLGlobalOption, param: cffi.int) ---

    @(link_name="NSOpenGLGetOption")
    OpenGLGetOption :: proc(pname: OpenGLGlobalOption, param: ^cffi.int) ---

    @(link_name="NSOpenGLGetVersion")
    OpenGLGetVersion :: proc(major: ^cffi.int, minor: ^cffi.int) ---
