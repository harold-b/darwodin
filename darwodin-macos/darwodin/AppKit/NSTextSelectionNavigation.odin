...
foreign lib {
    ...
    TextSelectionNavigation_initWithDataSource :: proc(self: ^TextSelectionNavigation, dataSource: ^TextSelectionDataSource) -> instancetype ---
    ...
    TextSelectionNavigation_init :: proc(self: ^TextSelectionNavigation) -> instancetype ---
