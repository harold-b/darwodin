...
VTable :: struct {
    ...
    setReceiversSpecifier: proc(self: ^AK.CloneCommand, receiversRef: ^AK.ScriptObjectSpecifier),
    keySpecifier: proc(self: ^AK.CloneCommand) -> ^AK.ScriptObjectSpecifier,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.setReceiversSpecifier != nil {
        setReceiversSpecifier :: proc "c" (self: ^AK.CloneCommand, _: SEL, receiversRef: ^AK.ScriptObjectSpecifier) {
    ...
    if vt.keySpecifier != nil {
        keySpecifier :: proc "c" (self: ^AK.CloneCommand, _: SEL) -> ^AK.ScriptObjectSpecifier {
