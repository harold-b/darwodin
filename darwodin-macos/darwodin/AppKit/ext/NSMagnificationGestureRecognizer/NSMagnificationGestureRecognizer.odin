...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.MagnificationGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.MagnificationGestureRecognizer,
    alloc: proc() -> ^AK.MagnificationGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.MagnificationGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.MagnificationGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.MagnificationGestureRecognizer {
