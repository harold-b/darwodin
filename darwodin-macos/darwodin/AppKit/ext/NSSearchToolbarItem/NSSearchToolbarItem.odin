...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.SearchToolbarItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.SearchToolbarItem,
    alloc: proc() -> ^AK.SearchToolbarItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.SearchToolbarItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.SearchToolbarItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.SearchToolbarItem {
