...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberProportionalLayout,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberProportionalLayout,
    alloc: proc() -> ^AK.ScrubberProportionalLayout,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberProportionalLayout {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberProportionalLayout {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberProportionalLayout {
