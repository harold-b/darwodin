...
VTable :: struct {
    ...
    rowActionWithStyle: proc(style: AK.TableViewRowActionStyle, title: ^NS.String, handler: ^Objc_Block(proc "c" (action: ^AK.TableViewRowAction, row: NS.Integer))) -> instancetype,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.rowActionWithStyle != nil {
        rowActionWithStyle :: proc "c" (self: Class, _: SEL, style: AK.TableViewRowActionStyle, title: ^NS.String, handler: ^Objc_Block(proc "c" (action: ^AK.TableViewRowAction, row: NS.Integer))) -> instancetype {
