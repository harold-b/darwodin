...
VTable :: struct {
    ...
    setReceiversSpecifier: proc(self: ^AK.SetCommand, receiversRef: ^AK.ScriptObjectSpecifier),
    keySpecifier: proc(self: ^AK.SetCommand) -> ^AK.ScriptObjectSpecifier,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.setReceiversSpecifier != nil {
        setReceiversSpecifier :: proc "c" (self: ^AK.SetCommand, _: SEL, receiversRef: ^AK.ScriptObjectSpecifier) {
    ...
    if vt.keySpecifier != nil {
        keySpecifier :: proc "c" (self: ^AK.SetCommand, _: SEL) -> ^AK.ScriptObjectSpecifier {
