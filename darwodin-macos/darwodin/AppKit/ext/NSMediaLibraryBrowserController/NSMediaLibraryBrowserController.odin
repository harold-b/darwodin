...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.MediaLibraryBrowserController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.MediaLibraryBrowserController,
    alloc: proc() -> ^AK.MediaLibraryBrowserController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.MediaLibraryBrowserController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.MediaLibraryBrowserController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.MediaLibraryBrowserController {
