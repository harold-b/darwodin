...
VTable :: struct {
    stringAtIndex: proc(self: ^NS.TextFinderClient, characterIndex: NS.UInteger, outRange: ^NS._NSRange, outFlag: ^bool) -> ^NS.String,
    stringLength: proc(self: ^NS.TextFinderClient) -> NS.UInteger,
    scrollRangeToVisible: proc(self: ^NS.TextFinderClient, range: NS._NSRange),
    shouldReplaceCharactersInRanges: proc(self: ^NS.TextFinderClient, ranges: ^NS.Array, strings: ^NS.Array) -> bool,
    replaceCharactersInRange: proc(self: ^NS.TextFinderClient, range: NS._NSRange, string: ^NS.String),
    didReplaceCharacters: proc(self: ^NS.TextFinderClient),
    contentViewAtIndex: proc(self: ^NS.TextFinderClient, index: NS.UInteger, outRange: ^NS._NSRange) -> ^NS.View,
    rectsForCharacterRange: proc(self: ^NS.TextFinderClient, range: NS._NSRange) -> ^NS.Array,
    drawCharactersInRange: proc(self: ^NS.TextFinderClient, range: NS._NSRange, view: ^NS.View),
    isSelectable: proc(self: ^NS.TextFinderClient) -> bool,
    allowsMultipleSelection: proc(self: ^NS.TextFinderClient) -> bool,
    isEditable: proc(self: ^NS.TextFinderClient) -> bool,
    string: proc(self: ^NS.TextFinderClient) -> ^NS.String,
    firstSelectedRange: proc(self: ^NS.TextFinderClient) -> NS._NSRange,
    selectedRanges: proc(self: ^NS.TextFinderClient) -> ^NS.Array,
    setSelectedRanges: proc(self: ^NS.TextFinderClient, selectedRanges: ^NS.Array),
    visibleCharacterRanges: proc(self: ^NS.TextFinderClient) -> ^NS.Array,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.stringAtIndex != nil {
        stringAtIndex :: proc "c" (self: ^NS.TextFinderClient, _: SEL, characterIndex: NS.UInteger, outRange: ^NS._NSRange, outFlag: ^bool) -> ^NS.String {
    ...
    if vt.stringLength != nil {
        stringLength :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> NS.UInteger {
    ...
    if vt.scrollRangeToVisible != nil {
        scrollRangeToVisible :: proc "c" (self: ^NS.TextFinderClient, _: SEL, range: NS._NSRange) {
    ...
    if vt.shouldReplaceCharactersInRanges != nil {
        shouldReplaceCharactersInRanges :: proc "c" (self: ^NS.TextFinderClient, _: SEL, ranges: ^NS.Array, strings: ^NS.Array) -> bool {
    ...
    if vt.replaceCharactersInRange != nil {
        replaceCharactersInRange :: proc "c" (self: ^NS.TextFinderClient, _: SEL, range: NS._NSRange, string: ^NS.String) {
    ...
    if vt.didReplaceCharacters != nil {
        didReplaceCharacters :: proc "c" (self: ^NS.TextFinderClient, _: SEL) {
    ...
    if vt.contentViewAtIndex != nil {
        contentViewAtIndex :: proc "c" (self: ^NS.TextFinderClient, _: SEL, index: NS.UInteger, outRange: ^NS._NSRange) -> ^NS.View {
    ...
    if vt.rectsForCharacterRange != nil {
        rectsForCharacterRange :: proc "c" (self: ^NS.TextFinderClient, _: SEL, range: NS._NSRange) -> ^NS.Array {
    ...
    if vt.drawCharactersInRange != nil {
        drawCharactersInRange :: proc "c" (self: ^NS.TextFinderClient, _: SEL, range: NS._NSRange, view: ^NS.View) {
    ...
    if vt.isSelectable != nil {
        isSelectable :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> bool {
    ...
    if vt.allowsMultipleSelection != nil {
        allowsMultipleSelection :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> bool {
    ...
    if vt.isEditable != nil {
        isEditable :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> bool {
    ...
    if vt.string != nil {
        string :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> ^NS.String {
    ...
    if vt.firstSelectedRange != nil {
        firstSelectedRange :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> NS._NSRange {
    ...
    if vt.selectedRanges != nil {
        selectedRanges :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> ^NS.Array {
    ...
    if vt.setSelectedRanges != nil {
        setSelectedRanges :: proc "c" (self: ^NS.TextFinderClient, _: SEL, selectedRanges: ^NS.Array) {
    ...
    if vt.visibleCharacterRanges != nil {
        visibleCharacterRanges :: proc "c" (self: ^NS.TextFinderClient, _: SEL) -> ^NS.Array {
