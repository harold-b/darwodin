...
VTable :: struct {
    _URLHandle_resourceDataDidBecomeAvailable: proc(self: ^AK.URLHandleClient, sender: ^AK.URLHandle, newBytes: ^NS.Data),
    _URLHandleResourceDidBeginLoading: proc(self: ^AK.URLHandleClient, sender: ^AK.URLHandle),
    _URLHandleResourceDidFinishLoading: proc(self: ^AK.URLHandleClient, sender: ^AK.URLHandle),
    _URLHandleResourceDidCancelLoading: proc(self: ^AK.URLHandleClient, sender: ^AK.URLHandle),
    _URLHandle_resourceDidFailLoadingWithReason: proc(self: ^AK.URLHandleClient, sender: ^AK.URLHandle, reason: ^NS.String),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt._URLHandle_resourceDataDidBecomeAvailable != nil {
        _URLHandle_resourceDataDidBecomeAvailable :: proc "c" (self: ^AK.URLHandleClient, _: SEL, sender: ^AK.URLHandle, newBytes: ^NS.Data) {
    ...
    if vt._URLHandleResourceDidBeginLoading != nil {
        _URLHandleResourceDidBeginLoading :: proc "c" (self: ^AK.URLHandleClient, _: SEL, sender: ^AK.URLHandle) {
    ...
    if vt._URLHandleResourceDidFinishLoading != nil {
        _URLHandleResourceDidFinishLoading :: proc "c" (self: ^AK.URLHandleClient, _: SEL, sender: ^AK.URLHandle) {
    ...
    if vt._URLHandleResourceDidCancelLoading != nil {
        _URLHandleResourceDidCancelLoading :: proc "c" (self: ^AK.URLHandleClient, _: SEL, sender: ^AK.URLHandle) {
    ...
    if vt._URLHandle_resourceDidFailLoadingWithReason != nil {
        _URLHandle_resourceDidFailLoadingWithReason :: proc "c" (self: ^AK.URLHandleClient, _: SEL, sender: ^AK.URLHandle, reason: ^NS.String) {
