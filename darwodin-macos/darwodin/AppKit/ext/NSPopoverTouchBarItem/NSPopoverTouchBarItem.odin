...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.PopoverTouchBarItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.PopoverTouchBarItem,
    alloc: proc() -> ^AK.PopoverTouchBarItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.PopoverTouchBarItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.PopoverTouchBarItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.PopoverTouchBarItem {
