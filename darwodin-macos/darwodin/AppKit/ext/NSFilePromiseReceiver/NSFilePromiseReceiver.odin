...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.FilePromiseReceiver,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.FilePromiseReceiver,
    alloc: proc() -> ^AK.FilePromiseReceiver,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.FilePromiseReceiver {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.FilePromiseReceiver {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.FilePromiseReceiver {
