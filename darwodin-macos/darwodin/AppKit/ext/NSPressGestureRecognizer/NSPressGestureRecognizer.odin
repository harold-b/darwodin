...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.PressGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.PressGestureRecognizer,
    alloc: proc() -> ^AK.PressGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.PressGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.PressGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.PressGestureRecognizer {
