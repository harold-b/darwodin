...
VTable :: struct {
    ...
    hide: proc(self: ^NS.Application, sender: id),
    unhide: proc(self: ^NS.Application, sender: id),
    unhideWithoutActivation: proc(self: ^NS.Application),
    windowWithWindowNumber: proc(self: ^NS.Application, windowNum: NS.Integer) -> ^NS.Window,
    deactivate: proc(self: ^NS.Application),
    activateIgnoringOtherApps: proc(self: ^NS.Application, ignoreOtherApps: bool),
    activate: proc(self: ^NS.Application),
    yieldActivationToApplication: proc(self: ^NS.Application, application: ^NS.RunningApplication),
    yieldActivationToApplicationWithBundleIdentifier: proc(self: ^NS.Application, bundleIdentifier: ^NS.String),
    hideOtherApplications: proc(self: ^NS.Application, sender: id),
    unhideAllApplications: proc(self: ^NS.Application, sender: id),
    finishLaunching: proc(self: ^NS.Application),
    run: proc(self: ^NS.Application),
    runModalForWindow_: proc(self: ^NS.Application, window: ^NS.Window) -> NS.ModalResponse,
    stop: proc(self: ^NS.Application, sender: id),
    stopModal: proc(self: ^NS.Application),
    stopModalWithCode: proc(self: ^NS.Application, returnCode: NS.ModalResponse),
    abortModal: proc(self: ^NS.Application),
    beginModalSessionForWindow_: proc(self: ^NS.Application, window: ^NS.Window) -> NS.ModalSession,
    runModalSession: proc(self: ^NS.Application, session: NS.ModalSession) -> NS.ModalResponse,
    endModalSession: proc(self: ^NS.Application, session: NS.ModalSession),
    terminate: proc(self: ^NS.Application, sender: id),
    requestUserAttention: proc(self: ^NS.Application, requestType: NS.RequestUserAttentionType) -> NS.Integer,
    cancelUserAttentionRequest: proc(self: ^NS.Application, request: NS.Integer),
    enumerateWindowsWithOptions: proc(self: ^NS.Application, options: NS.WindowListOptions, block: ^Objc_Block(proc "c" ( window: ^NS.Window, stop: ^bool ))),
    preventWindowOrdering: proc(self: ^NS.Application),
    setWindowsNeedUpdate: proc(self: ^NS.Application, needUpdate: bool),
    updateWindows: proc(self: ^NS.Application),
    activationPolicy: proc(self: ^NS.Application) -> NS.ApplicationActivationPolicy,
    setActivationPolicy: proc(self: ^NS.Application, activationPolicy: NS.ApplicationActivationPolicy) -> bool,
    reportException: proc(self: ^NS.Application, exception: ^NS.Exception),
    detachDrawingThread: proc(selector: SEL, target: id, argument: id),
    replyToApplicationShouldTerminate: proc(self: ^NS.Application, shouldTerminate: bool),
    replyToOpenOrPrint: proc(self: ^NS.Application, reply: NS.ApplicationDelegateReply),
    orderFrontCharacterPalette: proc(self: ^NS.Application, sender: id),
    sharedApplication: proc() -> ^NS.Application,
    delegate: proc(self: ^NS.Application) -> ^NS.ApplicationDelegate,
    setDelegate: proc(self: ^NS.Application, delegate: ^NS.ApplicationDelegate),
    mainWindow: proc(self: ^NS.Application) -> ^NS.Window,
    keyWindow: proc(self: ^NS.Application) -> ^NS.Window,
    isActive: proc(self: ^NS.Application) -> bool,
    isHidden: proc(self: ^NS.Application) -> bool,
    isRunning: proc(self: ^NS.Application) -> bool,
    applicationShouldSuppressHighDynamicRangeContent: proc(self: ^NS.Application) -> bool,
    modalWindow: proc(self: ^NS.Application) -> ^NS.Window,
    windows: proc(self: ^NS.Application) -> ^NS.Array,
    mainMenu: proc(self: ^NS.Application) -> ^NS.Menu,
    setMainMenu: proc(self: ^NS.Application, mainMenu: ^NS.Menu),
    helpMenu: proc(self: ^NS.Application) -> ^NS.Menu,
    setHelpMenu: proc(self: ^NS.Application, helpMenu: ^NS.Menu),
    applicationIconImage: proc(self: ^NS.Application) -> ^NS.Image,
    setApplicationIconImage: proc(self: ^NS.Application, applicationIconImage: ^NS.Image),
    dockTile: proc(self: ^NS.Application) -> ^NS.DockTile,
    presentationOptions: proc(self: ^NS.Application) -> NS.ApplicationPresentationOptions,
    setPresentationOptions: proc(self: ^NS.Application, presentationOptions: NS.ApplicationPresentationOptions),
    currentSystemPresentationOptions: proc(self: ^NS.Application) -> NS.ApplicationPresentationOptions,
    occlusionState: proc(self: ^NS.Application) -> NS.ApplicationOcclusionState,
    isProtectedDataAvailable: proc(self: ^NS.Application) -> bool,
    appearance: proc(self: ^NS.Application) -> ^NS.Appearance,
    setAppearance: proc(self: ^NS.Application, appearance: ^NS.Appearance),
    effectiveAppearance: proc(self: ^NS.Application) -> ^NS.Appearance,
    sendEvent: proc(self: ^NS.Application, event: ^NS.Event),
    postEvent: proc(self: ^NS.Application, event: ^NS.Event, atStart: bool),
    nextEventMatchingMask: proc(self: ^NS.Application, mask: NS.EventMask, expiration: ^NS.Date, mode: ^NS.String, deqFlag: bool) -> ^NS.Event,
    discardEventsMatchingMask: proc(self: ^NS.Application, mask: NS.EventMask, lastEvent: ^NS.Event),
    currentEvent: proc(self: ^NS.Application) -> ^NS.Event,
    sendAction: proc(self: ^NS.Application, action: SEL, target: id, sender: id) -> bool,
    targetForAction_: proc(self: ^NS.Application, action: SEL) -> id,
    targetForAction_to_from: proc(self: ^NS.Application, action: SEL, target: id, sender: id) -> id,
    tryToPerform: proc(self: ^NS.Application, action: SEL, object: id) -> bool,
    validRequestorForSendType: proc(self: ^NS.Application, sendType: ^NS.String, returnType: ^NS.String) -> id,
    arrangeInFront: proc(self: ^NS.Application, sender: id),
    removeWindowsItem: proc(self: ^NS.Application, win: ^NS.Window),
    addWindowsItem: proc(self: ^NS.Application, win: ^NS.Window, string: ^NS.String, isFilename: bool),
    changeWindowsItem: proc(self: ^NS.Application, win: ^NS.Window, string: ^NS.String, isFilename: bool),
    updateWindowsItem: proc(self: ^NS.Application, win: ^NS.Window),
    miniaturizeAll: proc(self: ^NS.Application, sender: id),
    windowsMenu: proc(self: ^NS.Application) -> ^NS.Menu,
    setWindowsMenu: proc(self: ^NS.Application, windowsMenu: ^NS.Menu),
    isFullKeyboardAccessEnabled: proc(self: ^NS.Application) -> bool,
    registerServicesMenuSendTypes: proc(self: ^NS.Application, sendTypes: ^NS.Array, returnTypes: ^NS.Array),
    servicesMenu: proc(self: ^NS.Application) -> ^NS.Menu,
    setServicesMenu: proc(self: ^NS.Application, servicesMenu: ^NS.Menu),
    servicesProvider: proc(self: ^NS.Application) -> id,
    setServicesProvider: proc(self: ^NS.Application, servicesProvider: id),
    orderFrontStandardAboutPanel: proc(self: ^NS.Application, sender: id),
    orderFrontStandardAboutPanelWithOptions: proc(self: ^NS.Application, optionsDictionary: ^NS.Dictionary),
    userInterfaceLayoutDirection: proc(self: ^NS.Application) -> NS.UserInterfaceLayoutDirection,
    disableRelaunchOnLogin: proc(self: ^NS.Application),
    enableRelaunchOnLogin: proc(self: ^NS.Application),
    registerForRemoteNotifications: proc(self: ^NS.Application),
    unregisterForRemoteNotifications: proc(self: ^NS.Application),
    registerForRemoteNotificationTypes: proc(self: ^NS.Application, types: NS.RemoteNotificationType),
    isRegisteredForRemoteNotifications: proc(self: ^NS.Application) -> bool,
    enabledRemoteNotificationTypes: proc(self: ^NS.Application) -> NS.RemoteNotificationType,
    runModalForWindow_relativeToWindow: proc(self: ^NS.Application, window: ^NS.Window, docWindow: ^NS.Window) -> NS.Integer,
    beginModalSessionForWindow_relativeToWindow: proc(self: ^NS.Application, window: ^NS.Window, docWindow: ^NS.Window) -> NS.ModalSession,
    application: proc(self: ^NS.Application, sender: ^NS.Application, filenames: ^NS.Array),
    beginSheet: proc(self: ^NS.Application, sheet: ^NS.Window, docWindow: ^NS.Window, modalDelegate: id, didEndSelector: SEL, contextInfo: rawptr),
    endSheet_: proc(self: ^NS.Application, sheet: ^NS.Window),
    endSheet_returnCode: proc(self: ^NS.Application, sheet: ^NS.Window, returnCode: NS.Integer),
    makeWindowsPerform: proc(self: ^NS.Application, selector: SEL, inOrder: bool) -> ^NS.Window,
    _context: proc(self: ^NS.Application) -> ^NS.GraphicsContext,
    activateContextHelpMode: proc(self: ^NS.Application, sender: id),
    showHelp: proc(self: ^NS.Application, sender: id),
    toggleTouchBarCustomizationPalette: proc(self: ^NS.Application, sender: id),
    isAutomaticCustomizeTouchBarMenuItemEnabled: proc(self: ^NS.Application) -> bool,
    setAutomaticCustomizeTouchBarMenuItemEnabled: proc(self: ^NS.Application, automaticCustomizeTouchBarMenuItemEnabled: bool),
    orderFrontColorPanel: proc(self: ^NS.Application, sender: id),
    runPageLayout: proc(self: ^NS.Application, sender: id),
    orderedDocuments: proc(self: ^NS.Application) -> ^NS.Array,
    orderedWindows: proc(self: ^NS.Application) -> ^NS.Array,
    registerUserInterfaceItemSearchHandler: proc(self: ^NS.Application, handler: ^NS.UserInterfaceItemSearching),
    unregisterUserInterfaceItemSearchHandler: proc(self: ^NS.Application, handler: ^NS.UserInterfaceItemSearching),
    searchString: proc(self: ^NS.Application, searchString: ^NS.String, stringToSearch: ^NS.String, searchRange: NS._NSRange, foundRange: ^NS._NSRange) -> bool,
    restoreWindowWithIdentifier: proc(self: ^NS.Application, identifier: ^NS.String, state: ^NS.Coder, completionHandler: ^Objc_Block(proc "c" ( _0: ^NS.Window, _1: ^NS.Error ))) -> bool,
    extendStateRestoration: proc(self: ^NS.Application),
    completeStateRestoration: proc(self: ^NS.Application),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.hide != nil {
        hide :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.unhide != nil {
        unhide :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.unhideWithoutActivation != nil {
        unhideWithoutActivation :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.windowWithWindowNumber != nil {
        windowWithWindowNumber :: proc "c" (self: ^NS.Application, _: SEL, windowNum: NS.Integer) -> ^NS.Window {
    ...
    if vt.deactivate != nil {
        deactivate :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.activateIgnoringOtherApps != nil {
        activateIgnoringOtherApps :: proc "c" (self: ^NS.Application, _: SEL, ignoreOtherApps: bool) {
    ...
    if vt.activate != nil {
        activate :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.yieldActivationToApplication != nil {
        yieldActivationToApplication :: proc "c" (self: ^NS.Application, _: SEL, application: ^NS.RunningApplication) {
    ...
    if vt.yieldActivationToApplicationWithBundleIdentifier != nil {
        yieldActivationToApplicationWithBundleIdentifier :: proc "c" (self: ^NS.Application, _: SEL, bundleIdentifier: ^NS.String) {
    ...
    if vt.hideOtherApplications != nil {
        hideOtherApplications :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.unhideAllApplications != nil {
        unhideAllApplications :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.finishLaunching != nil {
        finishLaunching :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.run != nil {
        run :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.runModalForWindow_ != nil {
        runModalForWindow_ :: proc "c" (self: ^NS.Application, _: SEL, window: ^NS.Window) -> NS.ModalResponse {
    ...
    if vt.stop != nil {
        stop :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.stopModal != nil {
        stopModal :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.stopModalWithCode != nil {
        stopModalWithCode :: proc "c" (self: ^NS.Application, _: SEL, returnCode: NS.ModalResponse) {
    ...
    if vt.abortModal != nil {
        abortModal :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.beginModalSessionForWindow_ != nil {
        beginModalSessionForWindow_ :: proc "c" (self: ^NS.Application, _: SEL, window: ^NS.Window) -> NS.ModalSession {
    ...
    if vt.runModalSession != nil {
        runModalSession :: proc "c" (self: ^NS.Application, _: SEL, session: NS.ModalSession) -> NS.ModalResponse {
    ...
    if vt.endModalSession != nil {
        endModalSession :: proc "c" (self: ^NS.Application, _: SEL, session: NS.ModalSession) {
    ...
    if vt.terminate != nil {
        terminate :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.requestUserAttention != nil {
        requestUserAttention :: proc "c" (self: ^NS.Application, _: SEL, requestType: NS.RequestUserAttentionType) -> NS.Integer {
    ...
    if vt.cancelUserAttentionRequest != nil {
        cancelUserAttentionRequest :: proc "c" (self: ^NS.Application, _: SEL, request: NS.Integer) {
    ...
    if vt.enumerateWindowsWithOptions != nil {
        enumerateWindowsWithOptions :: proc "c" (self: ^NS.Application, _: SEL, options: NS.WindowListOptions, block: ^Objc_Block(proc "c" ( window: ^NS.Window, stop: ^bool ))) {
    ...
    if vt.preventWindowOrdering != nil {
        preventWindowOrdering :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.setWindowsNeedUpdate != nil {
        setWindowsNeedUpdate :: proc "c" (self: ^NS.Application, _: SEL, needUpdate: bool) {
    ...
    if vt.updateWindows != nil {
        updateWindows :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.activationPolicy != nil {
        activationPolicy :: proc "c" (self: ^NS.Application, _: SEL) -> NS.ApplicationActivationPolicy {
    ...
    if vt.setActivationPolicy != nil {
        setActivationPolicy :: proc "c" (self: ^NS.Application, _: SEL, activationPolicy: NS.ApplicationActivationPolicy) -> bool {
    ...
    if vt.reportException != nil {
        reportException :: proc "c" (self: ^NS.Application, _: SEL, exception: ^NS.Exception) {
    ...
    if vt.replyToApplicationShouldTerminate != nil {
        replyToApplicationShouldTerminate :: proc "c" (self: ^NS.Application, _: SEL, shouldTerminate: bool) {
    ...
    if vt.replyToOpenOrPrint != nil {
        replyToOpenOrPrint :: proc "c" (self: ^NS.Application, _: SEL, reply: NS.ApplicationDelegateReply) {
    ...
    if vt.orderFrontCharacterPalette != nil {
        orderFrontCharacterPalette :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.sharedApplication != nil {
        sharedApplication :: proc "c" (self: Class, _: SEL) -> ^NS.Application {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.ApplicationDelegate {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^NS.Application, _: SEL, delegate: ^NS.ApplicationDelegate) {
    ...
    if vt.mainWindow != nil {
        mainWindow :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Window {
    ...
    if vt.keyWindow != nil {
        keyWindow :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Window {
    ...
    if vt.isActive != nil {
        isActive :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.isHidden != nil {
        isHidden :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.isRunning != nil {
        isRunning :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.applicationShouldSuppressHighDynamicRangeContent != nil {
        applicationShouldSuppressHighDynamicRangeContent :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.modalWindow != nil {
        modalWindow :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Window {
    ...
    if vt.windows != nil {
        windows :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Array {
    ...
    if vt.mainMenu != nil {
        mainMenu :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Menu {
    ...
    if vt.setMainMenu != nil {
        setMainMenu :: proc "c" (self: ^NS.Application, _: SEL, mainMenu: ^NS.Menu) {
    ...
    if vt.helpMenu != nil {
        helpMenu :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Menu {
    ...
    if vt.setHelpMenu != nil {
        setHelpMenu :: proc "c" (self: ^NS.Application, _: SEL, helpMenu: ^NS.Menu) {
    ...
    if vt.applicationIconImage != nil {
        applicationIconImage :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Image {
    ...
    if vt.setApplicationIconImage != nil {
        setApplicationIconImage :: proc "c" (self: ^NS.Application, _: SEL, applicationIconImage: ^NS.Image) {
    ...
    if vt.dockTile != nil {
        dockTile :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.DockTile {
    ...
    if vt.presentationOptions != nil {
        presentationOptions :: proc "c" (self: ^NS.Application, _: SEL) -> NS.ApplicationPresentationOptions {
    ...
    if vt.setPresentationOptions != nil {
        setPresentationOptions :: proc "c" (self: ^NS.Application, _: SEL, presentationOptions: NS.ApplicationPresentationOptions) {
    ...
    if vt.currentSystemPresentationOptions != nil {
        currentSystemPresentationOptions :: proc "c" (self: ^NS.Application, _: SEL) -> NS.ApplicationPresentationOptions {
    ...
    if vt.occlusionState != nil {
        occlusionState :: proc "c" (self: ^NS.Application, _: SEL) -> NS.ApplicationOcclusionState {
    ...
    if vt.isProtectedDataAvailable != nil {
        isProtectedDataAvailable :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.appearance != nil {
        appearance :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Appearance {
    ...
    if vt.setAppearance != nil {
        setAppearance :: proc "c" (self: ^NS.Application, _: SEL, appearance: ^NS.Appearance) {
    ...
    if vt.effectiveAppearance != nil {
        effectiveAppearance :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Appearance {
    ...
    if vt.sendEvent != nil {
        sendEvent :: proc "c" (self: ^NS.Application, _: SEL, event: ^NS.Event) {
    ...
    if vt.postEvent != nil {
        postEvent :: proc "c" (self: ^NS.Application, _: SEL, event: ^NS.Event, atStart: bool) {
    ...
    if vt.nextEventMatchingMask != nil {
        nextEventMatchingMask :: proc "c" (self: ^NS.Application, _: SEL, mask: NS.EventMask, expiration: ^NS.Date, mode: ^NS.String, deqFlag: bool) -> ^NS.Event {
    ...
    if vt.discardEventsMatchingMask != nil {
        discardEventsMatchingMask :: proc "c" (self: ^NS.Application, _: SEL, mask: NS.EventMask, lastEvent: ^NS.Event) {
    ...
    if vt.currentEvent != nil {
        currentEvent :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Event {
    ...
    if vt.sendAction != nil {
        sendAction :: proc "c" (self: ^NS.Application, _: SEL, action: SEL, target: id, sender: id) -> bool {
    ...
    if vt.targetForAction_ != nil {
        targetForAction_ :: proc "c" (self: ^NS.Application, _: SEL, action: SEL) -> id {
    ...
    if vt.targetForAction_to_from != nil {
        targetForAction_to_from :: proc "c" (self: ^NS.Application, _: SEL, action: SEL, target: id, sender: id) -> id {
    ...
    if vt.tryToPerform != nil {
        tryToPerform :: proc "c" (self: ^NS.Application, _: SEL, action: SEL, object: id) -> bool {
    ...
    if vt.validRequestorForSendType != nil {
        validRequestorForSendType :: proc "c" (self: ^NS.Application, _: SEL, sendType: ^NS.String, returnType: ^NS.String) -> id {
    ...
    if vt.arrangeInFront != nil {
        arrangeInFront :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.removeWindowsItem != nil {
        removeWindowsItem :: proc "c" (self: ^NS.Application, _: SEL, win: ^NS.Window) {
    ...
    if vt.addWindowsItem != nil {
        addWindowsItem :: proc "c" (self: ^NS.Application, _: SEL, win: ^NS.Window, string: ^NS.String, isFilename: bool) {
    ...
    if vt.changeWindowsItem != nil {
        changeWindowsItem :: proc "c" (self: ^NS.Application, _: SEL, win: ^NS.Window, string: ^NS.String, isFilename: bool) {
    ...
    if vt.updateWindowsItem != nil {
        updateWindowsItem :: proc "c" (self: ^NS.Application, _: SEL, win: ^NS.Window) {
    ...
    if vt.miniaturizeAll != nil {
        miniaturizeAll :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.windowsMenu != nil {
        windowsMenu :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Menu {
    ...
    if vt.setWindowsMenu != nil {
        setWindowsMenu :: proc "c" (self: ^NS.Application, _: SEL, windowsMenu: ^NS.Menu) {
    ...
    if vt.isFullKeyboardAccessEnabled != nil {
        isFullKeyboardAccessEnabled :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.registerServicesMenuSendTypes != nil {
        registerServicesMenuSendTypes :: proc "c" (self: ^NS.Application, _: SEL, sendTypes: ^NS.Array, returnTypes: ^NS.Array) {
    ...
    if vt.servicesMenu != nil {
        servicesMenu :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Menu {
    ...
    if vt.setServicesMenu != nil {
        setServicesMenu :: proc "c" (self: ^NS.Application, _: SEL, servicesMenu: ^NS.Menu) {
    ...
    if vt.servicesProvider != nil {
        servicesProvider :: proc "c" (self: ^NS.Application, _: SEL) -> id {
    ...
    if vt.setServicesProvider != nil {
        setServicesProvider :: proc "c" (self: ^NS.Application, _: SEL, servicesProvider: id) {
    ...
    if vt.orderFrontStandardAboutPanel != nil {
        orderFrontStandardAboutPanel :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.orderFrontStandardAboutPanelWithOptions != nil {
        orderFrontStandardAboutPanelWithOptions :: proc "c" (self: ^NS.Application, _: SEL, optionsDictionary: ^NS.Dictionary) {
    ...
    if vt.userInterfaceLayoutDirection != nil {
        userInterfaceLayoutDirection :: proc "c" (self: ^NS.Application, _: SEL) -> NS.UserInterfaceLayoutDirection {
    ...
    if vt.disableRelaunchOnLogin != nil {
        disableRelaunchOnLogin :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.enableRelaunchOnLogin != nil {
        enableRelaunchOnLogin :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.registerForRemoteNotifications != nil {
        registerForRemoteNotifications :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.unregisterForRemoteNotifications != nil {
        unregisterForRemoteNotifications :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.registerForRemoteNotificationTypes != nil {
        registerForRemoteNotificationTypes :: proc "c" (self: ^NS.Application, _: SEL, types: NS.RemoteNotificationType) {
    ...
    if vt.isRegisteredForRemoteNotifications != nil {
        isRegisteredForRemoteNotifications :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.enabledRemoteNotificationTypes != nil {
        enabledRemoteNotificationTypes :: proc "c" (self: ^NS.Application, _: SEL) -> NS.RemoteNotificationType {
    ...
    if vt.runModalForWindow_relativeToWindow != nil {
        runModalForWindow_relativeToWindow :: proc "c" (self: ^NS.Application, _: SEL, window: ^NS.Window, docWindow: ^NS.Window) -> NS.Integer {
    ...
    if vt.beginModalSessionForWindow_relativeToWindow != nil {
        beginModalSessionForWindow_relativeToWindow :: proc "c" (self: ^NS.Application, _: SEL, window: ^NS.Window, docWindow: ^NS.Window) -> NS.ModalSession {
    ...
    if vt.application != nil {
        application :: proc "c" (self: ^NS.Application, _: SEL, sender: ^NS.Application, filenames: ^NS.Array) {
    ...
    if vt.beginSheet != nil {
        beginSheet :: proc "c" (self: ^NS.Application, _: SEL, sheet: ^NS.Window, docWindow: ^NS.Window, modalDelegate: id, didEndSelector: SEL, contextInfo: rawptr) {
    ...
    if vt.endSheet_ != nil {
        endSheet_ :: proc "c" (self: ^NS.Application, _: SEL, sheet: ^NS.Window) {
    ...
    if vt.endSheet_returnCode != nil {
        endSheet_returnCode :: proc "c" (self: ^NS.Application, _: SEL, sheet: ^NS.Window, returnCode: NS.Integer) {
    ...
    if vt.makeWindowsPerform != nil {
        makeWindowsPerform :: proc "c" (self: ^NS.Application, _: SEL, selector: SEL, inOrder: bool) -> ^NS.Window {
    ...
    if vt._context != nil {
        _context :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.GraphicsContext {
    ...
    if vt.activateContextHelpMode != nil {
        activateContextHelpMode :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.showHelp != nil {
        showHelp :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.toggleTouchBarCustomizationPalette != nil {
        toggleTouchBarCustomizationPalette :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.isAutomaticCustomizeTouchBarMenuItemEnabled != nil {
        isAutomaticCustomizeTouchBarMenuItemEnabled :: proc "c" (self: ^NS.Application, _: SEL) -> bool {
    ...
    if vt.setAutomaticCustomizeTouchBarMenuItemEnabled != nil {
        setAutomaticCustomizeTouchBarMenuItemEnabled :: proc "c" (self: ^NS.Application, _: SEL, automaticCustomizeTouchBarMenuItemEnabled: bool) {
    ...
    if vt.orderFrontColorPanel != nil {
        orderFrontColorPanel :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.runPageLayout != nil {
        runPageLayout :: proc "c" (self: ^NS.Application, _: SEL, sender: id) {
    ...
    if vt.orderedDocuments != nil {
        orderedDocuments :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Array {
    ...
    if vt.orderedWindows != nil {
        orderedWindows :: proc "c" (self: ^NS.Application, _: SEL) -> ^NS.Array {
    ...
    if vt.registerUserInterfaceItemSearchHandler != nil {
        registerUserInterfaceItemSearchHandler :: proc "c" (self: ^NS.Application, _: SEL, handler: ^NS.UserInterfaceItemSearching) {
    ...
    if vt.unregisterUserInterfaceItemSearchHandler != nil {
        unregisterUserInterfaceItemSearchHandler :: proc "c" (self: ^NS.Application, _: SEL, handler: ^NS.UserInterfaceItemSearching) {
    ...
    if vt.searchString != nil {
        searchString :: proc "c" (self: ^NS.Application, _: SEL, searchString: ^NS.String, stringToSearch: ^NS.String, searchRange: NS._NSRange, foundRange: ^NS._NSRange) -> bool {
    ...
    if vt.restoreWindowWithIdentifier != nil {
        restoreWindowWithIdentifier :: proc "c" (self: ^NS.Application, _: SEL, identifier: ^NS.String, state: ^NS.Coder, completionHandler: ^Objc_Block(proc "c" ( _0: ^NS.Window, _1: ^NS.Error ))) -> bool {
    ...
    if vt.extendStateRestoration != nil {
        extendStateRestoration :: proc "c" (self: ^NS.Application, _: SEL) {
    ...
    if vt.completeStateRestoration != nil {
        completeStateRestoration :: proc "c" (self: ^NS.Application, _: SEL) {
