...
VTable :: struct {
    ...
    initWithCollectionView: proc(self: ^NS.CollectionViewDiffableDataSource, collectionView: ^NS.CollectionView, itemProvider: NS.CollectionViewDiffableDataSourceItemProvider) -> instancetype,
    init: proc(self: ^NS.CollectionViewDiffableDataSource) -> instancetype,
    new: proc() -> ^NS.CollectionViewDiffableDataSource,
    snapshot: proc(self: ^NS.CollectionViewDiffableDataSource) -> ^NS.DiffableDataSourceSnapshot,
    applySnapshot: proc(self: ^NS.CollectionViewDiffableDataSource, snapshot: ^NS.DiffableDataSourceSnapshot, animatingDifferences: bool),
    itemIdentifierForIndexPath: proc(self: ^NS.CollectionViewDiffableDataSource, indexPath: ^NS.IndexPath) -> id,
    indexPathForItemIdentifier: proc(self: ^NS.CollectionViewDiffableDataSource, identifier: id) -> ^NS.IndexPath,
    supplementaryViewProvider: proc(self: ^NS.CollectionViewDiffableDataSource) -> NS.CollectionViewDiffableDataSourceSupplementaryViewProvider,
    setSupplementaryViewProvider: proc(self: ^NS.CollectionViewDiffableDataSource, supplementaryViewProvider: NS.CollectionViewDiffableDataSourceSupplementaryViewProvider),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithCollectionView != nil {
        initWithCollectionView :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL, collectionView: ^NS.CollectionView, itemProvider: NS.CollectionViewDiffableDataSourceItemProvider) -> instancetype {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL) -> instancetype {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.CollectionViewDiffableDataSource {
    ...
    if vt.snapshot != nil {
        snapshot :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL) -> ^NS.DiffableDataSourceSnapshot {
    ...
    if vt.applySnapshot != nil {
        applySnapshot :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL, snapshot: ^NS.DiffableDataSourceSnapshot, animatingDifferences: bool) {
    ...
    if vt.itemIdentifierForIndexPath != nil {
        itemIdentifierForIndexPath :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL, indexPath: ^NS.IndexPath) -> id {
    ...
    if vt.indexPathForItemIdentifier != nil {
        indexPathForItemIdentifier :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL, identifier: id) -> ^NS.IndexPath {
    ...
    if vt.supplementaryViewProvider != nil {
        supplementaryViewProvider :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL) -> NS.CollectionViewDiffableDataSourceSupplementaryViewProvider {
    ...
    if vt.setSupplementaryViewProvider != nil {
        setSupplementaryViewProvider :: proc "c" (self: ^NS.CollectionViewDiffableDataSource, _: SEL, supplementaryViewProvider: NS.CollectionViewDiffableDataSourceSupplementaryViewProvider) {
