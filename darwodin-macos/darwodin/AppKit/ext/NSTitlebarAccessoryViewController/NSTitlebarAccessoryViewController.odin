...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.TitlebarAccessoryViewController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.TitlebarAccessoryViewController,
    alloc: proc() -> ^AK.TitlebarAccessoryViewController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.TitlebarAccessoryViewController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.TitlebarAccessoryViewController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.TitlebarAccessoryViewController {
