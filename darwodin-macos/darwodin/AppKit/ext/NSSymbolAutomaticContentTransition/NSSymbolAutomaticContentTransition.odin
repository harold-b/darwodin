...
VTable :: struct {
    ...
    new: proc() -> ^AK.SymbolAutomaticContentTransition,
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.SymbolAutomaticContentTransition,
    alloc: proc() -> ^AK.SymbolAutomaticContentTransition,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.SymbolAutomaticContentTransition {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.SymbolAutomaticContentTransition {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.SymbolAutomaticContentTransition {
