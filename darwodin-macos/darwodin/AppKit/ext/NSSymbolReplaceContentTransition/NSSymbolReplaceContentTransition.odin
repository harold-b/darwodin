...
VTable :: struct {
    ...
    new: proc() -> ^AK.SymbolReplaceContentTransition,
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.SymbolReplaceContentTransition,
    alloc: proc() -> ^AK.SymbolReplaceContentTransition,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.SymbolReplaceContentTransition {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.SymbolReplaceContentTransition {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.SymbolReplaceContentTransition {
