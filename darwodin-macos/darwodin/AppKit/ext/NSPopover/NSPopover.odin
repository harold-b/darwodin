...
VTable :: struct {
    ...
    init: proc(self: ^NS.Popover) -> instancetype,
    initWithCoder: proc(self: ^NS.Popover, coder: ^NS.Coder) -> instancetype,
    showRelativeToRect: proc(self: ^NS.Popover, positioningRect: NS.Rect, positioningView: ^NS.View, preferredEdge: NS.RectEdge),
    showRelativeToToolbarItem: proc(self: ^NS.Popover, toolbarItem: ^NS.ToolbarItem),
    performClose: proc(self: ^NS.Popover, sender: id),
    close: proc(self: ^NS.Popover),
    delegate: proc(self: ^NS.Popover) -> ^NS.PopoverDelegate,
    setDelegate: proc(self: ^NS.Popover, delegate: ^NS.PopoverDelegate),
    appearance: proc(self: ^NS.Popover) -> ^NS.Appearance,
    setAppearance: proc(self: ^NS.Popover, appearance: ^NS.Appearance),
    effectiveAppearance: proc(self: ^NS.Popover) -> ^NS.Appearance,
    behavior: proc(self: ^NS.Popover) -> NS.PopoverBehavior,
    setBehavior: proc(self: ^NS.Popover, behavior: NS.PopoverBehavior),
    animates: proc(self: ^NS.Popover) -> bool,
    setAnimates: proc(self: ^NS.Popover, animates: bool),
    contentViewController: proc(self: ^NS.Popover) -> ^NS.ViewController,
    setContentViewController: proc(self: ^NS.Popover, contentViewController: ^NS.ViewController),
    contentSize: proc(self: ^NS.Popover) -> NS.Size,
    setContentSize: proc(self: ^NS.Popover, contentSize: NS.Size),
    isShown: proc(self: ^NS.Popover) -> bool,
    isDetached: proc(self: ^NS.Popover) -> bool,
    positioningRect: proc(self: ^NS.Popover) -> NS.Rect,
    setPositioningRect: proc(self: ^NS.Popover, positioningRect: NS.Rect),
    hasFullSizeContent: proc(self: ^NS.Popover) -> bool,
    setHasFullSizeContent: proc(self: ^NS.Popover, hasFullSizeContent: bool),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^NS.Popover, _: SEL) -> instancetype {
    ...
    if vt.initWithCoder != nil {
        initWithCoder :: proc "c" (self: ^NS.Popover, _: SEL, coder: ^NS.Coder) -> instancetype {
    ...
    if vt.showRelativeToRect != nil {
        showRelativeToRect :: proc "c" (self: ^NS.Popover, _: SEL, positioningRect: NS.Rect, positioningView: ^NS.View, preferredEdge: NS.RectEdge) {
    ...
    if vt.showRelativeToToolbarItem != nil {
        showRelativeToToolbarItem :: proc "c" (self: ^NS.Popover, _: SEL, toolbarItem: ^NS.ToolbarItem) {
    ...
    if vt.performClose != nil {
        performClose :: proc "c" (self: ^NS.Popover, _: SEL, sender: id) {
    ...
    if vt.close != nil {
        close :: proc "c" (self: ^NS.Popover, _: SEL) {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^NS.Popover, _: SEL) -> ^NS.PopoverDelegate {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^NS.Popover, _: SEL, delegate: ^NS.PopoverDelegate) {
    ...
    if vt.appearance != nil {
        appearance :: proc "c" (self: ^NS.Popover, _: SEL) -> ^NS.Appearance {
    ...
    if vt.setAppearance != nil {
        setAppearance :: proc "c" (self: ^NS.Popover, _: SEL, appearance: ^NS.Appearance) {
    ...
    if vt.effectiveAppearance != nil {
        effectiveAppearance :: proc "c" (self: ^NS.Popover, _: SEL) -> ^NS.Appearance {
    ...
    if vt.behavior != nil {
        behavior :: proc "c" (self: ^NS.Popover, _: SEL) -> NS.PopoverBehavior {
    ...
    if vt.setBehavior != nil {
        setBehavior :: proc "c" (self: ^NS.Popover, _: SEL, behavior: NS.PopoverBehavior) {
    ...
    if vt.animates != nil {
        animates :: proc "c" (self: ^NS.Popover, _: SEL) -> bool {
    ...
    if vt.setAnimates != nil {
        setAnimates :: proc "c" (self: ^NS.Popover, _: SEL, animates: bool) {
    ...
    if vt.contentViewController != nil {
        contentViewController :: proc "c" (self: ^NS.Popover, _: SEL) -> ^NS.ViewController {
    ...
    if vt.setContentViewController != nil {
        setContentViewController :: proc "c" (self: ^NS.Popover, _: SEL, contentViewController: ^NS.ViewController) {
    ...
    if vt.contentSize != nil {
        contentSize :: proc "c" (self: ^NS.Popover, _: SEL) -> NS.Size {
    ...
    if vt.setContentSize != nil {
        setContentSize :: proc "c" (self: ^NS.Popover, _: SEL, contentSize: NS.Size) {
    ...
    if vt.isShown != nil {
        isShown :: proc "c" (self: ^NS.Popover, _: SEL) -> bool {
    ...
    if vt.isDetached != nil {
        isDetached :: proc "c" (self: ^NS.Popover, _: SEL) -> bool {
    ...
    if vt.positioningRect != nil {
        positioningRect :: proc "c" (self: ^NS.Popover, _: SEL) -> NS.Rect {
    ...
    if vt.setPositioningRect != nil {
        setPositioningRect :: proc "c" (self: ^NS.Popover, _: SEL, positioningRect: NS.Rect) {
    ...
    if vt.hasFullSizeContent != nil {
        hasFullSizeContent :: proc "c" (self: ^NS.Popover, _: SEL) -> bool {
    ...
    if vt.setHasFullSizeContent != nil {
        setHasFullSizeContent :: proc "c" (self: ^NS.Popover, _: SEL, hasFullSizeContent: bool) {
