...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Popover,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Popover,
    alloc: proc() -> ^AK.Popover,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Popover {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Popover {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Popover {
