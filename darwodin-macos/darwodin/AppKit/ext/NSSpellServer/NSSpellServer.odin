...
VTable :: struct {
    ...
    registerLanguage: proc(self: ^AK.SpellServer, language: ^NS.String, vendor: ^NS.String) -> bool,
    isWordInUserDictionaries: proc(self: ^AK.SpellServer, word: ^NS.String, flag: bool) -> bool,
    run: proc(self: ^AK.SpellServer),
    delegate: proc(self: ^AK.SpellServer) -> ^AK.SpellServerDelegate,
    setDelegate: proc(self: ^AK.SpellServer, delegate: ^AK.SpellServerDelegate),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.registerLanguage != nil {
        registerLanguage :: proc "c" (self: ^AK.SpellServer, _: SEL, language: ^NS.String, vendor: ^NS.String) -> bool {
    ...
    if vt.isWordInUserDictionaries != nil {
        isWordInUserDictionaries :: proc "c" (self: ^AK.SpellServer, _: SEL, word: ^NS.String, flag: bool) -> bool {
    ...
    if vt.run != nil {
        run :: proc "c" (self: ^AK.SpellServer, _: SEL) {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^AK.SpellServer, _: SEL) -> ^AK.SpellServerDelegate {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^AK.SpellServer, _: SEL, delegate: ^AK.SpellServerDelegate) {
