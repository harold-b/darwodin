...
VTable :: struct {
    layer: proc(self: ^NS.ViewLayerContentScaleDelegate, layer: ^CA.Layer, newScale: CG.Float, window: ^NS.Window) -> bool,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    _=meta
    if vt.layer != nil {
        layer :: proc "c" (self: ^NS.ViewLayerContentScaleDelegate, _: SEL, layer: ^CA.Layer, newScale: CG.Float, window: ^NS.Window) -> bool {
