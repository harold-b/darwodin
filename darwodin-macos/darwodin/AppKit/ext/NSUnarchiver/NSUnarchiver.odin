...
import "../../../Foundation/ext/NSCoder"

VTable :: struct {
    super: NSCoder.VTable,
    initForReadingWithData: proc(self: ^AK.Unarchiver, data: ^NS.Data) -> ^AK.Unarchiver,
    setObjectZone: proc(self: ^AK.Unarchiver, zone: ^NS.Zone),
    objectZone: proc(self: ^AK.Unarchiver) -> ^NS.Zone,
    ...
    decodeClassName: proc(self: ^AK.Unarchiver, inArchiveName: ^NS.String, trueName: ^NS.String),
    classNameDecodedForArchiveClassNameStatic: proc(inArchiveName: ^NS.String) -> ^NS.String,
    classNameDecodedForArchiveClassName: proc(self: ^AK.Unarchiver, inArchiveName: ^NS.String) -> ^NS.String,
    replaceObject: proc(self: ^AK.Unarchiver, object: id, newObject: id),
    isAtEnd: proc(self: ^AK.Unarchiver) -> bool,
    systemVersion: proc(self: ^AK.Unarchiver) -> cffi.uint,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initForReadingWithData != nil {
        initForReadingWithData :: proc "c" (self: ^AK.Unarchiver, _: SEL, data: ^NS.Data) -> ^AK.Unarchiver {
    ...
    if vt.setObjectZone != nil {
        setObjectZone :: proc "c" (self: ^AK.Unarchiver, _: SEL, zone: ^NS.Zone) {
    ...
    if vt.objectZone != nil {
        objectZone :: proc "c" (self: ^AK.Unarchiver, _: SEL) -> ^NS.Zone {
    ...
    if vt.decodeClassName != nil {
        decodeClassName :: proc "c" (self: ^AK.Unarchiver, _: SEL, inArchiveName: ^NS.String, trueName: ^NS.String) {
    ...
    if vt.classNameDecodedForArchiveClassName != nil {
        classNameDecodedForArchiveClassName :: proc "c" (self: ^AK.Unarchiver, _: SEL, inArchiveName: ^NS.String) -> ^NS.String {
    ...
    if vt.replaceObject != nil {
        replaceObject :: proc "c" (self: ^AK.Unarchiver, _: SEL, object: id, newObject: id) {
    ...
    if vt.isAtEnd != nil {
        isAtEnd :: proc "c" (self: ^AK.Unarchiver, _: SEL) -> bool {
    ...
    if vt.systemVersion != nil {
        systemVersion :: proc "c" (self: ^AK.Unarchiver, _: SEL) -> cffi.uint {
