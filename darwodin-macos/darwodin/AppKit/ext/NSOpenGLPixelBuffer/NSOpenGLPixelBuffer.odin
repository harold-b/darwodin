...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.OpenGLPixelBuffer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.OpenGLPixelBuffer,
    alloc: proc() -> ^AK.OpenGLPixelBuffer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.OpenGLPixelBuffer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.OpenGLPixelBuffer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.OpenGLPixelBuffer {
