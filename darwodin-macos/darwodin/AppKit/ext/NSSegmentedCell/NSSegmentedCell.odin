...
VTable :: struct {
    ...
    setImage: proc(self: ^AK.SegmentedCell, image: ^AK.Image, segment: NS.Integer),
    imageForSegment: proc(self: ^AK.SegmentedCell, segment: NS.Integer) -> ^AK.Image,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.setImage != nil {
        setImage :: proc "c" (self: ^AK.SegmentedCell, _: SEL, image: ^AK.Image, segment: NS.Integer) {
    ...
    if vt.imageForSegment != nil {
        imageForSegment :: proc "c" (self: ^AK.SegmentedCell, _: SEL, segment: NS.Integer) -> ^AK.Image {
