...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.TextTab,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.TextTab,
    alloc: proc() -> ^AK.TextTab,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.TextTab {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.TextTab {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.TextTab {
