...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Nib,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Nib,
    alloc: proc() -> ^AK.Nib,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Nib {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Nib {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Nib {
