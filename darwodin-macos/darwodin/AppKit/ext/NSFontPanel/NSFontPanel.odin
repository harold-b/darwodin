...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.FontPanel,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.FontPanel,
    alloc: proc() -> ^AK.FontPanel,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.FontPanel {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.FontPanel {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.FontPanel {
