...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^NS.SymbolAppearEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^NS.SymbolAppearEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^NS.SymbolAppearEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^NS.SymbolAppearEffect, _: SEL) -> instancetype {
