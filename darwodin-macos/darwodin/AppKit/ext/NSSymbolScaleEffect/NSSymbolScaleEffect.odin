...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^NS.SymbolScaleEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^NS.SymbolScaleEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^NS.SymbolScaleEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^NS.SymbolScaleEffect, _: SEL) -> instancetype {
