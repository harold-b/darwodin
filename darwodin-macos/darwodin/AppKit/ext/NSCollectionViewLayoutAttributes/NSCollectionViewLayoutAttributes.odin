...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.CollectionViewLayoutAttributes,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.CollectionViewLayoutAttributes,
    alloc: proc() -> ^AK.CollectionViewLayoutAttributes,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewLayoutAttributes {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.CollectionViewLayoutAttributes {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewLayoutAttributes {
