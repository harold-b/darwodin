...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Slider,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Slider,
    alloc: proc() -> ^AK.Slider,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Slider {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Slider {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Slider {
