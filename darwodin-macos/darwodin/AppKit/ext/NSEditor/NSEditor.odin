...
VTable :: struct {
    discardEditing: proc(self: ^NS.Editor),
    commitEditing: proc(self: ^NS.Editor) -> bool,
    commitEditingWithDelegate: proc(self: ^NS.Editor, delegate: id, didCommitSelector: SEL, contextInfo: rawptr),
    commitEditingAndReturnError: proc(self: ^NS.Editor, error: ^^NS.Error) -> bool,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.discardEditing != nil {
        discardEditing :: proc "c" (self: ^NS.Editor, _: SEL) {
    ...
    if vt.commitEditing != nil {
        commitEditing :: proc "c" (self: ^NS.Editor, _: SEL) -> bool {
    ...
    if vt.commitEditingWithDelegate != nil {
        commitEditingWithDelegate :: proc "c" (self: ^NS.Editor, _: SEL, delegate: id, didCommitSelector: SEL, contextInfo: rawptr) {
    ...
    if vt.commitEditingAndReturnError != nil {
        commitEditingAndReturnError :: proc "c" (self: ^NS.Editor, _: SEL, error: ^^NS.Error) -> bool {
