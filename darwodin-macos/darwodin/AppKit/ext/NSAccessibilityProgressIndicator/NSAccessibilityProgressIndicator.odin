package darwodin_NSAccessibilityProgressIndicator_Ext
...
VTable :: struct {
    accessibilityValue: proc(self: ^AK.AccessibilityProgressIndicator) -> ^NS.Number,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.accessibilityValue != nil {
        accessibilityValue :: proc "c" (self: ^AK.AccessibilityProgressIndicator, _: SEL) -> ^NS.Number {
