...
VTable :: struct {
    accessibilityValue: proc(self: ^NS.AccessibilityProgressIndicator) -> ^NS.Number,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.accessibilityValue != nil {
        accessibilityValue :: proc "c" (self: ^NS.AccessibilityProgressIndicator, _: SEL) -> ^NS.Number {
