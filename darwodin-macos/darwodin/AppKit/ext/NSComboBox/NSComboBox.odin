...
VTable :: struct {
    ...
    reloadData: proc(self: ^NS.ComboBox),
    noteNumberOfItemsChanged: proc(self: ^NS.ComboBox),
    scrollItemAtIndexToTop: proc(self: ^NS.ComboBox, index: NS.Integer),
    scrollItemAtIndexToVisible: proc(self: ^NS.ComboBox, index: NS.Integer),
    selectItemAtIndex: proc(self: ^NS.ComboBox, index: NS.Integer),
    deselectItemAtIndex: proc(self: ^NS.ComboBox, index: NS.Integer),
    addItemWithObjectValue: proc(self: ^NS.ComboBox, object: id),
    addItemsWithObjectValues: proc(self: ^NS.ComboBox, objects: ^NS.Array),
    insertItemWithObjectValue: proc(self: ^NS.ComboBox, object: id, index: NS.Integer),
    removeItemWithObjectValue: proc(self: ^NS.ComboBox, object: id),
    removeItemAtIndex: proc(self: ^NS.ComboBox, index: NS.Integer),
    removeAllItems: proc(self: ^NS.ComboBox),
    selectItemWithObjectValue: proc(self: ^NS.ComboBox, object: id),
    itemObjectValueAtIndex: proc(self: ^NS.ComboBox, index: NS.Integer) -> id,
    indexOfItemWithObjectValue: proc(self: ^NS.ComboBox, object: id) -> NS.Integer,
    hasVerticalScroller: proc(self: ^NS.ComboBox) -> bool,
    setHasVerticalScroller: proc(self: ^NS.ComboBox, hasVerticalScroller: bool),
    intercellSpacing: proc(self: ^NS.ComboBox) -> NS.Size,
    setIntercellSpacing: proc(self: ^NS.ComboBox, intercellSpacing: NS.Size),
    itemHeight: proc(self: ^NS.ComboBox) -> CG.Float,
    setItemHeight: proc(self: ^NS.ComboBox, itemHeight: CG.Float),
    numberOfVisibleItems: proc(self: ^NS.ComboBox) -> NS.Integer,
    setNumberOfVisibleItems: proc(self: ^NS.ComboBox, numberOfVisibleItems: NS.Integer),
    isButtonBordered: proc(self: ^NS.ComboBox) -> bool,
    setButtonBordered: proc(self: ^NS.ComboBox, buttonBordered: bool),
    usesDataSource: proc(self: ^NS.ComboBox) -> bool,
    setUsesDataSource: proc(self: ^NS.ComboBox, usesDataSource: bool),
    indexOfSelectedItem: proc(self: ^NS.ComboBox) -> NS.Integer,
    numberOfItems: proc(self: ^NS.ComboBox) -> NS.Integer,
    completes: proc(self: ^NS.ComboBox) -> bool,
    setCompletes: proc(self: ^NS.ComboBox, completes: bool),
    delegate: proc(self: ^NS.ComboBox) -> ^NS.ComboBoxDelegate,
    setDelegate: proc(self: ^NS.ComboBox, delegate: ^NS.ComboBoxDelegate),
    dataSource: proc(self: ^NS.ComboBox) -> ^NS.ComboBoxDataSource,
    setDataSource: proc(self: ^NS.ComboBox, dataSource: ^NS.ComboBoxDataSource),
    objectValueOfSelectedItem: proc(self: ^NS.ComboBox) -> id,
    objectValues: proc(self: ^NS.ComboBox) -> ^NS.Array,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.reloadData != nil {
        reloadData :: proc "c" (self: ^NS.ComboBox, _: SEL) {
    ...
    if vt.noteNumberOfItemsChanged != nil {
        noteNumberOfItemsChanged :: proc "c" (self: ^NS.ComboBox, _: SEL) {
    ...
    if vt.scrollItemAtIndexToTop != nil {
        scrollItemAtIndexToTop :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) {
    ...
    if vt.scrollItemAtIndexToVisible != nil {
        scrollItemAtIndexToVisible :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) {
    ...
    if vt.selectItemAtIndex != nil {
        selectItemAtIndex :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) {
    ...
    if vt.deselectItemAtIndex != nil {
        deselectItemAtIndex :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) {
    ...
    if vt.addItemWithObjectValue != nil {
        addItemWithObjectValue :: proc "c" (self: ^NS.ComboBox, _: SEL, object: id) {
    ...
    if vt.addItemsWithObjectValues != nil {
        addItemsWithObjectValues :: proc "c" (self: ^NS.ComboBox, _: SEL, objects: ^NS.Array) {
    ...
    if vt.insertItemWithObjectValue != nil {
        insertItemWithObjectValue :: proc "c" (self: ^NS.ComboBox, _: SEL, object: id, index: NS.Integer) {
    ...
    if vt.removeItemWithObjectValue != nil {
        removeItemWithObjectValue :: proc "c" (self: ^NS.ComboBox, _: SEL, object: id) {
    ...
    if vt.removeItemAtIndex != nil {
        removeItemAtIndex :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) {
    ...
    if vt.removeAllItems != nil {
        removeAllItems :: proc "c" (self: ^NS.ComboBox, _: SEL) {
    ...
    if vt.selectItemWithObjectValue != nil {
        selectItemWithObjectValue :: proc "c" (self: ^NS.ComboBox, _: SEL, object: id) {
    ...
    if vt.itemObjectValueAtIndex != nil {
        itemObjectValueAtIndex :: proc "c" (self: ^NS.ComboBox, _: SEL, index: NS.Integer) -> id {
    ...
    if vt.indexOfItemWithObjectValue != nil {
        indexOfItemWithObjectValue :: proc "c" (self: ^NS.ComboBox, _: SEL, object: id) -> NS.Integer {
    ...
    if vt.hasVerticalScroller != nil {
        hasVerticalScroller :: proc "c" (self: ^NS.ComboBox, _: SEL) -> bool {
    ...
    if vt.setHasVerticalScroller != nil {
        setHasVerticalScroller :: proc "c" (self: ^NS.ComboBox, _: SEL, hasVerticalScroller: bool) {
    ...
    if vt.intercellSpacing != nil {
        intercellSpacing :: proc "c" (self: ^NS.ComboBox, _: SEL) -> NS.Size {
    ...
    if vt.setIntercellSpacing != nil {
        setIntercellSpacing :: proc "c" (self: ^NS.ComboBox, _: SEL, intercellSpacing: NS.Size) {
    ...
    if vt.itemHeight != nil {
        itemHeight :: proc "c" (self: ^NS.ComboBox, _: SEL) -> CG.Float {
    ...
    if vt.setItemHeight != nil {
        setItemHeight :: proc "c" (self: ^NS.ComboBox, _: SEL, itemHeight: CG.Float) {
    ...
    if vt.numberOfVisibleItems != nil {
        numberOfVisibleItems :: proc "c" (self: ^NS.ComboBox, _: SEL) -> NS.Integer {
    ...
    if vt.setNumberOfVisibleItems != nil {
        setNumberOfVisibleItems :: proc "c" (self: ^NS.ComboBox, _: SEL, numberOfVisibleItems: NS.Integer) {
    ...
    if vt.isButtonBordered != nil {
        isButtonBordered :: proc "c" (self: ^NS.ComboBox, _: SEL) -> bool {
    ...
    if vt.setButtonBordered != nil {
        setButtonBordered :: proc "c" (self: ^NS.ComboBox, _: SEL, buttonBordered: bool) {
    ...
    if vt.usesDataSource != nil {
        usesDataSource :: proc "c" (self: ^NS.ComboBox, _: SEL) -> bool {
    ...
    if vt.setUsesDataSource != nil {
        setUsesDataSource :: proc "c" (self: ^NS.ComboBox, _: SEL, usesDataSource: bool) {
    ...
    if vt.indexOfSelectedItem != nil {
        indexOfSelectedItem :: proc "c" (self: ^NS.ComboBox, _: SEL) -> NS.Integer {
    ...
    if vt.numberOfItems != nil {
        numberOfItems :: proc "c" (self: ^NS.ComboBox, _: SEL) -> NS.Integer {
    ...
    if vt.completes != nil {
        completes :: proc "c" (self: ^NS.ComboBox, _: SEL) -> bool {
    ...
    if vt.setCompletes != nil {
        setCompletes :: proc "c" (self: ^NS.ComboBox, _: SEL, completes: bool) {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^NS.ComboBox, _: SEL) -> ^NS.ComboBoxDelegate {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^NS.ComboBox, _: SEL, delegate: ^NS.ComboBoxDelegate) {
    ...
    if vt.dataSource != nil {
        dataSource :: proc "c" (self: ^NS.ComboBox, _: SEL) -> ^NS.ComboBoxDataSource {
    ...
    if vt.setDataSource != nil {
        setDataSource :: proc "c" (self: ^NS.ComboBox, _: SEL, dataSource: ^NS.ComboBoxDataSource) {
    ...
    if vt.objectValueOfSelectedItem != nil {
        objectValueOfSelectedItem :: proc "c" (self: ^NS.ComboBox, _: SEL) -> id {
    ...
    if vt.objectValues != nil {
        objectValues :: proc "c" (self: ^NS.ComboBox, _: SEL) -> ^NS.Array {
