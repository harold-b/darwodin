...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.UserInterfaceCompressionOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.UserInterfaceCompressionOptions,
    alloc: proc() -> ^AK.UserInterfaceCompressionOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.UserInterfaceCompressionOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.UserInterfaceCompressionOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.UserInterfaceCompressionOptions {
