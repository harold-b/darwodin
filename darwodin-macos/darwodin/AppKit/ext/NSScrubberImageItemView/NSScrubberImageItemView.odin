...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberImageItemView,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberImageItemView,
    alloc: proc() -> ^AK.ScrubberImageItemView,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberImageItemView {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberImageItemView {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberImageItemView {
