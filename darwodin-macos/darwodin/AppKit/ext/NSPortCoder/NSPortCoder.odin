...
VTable :: struct {
    ...
    isBycopy: proc(self: ^AK.PortCoder) -> bool,
    isByref: proc(self: ^AK.PortCoder) -> bool,
    encodePortObject: proc(self: ^AK.PortCoder, aport: ^NS.Port),
    decodePortObject: proc(self: ^AK.PortCoder) -> ^NS.Port,
    connection: proc(self: ^AK.PortCoder) -> ^NS.Connection,
    portCoderWithReceivePort: proc(rcvPort: ^NS.Port, sndPort: ^NS.Port, comps: ^NS.Array) -> id,
    initWithReceivePort: proc(self: ^AK.PortCoder, rcvPort: ^NS.Port, sndPort: ^NS.Port, comps: ^NS.Array) -> id,
    dispatch: proc(self: ^AK.PortCoder),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.isBycopy != nil {
        isBycopy :: proc "c" (self: ^AK.PortCoder, _: SEL) -> bool {
    ...
    if vt.isByref != nil {
        isByref :: proc "c" (self: ^AK.PortCoder, _: SEL) -> bool {
    ...
    if vt.encodePortObject != nil {
        encodePortObject :: proc "c" (self: ^AK.PortCoder, _: SEL, aport: ^NS.Port) {
    ...
    if vt.decodePortObject != nil {
        decodePortObject :: proc "c" (self: ^AK.PortCoder, _: SEL) -> ^NS.Port {
    ...
    if vt.connection != nil {
        connection :: proc "c" (self: ^AK.PortCoder, _: SEL) -> ^NS.Connection {
    ...
    if vt.initWithReceivePort != nil {
        initWithReceivePort :: proc "c" (self: ^AK.PortCoder, _: SEL, rcvPort: ^NS.Port, sndPort: ^NS.Port, comps: ^NS.Array) -> id {
    ...
    if vt.dispatch != nil {
        dispatch :: proc "c" (self: ^AK.PortCoder, _: SEL) {
