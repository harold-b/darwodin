...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.CollectionViewFlowLayoutInvalidationContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.CollectionViewFlowLayoutInvalidationContext,
    alloc: proc() -> ^AK.CollectionViewFlowLayoutInvalidationContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewFlowLayoutInvalidationContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.CollectionViewFlowLayoutInvalidationContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewFlowLayoutInvalidationContext {
