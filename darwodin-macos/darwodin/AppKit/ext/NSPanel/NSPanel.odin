...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Panel,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Panel,
    alloc: proc() -> ^AK.Panel,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Panel {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Panel {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Panel {
