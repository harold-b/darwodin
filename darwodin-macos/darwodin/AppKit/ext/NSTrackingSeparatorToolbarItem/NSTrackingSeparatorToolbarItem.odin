...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.TrackingSeparatorToolbarItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.TrackingSeparatorToolbarItem,
    alloc: proc() -> ^AK.TrackingSeparatorToolbarItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.TrackingSeparatorToolbarItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.TrackingSeparatorToolbarItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.TrackingSeparatorToolbarItem {
