...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Stepper,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Stepper,
    alloc: proc() -> ^AK.Stepper,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Stepper {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Stepper {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Stepper {
