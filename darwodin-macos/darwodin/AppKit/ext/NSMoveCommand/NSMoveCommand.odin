...
VTable :: struct {
    ...
    setReceiversSpecifier: proc(self: ^AK.MoveCommand, receiversRef: ^AK.ScriptObjectSpecifier),
    keySpecifier: proc(self: ^AK.MoveCommand) -> ^AK.ScriptObjectSpecifier,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.setReceiversSpecifier != nil {
        setReceiversSpecifier :: proc "c" (self: ^AK.MoveCommand, _: SEL, receiversRef: ^AK.ScriptObjectSpecifier) {
    ...
    if vt.keySpecifier != nil {
        keySpecifier :: proc "c" (self: ^AK.MoveCommand, _: SEL) -> ^AK.ScriptObjectSpecifier {
