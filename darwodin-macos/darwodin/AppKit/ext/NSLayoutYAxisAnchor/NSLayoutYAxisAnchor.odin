...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.LayoutYAxisAnchor,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.LayoutYAxisAnchor,
    alloc: proc() -> ^AK.LayoutYAxisAnchor,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.LayoutYAxisAnchor {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.LayoutYAxisAnchor {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.LayoutYAxisAnchor {
