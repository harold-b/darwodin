...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Cell,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Cell,
    alloc: proc() -> ^AK.Cell,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Cell {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Cell {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Cell {
