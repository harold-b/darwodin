...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.previewImage != nil {
        previewImage :: proc "c" (self: ^AK.TextPreview, _: SEL) -> CG.ImageRef {
    ...
    if vt.presentationFrame != nil {
        presentationFrame :: proc "c" (self: ^AK.TextPreview, _: SEL) -> NS.Rect {
    ...
    if vt.candidateRects != nil {
        candidateRects :: proc "c" (self: ^AK.TextPreview, _: SEL) -> ^NS.Array {
