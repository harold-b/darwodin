...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.FilePromiseProvider,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.FilePromiseProvider,
    alloc: proc() -> ^AK.FilePromiseProvider,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.FilePromiseProvider {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.FilePromiseProvider {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.FilePromiseProvider {
