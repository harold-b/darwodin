...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ColorSampler,
    alloc: proc() -> ^AK.ColorSampler,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ColorSampler {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ColorSampler {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ColorSampler {
