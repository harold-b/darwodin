...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Form,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Form,
    alloc: proc() -> ^AK.Form,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Form {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Form {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Form {
