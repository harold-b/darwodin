...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.GridRow,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.GridRow,
    alloc: proc() -> ^AK.GridRow,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.GridRow {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.GridRow {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.GridRow {
