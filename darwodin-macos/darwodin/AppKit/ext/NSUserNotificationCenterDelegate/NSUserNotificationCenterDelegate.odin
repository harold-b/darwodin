...
VTable :: struct {
    userNotificationCenter_didDeliverNotification: proc(self: ^AK.UserNotificationCenterDelegate, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    userNotificationCenter_didActivateNotification: proc(self: ^AK.UserNotificationCenterDelegate, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    userNotificationCenter_shouldPresentNotification: proc(self: ^AK.UserNotificationCenterDelegate, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification) -> bool,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.userNotificationCenter_didDeliverNotification != nil {
        userNotificationCenter_didDeliverNotification :: proc "c" (self: ^AK.UserNotificationCenterDelegate, _: SEL, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification) {
    ...
    if vt.userNotificationCenter_didActivateNotification != nil {
        userNotificationCenter_didActivateNotification :: proc "c" (self: ^AK.UserNotificationCenterDelegate, _: SEL, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification) {
    ...
    if vt.userNotificationCenter_shouldPresentNotification != nil {
        userNotificationCenter_shouldPresentNotification :: proc "c" (self: ^AK.UserNotificationCenterDelegate, _: SEL, center: ^AK.UserNotificationCenter, notification: ^AK.UserNotification) -> bool {
