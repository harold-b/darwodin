...
VTable :: struct {
    makeNewConnection: proc(self: ^AK.ConnectionDelegate, conn: ^NS.Connection, ancestor: ^NS.Connection) -> bool,
    connection_shouldMakeNewConnection: proc(self: ^AK.ConnectionDelegate, ancestor: ^NS.Connection, conn: ^NS.Connection) -> bool,
    authenticationDataForComponents: proc(self: ^AK.ConnectionDelegate, components: ^NS.Array) -> ^NS.Data,
    authenticateComponents: proc(self: ^AK.ConnectionDelegate, components: ^NS.Array, signature: ^NS.Data) -> bool,
    createConversationForConnection: proc(self: ^AK.ConnectionDelegate, conn: ^NS.Connection) -> id,
    connection_handleRequest: proc(self: ^AK.ConnectionDelegate, connection: ^NS.Connection, doreq: ^AK.DistantObjectRequest) -> bool,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.makeNewConnection != nil {
        makeNewConnection :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, conn: ^NS.Connection, ancestor: ^NS.Connection) -> bool {
    ...
    if vt.connection_shouldMakeNewConnection != nil {
        connection_shouldMakeNewConnection :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, ancestor: ^NS.Connection, conn: ^NS.Connection) -> bool {
    ...
    if vt.authenticationDataForComponents != nil {
        authenticationDataForComponents :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, components: ^NS.Array) -> ^NS.Data {
    ...
    if vt.authenticateComponents != nil {
        authenticateComponents :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, components: ^NS.Array, signature: ^NS.Data) -> bool {
    ...
    if vt.createConversationForConnection != nil {
        createConversationForConnection :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, conn: ^NS.Connection) -> id {
    ...
    if vt.connection_handleRequest != nil {
        connection_handleRequest :: proc "c" (self: ^AK.ConnectionDelegate, _: SEL, connection: ^NS.Connection, doreq: ^AK.DistantObjectRequest) -> bool {
