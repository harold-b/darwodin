...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Matrix,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Matrix,
    alloc: proc() -> ^AK.Matrix,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.cellClassStatic != nil {
        cellClassStatic :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).cellClassStatic()
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Matrix {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Matrix {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Matrix {
