...
VTable :: struct {
    drawWithFrame_inView: proc(self: ^NS.TextAttachmentCellProtocol, cellFrame: NS.Rect, controlView: ^NS.View),
    wantsToTrackMouse: proc(self: ^NS.TextAttachmentCellProtocol) -> bool,
    highlight: proc(self: ^NS.TextAttachmentCellProtocol, flag: bool, cellFrame: NS.Rect, controlView: ^NS.View),
    trackMouse_inRect_ofView_untilMouseUp: proc(self: ^NS.TextAttachmentCellProtocol, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, flag: bool) -> bool,
    cellSize: proc(self: ^NS.TextAttachmentCellProtocol) -> NS.Size,
    cellBaselineOffset: proc(self: ^NS.TextAttachmentCellProtocol) -> CG.Point,
    drawWithFrame_inView_characterIndex: proc(self: ^NS.TextAttachmentCellProtocol, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger),
    drawWithFrame_inView_characterIndex_layoutManager: proc(self: ^NS.TextAttachmentCellProtocol, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger, layoutManager: ^NS.LayoutManager),
    wantsToTrackMouseForEvent: proc(self: ^NS.TextAttachmentCellProtocol, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger) -> bool,
    trackMouse_inRect_ofView_atCharacterIndex_untilMouseUp: proc(self: ^NS.TextAttachmentCellProtocol, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger, flag: bool) -> bool,
    cellFrameForTextContainer: proc(self: ^NS.TextAttachmentCellProtocol, textContainer: ^NS.TextContainer, lineFrag: NS.Rect, position: CG.Point, charIndex: NS.UInteger) -> NS.Rect,
    attachment: proc(self: ^NS.TextAttachmentCellProtocol) -> ^NS.TextAttachment,
    setAttachment: proc(self: ^NS.TextAttachmentCellProtocol, attachment: ^NS.TextAttachment),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.drawWithFrame_inView != nil {
        drawWithFrame_inView :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, cellFrame: NS.Rect, controlView: ^NS.View) {
    ...
    if vt.wantsToTrackMouse != nil {
        wantsToTrackMouse :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL) -> bool {
    ...
    if vt.highlight != nil {
        highlight :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, flag: bool, cellFrame: NS.Rect, controlView: ^NS.View) {
    ...
    if vt.trackMouse_inRect_ofView_untilMouseUp != nil {
        trackMouse_inRect_ofView_untilMouseUp :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, flag: bool) -> bool {
    ...
    if vt.cellSize != nil {
        cellSize :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL) -> NS.Size {
    ...
    if vt.cellBaselineOffset != nil {
        cellBaselineOffset :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL) -> CG.Point {
    ...
    if vt.drawWithFrame_inView_characterIndex != nil {
        drawWithFrame_inView_characterIndex :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger) {
    ...
    if vt.drawWithFrame_inView_characterIndex_layoutManager != nil {
        drawWithFrame_inView_characterIndex_layoutManager :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger, layoutManager: ^NS.LayoutManager) {
    ...
    if vt.wantsToTrackMouseForEvent != nil {
        wantsToTrackMouseForEvent :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger) -> bool {
    ...
    if vt.trackMouse_inRect_ofView_atCharacterIndex_untilMouseUp != nil {
        trackMouse_inRect_ofView_atCharacterIndex_untilMouseUp :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, theEvent: ^NS.Event, cellFrame: NS.Rect, controlView: ^NS.View, charIndex: NS.UInteger, flag: bool) -> bool {
    ...
    if vt.cellFrameForTextContainer != nil {
        cellFrameForTextContainer :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, textContainer: ^NS.TextContainer, lineFrag: NS.Rect, position: CG.Point, charIndex: NS.UInteger) -> NS.Rect {
    ...
    if vt.attachment != nil {
        attachment :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL) -> ^NS.TextAttachment {
    ...
    if vt.setAttachment != nil {
        setAttachment :: proc "c" (self: ^NS.TextAttachmentCellProtocol, _: SEL, attachment: ^NS.TextAttachment) {
