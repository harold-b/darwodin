...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberLayoutAttributes,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberLayoutAttributes,
    alloc: proc() -> ^AK.ScrubberLayoutAttributes,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberLayoutAttributes {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberLayoutAttributes {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberLayoutAttributes {
