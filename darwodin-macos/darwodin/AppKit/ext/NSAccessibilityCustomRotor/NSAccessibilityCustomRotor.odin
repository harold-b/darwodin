...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.AccessibilityCustomRotor,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.AccessibilityCustomRotor,
    alloc: proc() -> ^AK.AccessibilityCustomRotor,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.AccessibilityCustomRotor {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.AccessibilityCustomRotor {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.AccessibilityCustomRotor {
