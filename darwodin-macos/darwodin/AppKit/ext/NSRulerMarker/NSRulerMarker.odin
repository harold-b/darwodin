...
VTable :: struct {
    ...
    initWithRulerView: proc(self: ^AK.RulerMarker, ruler: ^AK.RulerView, location: CG.Float, image: ^AK.Image, imageOrigin: CG.Point) -> instancetype,
    ...
    image: proc(self: ^AK.RulerMarker) -> ^AK.Image,
    setImage: proc(self: ^AK.RulerMarker, image: ^AK.Image),
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithRulerView != nil {
        initWithRulerView :: proc "c" (self: ^AK.RulerMarker, _: SEL, ruler: ^AK.RulerView, location: CG.Float, image: ^AK.Image, imageOrigin: CG.Point) -> instancetype {
    ...
    if vt.image != nil {
        image :: proc "c" (self: ^AK.RulerMarker, _: SEL) -> ^AK.Image {
    ...
    if vt.setImage != nil {
        setImage :: proc "c" (self: ^AK.RulerMarker, _: SEL, image: ^AK.Image) {
