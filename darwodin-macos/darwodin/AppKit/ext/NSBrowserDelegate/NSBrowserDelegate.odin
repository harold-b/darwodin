...
VTable :: struct {
    browser_numberOfRowsInColumn: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, column: NS.Integer) -> NS.Integer,
    browser_createRowsForColumn_inMatrix: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, column: NS.Integer, _matrix: ^NS.Matrix),
    browser_numberOfChildrenOfItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> NS.Integer,
    browser_child_ofItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, index: NS.Integer, item: id) -> id,
    browser_isLeafItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> bool,
    browser_objectValueForItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> id,
    browser_heightOfRow_inColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, row: NS.Integer, columnIndex: NS.Integer) -> CG.Float,
    rootItemForBrowser: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser) -> id,
    browser_setObjectValue_forItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, object: id, item: id),
    browser_shouldEditItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> bool,
    browser_willDisplayCell_atRow_column: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, cell: id, row: NS.Integer, column: NS.Integer),
    browser_titleOfColumn: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, column: NS.Integer) -> ^NS.String,
    browser_selectCellWithString_inColumn: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, title: ^NS.String, column: NS.Integer) -> bool,
    browser_selectRow_inColumn: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> bool,
    browser_isColumnValid: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser, column: NS.Integer) -> bool,
    browserWillScroll: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser),
    browserDidScroll: proc(self: ^NS.BrowserDelegate, sender: ^NS.Browser),
    browser_shouldSizeColumn_forUserResize_toWidth: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, columnIndex: NS.Integer, forUserResize: bool, suggestedWidth: CG.Float) -> CG.Float,
    browser_sizeToFitWidthOfColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, columnIndex: NS.Integer) -> CG.Float,
    browserColumnConfigurationDidChange: proc(self: ^NS.BrowserDelegate, notification: ^NS.Notification),
    browser_shouldShowCellExpansionForRow_column: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> bool,
    browser_writeRowsWithIndexes_inColumn_toPasteboard: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, pasteboard: ^NS.Pasteboard) -> bool,
    browser_namesOfPromisedFilesDroppedAtDestination_forDraggedRowsWithIndexes_inColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, dropDestination: ^NS.URL, rowIndexes: ^NS.IndexSet, column: NS.Integer) -> ^NS.Array,
    browser_canDragRowsWithIndexes_inColumn_withEvent: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, event: ^NS.Event) -> bool,
    browser_draggingImageForRowsWithIndexes_inColumn_withEvent_offset: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, event: ^NS.Event, dragImageOffset: ^CG.Point) -> ^NS.Image,
    browser_validateDrop_proposedRow_column_dropOperation: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, info: ^NS.DraggingInfo, row: ^NS.Integer, column: ^NS.Integer, dropOperation: ^NS.BrowserDropOperation) -> NS.DragOperation,
    browser_acceptDrop_atRow_column_dropOperation: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, info: ^NS.DraggingInfo, row: NS.Integer, column: NS.Integer, dropOperation: NS.BrowserDropOperation) -> bool,
    browser_typeSelectStringForRow_inColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> ^NS.String,
    browser_shouldTypeSelectForEvent_withCurrentSearchString: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, event: ^NS.Event, searchString: ^NS.String) -> bool,
    browser_nextTypeSelectMatchFromRow_toRow_inColumn_forString: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, startRow: NS.Integer, endRow: NS.Integer, column: NS.Integer, searchString: ^NS.String) -> NS.Integer,
    browser_previewViewControllerForLeafItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> ^NS.ViewController,
    browser_headerViewControllerForItem: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, item: id) -> ^NS.ViewController,
    browser_didChangeLastColumn_toColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, oldLastColumn: NS.Integer, column: NS.Integer),
    browser_selectionIndexesForProposedSelection_inColumn: proc(self: ^NS.BrowserDelegate, browser: ^NS.Browser, proposedSelectionIndexes: ^NS.IndexSet, column: NS.Integer) -> ^NS.IndexSet,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.browser_numberOfRowsInColumn != nil {
        browser_numberOfRowsInColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, column: NS.Integer) -> NS.Integer {
    ...
    if vt.browser_createRowsForColumn_inMatrix != nil {
        browser_createRowsForColumn_inMatrix :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, column: NS.Integer, _matrix: ^NS.Matrix) {
    ...
    if vt.browser_numberOfChildrenOfItem != nil {
        browser_numberOfChildrenOfItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> NS.Integer {
    ...
    if vt.browser_child_ofItem != nil {
        browser_child_ofItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, index: NS.Integer, item: id) -> id {
    ...
    if vt.browser_isLeafItem != nil {
        browser_isLeafItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> bool {
    ...
    if vt.browser_objectValueForItem != nil {
        browser_objectValueForItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> id {
    ...
    if vt.browser_heightOfRow_inColumn != nil {
        browser_heightOfRow_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, row: NS.Integer, columnIndex: NS.Integer) -> CG.Float {
    ...
    if vt.rootItemForBrowser != nil {
        rootItemForBrowser :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser) -> id {
    ...
    if vt.browser_setObjectValue_forItem != nil {
        browser_setObjectValue_forItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, object: id, item: id) {
    ...
    if vt.browser_shouldEditItem != nil {
        browser_shouldEditItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> bool {
    ...
    if vt.browser_willDisplayCell_atRow_column != nil {
        browser_willDisplayCell_atRow_column :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, cell: id, row: NS.Integer, column: NS.Integer) {
    ...
    if vt.browser_titleOfColumn != nil {
        browser_titleOfColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, column: NS.Integer) -> ^NS.String {
    ...
    if vt.browser_selectCellWithString_inColumn != nil {
        browser_selectCellWithString_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, title: ^NS.String, column: NS.Integer) -> bool {
    ...
    if vt.browser_selectRow_inColumn != nil {
        browser_selectRow_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> bool {
    ...
    if vt.browser_isColumnValid != nil {
        browser_isColumnValid :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser, column: NS.Integer) -> bool {
    ...
    if vt.browserWillScroll != nil {
        browserWillScroll :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser) {
    ...
    if vt.browserDidScroll != nil {
        browserDidScroll :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, sender: ^NS.Browser) {
    ...
    if vt.browser_shouldSizeColumn_forUserResize_toWidth != nil {
        browser_shouldSizeColumn_forUserResize_toWidth :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, columnIndex: NS.Integer, forUserResize: bool, suggestedWidth: CG.Float) -> CG.Float {
    ...
    if vt.browser_sizeToFitWidthOfColumn != nil {
        browser_sizeToFitWidthOfColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, columnIndex: NS.Integer) -> CG.Float {
    ...
    if vt.browserColumnConfigurationDidChange != nil {
        browserColumnConfigurationDidChange :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, notification: ^NS.Notification) {
    ...
    if vt.browser_shouldShowCellExpansionForRow_column != nil {
        browser_shouldShowCellExpansionForRow_column :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> bool {
    ...
    if vt.browser_writeRowsWithIndexes_inColumn_toPasteboard != nil {
        browser_writeRowsWithIndexes_inColumn_toPasteboard :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, pasteboard: ^NS.Pasteboard) -> bool {
    ...
    if vt.browser_namesOfPromisedFilesDroppedAtDestination_forDraggedRowsWithIndexes_inColumn != nil {
        browser_namesOfPromisedFilesDroppedAtDestination_forDraggedRowsWithIndexes_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, dropDestination: ^NS.URL, rowIndexes: ^NS.IndexSet, column: NS.Integer) -> ^NS.Array {
    ...
    if vt.browser_canDragRowsWithIndexes_inColumn_withEvent != nil {
        browser_canDragRowsWithIndexes_inColumn_withEvent :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, event: ^NS.Event) -> bool {
    ...
    if vt.browser_draggingImageForRowsWithIndexes_inColumn_withEvent_offset != nil {
        browser_draggingImageForRowsWithIndexes_inColumn_withEvent_offset :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, rowIndexes: ^NS.IndexSet, column: NS.Integer, event: ^NS.Event, dragImageOffset: ^CG.Point) -> ^NS.Image {
    ...
    if vt.browser_validateDrop_proposedRow_column_dropOperation != nil {
        browser_validateDrop_proposedRow_column_dropOperation :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, info: ^NS.DraggingInfo, row: ^NS.Integer, column: ^NS.Integer, dropOperation: ^NS.BrowserDropOperation) -> NS.DragOperation {
    ...
    if vt.browser_acceptDrop_atRow_column_dropOperation != nil {
        browser_acceptDrop_atRow_column_dropOperation :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, info: ^NS.DraggingInfo, row: NS.Integer, column: NS.Integer, dropOperation: NS.BrowserDropOperation) -> bool {
    ...
    if vt.browser_typeSelectStringForRow_inColumn != nil {
        browser_typeSelectStringForRow_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, row: NS.Integer, column: NS.Integer) -> ^NS.String {
    ...
    if vt.browser_shouldTypeSelectForEvent_withCurrentSearchString != nil {
        browser_shouldTypeSelectForEvent_withCurrentSearchString :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, event: ^NS.Event, searchString: ^NS.String) -> bool {
    ...
    if vt.browser_nextTypeSelectMatchFromRow_toRow_inColumn_forString != nil {
        browser_nextTypeSelectMatchFromRow_toRow_inColumn_forString :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, startRow: NS.Integer, endRow: NS.Integer, column: NS.Integer, searchString: ^NS.String) -> NS.Integer {
    ...
    if vt.browser_previewViewControllerForLeafItem != nil {
        browser_previewViewControllerForLeafItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> ^NS.ViewController {
    ...
    if vt.browser_headerViewControllerForItem != nil {
        browser_headerViewControllerForItem :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, item: id) -> ^NS.ViewController {
    ...
    if vt.browser_didChangeLastColumn_toColumn != nil {
        browser_didChangeLastColumn_toColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, oldLastColumn: NS.Integer, column: NS.Integer) {
    ...
    if vt.browser_selectionIndexesForProposedSelection_inColumn != nil {
        browser_selectionIndexesForProposedSelection_inColumn :: proc "c" (self: ^NS.BrowserDelegate, _: SEL, browser: ^NS.Browser, proposedSelectionIndexes: ^NS.IndexSet, column: NS.Integer) -> ^NS.IndexSet {
