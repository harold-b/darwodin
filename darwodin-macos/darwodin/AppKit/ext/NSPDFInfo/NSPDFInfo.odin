...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.PDFInfo,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.PDFInfo,
    alloc: proc() -> ^AK.PDFInfo,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.PDFInfo {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.PDFInfo {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.PDFInfo {
