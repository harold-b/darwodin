...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.LevelIndicatorCell,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.LevelIndicatorCell,
    alloc: proc() -> ^AK.LevelIndicatorCell,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.LevelIndicatorCell {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.LevelIndicatorCell {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.LevelIndicatorCell {
