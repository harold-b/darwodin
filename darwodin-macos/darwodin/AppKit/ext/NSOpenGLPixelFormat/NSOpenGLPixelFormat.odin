...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.OpenGLPixelFormat,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.OpenGLPixelFormat,
    alloc: proc() -> ^AK.OpenGLPixelFormat,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.OpenGLPixelFormat {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.OpenGLPixelFormat {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.OpenGLPixelFormat {
