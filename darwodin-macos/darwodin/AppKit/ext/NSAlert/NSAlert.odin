...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Alert,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Alert,
    alloc: proc() -> ^AK.Alert,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Alert {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Alert {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Alert {
