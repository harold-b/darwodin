...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Movie,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Movie,
    alloc: proc() -> ^AK.Movie,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Movie {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Movie {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Movie {
