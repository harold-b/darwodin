...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.PredicateEditorRowTemplate,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.PredicateEditorRowTemplate,
    alloc: proc() -> ^AK.PredicateEditorRowTemplate,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.PredicateEditorRowTemplate {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.PredicateEditorRowTemplate {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.PredicateEditorRowTemplate {
