...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Drawer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Drawer,
    alloc: proc() -> ^AK.Drawer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Drawer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Drawer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Drawer {
