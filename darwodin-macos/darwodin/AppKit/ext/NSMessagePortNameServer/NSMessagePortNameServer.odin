...
VTable :: struct {
    ...
    portForName_: proc(self: ^AK.MessagePortNameServer, name: ^NS.String) -> ^NS.Port,
    portForName_host: proc(self: ^AK.MessagePortNameServer, name: ^NS.String, host: ^NS.String) -> ^NS.Port,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.portForName_ != nil {
        portForName_ :: proc "c" (self: ^AK.MessagePortNameServer, _: SEL, name: ^NS.String) -> ^NS.Port {
    ...
    if vt.portForName_host != nil {
        portForName_host :: proc "c" (self: ^AK.MessagePortNameServer, _: SEL, name: ^NS.String, host: ^NS.String) -> ^NS.Port {
