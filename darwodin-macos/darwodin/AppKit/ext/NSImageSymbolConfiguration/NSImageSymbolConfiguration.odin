...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ImageSymbolConfiguration,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ImageSymbolConfiguration,
    alloc: proc() -> ^AK.ImageSymbolConfiguration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ImageSymbolConfiguration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ImageSymbolConfiguration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ImageSymbolConfiguration {
