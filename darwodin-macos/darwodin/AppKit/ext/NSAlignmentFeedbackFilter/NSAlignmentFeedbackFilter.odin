...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.AlignmentFeedbackFilter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.AlignmentFeedbackFilter,
    alloc: proc() -> ^AK.AlignmentFeedbackFilter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.AlignmentFeedbackFilter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.AlignmentFeedbackFilter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.AlignmentFeedbackFilter {
