...
VTable :: struct {
    insertText: proc(self: ^NS.TextInput, string: id),
    doCommandBySelector: proc(self: ^NS.TextInput, selector: SEL),
    setMarkedText: proc(self: ^NS.TextInput, string: id, selRange: NS._NSRange),
    unmarkText: proc(self: ^NS.TextInput),
    hasMarkedText: proc(self: ^NS.TextInput) -> bool,
    conversationIdentifier: proc(self: ^NS.TextInput) -> NS.Integer,
    attributedSubstringFromRange: proc(self: ^NS.TextInput, range: NS._NSRange) -> ^NS.AttributedString,
    markedRange: proc(self: ^NS.TextInput) -> NS._NSRange,
    selectedRange: proc(self: ^NS.TextInput) -> NS._NSRange,
    firstRectForCharacterRange: proc(self: ^NS.TextInput, range: NS._NSRange) -> NS.Rect,
    characterIndexForPoint: proc(self: ^NS.TextInput, point: CG.Point) -> NS.UInteger,
    validAttributesForMarkedText: proc(self: ^NS.TextInput) -> ^NS.Array,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.insertText != nil {
        insertText :: proc "c" (self: ^NS.TextInput, _: SEL, string: id) {
    ...
    if vt.doCommandBySelector != nil {
        doCommandBySelector :: proc "c" (self: ^NS.TextInput, _: SEL, selector: SEL) {
    ...
    if vt.setMarkedText != nil {
        setMarkedText :: proc "c" (self: ^NS.TextInput, _: SEL, string: id, selRange: NS._NSRange) {
    ...
    if vt.unmarkText != nil {
        unmarkText :: proc "c" (self: ^NS.TextInput, _: SEL) {
    ...
    if vt.hasMarkedText != nil {
        hasMarkedText :: proc "c" (self: ^NS.TextInput, _: SEL) -> bool {
    ...
    if vt.conversationIdentifier != nil {
        conversationIdentifier :: proc "c" (self: ^NS.TextInput, _: SEL) -> NS.Integer {
    ...
    if vt.attributedSubstringFromRange != nil {
        attributedSubstringFromRange :: proc "c" (self: ^NS.TextInput, _: SEL, range: NS._NSRange) -> ^NS.AttributedString {
    ...
    if vt.markedRange != nil {
        markedRange :: proc "c" (self: ^NS.TextInput, _: SEL) -> NS._NSRange {
    ...
    if vt.selectedRange != nil {
        selectedRange :: proc "c" (self: ^NS.TextInput, _: SEL) -> NS._NSRange {
    ...
    if vt.firstRectForCharacterRange != nil {
        firstRectForCharacterRange :: proc "c" (self: ^NS.TextInput, _: SEL, range: NS._NSRange) -> NS.Rect {
    ...
    if vt.characterIndexForPoint != nil {
        characterIndexForPoint :: proc "c" (self: ^NS.TextInput, _: SEL, point: CG.Point) -> NS.UInteger {
    ...
    if vt.validAttributesForMarkedText != nil {
        validAttributesForMarkedText :: proc "c" (self: ^NS.TextInput, _: SEL) -> ^NS.Array {
