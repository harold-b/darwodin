...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.TextAttachment,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.TextAttachment,
    alloc: proc() -> ^AK.TextAttachment,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.TextAttachment {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.TextAttachment {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.TextAttachment {
