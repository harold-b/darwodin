...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Shadow,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Shadow,
    alloc: proc() -> ^AK.Shadow,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Shadow {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Shadow {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Shadow {
