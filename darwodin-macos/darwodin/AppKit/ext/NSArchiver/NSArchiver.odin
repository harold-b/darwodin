...
VTable :: struct {
    ...
    initForWritingWithMutableData: proc(self: ^AK.Archiver, mdata: ^NS.MutableData) -> ^AK.Archiver,
    encodeRootObject: proc(self: ^AK.Archiver, rootObject: id),
    encodeConditionalObject: proc(self: ^AK.Archiver, object: id),
    archivedDataWithRootObject: proc(rootObject: id) -> ^NS.Data,
    archiveRootObject: proc(rootObject: id, path: ^NS.String) -> bool,
    encodeClassName: proc(self: ^AK.Archiver, trueName: ^NS.String, inArchiveName: ^NS.String),
    classNameEncodedForTrueClassName: proc(self: ^AK.Archiver, trueName: ^NS.String) -> ^NS.String,
    replaceObject: proc(self: ^AK.Archiver, object: id, newObject: id),
    archiverData: proc(self: ^AK.Archiver) -> ^NS.MutableData,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initForWritingWithMutableData != nil {
        initForWritingWithMutableData :: proc "c" (self: ^AK.Archiver, _: SEL, mdata: ^NS.MutableData) -> ^AK.Archiver {
    ...
    if vt.encodeRootObject != nil {
        encodeRootObject :: proc "c" (self: ^AK.Archiver, _: SEL, rootObject: id) {
    ...
    if vt.encodeConditionalObject != nil {
        encodeConditionalObject :: proc "c" (self: ^AK.Archiver, _: SEL, object: id) {
    ...
    if vt.encodeClassName != nil {
        encodeClassName :: proc "c" (self: ^AK.Archiver, _: SEL, trueName: ^NS.String, inArchiveName: ^NS.String) {
    ...
    if vt.classNameEncodedForTrueClassName != nil {
        classNameEncodedForTrueClassName :: proc "c" (self: ^AK.Archiver, _: SEL, trueName: ^NS.String) -> ^NS.String {
    ...
    if vt.replaceObject != nil {
        replaceObject :: proc "c" (self: ^AK.Archiver, _: SEL, object: id, newObject: id) {
    ...
    if vt.archiverData != nil {
        archiverData :: proc "c" (self: ^AK.Archiver, _: SEL) -> ^NS.MutableData {
