...
VTable :: struct {
    ...
    comboButtonWithTitle_menu_target_action: proc(title: ^NS.String, menu: ^NS.Menu, target: id, action: SEL) -> instancetype,
    comboButtonWithImage: proc(image: ^NS.Image, menu: ^NS.Menu, target: id, action: SEL) -> instancetype,
    comboButtonWithTitle_image_menu_target_action: proc(title: ^NS.String, image: ^NS.Image, menu: ^NS.Menu, target: id, action: SEL) -> instancetype,
    title: proc(self: ^NS.ComboButton) -> ^NS.String,
    setTitle: proc(self: ^NS.ComboButton, title: ^NS.String),
    image: proc(self: ^NS.ComboButton) -> ^NS.Image,
    setImage: proc(self: ^NS.ComboButton, image: ^NS.Image),
    imageScaling: proc(self: ^NS.ComboButton) -> NS.ImageScaling,
    setImageScaling: proc(self: ^NS.ComboButton, imageScaling: NS.ImageScaling),
    menu: proc(self: ^NS.ComboButton) -> ^NS.Menu,
    setMenu: proc(self: ^NS.ComboButton, menu: ^NS.Menu),
    style: proc(self: ^NS.ComboButton) -> NS.ComboButtonStyle,
    setStyle: proc(self: ^NS.ComboButton, style: NS.ComboButtonStyle),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.comboButtonWithTitle_menu_target_action != nil {
        comboButtonWithTitle_menu_target_action :: proc "c" (self: Class, _: SEL, title: ^NS.String, menu: ^NS.Menu, target: id, action: SEL) -> instancetype {
    ...
    if vt.comboButtonWithImage != nil {
        comboButtonWithImage :: proc "c" (self: Class, _: SEL, image: ^NS.Image, menu: ^NS.Menu, target: id, action: SEL) -> instancetype {
    ...
    if vt.comboButtonWithTitle_image_menu_target_action != nil {
        comboButtonWithTitle_image_menu_target_action :: proc "c" (self: Class, _: SEL, title: ^NS.String, image: ^NS.Image, menu: ^NS.Menu, target: id, action: SEL) -> instancetype {
    ...
    if vt.title != nil {
        title :: proc "c" (self: ^NS.ComboButton, _: SEL) -> ^NS.String {
    ...
    if vt.setTitle != nil {
        setTitle :: proc "c" (self: ^NS.ComboButton, _: SEL, title: ^NS.String) {
    ...
    if vt.image != nil {
        image :: proc "c" (self: ^NS.ComboButton, _: SEL) -> ^NS.Image {
    ...
    if vt.setImage != nil {
        setImage :: proc "c" (self: ^NS.ComboButton, _: SEL, image: ^NS.Image) {
    ...
    if vt.imageScaling != nil {
        imageScaling :: proc "c" (self: ^NS.ComboButton, _: SEL) -> NS.ImageScaling {
    ...
    if vt.setImageScaling != nil {
        setImageScaling :: proc "c" (self: ^NS.ComboButton, _: SEL, imageScaling: NS.ImageScaling) {
    ...
    if vt.menu != nil {
        menu :: proc "c" (self: ^NS.ComboButton, _: SEL) -> ^NS.Menu {
    ...
    if vt.setMenu != nil {
        setMenu :: proc "c" (self: ^NS.ComboButton, _: SEL, menu: ^NS.Menu) {
    ...
    if vt.style != nil {
        style :: proc "c" (self: ^NS.ComboButton, _: SEL) -> NS.ComboButtonStyle {
    ...
    if vt.setStyle != nil {
        setStyle :: proc "c" (self: ^NS.ComboButton, _: SEL, style: NS.ComboButtonStyle) {
