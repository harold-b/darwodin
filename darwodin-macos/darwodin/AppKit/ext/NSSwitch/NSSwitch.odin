...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Switch,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Switch,
    alloc: proc() -> ^AK.Switch,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Switch {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Switch {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Switch {
