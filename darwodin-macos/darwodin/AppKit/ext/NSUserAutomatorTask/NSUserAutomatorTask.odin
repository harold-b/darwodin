...
VTable :: struct {
    ...
    executeWithInput: proc(self: ^AK.UserAutomatorTask, input: ^NS.SecureCoding, handler: AK.UserAutomatorTaskCompletionHandler),
    variables: proc(self: ^AK.UserAutomatorTask) -> ^NS.Dictionary,
    setVariables: proc(self: ^AK.UserAutomatorTask, variables: ^NS.Dictionary),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.executeWithInput != nil {
        executeWithInput :: proc "c" (self: ^AK.UserAutomatorTask, _: SEL, input: ^NS.SecureCoding, handler: AK.UserAutomatorTaskCompletionHandler) {
    ...
    if vt.variables != nil {
        variables :: proc "c" (self: ^AK.UserAutomatorTask, _: SEL) -> ^NS.Dictionary {
    ...
    if vt.setVariables != nil {
        setVariables :: proc "c" (self: ^AK.UserAutomatorTask, _: SEL, variables: ^NS.Dictionary) {
