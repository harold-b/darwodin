...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.CollectionViewLayoutInvalidationContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.CollectionViewLayoutInvalidationContext,
    alloc: proc() -> ^AK.CollectionViewLayoutInvalidationContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewLayoutInvalidationContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.CollectionViewLayoutInvalidationContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.CollectionViewLayoutInvalidationContext {
