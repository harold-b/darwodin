...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.AdaptiveImageGlyph,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.AdaptiveImageGlyph,
    alloc: proc() -> ^AK.AdaptiveImageGlyph,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.AdaptiveImageGlyph {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.AdaptiveImageGlyph {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.AdaptiveImageGlyph {
