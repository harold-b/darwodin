...
VTable :: struct {
    ...
    portForName_: proc(self: ^AK.SocketPortNameServer, name: ^NS.String) -> ^NS.Port,
    portForName_host: proc(self: ^AK.SocketPortNameServer, name: ^NS.String, host: ^NS.String) -> ^NS.Port,
    registerPort_name: proc(self: ^AK.SocketPortNameServer, port: ^NS.Port, name: ^NS.String) -> bool,
    removePortForName: proc(self: ^AK.SocketPortNameServer, name: ^NS.String) -> bool,
    portForName_host_nameServerPortNumber: proc(self: ^AK.SocketPortNameServer, name: ^NS.String, host: ^NS.String, portNumber: cffi.uint16_t) -> ^NS.Port,
    registerPort_name_nameServerPortNumber: proc(self: ^AK.SocketPortNameServer, port: ^NS.Port, name: ^NS.String, portNumber: cffi.uint16_t) -> bool,
    defaultNameServerPortNumber: proc(self: ^AK.SocketPortNameServer) -> cffi.uint16_t,
    setDefaultNameServerPortNumber: proc(self: ^AK.SocketPortNameServer, defaultNameServerPortNumber: cffi.uint16_t),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.portForName_ != nil {
        portForName_ :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, name: ^NS.String) -> ^NS.Port {
    ...
    if vt.portForName_host != nil {
        portForName_host :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, name: ^NS.String, host: ^NS.String) -> ^NS.Port {
    ...
    if vt.registerPort_name != nil {
        registerPort_name :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, port: ^NS.Port, name: ^NS.String) -> bool {
    ...
    if vt.removePortForName != nil {
        removePortForName :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, name: ^NS.String) -> bool {
    ...
    if vt.portForName_host_nameServerPortNumber != nil {
        portForName_host_nameServerPortNumber :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, name: ^NS.String, host: ^NS.String, portNumber: cffi.uint16_t) -> ^NS.Port {
    ...
    if vt.registerPort_name_nameServerPortNumber != nil {
        registerPort_name_nameServerPortNumber :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, port: ^NS.Port, name: ^NS.String, portNumber: cffi.uint16_t) -> bool {
    ...
    if vt.defaultNameServerPortNumber != nil {
        defaultNameServerPortNumber :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL) -> cffi.uint16_t {
    ...
    if vt.setDefaultNameServerPortNumber != nil {
        setDefaultNameServerPortNumber :: proc "c" (self: ^AK.SocketPortNameServer, _: SEL, defaultNameServerPortNumber: cffi.uint16_t) {
