...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.SliderAccessoryBehavior,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.SliderAccessoryBehavior,
    alloc: proc() -> ^AK.SliderAccessoryBehavior,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.SliderAccessoryBehavior {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.SliderAccessoryBehavior {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.SliderAccessoryBehavior {
