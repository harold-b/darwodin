package darwodin_NSScrubberSelectionView_Ext
...
import "../NSScrubberArrangedView"

VTable :: struct {
    super: NSScrubberArrangedView.VTable,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberSelectionView,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberSelectionView,
    alloc: proc() -> ^AK.ScrubberSelectionView,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    NSScrubberArrangedView.extend(cls, &vt.super)
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberSelectionView {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberSelectionView {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberSelectionView {
