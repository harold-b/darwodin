...
VTable :: struct {
    ...
    setSelectedFont: proc(self: ^NS.FontManager, fontObj: ^NS.Font, flag: bool),
    setFontMenu: proc(self: ^NS.FontManager, newMenu: ^NS.Menu),
    fontMenu: proc(self: ^NS.FontManager, create: bool) -> ^NS.Menu,
    fontPanel: proc(self: ^NS.FontManager, create: bool) -> ^NS.FontPanel,
    fontWithFamily: proc(self: ^NS.FontManager, family: ^NS.String, traits: NS.FontTraitMask, weight: NS.Integer, size: CG.Float) -> ^NS.Font,
    traitsOfFont: proc(self: ^NS.FontManager, fontObj: ^NS.Font) -> NS.FontTraitMask,
    weightOfFont: proc(self: ^NS.FontManager, fontObj: ^NS.Font) -> NS.Integer,
    availableMembersOfFontFamily: proc(self: ^NS.FontManager, fam: ^NS.String) -> ^NS.Array,
    convertFont_: proc(self: ^NS.FontManager, fontObj: ^NS.Font) -> ^NS.Font,
    convertFont_toSize: proc(self: ^NS.FontManager, fontObj: ^NS.Font, size: CG.Float) -> ^NS.Font,
    convertFont_toFace: proc(self: ^NS.FontManager, fontObj: ^NS.Font, typeface: ^NS.String) -> ^NS.Font,
    convertFont_toFamily: proc(self: ^NS.FontManager, fontObj: ^NS.Font, family: ^NS.String) -> ^NS.Font,
    convertFont_toHaveTrait: proc(self: ^NS.FontManager, fontObj: ^NS.Font, trait: NS.FontTraitMask) -> ^NS.Font,
    convertFont_toNotHaveTrait: proc(self: ^NS.FontManager, fontObj: ^NS.Font, trait: NS.FontTraitMask) -> ^NS.Font,
    convertWeight: proc(self: ^NS.FontManager, upFlag: bool, fontObj: ^NS.Font) -> ^NS.Font,
    sendAction: proc(self: ^NS.FontManager) -> bool,
    localizedNameForFamily: proc(self: ^NS.FontManager, family: ^NS.String, faceKey: ^NS.String) -> ^NS.String,
    setSelectedAttributes: proc(self: ^NS.FontManager, attributes: ^NS.Dictionary, flag: bool),
    convertAttributes: proc(self: ^NS.FontManager, attributes: ^NS.Dictionary) -> ^NS.Dictionary,
    availableFontNamesMatchingFontDescriptor: proc(self: ^NS.FontManager, descriptor: ^NS.FontDescriptor) -> ^NS.Array,
    fontDescriptorsInCollection: proc(self: ^NS.FontManager, collectionNames: ^NS.String) -> ^NS.Array,
    addCollection: proc(self: ^NS.FontManager, collectionName: ^NS.String, collectionOptions: NS.FontCollectionOptions) -> bool,
    removeCollection: proc(self: ^NS.FontManager, collectionName: ^NS.String) -> bool,
    addFontDescriptors: proc(self: ^NS.FontManager, descriptors: ^NS.Array, collectionName: ^NS.String),
    removeFontDescriptor: proc(self: ^NS.FontManager, descriptor: ^NS.FontDescriptor, collection: ^NS.String),
    convertFontTraits: proc(self: ^NS.FontManager, traits: NS.FontTraitMask) -> NS.FontTraitMask,
    sharedFontManager: proc() -> ^NS.FontManager,
    isMultiple: proc(self: ^NS.FontManager) -> bool,
    selectedFont: proc(self: ^NS.FontManager) -> ^NS.Font,
    availableFonts: proc(self: ^NS.FontManager) -> ^NS.Array,
    availableFontFamilies: proc(self: ^NS.FontManager) -> ^NS.Array,
    isEnabled: proc(self: ^NS.FontManager) -> bool,
    setEnabled: proc(self: ^NS.FontManager, enabled: bool),
    action: proc(self: ^NS.FontManager) -> SEL,
    setAction: proc(self: ^NS.FontManager, action: SEL),
    delegate: proc(self: ^NS.FontManager) -> id,
    setDelegate: proc(self: ^NS.FontManager, delegate: id),
    collectionNames: proc(self: ^NS.FontManager) -> ^NS.Array,
    currentFontAction: proc(self: ^NS.FontManager) -> NS.FontAction,
    target: proc(self: ^NS.FontManager) -> id,
    setTarget: proc(self: ^NS.FontManager, target: id),
    fontNamed: proc(self: ^NS.FontManager, fName: ^NS.String, someTraits: NS.FontTraitMask) -> bool,
    availableFontNamesWithTraits: proc(self: ^NS.FontManager, someTraits: NS.FontTraitMask) -> ^NS.Array,
    addFontTrait: proc(self: ^NS.FontManager, sender: id),
    removeFontTrait: proc(self: ^NS.FontManager, sender: id),
    modifyFontViaPanel: proc(self: ^NS.FontManager, sender: id),
    modifyFont: proc(self: ^NS.FontManager, sender: id),
    orderFrontFontPanel: proc(self: ^NS.FontManager, sender: id),
    orderFrontStylesPanel: proc(self: ^NS.FontManager, sender: id),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.setSelectedFont != nil {
        setSelectedFont :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, flag: bool) {
    ...
    if vt.setFontMenu != nil {
        setFontMenu :: proc "c" (self: ^NS.FontManager, _: SEL, newMenu: ^NS.Menu) {
    ...
    if vt.fontMenu != nil {
        fontMenu :: proc "c" (self: ^NS.FontManager, _: SEL, create: bool) -> ^NS.Menu {
    ...
    if vt.fontPanel != nil {
        fontPanel :: proc "c" (self: ^NS.FontManager, _: SEL, create: bool) -> ^NS.FontPanel {
    ...
    if vt.fontWithFamily != nil {
        fontWithFamily :: proc "c" (self: ^NS.FontManager, _: SEL, family: ^NS.String, traits: NS.FontTraitMask, weight: NS.Integer, size: CG.Float) -> ^NS.Font {
    ...
    if vt.traitsOfFont != nil {
        traitsOfFont :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font) -> NS.FontTraitMask {
    ...
    if vt.weightOfFont != nil {
        weightOfFont :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font) -> NS.Integer {
    ...
    if vt.availableMembersOfFontFamily != nil {
        availableMembersOfFontFamily :: proc "c" (self: ^NS.FontManager, _: SEL, fam: ^NS.String) -> ^NS.Array {
    ...
    if vt.convertFont_ != nil {
        convertFont_ :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font) -> ^NS.Font {
    ...
    if vt.convertFont_toSize != nil {
        convertFont_toSize :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, size: CG.Float) -> ^NS.Font {
    ...
    if vt.convertFont_toFace != nil {
        convertFont_toFace :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, typeface: ^NS.String) -> ^NS.Font {
    ...
    if vt.convertFont_toFamily != nil {
        convertFont_toFamily :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, family: ^NS.String) -> ^NS.Font {
    ...
    if vt.convertFont_toHaveTrait != nil {
        convertFont_toHaveTrait :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, trait: NS.FontTraitMask) -> ^NS.Font {
    ...
    if vt.convertFont_toNotHaveTrait != nil {
        convertFont_toNotHaveTrait :: proc "c" (self: ^NS.FontManager, _: SEL, fontObj: ^NS.Font, trait: NS.FontTraitMask) -> ^NS.Font {
    ...
    if vt.convertWeight != nil {
        convertWeight :: proc "c" (self: ^NS.FontManager, _: SEL, upFlag: bool, fontObj: ^NS.Font) -> ^NS.Font {
    ...
    if vt.sendAction != nil {
        sendAction :: proc "c" (self: ^NS.FontManager, _: SEL) -> bool {
    ...
    if vt.localizedNameForFamily != nil {
        localizedNameForFamily :: proc "c" (self: ^NS.FontManager, _: SEL, family: ^NS.String, faceKey: ^NS.String) -> ^NS.String {
    ...
    if vt.setSelectedAttributes != nil {
        setSelectedAttributes :: proc "c" (self: ^NS.FontManager, _: SEL, attributes: ^NS.Dictionary, flag: bool) {
    ...
    if vt.convertAttributes != nil {
        convertAttributes :: proc "c" (self: ^NS.FontManager, _: SEL, attributes: ^NS.Dictionary) -> ^NS.Dictionary {
    ...
    if vt.availableFontNamesMatchingFontDescriptor != nil {
        availableFontNamesMatchingFontDescriptor :: proc "c" (self: ^NS.FontManager, _: SEL, descriptor: ^NS.FontDescriptor) -> ^NS.Array {
    ...
    if vt.fontDescriptorsInCollection != nil {
        fontDescriptorsInCollection :: proc "c" (self: ^NS.FontManager, _: SEL, collectionNames: ^NS.String) -> ^NS.Array {
    ...
    if vt.addCollection != nil {
        addCollection :: proc "c" (self: ^NS.FontManager, _: SEL, collectionName: ^NS.String, collectionOptions: NS.FontCollectionOptions) -> bool {
    ...
    if vt.removeCollection != nil {
        removeCollection :: proc "c" (self: ^NS.FontManager, _: SEL, collectionName: ^NS.String) -> bool {
    ...
    if vt.addFontDescriptors != nil {
        addFontDescriptors :: proc "c" (self: ^NS.FontManager, _: SEL, descriptors: ^NS.Array, collectionName: ^NS.String) {
    ...
    if vt.removeFontDescriptor != nil {
        removeFontDescriptor :: proc "c" (self: ^NS.FontManager, _: SEL, descriptor: ^NS.FontDescriptor, collection: ^NS.String) {
    ...
    if vt.convertFontTraits != nil {
        convertFontTraits :: proc "c" (self: ^NS.FontManager, _: SEL, traits: NS.FontTraitMask) -> NS.FontTraitMask {
    ...
    if vt.sharedFontManager != nil {
        sharedFontManager :: proc "c" (self: Class, _: SEL) -> ^NS.FontManager {
    ...
    if vt.isMultiple != nil {
        isMultiple :: proc "c" (self: ^NS.FontManager, _: SEL) -> bool {
    ...
    if vt.selectedFont != nil {
        selectedFont :: proc "c" (self: ^NS.FontManager, _: SEL) -> ^NS.Font {
    ...
    if vt.availableFonts != nil {
        availableFonts :: proc "c" (self: ^NS.FontManager, _: SEL) -> ^NS.Array {
    ...
    if vt.availableFontFamilies != nil {
        availableFontFamilies :: proc "c" (self: ^NS.FontManager, _: SEL) -> ^NS.Array {
    ...
    if vt.isEnabled != nil {
        isEnabled :: proc "c" (self: ^NS.FontManager, _: SEL) -> bool {
    ...
    if vt.setEnabled != nil {
        setEnabled :: proc "c" (self: ^NS.FontManager, _: SEL, enabled: bool) {
    ...
    if vt.action != nil {
        action :: proc "c" (self: ^NS.FontManager, _: SEL) -> SEL {
    ...
    if vt.setAction != nil {
        setAction :: proc "c" (self: ^NS.FontManager, _: SEL, action: SEL) {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^NS.FontManager, _: SEL) -> id {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^NS.FontManager, _: SEL, delegate: id) {
    ...
    if vt.collectionNames != nil {
        collectionNames :: proc "c" (self: ^NS.FontManager, _: SEL) -> ^NS.Array {
    ...
    if vt.currentFontAction != nil {
        currentFontAction :: proc "c" (self: ^NS.FontManager, _: SEL) -> NS.FontAction {
    ...
    if vt.target != nil {
        target :: proc "c" (self: ^NS.FontManager, _: SEL) -> id {
    ...
    if vt.setTarget != nil {
        setTarget :: proc "c" (self: ^NS.FontManager, _: SEL, target: id) {
    ...
    if vt.fontNamed != nil {
        fontNamed :: proc "c" (self: ^NS.FontManager, _: SEL, fName: ^NS.String, someTraits: NS.FontTraitMask) -> bool {
    ...
    if vt.availableFontNamesWithTraits != nil {
        availableFontNamesWithTraits :: proc "c" (self: ^NS.FontManager, _: SEL, someTraits: NS.FontTraitMask) -> ^NS.Array {
    ...
    if vt.addFontTrait != nil {
        addFontTrait :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
    ...
    if vt.removeFontTrait != nil {
        removeFontTrait :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
    ...
    if vt.modifyFontViaPanel != nil {
        modifyFontViaPanel :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
    ...
    if vt.modifyFont != nil {
        modifyFont :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
    ...
    if vt.orderFrontFontPanel != nil {
        orderFrontFontPanel :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
    ...
    if vt.orderFrontStylesPanel != nil {
        orderFrontStylesPanel :: proc "c" (self: ^NS.FontManager, _: SEL, sender: id) {
