...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Box,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Box,
    alloc: proc() -> ^AK.Box,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Box {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Box {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Box {
