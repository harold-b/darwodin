...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberFlowLayout,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberFlowLayout,
    alloc: proc() -> ^AK.ScrubberFlowLayout,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberFlowLayout {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberFlowLayout {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberFlowLayout {
