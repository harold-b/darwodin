...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.AccessibilityCustomAction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.AccessibilityCustomAction,
    alloc: proc() -> ^AK.AccessibilityCustomAction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.AccessibilityCustomAction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.AccessibilityCustomAction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.AccessibilityCustomAction {
