...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.StepperTouchBarItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.StepperTouchBarItem,
    alloc: proc() -> ^AK.StepperTouchBarItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.StepperTouchBarItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.StepperTouchBarItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.StepperTouchBarItem {
