...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.ScrubberSelectionStyle,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.ScrubberSelectionStyle,
    alloc: proc() -> ^AK.ScrubberSelectionStyle,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberSelectionStyle {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.ScrubberSelectionStyle {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.ScrubberSelectionStyle {
