...
VTable :: struct {
    ...
    isCollecting: proc(self: ^AK.GarbageCollector) -> bool,
    disable: proc(self: ^AK.GarbageCollector),
    enable: proc(self: ^AK.GarbageCollector),
    isEnabled: proc(self: ^AK.GarbageCollector) -> bool,
    collectIfNeeded: proc(self: ^AK.GarbageCollector),
    collectExhaustively: proc(self: ^AK.GarbageCollector),
    disableCollectorForPointer: proc(self: ^AK.GarbageCollector, ptr: rawptr),
    enableCollectorForPointer: proc(self: ^AK.GarbageCollector, ptr: rawptr),
    zone: proc(self: ^AK.GarbageCollector) -> ^NS.Zone,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.isCollecting != nil {
        isCollecting :: proc "c" (self: ^AK.GarbageCollector, _: SEL) -> bool {
    ...
    if vt.disable != nil {
        disable :: proc "c" (self: ^AK.GarbageCollector, _: SEL) {
    ...
    if vt.enable != nil {
        enable :: proc "c" (self: ^AK.GarbageCollector, _: SEL) {
    ...
    if vt.isEnabled != nil {
        isEnabled :: proc "c" (self: ^AK.GarbageCollector, _: SEL) -> bool {
    ...
    if vt.collectIfNeeded != nil {
        collectIfNeeded :: proc "c" (self: ^AK.GarbageCollector, _: SEL) {
    ...
    if vt.collectExhaustively != nil {
        collectExhaustively :: proc "c" (self: ^AK.GarbageCollector, _: SEL) {
    ...
    if vt.disableCollectorForPointer != nil {
        disableCollectorForPointer :: proc "c" (self: ^AK.GarbageCollector, _: SEL, ptr: rawptr) {
    ...
    if vt.enableCollectorForPointer != nil {
        enableCollectorForPointer :: proc "c" (self: ^AK.GarbageCollector, _: SEL, ptr: rawptr) {
    ...
    if vt.zone != nil {
        zone :: proc "c" (self: ^AK.GarbageCollector, _: SEL) -> ^NS.Zone {
