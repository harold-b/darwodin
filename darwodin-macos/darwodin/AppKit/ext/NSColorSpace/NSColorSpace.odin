...
VTable :: struct {
    ...
    initWithICCProfileData: proc(self: ^NS.ColorSpace, iccData: ^NS.Data) -> instancetype,
    initWithColorSyncProfile: proc(self: ^NS.ColorSpace, prof: rawptr) -> instancetype,
    initWithCGColorSpace: proc(self: ^NS.ColorSpace, cgColorSpace: CG.ColorSpaceRef) -> instancetype,
    availableColorSpacesWithModel: proc(model: NS.ColorSpaceModel) -> ^NS.Array,
    _ICCProfileData: proc(self: ^NS.ColorSpace) -> ^NS.Data,
    colorSyncProfile: proc(self: ^NS.ColorSpace) -> rawptr,
    _CGColorSpace: proc(self: ^NS.ColorSpace) -> CG.ColorSpaceRef,
    numberOfColorComponents: proc(self: ^NS.ColorSpace) -> NS.Integer,
    colorSpaceModel: proc(self: ^NS.ColorSpace) -> NS.ColorSpaceModel,
    localizedName: proc(self: ^NS.ColorSpace) -> ^NS.String,
    sRGBColorSpace: proc() -> ^NS.ColorSpace,
    genericGamma22GrayColorSpace: proc() -> ^NS.ColorSpace,
    extendedSRGBColorSpace: proc() -> ^NS.ColorSpace,
    extendedGenericGamma22GrayColorSpace: proc() -> ^NS.ColorSpace,
    displayP3ColorSpace: proc() -> ^NS.ColorSpace,
    adobeRGB1998ColorSpace: proc() -> ^NS.ColorSpace,
    genericRGBColorSpace: proc() -> ^NS.ColorSpace,
    genericGrayColorSpace: proc() -> ^NS.ColorSpace,
    genericCMYKColorSpace: proc() -> ^NS.ColorSpace,
    deviceRGBColorSpace: proc() -> ^NS.ColorSpace,
    deviceGrayColorSpace: proc() -> ^NS.ColorSpace,
    deviceCMYKColorSpace: proc() -> ^NS.ColorSpace,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithICCProfileData != nil {
        initWithICCProfileData :: proc "c" (self: ^NS.ColorSpace, _: SEL, iccData: ^NS.Data) -> instancetype {
    ...
    if vt.initWithColorSyncProfile != nil {
        initWithColorSyncProfile :: proc "c" (self: ^NS.ColorSpace, _: SEL, prof: rawptr) -> instancetype {
    ...
    if vt.initWithCGColorSpace != nil {
        initWithCGColorSpace :: proc "c" (self: ^NS.ColorSpace, _: SEL, cgColorSpace: CG.ColorSpaceRef) -> instancetype {
    ...
    if vt.availableColorSpacesWithModel != nil {
        availableColorSpacesWithModel :: proc "c" (self: Class, _: SEL, model: NS.ColorSpaceModel) -> ^NS.Array {
    ...
    if vt._ICCProfileData != nil {
        _ICCProfileData :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> ^NS.Data {
    ...
    if vt.colorSyncProfile != nil {
        colorSyncProfile :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> rawptr {
    ...
    if vt._CGColorSpace != nil {
        _CGColorSpace :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> CG.ColorSpaceRef {
    ...
    if vt.numberOfColorComponents != nil {
        numberOfColorComponents :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> NS.Integer {
    ...
    if vt.colorSpaceModel != nil {
        colorSpaceModel :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> NS.ColorSpaceModel {
    ...
    if vt.localizedName != nil {
        localizedName :: proc "c" (self: ^NS.ColorSpace, _: SEL) -> ^NS.String {
    ...
    if vt.sRGBColorSpace != nil {
        sRGBColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.genericGamma22GrayColorSpace != nil {
        genericGamma22GrayColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.extendedSRGBColorSpace != nil {
        extendedSRGBColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.extendedGenericGamma22GrayColorSpace != nil {
        extendedGenericGamma22GrayColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.displayP3ColorSpace != nil {
        displayP3ColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.adobeRGB1998ColorSpace != nil {
        adobeRGB1998ColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.genericRGBColorSpace != nil {
        genericRGBColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.genericGrayColorSpace != nil {
        genericGrayColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.genericCMYKColorSpace != nil {
        genericCMYKColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.deviceRGBColorSpace != nil {
        deviceRGBColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.deviceGrayColorSpace != nil {
        deviceGrayColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
    ...
    if vt.deviceCMYKColorSpace != nil {
        deviceCMYKColorSpace :: proc "c" (self: Class, _: SEL) -> ^NS.ColorSpace {
