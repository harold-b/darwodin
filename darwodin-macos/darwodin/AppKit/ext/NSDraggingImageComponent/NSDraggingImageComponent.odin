...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.DraggingImageComponent,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.DraggingImageComponent,
    alloc: proc() -> ^AK.DraggingImageComponent,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.DraggingImageComponent {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.DraggingImageComponent {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.DraggingImageComponent {
