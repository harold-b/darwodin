...
VTable :: struct {
    ...
    initWithRequest: proc(self: ^AK.URLDownload, request: ^NS.URLRequest, delegate: ^AK.URLDownloadDelegate) -> ^AK.URLDownload,
    initWithResumeData: proc(self: ^AK.URLDownload, resumeData: ^NS.Data, delegate: ^AK.URLDownloadDelegate, path: ^NS.String) -> ^AK.URLDownload,
    cancel: proc(self: ^AK.URLDownload),
    setDestination: proc(self: ^AK.URLDownload, path: ^NS.String, allowOverwrite: bool),
    request: proc(self: ^AK.URLDownload) -> ^NS.URLRequest,
    resumeData: proc(self: ^AK.URLDownload) -> ^NS.Data,
    deletesFileUponFailure: proc(self: ^AK.URLDownload) -> bool,
    setDeletesFileUponFailure: proc(self: ^AK.URLDownload, deletesFileUponFailure: bool),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithRequest != nil {
        initWithRequest :: proc "c" (self: ^AK.URLDownload, _: SEL, request: ^NS.URLRequest, delegate: ^AK.URLDownloadDelegate) -> ^AK.URLDownload {
    ...
    if vt.initWithResumeData != nil {
        initWithResumeData :: proc "c" (self: ^AK.URLDownload, _: SEL, resumeData: ^NS.Data, delegate: ^AK.URLDownloadDelegate, path: ^NS.String) -> ^AK.URLDownload {
    ...
    if vt.cancel != nil {
        cancel :: proc "c" (self: ^AK.URLDownload, _: SEL) {
    ...
    if vt.setDestination != nil {
        setDestination :: proc "c" (self: ^AK.URLDownload, _: SEL, path: ^NS.String, allowOverwrite: bool) {
    ...
    if vt.request != nil {
        request :: proc "c" (self: ^AK.URLDownload, _: SEL) -> ^NS.URLRequest {
    ...
    if vt.resumeData != nil {
        resumeData :: proc "c" (self: ^AK.URLDownload, _: SEL) -> ^NS.Data {
    ...
    if vt.deletesFileUponFailure != nil {
        deletesFileUponFailure :: proc "c" (self: ^AK.URLDownload, _: SEL) -> bool {
    ...
    if vt.setDeletesFileUponFailure != nil {
        setDeletesFileUponFailure :: proc "c" (self: ^AK.URLDownload, _: SEL, deletesFileUponFailure: bool) {
