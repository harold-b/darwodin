...
VTable :: struct {
    ...
    registerClassDescription: proc(description: ^AK.ClassDescription, aClass: Class),
    invalidateClassDescriptionCache: proc(),
    classDescriptionForClass: proc(aClass: Class) -> ^AK.ClassDescription,
    inverseForRelationshipKey: proc(self: ^AK.ClassDescription, relationshipKey: ^NS.String) -> ^NS.String,
    attributeKeys: proc(self: ^AK.ClassDescription) -> ^NS.Array,
    toOneRelationshipKeys: proc(self: ^AK.ClassDescription) -> ^NS.Array,
    toManyRelationshipKeys: proc(self: ^AK.ClassDescription) -> ^NS.Array,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.registerClassDescription != nil {
        registerClassDescription :: proc "c" (self: Class, _: SEL, description: ^AK.ClassDescription, aClass: Class) {
    ...
    if vt.classDescriptionForClass != nil {
        classDescriptionForClass :: proc "c" (self: Class, _: SEL, aClass: Class) -> ^AK.ClassDescription {
    ...
    if vt.inverseForRelationshipKey != nil {
        inverseForRelationshipKey :: proc "c" (self: ^AK.ClassDescription, _: SEL, relationshipKey: ^NS.String) -> ^NS.String {
    ...
    if vt.attributeKeys != nil {
        attributeKeys :: proc "c" (self: ^AK.ClassDescription, _: SEL) -> ^NS.Array {
    ...
    if vt.toOneRelationshipKeys != nil {
        toOneRelationshipKeys :: proc "c" (self: ^AK.ClassDescription, _: SEL) -> ^NS.Array {
    ...
    if vt.toManyRelationshipKeys != nil {
        toManyRelationshipKeys :: proc "c" (self: ^AK.ClassDescription, _: SEL) -> ^NS.Array {
