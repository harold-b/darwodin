...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.TextInsertionIndicator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.TextInsertionIndicator,
    alloc: proc() -> ^AK.TextInsertionIndicator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.TextInsertionIndicator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.TextInsertionIndicator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.TextInsertionIndicator {
