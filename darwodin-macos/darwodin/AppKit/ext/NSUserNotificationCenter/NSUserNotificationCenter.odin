...
VTable :: struct {
    ...
    scheduleNotification: proc(self: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    removeScheduledNotification: proc(self: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    deliverNotification: proc(self: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    removeDeliveredNotification: proc(self: ^AK.UserNotificationCenter, notification: ^AK.UserNotification),
    removeAllDeliveredNotifications: proc(self: ^AK.UserNotificationCenter),
    defaultUserNotificationCenter: proc() -> ^AK.UserNotificationCenter,
    delegate: proc(self: ^AK.UserNotificationCenter) -> ^AK.UserNotificationCenterDelegate,
    setDelegate: proc(self: ^AK.UserNotificationCenter, delegate: ^AK.UserNotificationCenterDelegate),
    scheduledNotifications: proc(self: ^AK.UserNotificationCenter) -> ^NS.Array,
    setScheduledNotifications: proc(self: ^AK.UserNotificationCenter, scheduledNotifications: ^NS.Array),
    deliveredNotifications: proc(self: ^AK.UserNotificationCenter) -> ^NS.Array,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.scheduleNotification != nil {
        scheduleNotification :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, notification: ^AK.UserNotification) {
    ...
    if vt.removeScheduledNotification != nil {
        removeScheduledNotification :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, notification: ^AK.UserNotification) {
    ...
    if vt.deliverNotification != nil {
        deliverNotification :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, notification: ^AK.UserNotification) {
    ...
    if vt.removeDeliveredNotification != nil {
        removeDeliveredNotification :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, notification: ^AK.UserNotification) {
    ...
    if vt.removeAllDeliveredNotifications != nil {
        removeAllDeliveredNotifications :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL) {
    ...
    if vt.defaultUserNotificationCenter != nil {
        defaultUserNotificationCenter :: proc "c" (self: Class, _: SEL) -> ^AK.UserNotificationCenter {
    ...
    if vt.delegate != nil {
        delegate :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL) -> ^AK.UserNotificationCenterDelegate {
    ...
    if vt.setDelegate != nil {
        setDelegate :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, delegate: ^AK.UserNotificationCenterDelegate) {
    ...
    if vt.scheduledNotifications != nil {
        scheduledNotifications :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL) -> ^NS.Array {
    ...
    if vt.setScheduledNotifications != nil {
        setScheduledNotifications :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL, scheduledNotifications: ^NS.Array) {
    ...
    if vt.deliveredNotifications != nil {
        deliveredNotifications :: proc "c" (self: ^AK.UserNotificationCenter, _: SEL) -> ^NS.Array {
