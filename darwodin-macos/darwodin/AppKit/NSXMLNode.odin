...
/// NSXMLNode
///
@(objc_class="NSXMLNode", objc_superclass=NS.Object)
...
foreign lib {
    ...
    XMLNode_elementWithName_ :: proc(name: ^NS.String) -> id ---

    @(objc_type=XMLNode, objc_selector="elementWithName:URI:", objc_name="elementWithName_URI", objc_is_class_method=true)
    XMLNode_elementWithName_URI :: proc(name: ^NS.String, URI: ^NS.String) -> id ---
    ...
    XMLNode_elementWithName_stringValue :: proc(name: ^NS.String, string: ^NS.String) -> id ---
    ...
    XMLNode_elementWithName_children_attributes :: proc(name: ^NS.String, children: ^NS.Array, attributes: ^NS.Array) -> id ---
    ...
    XMLNode_attributeWithName_stringValue :: proc(name: ^NS.String, stringValue: ^NS.String) -> id ---
    ...
    XMLNode_attributeWithName_URI_stringValue :: proc(name: ^NS.String, URI: ^NS.String, stringValue: ^NS.String) -> id ---

    @(objc_type=XMLNode, objc_selector="namespaceWithName:stringValue:", objc_name="namespaceWithName", objc_is_class_method=true)
    XMLNode_namespaceWithName :: proc(name: ^NS.String, stringValue: ^NS.String) -> id ---
    ...
    XMLNode_localNameForName :: proc(name: ^NS.String) -> ^NS.String ---

    @(objc_type=XMLNode, objc_selector="prefixForName:", objc_name="prefixForName", objc_is_class_method=true)
    XMLNode_prefixForName :: proc(name: ^NS.String) -> ^NS.String ---
    ...
    XMLNode_predefinedNamespaceForPrefix :: proc(name: ^NS.String) -> ^XMLNode ---

    @(objc_type=XMLNode, objc_selector="XMLStringWithOptions:", objc_name="XMLStringWithOptions")
    XMLNode_XMLStringWithOptions :: proc(self: ^XMLNode, options: XMLNodeOptions) -> ^NS.String ---

    @(objc_type=XMLNode, objc_selector="canonicalXMLStringPreservingComments:", objc_name="canonicalXMLStringPreservingComments")
    XMLNode_canonicalXMLStringPreservingComments :: proc(self: ^XMLNode, comments: bool) -> ^NS.String ---

    @(objc_type=XMLNode, objc_selector="nodesForXPath:error:", objc_name="nodesForXPath")
    XMLNode_nodesForXPath :: proc(self: ^XMLNode, xpath: ^NS.String, error: ^^NS.Error) -> ^NS.Array ---

    @(objc_type=XMLNode, objc_selector="objectsForXQuery:constants:error:", objc_name="objectsForXQuery_constants_error")
    XMLNode_objectsForXQuery_constants_error :: proc(self: ^XMLNode, xquery: ^NS.String, constants: ^NS.Dictionary, error: ^^NS.Error) -> ^NS.Array ---

    @(objc_type=XMLNode, objc_selector="objectsForXQuery:error:", objc_name="objectsForXQuery_error")
    XMLNode_objectsForXQuery_error :: proc(self: ^XMLNode, xquery: ^NS.String, error: ^^NS.Error) -> ^NS.Array ---
    ...
    XMLNode_name :: proc(self: ^XMLNode) -> ^NS.String ---

    @(objc_type=XMLNode, objc_selector="setName:", objc_name="setName")
    XMLNode_setName :: proc(self: ^XMLNode, name: ^NS.String) ---
    ...
    XMLNode_stringValue :: proc(self: ^XMLNode) -> ^NS.String ---

    @(objc_type=XMLNode, objc_selector="setStringValue:", objc_name="setStringValue_")
    XMLNode_setStringValue_ :: proc(self: ^XMLNode, stringValue: ^NS.String) ---

    @(objc_type=XMLNode, objc_selector="index", objc_name="index")
    XMLNode_index :: proc(self: ^XMLNode) -> NS.UInteger ---

    @(objc_type=XMLNode, objc_selector="level", objc_name="level")
    XMLNode_level :: proc(self: ^XMLNode) -> NS.UInteger ---
    ...
    XMLNode_childCount :: proc(self: ^XMLNode) -> NS.UInteger ---

    @(objc_type=XMLNode, objc_selector="children", objc_name="children")
    XMLNode_children :: proc(self: ^XMLNode) -> ^NS.Array ---
