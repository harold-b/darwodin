...
ProtocolChecker_target :: #force_inline proc "c" (self: ^ProtocolChecker) -> ^NS.Object {
    return msgSend(^NS.Object, self, "target")
}
@(objc_type=ProtocolChecker, objc_name="protocolCheckerWithTarget", objc_is_class_method=true)
ProtocolChecker_protocolCheckerWithTarget :: #force_inline proc "c" (anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker {
...
ProtocolChecker_initWithTarget :: #force_inline proc "c" (self: ^ProtocolChecker, anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker {
...
ProtocolChecker_allocWithZone :: #force_inline proc "c" (zone: ^NS.Zone) -> ^ProtocolChecker {
...
ProtocolChecker_VTable :: struct {
    ...
    target: proc(self: ^ProtocolChecker) -> ^NS.Object,
    protocolCheckerWithTarget: proc(anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker,
    initWithTarget: proc(self: ^ProtocolChecker, anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker,
    alloc: proc() -> ^ProtocolChecker,
    allocWithZone: proc(zone: ^NS.Zone) -> ^ProtocolChecker,
    class: proc() -> Class,
...
ProtocolChecker_odin_extend :: proc(cls: Class, vt: ^ProtocolChecker_VTable) {
    ...
    if vt.target != nil {
        target :: proc "c" (self: ^ProtocolChecker, _: SEL) -> ^NS.Object {
    ...
    if vt.protocolCheckerWithTarget != nil {
        protocolCheckerWithTarget :: proc "c" (self: Class, _: SEL, anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker {
    ...
    if vt.initWithTarget != nil {
        initWithTarget :: proc "c" (self: ^ProtocolChecker, _: SEL, anObject: ^NS.Object, aProtocol: ^Protocol) -> ^ProtocolChecker {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS.Zone) -> ^ProtocolChecker {
