...
foreign lib {
    ...
    XMLDTDNode_initWithXMLString :: proc(self: ^XMLDTDNode, string: ^NS.String) -> ^XMLDTDNode ---
    ...
    XMLDTDNode_publicID :: proc(self: ^XMLDTDNode) -> ^NS.String ---

    @(objc_type=XMLDTDNode, objc_selector="setPublicID:", objc_name="setPublicID")
    XMLDTDNode_setPublicID :: proc(self: ^XMLDTDNode, publicID: ^NS.String) ---

    @(objc_type=XMLDTDNode, objc_selector="systemID", objc_name="systemID")
    XMLDTDNode_systemID :: proc(self: ^XMLDTDNode) -> ^NS.String ---

    @(objc_type=XMLDTDNode, objc_selector="setSystemID:", objc_name="setSystemID")
    XMLDTDNode_setSystemID :: proc(self: ^XMLDTDNode, systemID: ^NS.String) ---

    @(objc_type=XMLDTDNode, objc_selector="notationName", objc_name="notationName")
    XMLDTDNode_notationName :: proc(self: ^XMLDTDNode) -> ^NS.String ---

    @(objc_type=XMLDTDNode, objc_selector="setNotationName:", objc_name="setNotationName")
    XMLDTDNode_setNotationName :: proc(self: ^XMLDTDNode, notationName: ^NS.String) ---
}
