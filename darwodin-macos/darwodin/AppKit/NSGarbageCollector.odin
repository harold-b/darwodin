...
GarbageCollector_zone :: #force_inline proc "c" (self: ^GarbageCollector) -> ^NS.Zone {
    return msgSend(^NS.Zone, self, "zone")
}
...
GarbageCollector_allocWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> ^GarbageCollector {
...
GarbageCollector_copyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
GarbageCollector_mutableCopyWithZone :: #force_inline proc "c" (zone: ^NS._NSZone) -> id {
...
GarbageCollector_instanceMethodSignatureForSelector :: #force_inline proc "c" (aSelector: SEL) -> ^NS.MethodSignature {
    return msgSend(^NS.MethodSignature, GarbageCollector, "instanceMethodSignatureForSelector:", aSelector)
}
...
GarbageCollector_hash :: #force_inline proc "c" () -> NS.UInteger {
    return msgSend(NS.UInteger, GarbageCollector, "hash")
}
...
GarbageCollector_description :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, GarbageCollector, "description")
}
@(objc_type=GarbageCollector, objc_name="debugDescription", objc_is_class_method=true)
GarbageCollector_debugDescription :: #force_inline proc "c" () -> ^NS.String {
    return msgSend(^NS.String, GarbageCollector, "debugDescription")
}
@(objc_type=GarbageCollector, objc_name="version", objc_is_class_method=true)
GarbageCollector_version :: #force_inline proc "c" () -> NS.Integer {
    return msgSend(NS.Integer, GarbageCollector, "version")
}
@(objc_type=GarbageCollector, objc_name="setVersion", objc_is_class_method=true)
GarbageCollector_setVersion :: #force_inline proc "c" (aVersion: NS.Integer) {
...
GarbageCollector_keyPathsForValuesAffectingValueForKey :: #force_inline proc "c" (key: ^NS.String) -> ^NS.Set {
    return msgSend(^NS.Set, GarbageCollector, "keyPathsForValuesAffectingValueForKey:", key)
}
@(objc_type=GarbageCollector, objc_name="automaticallyNotifiesObserversForKey", objc_is_class_method=true)
GarbageCollector_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> bool {
...
GarbageCollector_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
...
GarbageCollector_classFallbacksForKeyedArchiver :: #force_inline proc "c" () -> ^NS.Array {
    return msgSend(^NS.Array, GarbageCollector, "classFallbacksForKeyedArchiver")
}
...
@(objc_type=GarbageCollector, objc_name="exposeBinding", objc_is_class_method=true)
GarbageCollector_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GarbageCollector, "exposeBinding:", binding)
}
@(objc_type=GarbageCollector, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GarbageCollector_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GarbageCollector, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GarbageCollector, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GarbageCollector_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GarbageCollector, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
...
GarbageCollector_VTable :: struct {
    ...
    zone: proc(self: ^GarbageCollector) -> ^NS.Zone,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^GarbageCollector,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^GarbageCollector,
...
GarbageCollector_odin_extend :: proc(cls: Class, vt: ^GarbageCollector_VTable) {
    ...
    if vt.zone != nil {
        zone :: proc "c" (self: ^GarbageCollector, _: SEL) -> ^NS.Zone {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^GarbageCollector {
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GarbageCollector_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GarbageCollector_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GarbageCollector_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
