...
StackView_VTable :: struct {
    ...
    addView: proc(self: ^StackView, view: ^View, gravity: StackViewGravity),
    insertView: proc(self: ^StackView, view: ^View, index: NS.UInteger, gravity: StackViewGravity),
    removeView: proc(self: ^StackView, view: ^View),
    viewsInGravity: proc(self: ^StackView, gravity: StackViewGravity) -> ^NS.Array,
    setViews: proc(self: ^StackView, views: ^NS.Array, gravity: StackViewGravity),
    views: proc(self: ^StackView) -> ^NS.Array,
    hasEqualSpacing: proc(self: ^StackView) -> bool,
    setHasEqualSpacing: proc(self: ^StackView, hasEqualSpacing: bool),
    focusView: proc() -> ^View,
...
StackView_odin_extend :: proc(cls: Class, vt: ^StackView_VTable) {
    ...
    if vt.addView != nil {
        addView :: proc "c" (self: ^StackView, _: SEL, view: ^View, gravity: StackViewGravity) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).addView(self, view, gravity)
        }
    ...
    if vt.insertView != nil {
        insertView :: proc "c" (self: ^StackView, _: SEL, view: ^View, index: NS.UInteger, gravity: StackViewGravity) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).insertView(self, view, index, gravity)
        }
    ...
    if vt.removeView != nil {
        removeView :: proc "c" (self: ^StackView, _: SEL, view: ^View) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).removeView(self, view)
        }
    ...
    if vt.viewsInGravity != nil {
        viewsInGravity :: proc "c" (self: ^StackView, _: SEL, gravity: StackViewGravity) -> ^NS.Array {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).viewsInGravity(self, gravity)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("viewsInGravity:"), auto_cast viewsInGravity, "@@:l") do panic("Failed to register objC method.")
    }
    if vt.setViews != nil {
        setViews :: proc "c" (self: ^StackView, _: SEL, views: ^NS.Array, gravity: StackViewGravity) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).setViews(self, views, gravity)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("setViews:inGravity:"), auto_cast setViews, "v@:@l") do panic("Failed to register objC method.")
    }
    if vt.views != nil {
        views :: proc "c" (self: ^StackView, _: SEL) -> ^NS.Array {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).views(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("views"), auto_cast views, "@@:") do panic("Failed to register objC method.")
    }
    if vt.hasEqualSpacing != nil {
        hasEqualSpacing :: proc "c" (self: ^StackView, _: SEL) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).hasEqualSpacing(self)
        }
    ...
    if vt.setHasEqualSpacing != nil {
        setHasEqualSpacing :: proc "c" (self: ^StackView, _: SEL, hasEqualSpacing: bool) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).setHasEqualSpacing(self, hasEqualSpacing)
        }
    ...
    if vt.defaultFocusRingType != nil {
        defaultFocusRingType :: proc "c" (self: Class, _: SEL) -> FocusRingType {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).defaultFocusRingType()
        }
    ...
    if vt.allowedClassesForRestorableStateKeyPath != nil {
        allowedClassesForRestorableStateKeyPath :: proc "c" (self: Class, _: SEL, keyPath: ^NS.String) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).allowedClassesForRestorableStateKeyPath( keyPath)
        }
    ...
    if vt.restorableStateKeyPaths != nil {
        restorableStateKeyPaths :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).restorableStateKeyPaths()
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^NS.Array, dependentKey: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
    ...
    if vt.exposeBinding != nil {
        exposeBinding :: proc "c" (self: Class, _: SEL, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).exposeBinding( binding)
        }
    ...
    if vt.setDefaultPlaceholder != nil {
        setDefaultPlaceholder :: proc "c" (self: Class, _: SEL, placeholder: id, marker: id, binding: ^NS.String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^StackView_VTable)vt_ctx.super_vt).setDefaultPlaceholder( placeholder, marker, binding)
        }
    ...
    if vt.defaultPlaceholderForMarker != nil {
        defaultPlaceholderForMarker :: proc "c" (self: Class, _: SEL, marker: id, binding: ^NS.String) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^StackView_VTable)vt_ctx.super_vt).defaultPlaceholderForMarker( marker, binding)
        }
