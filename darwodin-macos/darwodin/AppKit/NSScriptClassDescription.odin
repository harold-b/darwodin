...
foreign lib {
    ...
    ScriptClassDescription_initWithSuiteName :: proc(self: ^ScriptClassDescription, suiteName: ^NS.String, className: ^NS.String, classDeclaration: ^NS.Dictionary) -> ^ScriptClassDescription ---
    ...
    ScriptClassDescription_typeForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> ^NS.String ---

    @(objc_type=ScriptClassDescription, objc_selector="classDescriptionForKey:", objc_name="classDescriptionForKey")
    ScriptClassDescription_classDescriptionForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> ^ScriptClassDescription ---

    @(objc_type=ScriptClassDescription, objc_selector="appleEventCodeForKey:", objc_name="appleEventCodeForKey")
    ScriptClassDescription_appleEventCodeForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> CF.FourCharCode ---

    @(objc_type=ScriptClassDescription, objc_selector="keyWithAppleEventCode:", objc_name="keyWithAppleEventCode")
    ScriptClassDescription_keyWithAppleEventCode :: proc(self: ^ScriptClassDescription, appleEventCode: CF.FourCharCode) -> ^NS.String ---
    ...
    ScriptClassDescription_isLocationRequiredToCreateForKey :: proc(self: ^ScriptClassDescription, toManyRelationshipKey: ^NS.String) -> bool ---

    @(objc_type=ScriptClassDescription, objc_selector="hasPropertyForKey:", objc_name="hasPropertyForKey")
    ScriptClassDescription_hasPropertyForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> bool ---
    ...
    ScriptClassDescription_hasOrderedToManyRelationshipForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> bool ---

    @(objc_type=ScriptClassDescription, objc_selector="hasReadablePropertyForKey:", objc_name="hasReadablePropertyForKey")
    ScriptClassDescription_hasReadablePropertyForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> bool ---

    @(objc_type=ScriptClassDescription, objc_selector="hasWritablePropertyForKey:", objc_name="hasWritablePropertyForKey")
    ScriptClassDescription_hasWritablePropertyForKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> bool ---

    @(objc_type=ScriptClassDescription, objc_selector="suiteName", objc_name="suiteName")
    ScriptClassDescription_suiteName :: proc(self: ^ScriptClassDescription) -> ^NS.String ---

    @(objc_type=ScriptClassDescription, objc_selector="className", objc_name="className")
    ScriptClassDescription_className :: proc(self: ^ScriptClassDescription) -> ^NS.String ---

    @(objc_type=ScriptClassDescription, objc_selector="implementationClassName", objc_name="implementationClassName")
    ScriptClassDescription_implementationClassName :: proc(self: ^ScriptClassDescription) -> ^NS.String ---
    ...
    ScriptClassDescription_defaultSubcontainerAttributeKey :: proc(self: ^ScriptClassDescription) -> ^NS.String ---

    @(objc_type=ScriptClassDescription, objc_selector="isReadOnlyKey:", objc_name="isReadOnlyKey")
    ScriptClassDescription_isReadOnlyKey :: proc(self: ^ScriptClassDescription, key: ^NS.String) -> bool ---
}
