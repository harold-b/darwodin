...
foreign lib {
    ...
    URLHandleClient_URLHandle_resourceDataDidBecomeAvailable :: proc(self: ^URLHandleClient, sender: ^URLHandle, newBytes: ^NS.Data) ---
    ...
    URLHandleClient_URLHandle_resourceDidFailLoadingWithReason :: proc(self: ^URLHandleClient, sender: ^URLHandle, reason: ^NS.String) ---
}
