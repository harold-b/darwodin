...
URLHandleClient_URLHandle_resourceDataDidBecomeAvailable :: #force_inline proc "c" (self: ^URLHandleClient, sender: ^URLHandle, newBytes: ^NS.Data) {
...
URLHandleClient_URLHandle_resourceDidFailLoadingWithReason :: #force_inline proc "c" (self: ^URLHandleClient, sender: ^URLHandle, reason: ^NS.String) {
...
URLHandleClient_VTable :: struct {
    _URLHandle_resourceDataDidBecomeAvailable: proc(self: ^URLHandleClient, sender: ^URLHandle, newBytes: ^NS.Data),
    ...
    _URLHandle_resourceDidFailLoadingWithReason: proc(self: ^URLHandleClient, sender: ^URLHandle, reason: ^NS.String),
}
...
URLHandleClient_odin_extend :: proc(cls: Class, vt: ^URLHandleClient_VTable) {
    ...
    if vt._URLHandle_resourceDataDidBecomeAvailable != nil {
        _URLHandle_resourceDataDidBecomeAvailable :: proc "c" (self: ^URLHandleClient, _: SEL, sender: ^URLHandle, newBytes: ^NS.Data) {
    ...
    if vt._URLHandle_resourceDidFailLoadingWithReason != nil {
        _URLHandle_resourceDidFailLoadingWithReason :: proc "c" (self: ^URLHandleClient, _: SEL, sender: ^URLHandle, reason: ^NS.String) {
