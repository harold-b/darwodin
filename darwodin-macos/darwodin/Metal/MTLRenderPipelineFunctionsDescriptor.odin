...
@(objc_type=RenderPipelineFunctionsDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPipelineFunctionsDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPipelineFunctionsDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPipelineFunctionsDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPipelineFunctionsDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPipelineFunctionsDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
