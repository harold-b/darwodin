...
@(objc_type=InstanceAccelerationStructureDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
InstanceAccelerationStructureDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, InstanceAccelerationStructureDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=InstanceAccelerationStructureDescriptor, objc_name="setKeys", objc_is_class_method=true)
InstanceAccelerationStructureDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, InstanceAccelerationStructureDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
