...
@(objc_type=RenderPipelineColorAttachmentDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
RenderPipelineColorAttachmentDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPipelineColorAttachmentDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPipelineColorAttachmentDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
RenderPipelineColorAttachmentDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPipelineColorAttachmentDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
