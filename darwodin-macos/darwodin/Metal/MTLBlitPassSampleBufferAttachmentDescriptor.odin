...
@(objc_type=BlitPassSampleBufferAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
BlitPassSampleBufferAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, BlitPassSampleBufferAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=BlitPassSampleBufferAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
BlitPassSampleBufferAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, BlitPassSampleBufferAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
