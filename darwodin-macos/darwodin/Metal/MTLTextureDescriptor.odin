...
@(objc_type=TextureDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
TextureDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TextureDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=TextureDescriptor, objc_name="setKeys", objc_is_class_method=true)
TextureDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TextureDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
