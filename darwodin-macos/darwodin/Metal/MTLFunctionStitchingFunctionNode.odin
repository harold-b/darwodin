...
@(objc_type=FunctionStitchingFunctionNode, objc_name="poseAsClass", objc_is_class_method=true)
FunctionStitchingFunctionNode_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionStitchingFunctionNode, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionStitchingFunctionNode, objc_name="setKeys", objc_is_class_method=true)
FunctionStitchingFunctionNode_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionStitchingFunctionNode, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
