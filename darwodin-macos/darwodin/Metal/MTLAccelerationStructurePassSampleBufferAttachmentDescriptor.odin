...
@(objc_type=AccelerationStructurePassSampleBufferAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructurePassSampleBufferAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructurePassSampleBufferAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructurePassSampleBufferAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructurePassSampleBufferAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructurePassSampleBufferAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
