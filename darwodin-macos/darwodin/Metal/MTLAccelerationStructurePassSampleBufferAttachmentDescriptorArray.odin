...
@(objc_type=AccelerationStructurePassSampleBufferAttachmentDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructurePassSampleBufferAttachmentDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructurePassSampleBufferAttachmentDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructurePassSampleBufferAttachmentDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructurePassSampleBufferAttachmentDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructurePassSampleBufferAttachmentDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
