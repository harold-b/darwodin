...
@(objc_type=RenderPassAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPassAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
