...
@(objc_type=SharedTextureHandle, objc_name="poseAsClass", objc_is_class_method=true)
SharedTextureHandle_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SharedTextureHandle, "poseAsClass:", aClass)
}
...
@(objc_type=SharedTextureHandle, objc_name="setKeys", objc_is_class_method=true)
SharedTextureHandle_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SharedTextureHandle, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
