...
@(objc_type=LinkedFunctions, objc_name="poseAsClass", objc_is_class_method=true)
LinkedFunctions_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LinkedFunctions, "poseAsClass:", aClass)
}
...
@(objc_type=LinkedFunctions, objc_name="setKeys", objc_is_class_method=true)
LinkedFunctions_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LinkedFunctions, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
