...
@(objc_type=CommandQueueDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
CommandQueueDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, CommandQueueDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=CommandQueueDescriptor, objc_name="setKeys", objc_is_class_method=true)
CommandQueueDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, CommandQueueDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
