...
@(objc_type=BufferLayoutDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
BufferLayoutDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, BufferLayoutDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=BufferLayoutDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
BufferLayoutDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, BufferLayoutDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
