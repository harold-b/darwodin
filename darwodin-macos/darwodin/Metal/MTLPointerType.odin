...
@(objc_type=PointerType, objc_name="poseAsClass", objc_is_class_method=true)
PointerType_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PointerType, "poseAsClass:", aClass)
}
...
@(objc_type=PointerType, objc_name="setKeys", objc_is_class_method=true)
PointerType_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PointerType, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
