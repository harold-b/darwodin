...
@(objc_type=TextureReferenceType, objc_name="poseAsClass", objc_is_class_method=true)
TextureReferenceType_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TextureReferenceType, "poseAsClass:", aClass)
}
...
@(objc_type=TextureReferenceType, objc_name="setKeys", objc_is_class_method=true)
TextureReferenceType_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TextureReferenceType, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
