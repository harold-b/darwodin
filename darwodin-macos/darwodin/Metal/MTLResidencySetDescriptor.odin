...
@(objc_type=ResidencySetDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
ResidencySetDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ResidencySetDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=ResidencySetDescriptor, objc_name="setKeys", objc_is_class_method=true)
ResidencySetDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ResidencySetDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
