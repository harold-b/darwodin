...
@(objc_type=AccelerationStructureTriangleGeometryDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructureTriangleGeometryDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructureTriangleGeometryDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructureTriangleGeometryDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructureTriangleGeometryDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructureTriangleGeometryDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
