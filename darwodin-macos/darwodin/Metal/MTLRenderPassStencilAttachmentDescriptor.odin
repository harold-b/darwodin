...
@(objc_type=RenderPassStencilAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassStencilAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassStencilAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassStencilAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPassStencilAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassStencilAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
