...
@(objc_type=CounterSampleBufferDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
CounterSampleBufferDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, CounterSampleBufferDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=CounterSampleBufferDescriptor, objc_name="setKeys", objc_is_class_method=true)
CounterSampleBufferDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, CounterSampleBufferDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
