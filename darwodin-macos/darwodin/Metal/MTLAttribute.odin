...
@(objc_type=Attribute, objc_name="poseAsClass", objc_is_class_method=true)
Attribute_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Attribute, "poseAsClass:", aClass)
}
...
@(objc_type=Attribute, objc_name="setKeys", objc_is_class_method=true)
Attribute_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Attribute, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
