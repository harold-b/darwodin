...
@(objc_type=LogStateDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
LogStateDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LogStateDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=LogStateDescriptor, objc_name="setKeys", objc_is_class_method=true)
LogStateDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LogStateDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
