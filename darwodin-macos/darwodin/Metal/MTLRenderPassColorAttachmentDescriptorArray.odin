...
@(objc_type=RenderPassColorAttachmentDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassColorAttachmentDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassColorAttachmentDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassColorAttachmentDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
RenderPassColorAttachmentDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassColorAttachmentDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
