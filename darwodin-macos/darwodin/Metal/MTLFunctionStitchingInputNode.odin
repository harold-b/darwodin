...
@(objc_type=FunctionStitchingInputNode, objc_name="poseAsClass", objc_is_class_method=true)
FunctionStitchingInputNode_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionStitchingInputNode, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionStitchingInputNode, objc_name="setKeys", objc_is_class_method=true)
FunctionStitchingInputNode_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionStitchingInputNode, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
