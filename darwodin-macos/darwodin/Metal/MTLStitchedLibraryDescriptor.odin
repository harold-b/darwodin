...
@(objc_type=StitchedLibraryDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
StitchedLibraryDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, StitchedLibraryDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=StitchedLibraryDescriptor, objc_name="setKeys", objc_is_class_method=true)
StitchedLibraryDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, StitchedLibraryDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
