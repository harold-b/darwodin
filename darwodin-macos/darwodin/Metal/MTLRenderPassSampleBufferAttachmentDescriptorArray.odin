...
@(objc_type=RenderPassSampleBufferAttachmentDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassSampleBufferAttachmentDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassSampleBufferAttachmentDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassSampleBufferAttachmentDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
RenderPassSampleBufferAttachmentDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassSampleBufferAttachmentDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
