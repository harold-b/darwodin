...
/// MKMapView
///
@(objc_class="MKMapView", objc_superclass=UI.View)
MapView :: struct {
    using _: UI.View,
    using _: NS.Coding,
}
...
foreign lib {
    ...
    MapView_setVisibleMapRect_edgePadding_animated :: proc(self: ^MapView, mapRect: MapRect, insets: UI.EdgeInsets, animate: bool) ---

    @(objc_type=MapView, objc_selector="mapRectThatFits:edgePadding:", objc_name="mapRectThatFits_edgePadding")
    MapView_mapRectThatFits_edgePadding :: proc(self: ^MapView, mapRect: MapRect, insets: UI.EdgeInsets) -> MapRect ---
    ...
    MapView_convertCoordinate :: proc(self: ^MapView, coordinate: CL.LocationCoordinate2D, view: ^UI.View) -> CG.Point ---

    @(objc_type=MapView, objc_selector="convertPoint:toCoordinateFromView:", objc_name="convertPoint")
    MapView_convertPoint :: proc(self: ^MapView, point: CG.Point, view: ^UI.View) -> CL.LocationCoordinate2D ---

    @(objc_type=MapView, objc_selector="convertRegion:toRectToView:", objc_name="convertRegion")
    MapView_convertRegion :: proc(self: ^MapView, region: CoordinateRegion, view: ^UI.View) -> CG.Rect ---

    @(objc_type=MapView, objc_selector="convertRect:toRegionFromView:", objc_name="convertRect")
    MapView_convertRect :: proc(self: ^MapView, rect: CG.Rect, view: ^UI.View) -> CoordinateRegion ---
    ...
    @(objc_type=MapView, objc_selector="selectableMapFeatures", objc_name="selectableMapFeatures")
    MapView_selectableMapFeatures :: proc(self: ^MapView) -> MapFeatureOptions ---

    @(objc_type=MapView, objc_selector="setSelectableMapFeatures:", objc_name="setSelectableMapFeatures")
    MapView_setSelectableMapFeatures :: proc(self: ^MapView, selectableMapFeatures: MapFeatureOptions) ---
    ...
    @(objc_type=MapView, objc_selector="viewForOverlay:", objc_name="viewForOverlay")
    MapView_viewForOverlay :: proc(self: ^MapView, overlay: ^Overlay) -> ^OverlayView ---
