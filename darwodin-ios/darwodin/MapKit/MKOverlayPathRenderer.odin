...
foreign lib {
    ...
    OverlayPathRenderer_fillColor :: proc(self: ^OverlayPathRenderer) -> ^UI.Color ---

    @(objc_type=OverlayPathRenderer, objc_selector="setFillColor:", objc_name="setFillColor")
    OverlayPathRenderer_setFillColor :: proc(self: ^OverlayPathRenderer, fillColor: ^UI.Color) ---

    @(objc_type=OverlayPathRenderer, objc_selector="strokeColor", objc_name="strokeColor")
    OverlayPathRenderer_strokeColor :: proc(self: ^OverlayPathRenderer) -> ^UI.Color ---

    @(objc_type=OverlayPathRenderer, objc_selector="setStrokeColor:", objc_name="setStrokeColor")
    OverlayPathRenderer_setStrokeColor :: proc(self: ^OverlayPathRenderer, strokeColor: ^UI.Color) ---
