...
foreign lib {
    ...
    MapItemDetailSelectionAccessoryPresentationStyle_automaticWithPresentationViewController :: proc(presentationViewController: ^UI.ViewController) -> ^MapItemDetailSelectionAccessoryPresentationStyle ---
    ...
    MapItemDetailSelectionAccessoryPresentationStyle_sheetPresentedFromViewController :: proc(viewController: ^UI.ViewController) -> ^MapItemDetailSelectionAccessoryPresentationStyle ---
