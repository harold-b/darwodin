...
foreign lib {
    ...
    MapSnapshotOptions_traitCollection :: proc(self: ^MapSnapshotOptions) -> ^UI.TraitCollection ---

    @(objc_type=MapSnapshotOptions, objc_selector="setTraitCollection:", objc_name="setTraitCollection")
    MapSnapshotOptions_setTraitCollection :: proc(self: ^MapSnapshotOptions, traitCollection: ^UI.TraitCollection) ---
}
