...
foreign lib {
    ...
    MarkerAnnotationView_markerTintColor :: proc(self: ^MarkerAnnotationView) -> ^UI.Color ---

    @(objc_type=MarkerAnnotationView, objc_selector="setMarkerTintColor:", objc_name="setMarkerTintColor")
    MarkerAnnotationView_setMarkerTintColor :: proc(self: ^MarkerAnnotationView, markerTintColor: ^UI.Color) ---

    @(objc_type=MarkerAnnotationView, objc_selector="glyphTintColor", objc_name="glyphTintColor")
    MarkerAnnotationView_glyphTintColor :: proc(self: ^MarkerAnnotationView) -> ^UI.Color ---

    @(objc_type=MarkerAnnotationView, objc_selector="setGlyphTintColor:", objc_name="setGlyphTintColor")
    MarkerAnnotationView_setGlyphTintColor :: proc(self: ^MarkerAnnotationView, glyphTintColor: ^UI.Color) ---
    ...
    MarkerAnnotationView_glyphImage :: proc(self: ^MarkerAnnotationView) -> ^UI.Image ---

    @(objc_type=MarkerAnnotationView, objc_selector="setGlyphImage:", objc_name="setGlyphImage")
    MarkerAnnotationView_setGlyphImage :: proc(self: ^MarkerAnnotationView, glyphImage: ^UI.Image) ---

    @(objc_type=MarkerAnnotationView, objc_selector="selectedGlyphImage", objc_name="selectedGlyphImage")
    MarkerAnnotationView_selectedGlyphImage :: proc(self: ^MarkerAnnotationView) -> ^UI.Image ---

    @(objc_type=MarkerAnnotationView, objc_selector="setSelectedGlyphImage:", objc_name="setSelectedGlyphImage")
    MarkerAnnotationView_setSelectedGlyphImage :: proc(self: ^MarkerAnnotationView, selectedGlyphImage: ^UI.Image) ---
