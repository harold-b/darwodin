...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.KeyframeAnimation,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.KeyframeAnimation,
    alloc: proc() -> ^CA.KeyframeAnimation,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.KeyframeAnimation {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.KeyframeAnimation {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.KeyframeAnimation {
