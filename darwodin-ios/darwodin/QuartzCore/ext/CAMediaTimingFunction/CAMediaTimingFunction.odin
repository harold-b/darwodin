...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.MediaTimingFunction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.MediaTimingFunction,
    alloc: proc() -> ^CA.MediaTimingFunction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.MediaTimingFunction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.MediaTimingFunction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.MediaTimingFunction {
