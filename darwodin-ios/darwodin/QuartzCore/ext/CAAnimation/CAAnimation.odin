...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.Animation,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.Animation,
    alloc: proc() -> ^CA.Animation,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.Animation {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.Animation {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.Animation {
