...
foreign lib {
    ...
    MediaTimingFunction_functionWithControlPoints :: proc(c1x: cffi.float, c1y: cffi.float, c2x: cffi.float, c2y: cffi.float) -> instancetype ---

    @(objc_type=MediaTimingFunction, objc_selector="initWithControlPoints::::", objc_name="initWithControlPoints")
    MediaTimingFunction_initWithControlPoints :: proc(self: ^MediaTimingFunction, c1x: cffi.float, c1y: cffi.float, c2x: cffi.float, c2y: cffi.float) -> instancetype ---
