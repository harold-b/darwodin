...
ItemProviderWriting_VTable :: struct {
    itemProviderVisibilityForRepresentationWithTypeIdentifierStatic: proc(typeIdentifier: ^String) -> ItemProviderRepresentationVisibility,
    ...
    writableTypeIdentifiersForItemProviderStatic: proc() -> ^Array,
...
ItemProviderWriting_odin_extend :: proc(cls: Class, vt: ^ItemProviderWriting_VTable) {
    ...
    if vt.itemProviderVisibilityForRepresentationWithTypeIdentifierStatic != nil {
        itemProviderVisibilityForRepresentationWithTypeIdentifierStatic :: proc "c" (self: Class, _: SEL, typeIdentifier: ^String) -> ItemProviderRepresentationVisibility {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^ItemProviderWriting_VTable)vt_ctx.protocol_vt).itemProviderVisibilityForRepresentationWithTypeIdentifierStatic( typeIdentifier)
        }
    ...
    if vt.writableTypeIdentifiersForItemProviderStatic != nil {
        writableTypeIdentifiersForItemProviderStatic :: proc "c" (self: Class, _: SEL) -> ^Array {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^ItemProviderWriting_VTable)vt_ctx.protocol_vt).writableTypeIdentifiersForItemProviderStatic()
        }
