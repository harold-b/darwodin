...
VTable :: struct {
    ...
    new: proc() -> ^NS.UnitElectricPotentialDifference,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.UnitElectricPotentialDifference,
    alloc: proc() -> ^NS.UnitElectricPotentialDifference,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.UnitElectricPotentialDifference {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.UnitElectricPotentialDifference {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.UnitElectricPotentialDifference {
