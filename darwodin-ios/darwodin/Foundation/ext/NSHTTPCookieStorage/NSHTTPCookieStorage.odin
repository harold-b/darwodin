...
VTable :: struct {
    ...
    getCookiesForTask: proc(self: ^NS.HTTPCookieStorage, task: ^NS.URLSessionTask, completionHandler: proc "c" (cookies: ^NS.Array)),
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.HTTPCookieStorage,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.HTTPCookieStorage,
    alloc: proc() -> ^NS.HTTPCookieStorage,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.getCookiesForTask != nil {
        getCookiesForTask :: proc "c" (self: ^NS.HTTPCookieStorage, _: SEL, task: ^NS.URLSessionTask, completionHandler: proc "c" (cookies: ^NS.Array)) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.HTTPCookieStorage {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.HTTPCookieStorage {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.HTTPCookieStorage {
