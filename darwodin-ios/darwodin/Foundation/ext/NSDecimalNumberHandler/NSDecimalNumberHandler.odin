...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.DecimalNumberHandler,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.DecimalNumberHandler,
    alloc: proc() -> ^NS.DecimalNumberHandler,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.DecimalNumberHandler {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.DecimalNumberHandler {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DecimalNumberHandler {
