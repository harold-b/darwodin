...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.MetadataQueryResultGroup,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.MetadataQueryResultGroup,
    alloc: proc() -> ^NS.MetadataQueryResultGroup,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.MetadataQueryResultGroup {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.MetadataQueryResultGroup {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.MetadataQueryResultGroup {
