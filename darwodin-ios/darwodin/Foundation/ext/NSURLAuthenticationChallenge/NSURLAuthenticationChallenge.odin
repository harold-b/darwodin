...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.URLAuthenticationChallenge,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.URLAuthenticationChallenge,
    alloc: proc() -> ^NS.URLAuthenticationChallenge,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.URLAuthenticationChallenge {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.URLAuthenticationChallenge {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.URLAuthenticationChallenge {
