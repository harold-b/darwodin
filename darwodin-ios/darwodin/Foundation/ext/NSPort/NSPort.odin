...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Port,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Port,
    alloc: proc() -> ^NS.Port,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Port {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Port {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Port {
