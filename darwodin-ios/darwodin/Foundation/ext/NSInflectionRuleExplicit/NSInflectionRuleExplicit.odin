...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.InflectionRuleExplicit,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.InflectionRuleExplicit,
    alloc: proc() -> ^NS.InflectionRuleExplicit,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.InflectionRuleExplicit {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.InflectionRuleExplicit {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.InflectionRuleExplicit {
