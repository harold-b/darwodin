...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Thread,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Thread,
    alloc: proc() -> ^NS.Thread,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Thread {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Thread {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Thread {
