...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Pipe,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Pipe,
    alloc: proc() -> ^NS.Pipe,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Pipe {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Pipe {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Pipe {
