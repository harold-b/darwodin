...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.OrderedCollectionChange,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.OrderedCollectionChange,
    alloc: proc() -> ^NS.OrderedCollectionChange,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.OrderedCollectionChange {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.OrderedCollectionChange {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.OrderedCollectionChange {
