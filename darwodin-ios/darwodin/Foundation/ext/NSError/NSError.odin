...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Error,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Error,
    alloc: proc() -> ^NS.Error,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Error {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Error {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Error {
