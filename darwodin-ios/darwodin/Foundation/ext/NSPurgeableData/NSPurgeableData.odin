package darwodin_NSPurgeableData_Ext
...
import "../NSMutableData"

VTable :: struct {
    super: NSMutableData.VTable,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.PurgeableData,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.PurgeableData,
    alloc: proc() -> ^NS.PurgeableData,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    NSMutableData.extend(cls, &vt.super)
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.PurgeableData {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.PurgeableData {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.PurgeableData {
