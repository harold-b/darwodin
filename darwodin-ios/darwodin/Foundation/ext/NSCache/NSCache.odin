...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^NS.Cache,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.Cache,
    alloc: proc() -> ^NS.Cache,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.Cache {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.Cache {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.Cache {
