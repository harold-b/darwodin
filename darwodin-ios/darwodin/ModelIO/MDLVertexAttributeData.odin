...
VertexAttributeData_stride :: #force_inline proc "c" (self: ^VertexAttributeData) -> cffi.ulong {
    return msgSend(cffi.ulong, self, "stride")
}
@(objc_type=VertexAttributeData, objc_name="setStride")
VertexAttributeData_setStride :: #force_inline proc "c" (self: ^VertexAttributeData, stride: cffi.ulong) {
...
VertexAttributeData_bufferSize :: #force_inline proc "c" (self: ^VertexAttributeData) -> cffi.ulong {
    return msgSend(cffi.ulong, self, "bufferSize")
}
@(objc_type=VertexAttributeData, objc_name="setBufferSize")
VertexAttributeData_setBufferSize :: #force_inline proc "c" (self: ^VertexAttributeData, bufferSize: cffi.ulong) {
...
VertexAttributeData_instancesRespondToSelector :: #force_inline proc "c" (aSelector: SEL) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "instancesRespondToSelector:", aSelector)
}
@(objc_type=VertexAttributeData, objc_name="conformsToProtocol", objc_is_class_method=true)
VertexAttributeData_conformsToProtocol :: #force_inline proc "c" (protocol: ^Protocol) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "conformsToProtocol:", protocol)
}
@(objc_type=VertexAttributeData, objc_name="instanceMethodForSelector", objc_is_class_method=true)
VertexAttributeData_instanceMethodForSelector :: #force_inline proc "c" (aSelector: SEL) -> proc "c" (aSelector: SEL) {
    return msgSend(proc "c" (aSelector: SEL), VertexAttributeData, "instanceMethodForSelector:", aSelector)
}
...
VertexAttributeData_isSubclassOfClass :: #force_inline proc "c" (aClass: Class) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "isSubclassOfClass:", aClass)
}
@(objc_type=VertexAttributeData, objc_name="resolveClassMethod", objc_is_class_method=true)
VertexAttributeData_resolveClassMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "resolveClassMethod:", sel)
}
@(objc_type=VertexAttributeData, objc_name="resolveInstanceMethod", objc_is_class_method=true)
VertexAttributeData_resolveInstanceMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "resolveInstanceMethod:", sel)
}
@(objc_type=VertexAttributeData, objc_name="hash", objc_is_class_method=true)
VertexAttributeData_hash :: #force_inline proc "c" () -> cffi.ulong {
    return msgSend(cffi.ulong, VertexAttributeData, "hash")
}
...
VertexAttributeData_version :: #force_inline proc "c" () -> cffi.long {
    return msgSend(cffi.long, VertexAttributeData, "version")
}
@(objc_type=VertexAttributeData, objc_name="setVersion", objc_is_class_method=true)
VertexAttributeData_setVersion :: #force_inline proc "c" (aVersion: cffi.long) {
...
VertexAttributeData_accessInstanceVariablesDirectly :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "accessInstanceVariablesDirectly")
}
@(objc_type=VertexAttributeData, objc_name="useStoredAccessor", objc_is_class_method=true)
VertexAttributeData_useStoredAccessor :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "useStoredAccessor")
}
...
VertexAttributeData_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> cffi.bool {
    return msgSend(cffi.bool, VertexAttributeData, "automaticallyNotifiesObserversForKey:", key)
}
