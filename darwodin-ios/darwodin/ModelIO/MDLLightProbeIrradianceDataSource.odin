...
foreign lib {
    ...
    LightProbeIrradianceDataSource_sphericalHarmonicsCoefficientsAtPosition :: proc(self: ^LightProbeIrradianceDataSource, #by_ptr position: vector_float3) -> ^NS.Data ---
