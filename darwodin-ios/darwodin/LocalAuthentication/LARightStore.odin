...
foreign lib {
    ...
    RightStore_rightForIdentifier :: proc(self: ^RightStore, identifier: ^NS.String, handler: ^Objc_Block(proc "c" ( _0: ^PersistedRight, _1: ^NS.Error ))) ---

    @(objc_type=RightStore, objc_selector="saveRight:identifier:completion:", objc_name="saveRight_identifier_completion")
    RightStore_saveRight_identifier_completion :: proc(self: ^RightStore, right: ^Right, identifier: ^NS.String, handler: ^Objc_Block(proc "c" ( _0: ^PersistedRight, _1: ^NS.Error ))) ---
    ...
    RightStore_saveRight_identifier_secret_completion :: proc(self: ^RightStore, right: ^Right, identifier: ^NS.String, secret: ^NS.Data, handler: ^Objc_Block(proc "c" ( _0: ^PersistedRight, _1: ^NS.Error ))) ---
