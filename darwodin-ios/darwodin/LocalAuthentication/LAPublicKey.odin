...
foreign lib {
    ...
    PublicKey_exportBytesWithCompletion :: proc(self: ^PublicKey, handler: ^Objc_Block(proc "c" ( _0: ^NS.Data, _1: ^NS.Error ))) ---

    @(objc_type=PublicKey, objc_selector="encryptData:secKeyAlgorithm:completion:", objc_name="encryptData")
    PublicKey_encryptData :: proc(self: ^PublicKey, data: ^NS.Data, algorithm: Sec.SecKeyAlgorithm, handler: ^Objc_Block(proc "c" ( _0: ^NS.Data, _1: ^NS.Error ))) ---
    ...
    PublicKey_verifyData :: proc(self: ^PublicKey, signedData: ^NS.Data, signature: ^NS.Data, algorithm: Sec.SecKeyAlgorithm, handler: ^Objc_Block(proc "c" ( _0: ^NS.Error ))) ---
