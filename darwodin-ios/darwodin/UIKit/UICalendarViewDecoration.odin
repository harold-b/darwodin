...
foreign lib {
    ...
    CalendarViewDecoration_init :: proc(self: ^CalendarViewDecoration) -> instancetype ---

    @(objc_type=CalendarViewDecoration, objc_selector="initWithImage:color:size:", objc_name="initWithImage")
    CalendarViewDecoration_initWithImage :: proc(self: ^CalendarViewDecoration, image: ^Image, color: ^Color, size: CalendarViewDecorationSize) -> instancetype ---

    @(objc_type=CalendarViewDecoration, objc_selector="initWithCustomViewProvider:", objc_name="initWithCustomViewProvider")
    CalendarViewDecoration_initWithCustomViewProvider :: proc(self: ^CalendarViewDecoration, customViewProvider: ^Objc_Block(proc "c" () -> ^View)) -> instancetype ---
    ...
    CalendarViewDecoration_decorationWithColor :: proc(color: ^Color, size: CalendarViewDecorationSize) -> instancetype ---
    ...
    CalendarViewDecoration_decorationWithImage_ :: proc(image: ^Image) -> instancetype ---
    ...
    CalendarViewDecoration_decorationWithImage_color_size :: proc(image: ^Image, color: ^Color, size: CalendarViewDecorationSize) -> instancetype ---
    ...
    CalendarViewDecoration_decorationWithCustomViewProvider :: proc(customViewProvider: ^Objc_Block(proc "c" () -> ^View)) -> instancetype ---
}
