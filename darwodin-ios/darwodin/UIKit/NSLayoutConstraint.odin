...
foreign lib {
    ...
    NSLayoutConstraint_constraintWithItem :: proc(view1: id, attr1: NSLayoutAttribute, relation: NSLayoutRelation, view2: id, attr2: NSLayoutAttribute, multiplier: CG.Float, c: CG.Float) -> instancetype ---
