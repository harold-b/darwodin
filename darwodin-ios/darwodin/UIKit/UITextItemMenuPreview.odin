...
foreign lib {
    ...
    TextItemMenuPreview_defaultPreview :: proc() -> instancetype ---

    @(objc_type=TextItemMenuPreview, objc_selector="initWithView:", objc_name="initWithView")
    TextItemMenuPreview_initWithView :: proc(self: ^TextItemMenuPreview, view: ^View) -> instancetype ---

    @(objc_type=TextItemMenuPreview, objc_selector="init", objc_name="init")
    TextItemMenuPreview_init :: proc(self: ^TextItemMenuPreview) -> instancetype ---
