...
GraphicsPDFRendererContext_VTable :: struct {
    ...
    beginPage: proc(self: ^GraphicsPDFRendererContext),
    beginPageWithBounds: proc(self: ^GraphicsPDFRendererContext, bounds: CG.Rect, pageInfo: ^NS.Dictionary),
    setURL: proc(self: ^GraphicsPDFRendererContext, url: ^NS.URL, rect: CG.Rect),
    addDestinationWithName: proc(self: ^GraphicsPDFRendererContext, name: ^NS.String, point: CG.Point),
    setDestinationWithName: proc(self: ^GraphicsPDFRendererContext, name: ^NS.String, rect: CG.Rect),
    pdfContextBounds: proc(self: ^GraphicsPDFRendererContext) -> CG.Rect,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^GraphicsPDFRendererContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^GraphicsPDFRendererContext,
    alloc: proc() -> ^GraphicsPDFRendererContext,
...
GraphicsPDFRendererContext_odin_extend :: proc(cls: Class, vt: ^GraphicsPDFRendererContext_VTable) {
    assert(vt != nil);
    meta := ObjC.object_getClass(auto_cast cls)
    _=meta
    
    GraphicsRendererContext_odin_extend(cls, &vt.super)

    if vt.beginPage != nil {
        beginPage :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).beginPage(self)
        }
    ...
    if vt.beginPageWithBounds != nil {
        beginPageWithBounds :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL, bounds: CG.Rect, pageInfo: ^NS.Dictionary) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).beginPageWithBounds(self, bounds, pageInfo)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("beginPageWithBounds:pageInfo:"), auto_cast beginPageWithBounds, "v@:{CGRect={CGPoint=dd}{CGSize=dd}}@") do panic("Failed to register objC method.")
    }
    if vt.setURL != nil {
        setURL :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL, url: ^NS.URL, rect: CG.Rect) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).setURL(self, url, rect)
        }
    ...
    if vt.addDestinationWithName != nil {
        addDestinationWithName :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL, name: ^NS.String, point: CG.Point) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).addDestinationWithName(self, name, point)
        }
    ...
    if vt.setDestinationWithName != nil {
        setDestinationWithName :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL, name: ^NS.String, rect: CG.Rect) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).setDestinationWithName(self, name, rect)
        }
    ...
    if vt.pdfContextBounds != nil {
        pdfContextBounds :: proc "c" (self: ^GraphicsPDFRendererContext, _: SEL) -> CG.Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).pdfContextBounds(self)
        }
    ...
    if vt.load != nil {
        load :: proc "c" (self: Class, _: SEL) {
            ...
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).load()
        }
    ...
    if vt.initialize != nil {
        initialize :: proc "c" (self: Class, _: SEL) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).initialize()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("initialize"), auto_cast initialize, "v#:") do panic("Failed to register objC method.")
    }
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^GraphicsPDFRendererContext {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).new()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("new"), auto_cast new, "@#:") do panic("Failed to register objC method.")
    }
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^GraphicsPDFRendererContext {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).allocWithZone( zone)
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("allocWithZone:"), auto_cast allocWithZone, "@#:^void") do panic("Failed to register objC method.")
    }
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^GraphicsPDFRendererContext {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).alloc()
        }
    ...
    if vt.copyWithZone != nil {
        copyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).copyWithZone( zone)
        }
    ...
    if vt.mutableCopyWithZone != nil {
        mutableCopyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).mutableCopyWithZone( zone)
        }
    ...
    if vt.instancesRespondToSelector != nil {
        instancesRespondToSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).instancesRespondToSelector( aSelector)
        }
    ...
    if vt.conformsToProtocol != nil {
        conformsToProtocol :: proc "c" (self: Class, _: SEL, protocol: ^Protocol) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).conformsToProtocol( protocol)
        }
    ...
    if vt.instanceMethodForSelector != nil {
        instanceMethodForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> IMP {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).instanceMethodForSelector( aSelector)
        }
    ...
    if vt.instanceMethodSignatureForSelector != nil {
        instanceMethodSignatureForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> ^NS.MethodSignature {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).instanceMethodSignatureForSelector( aSelector)
        }
    ...
    if vt.isSubclassOfClass != nil {
        isSubclassOfClass :: proc "c" (self: Class, _: SEL, aClass: Class) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).isSubclassOfClass( aClass)
        }
    ...
    if vt.resolveClassMethod != nil {
        resolveClassMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).resolveClassMethod( sel)
        }
    ...
    if vt.resolveInstanceMethod != nil {
        resolveInstanceMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).resolveInstanceMethod( sel)
        }
    ...
    if vt.hash != nil {
        hash :: proc "c" (self: Class, _: SEL) -> NS.UInteger {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).hash()
        }
    ...
    if vt.superclass != nil {
        superclass :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).superclass()
        }
    ...
    if vt.class != nil {
        class :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).class()
        }
    ...
    if vt.description != nil {
        description :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).description()
        }
    ...
    if vt.debugDescription != nil {
        debugDescription :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).debugDescription()
        }
    ...
    if vt.version != nil {
        version :: proc "c" (self: Class, _: SEL) -> NS.Integer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).version()
        }
    ...
    if vt.setVersion != nil {
        setVersion :: proc "c" (self: Class, _: SEL, aVersion: NS.Integer) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).setVersion( aVersion)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_selector_object != nil {
        cancelPreviousPerformRequestsWithTarget_selector_object :: proc "c" (self: Class, _: SEL, aTarget: id, aSelector: SEL, anArgument: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_selector_object( aTarget, aSelector, anArgument)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_ != nil {
        cancelPreviousPerformRequestsWithTarget_ :: proc "c" (self: Class, _: SEL, aTarget: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_( aTarget)
        }
    ...
    if vt.accessInstanceVariablesDirectly != nil {
        accessInstanceVariablesDirectly :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).accessInstanceVariablesDirectly()
        }
    ...
    if vt.useStoredAccessor != nil {
        useStoredAccessor :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).useStoredAccessor()
        }
    ...
    if vt.keyPathsForValuesAffectingValueForKey != nil {
        keyPathsForValuesAffectingValueForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> ^NS.Set {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).keyPathsForValuesAffectingValueForKey( key)
        }
    ...
    if vt.automaticallyNotifiesObserversForKey != nil {
        automaticallyNotifiesObserversForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).automaticallyNotifiesObserversForKey( key)
        }
    ...
    if vt.classFallbacksForKeyedArchiver != nil {
        classFallbacksForKeyedArchiver :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).classFallbacksForKeyedArchiver()
        }
    ...
    if vt.classForKeyedUnarchiver != nil {
        classForKeyedUnarchiver :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^GraphicsPDFRendererContext_VTable)vt_ctx.super_vt).classForKeyedUnarchiver()
        }
