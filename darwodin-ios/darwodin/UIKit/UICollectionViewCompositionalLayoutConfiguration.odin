...
CollectionViewCompositionalLayoutConfiguration_VTable :: struct {
    ...
    contentInsetsReference: proc(self: ^CollectionViewCompositionalLayoutConfiguration) -> ContentInsetsReference,
    setContentInsetsReference: proc(self: ^CollectionViewCompositionalLayoutConfiguration, contentInsetsReference: ContentInsetsReference),
    load: proc(),
    initialize: proc(),
...
CollectionViewCompositionalLayoutConfiguration_odin_extend :: proc(cls: Class, vt: ^CollectionViewCompositionalLayoutConfiguration_VTable) {
    ...
    if vt.contentInsetsReference != nil {
        contentInsetsReference :: proc "c" (self: ^CollectionViewCompositionalLayoutConfiguration, _: SEL) -> ContentInsetsReference {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^CollectionViewCompositionalLayoutConfiguration_VTable)vt_ctx.super_vt).contentInsetsReference(self)
        }
    ...
    if vt.setContentInsetsReference != nil {
        setContentInsetsReference :: proc "c" (self: ^CollectionViewCompositionalLayoutConfiguration, _: SEL, contentInsetsReference: ContentInsetsReference) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^CollectionViewCompositionalLayoutConfiguration_VTable)vt_ctx.super_vt).setContentInsetsReference(self, contentInsetsReference)
        }
