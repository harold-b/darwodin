...
///
@(objc_class="UICollectionViewLayout", objc_superclass=NS.Object)
CollectionViewLayout :: struct {
    using _: NS.Object,
    using _: NS.Coding,
}
...
foreign lib {
    ...
    CollectionViewLayout_layoutAttributesForElementsInRect :: proc(self: ^CollectionViewLayout, rect: CG.Rect) -> ^NS.Array ---
    ...
    CollectionViewLayout_shouldInvalidateLayoutForBoundsChange :: proc(self: ^CollectionViewLayout, newBounds: CG.Rect) -> bool ---
    ...
    CollectionViewLayout_invalidationContextForBoundsChange :: proc(self: ^CollectionViewLayout, newBounds: CG.Rect) -> ^CollectionViewLayoutInvalidationContext ---
    ...
    CollectionViewLayout_collectionViewContentSize :: proc(self: ^CollectionViewLayout) -> CG.Size ---

    @(objc_type=CollectionViewLayout, objc_selector="developmentLayoutDirection", objc_name="developmentLayoutDirection")
    CollectionViewLayout_developmentLayoutDirection :: proc(self: ^CollectionViewLayout) -> UserInterfaceLayoutDirection ---

    @(objc_type=CollectionViewLayout, objc_selector="flipsHorizontallyInOppositeLayoutDirection", objc_name="flipsHorizontallyInOppositeLayoutDirection")
    CollectionViewLayout_flipsHorizontallyInOppositeLayoutDirection :: proc(self: ^CollectionViewLayout) -> bool ---
    ...
    CollectionViewLayout_prepareForAnimatedBoundsChange :: proc(self: ^CollectionViewLayout, oldBounds: CG.Rect) ---
    ...
    CollectionViewLayout_indexPathsToDeleteForSupplementaryViewOfKind :: proc(self: ^CollectionViewLayout, elementKind: ^NS.String) -> ^NS.Array ---
    ...
    CollectionViewLayout_indexPathsToDeleteForDecorationViewOfKind :: proc(self: ^CollectionViewLayout, elementKind: ^NS.String) -> ^NS.Array ---
    ...
    CollectionViewLayout_indexPathsToInsertForSupplementaryViewOfKind :: proc(self: ^CollectionViewLayout, elementKind: ^NS.String) -> ^NS.Array ---
    ...
    CollectionViewLayout_indexPathsToInsertForDecorationViewOfKind :: proc(self: ^CollectionViewLayout, elementKind: ^NS.String) -> ^NS.Array ---

    @(objc_type=CollectionViewLayout, objc_selector="targetIndexPathForInteractivelyMovingItem:withPosition:", objc_name="targetIndexPathForInteractivelyMovingItem")
    CollectionViewLayout_targetIndexPathForInteractivelyMovingItem :: proc(self: ^CollectionViewLayout, previousIndexPath: ^NS.IndexPath, position: CG.Point) -> ^NS.IndexPath ---

    @(objc_type=CollectionViewLayout, objc_selector="layoutAttributesForInteractivelyMovingItemAtIndexPath:withTargetPosition:", objc_name="layoutAttributesForInteractivelyMovingItemAtIndexPath")
    CollectionViewLayout_layoutAttributesForInteractivelyMovingItemAtIndexPath :: proc(self: ^CollectionViewLayout, indexPath: ^NS.IndexPath, position: CG.Point) -> ^CollectionViewLayoutAttributes ---

    @(objc_type=CollectionViewLayout, objc_selector="invalidationContextForInteractivelyMovingItems:withTargetPosition:previousIndexPaths:previousPosition:", objc_name="invalidationContextForInteractivelyMovingItems")
    CollectionViewLayout_invalidationContextForInteractivelyMovingItems :: proc(self: ^CollectionViewLayout, targetIndexPaths: ^NS.Array, targetPosition: CG.Point, previousIndexPaths: ^NS.Array, previousPosition: CG.Point) -> ^CollectionViewLayoutInvalidationContext ---

    @(objc_type=CollectionViewLayout, objc_selector="invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths:previousIndexPaths:movementCancelled:", objc_name="invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths")
    CollectionViewLayout_invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths :: proc(self: ^CollectionViewLayout, indexPaths: ^NS.Array, previousIndexPaths: ^NS.Array, movementCancelled: bool) -> ^CollectionViewLayoutInvalidationContext ---
}
