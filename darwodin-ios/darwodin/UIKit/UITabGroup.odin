...
foreign lib {
    ...
    TabGroup_initWithTitle :: proc(self: ^TabGroup, title: ^NS.String, image: ^Image, identifier: ^NS.String, children: ^NS.Array, viewControllerProvider: ^Objc_Block(proc "c" ( _0: ^Tab ) -> ^ViewController)) -> instancetype ---
