...
IndirectScribbleInteraction :: struct {
    using _: NS.Object,
    using _: Interaction,
}
...
foreign lib {
    ...
    IndirectScribbleInteraction_init :: proc(self: ^IndirectScribbleInteraction) -> instancetype ---
    ...
    IndirectScribbleInteraction_initWithDelegate :: proc(self: ^IndirectScribbleInteraction, delegate: ^IndirectScribbleInteractionDelegate) -> instancetype ---
