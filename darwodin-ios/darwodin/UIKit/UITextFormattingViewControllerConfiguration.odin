...
TextFormattingViewControllerConfiguration_VTable :: struct {
    super: NS.Object_VTable,
    init: proc(self: ^TextFormattingViewControllerConfiguration) -> ^TextFormattingViewControllerConfiguration,
    initWithGroups: proc(self: ^TextFormattingViewControllerConfiguration, groups: ^NS.Array) -> ^TextFormattingViewControllerConfiguration,
    groups: proc(self: ^TextFormattingViewControllerConfiguration) -> ^NS.Array,
    formattingStyles: proc(self: ^TextFormattingViewControllerConfiguration) -> ^NS.Array,
    setFormattingStyles: proc(self: ^TextFormattingViewControllerConfiguration, formattingStyles: ^NS.Array),
    fontPickerConfiguration: proc(self: ^TextFormattingViewControllerConfiguration) -> ^FontPickerViewControllerConfiguration,
    setFontPickerConfiguration: proc(self: ^TextFormattingViewControllerConfiguration, fontPickerConfiguration: ^FontPickerViewControllerConfiguration),
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^TextFormattingViewControllerConfiguration,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^TextFormattingViewControllerConfiguration,
    alloc: proc() -> ^TextFormattingViewControllerConfiguration,
...
TextFormattingViewControllerConfiguration_odin_extend :: proc(cls: Class, vt: ^TextFormattingViewControllerConfiguration_VTable) {
    assert(vt != nil);
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL) -> ^TextFormattingViewControllerConfiguration {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).init(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("init"), auto_cast init, "@@:") do panic("Failed to register objC method.")
    }
    if vt.initWithGroups != nil {
        initWithGroups :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL, groups: ^NS.Array) -> ^TextFormattingViewControllerConfiguration {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).initWithGroups(self, groups)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("initWithGroups:"), auto_cast initWithGroups, "@@:@") do panic("Failed to register objC method.")
    }
    if vt.groups != nil {
        groups :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL) -> ^NS.Array {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).groups(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("groups"), auto_cast groups, "@@:") do panic("Failed to register objC method.")
    }
    if vt.formattingStyles != nil {
        formattingStyles :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL) -> ^NS.Array {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).formattingStyles(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("formattingStyles"), auto_cast formattingStyles, "@@:") do panic("Failed to register objC method.")
    }
    if vt.setFormattingStyles != nil {
        setFormattingStyles :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL, formattingStyles: ^NS.Array) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).setFormattingStyles(self, formattingStyles)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("setFormattingStyles:"), auto_cast setFormattingStyles, "v@:@") do panic("Failed to register objC method.")
    }
    if vt.fontPickerConfiguration != nil {
        fontPickerConfiguration :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL) -> ^FontPickerViewControllerConfiguration {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).fontPickerConfiguration(self)
        }
    ...
    if vt.setFontPickerConfiguration != nil {
        setFontPickerConfiguration :: proc "c" (self: ^TextFormattingViewControllerConfiguration, _: SEL, fontPickerConfiguration: ^FontPickerViewControllerConfiguration) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).setFontPickerConfiguration(self, fontPickerConfiguration)
        }
    ...
    if vt.supportsSecureCoding != nil {
        supportsSecureCoding :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).supportsSecureCoding()
        }
    ...
    if vt.load != nil {
        load :: proc "c" (self: Class, _: SEL) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).load()
        }
    ...
    if vt.initialize != nil {
        initialize :: proc "c" (self: Class, _: SEL) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).initialize()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("initialize"), auto_cast initialize, "v#:") do panic("Failed to register objC method.")
    }
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^TextFormattingViewControllerConfiguration {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).new()
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("new"), auto_cast new, "@#:") do panic("Failed to register objC method.")
    }
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^TextFormattingViewControllerConfiguration {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).allocWithZone( zone)
        }

        if !class_addMethod(meta, intrinsics.objc_find_selector("allocWithZone:"), auto_cast allocWithZone, "@#:^void") do panic("Failed to register objC method.")
    }
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^TextFormattingViewControllerConfiguration {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).alloc()
        }
    ...
    if vt.copyWithZone != nil {
        copyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).copyWithZone( zone)
        }
    ...
    if vt.mutableCopyWithZone != nil {
        mutableCopyWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> id {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).mutableCopyWithZone( zone)
        }
    ...
    if vt.instancesRespondToSelector != nil {
        instancesRespondToSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).instancesRespondToSelector( aSelector)
        }
    ...
    if vt.conformsToProtocol != nil {
        conformsToProtocol :: proc "c" (self: Class, _: SEL, protocol: ^Protocol) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).conformsToProtocol( protocol)
        }
    ...
    if vt.instanceMethodForSelector != nil {
        instanceMethodForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> IMP {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).instanceMethodForSelector( aSelector)
        }
    ...
    if vt.instanceMethodSignatureForSelector != nil {
        instanceMethodSignatureForSelector :: proc "c" (self: Class, _: SEL, aSelector: SEL) -> ^NS.MethodSignature {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).instanceMethodSignatureForSelector( aSelector)
        }
    ...
    if vt.isSubclassOfClass != nil {
        isSubclassOfClass :: proc "c" (self: Class, _: SEL, aClass: Class) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).isSubclassOfClass( aClass)
        }
    ...
    if vt.resolveClassMethod != nil {
        resolveClassMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).resolveClassMethod( sel)
        }
    ...
    if vt.resolveInstanceMethod != nil {
        resolveInstanceMethod :: proc "c" (self: Class, _: SEL, sel: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).resolveInstanceMethod( sel)
        }
    ...
    if vt.hash != nil {
        hash :: proc "c" (self: Class, _: SEL) -> NS.UInteger {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).hash()
        }
    ...
    if vt.superclass != nil {
        superclass :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).superclass()
        }
    ...
    if vt.class != nil {
        class :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).class()
        }
    ...
    if vt.description != nil {
        description :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).description()
        }
    ...
    if vt.debugDescription != nil {
        debugDescription :: proc "c" (self: Class, _: SEL) -> ^NS.String {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).debugDescription()
        }
    ...
    if vt.version != nil {
        version :: proc "c" (self: Class, _: SEL) -> NS.Integer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).version()
        }
    ...
    if vt.setVersion != nil {
        setVersion :: proc "c" (self: Class, _: SEL, aVersion: NS.Integer) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).setVersion( aVersion)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_selector_object != nil {
        cancelPreviousPerformRequestsWithTarget_selector_object :: proc "c" (self: Class, _: SEL, aTarget: id, aSelector: SEL, anArgument: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_selector_object( aTarget, aSelector, anArgument)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_ != nil {
        cancelPreviousPerformRequestsWithTarget_ :: proc "c" (self: Class, _: SEL, aTarget: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_( aTarget)
        }
    ...
    if vt.accessInstanceVariablesDirectly != nil {
        accessInstanceVariablesDirectly :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).accessInstanceVariablesDirectly()
        }
    ...
    if vt.useStoredAccessor != nil {
        useStoredAccessor :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).useStoredAccessor()
        }
    ...
    if vt.keyPathsForValuesAffectingValueForKey != nil {
        keyPathsForValuesAffectingValueForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> ^NS.Set {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).keyPathsForValuesAffectingValueForKey( key)
        }
    ...
    if vt.automaticallyNotifiesObserversForKey != nil {
        automaticallyNotifiesObserversForKey :: proc "c" (self: Class, _: SEL, key: ^NS.String) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).automaticallyNotifiesObserversForKey( key)
        }
    ...
    if vt.classFallbacksForKeyedArchiver != nil {
        classFallbacksForKeyedArchiver :: proc "c" (self: Class, _: SEL) -> ^NS.Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).classFallbacksForKeyedArchiver()
        }
    ...
    if vt.classForKeyedUnarchiver != nil {
        classForKeyedUnarchiver :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^TextFormattingViewControllerConfiguration_VTable)vt_ctx.super_vt).classForKeyedUnarchiver()
        }
