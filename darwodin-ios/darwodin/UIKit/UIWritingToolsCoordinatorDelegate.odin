...
foreign lib {
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsBoundingBezierPathsForRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" (_: ^NS.Array))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsUnderlinePathsForRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" (_: ^NS.Array))) ---
    ...
    WritingToolsCoordinatorDelegate_writingToolsCoordinator_requestsPreviewForTextAnimation_ofRange_inContext_completion :: proc(self: ^WritingToolsCoordinatorDelegate, writingToolsCoordinator: ^WritingToolsCoordinator, textAnimation: WritingToolsCoordinatorTextAnimation, range: NS._NSRange, _context: ^WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" (_: ^TargetedPreview))) ---
