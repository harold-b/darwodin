...
/// UIFontDescriptor
///
@(objc_class="UIFontDescriptor", objc_superclass=NS.Object)
...
foreign lib {
    ...
    FontDescriptor_fontDescriptorWithName_matrix :: proc(fontName: ^NS.String, _matrix: CG.AffineTransform) -> ^FontDescriptor ---

    @(objc_type=FontDescriptor, objc_selector="preferredFontDescriptorWithTextStyle:", objc_name="preferredFontDescriptorWithTextStyle_", objc_is_class_method=true)
    FontDescriptor_preferredFontDescriptorWithTextStyle_ :: proc(style: ^NS.String) -> ^FontDescriptor ---

    @(objc_type=FontDescriptor, objc_selector="preferredFontDescriptorWithTextStyle:compatibleWithTraitCollection:", objc_name="preferredFontDescriptorWithTextStyle_compatibleWithTraitCollection", objc_is_class_method=true)
    ...
    FontDescriptor_fontDescriptorWithMatrix :: proc(self: ^FontDescriptor, _matrix: CG.AffineTransform) -> ^FontDescriptor ---
    ...
    FontDescriptor_matrix :: proc(self: ^FontDescriptor) -> CG.AffineTransform ---
