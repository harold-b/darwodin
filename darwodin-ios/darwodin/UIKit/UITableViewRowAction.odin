...
TableViewRowAction_rowActionWithStyle :: #force_inline proc "c" (style: TableViewRowActionStyle, title: ^NS.String, handler: ^Objc_Block(proc "c" (action: ^TableViewRowAction, indexPath: ^NS.IndexPath))) -> ^TableViewRowAction {
