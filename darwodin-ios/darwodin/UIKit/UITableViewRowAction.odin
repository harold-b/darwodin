...
foreign lib {
    ...
    TableViewRowAction_rowActionWithStyle :: proc(style: TableViewRowActionStyle, title: ^NS.String, handler: ^Objc_Block(proc "c" (action: ^TableViewRowAction, indexPath: ^NS.IndexPath))) -> instancetype ---
