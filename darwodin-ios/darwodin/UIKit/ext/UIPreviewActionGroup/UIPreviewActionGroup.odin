package darwodin_UIPreviewActionGroup_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.PreviewActionGroup,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PreviewActionGroup,
    alloc: proc() -> ^UI.PreviewActionGroup,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.actionGroupWithTitle != nil {
        actionGroupWithTitle :: proc "c" (self: Class, _: SEL, title: ^NS.String, style: UI.PreviewActionStyle, actions: ^NS.Array) -> ^UI.PreviewActionGroup {
            ...
            return (cast(^VTable)vt_ctx.super_vt).actionGroupWithTitle( title, style, actions)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PreviewActionGroup {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PreviewActionGroup {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PreviewActionGroup {
