...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CollectionViewSupplementaryRegistration,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewSupplementaryRegistration,
    alloc: proc() -> ^UI.CollectionViewSupplementaryRegistration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewSupplementaryRegistration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewSupplementaryRegistration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewSupplementaryRegistration {
