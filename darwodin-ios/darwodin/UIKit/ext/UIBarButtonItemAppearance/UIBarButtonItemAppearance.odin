...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.BarButtonItemAppearance,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.BarButtonItemAppearance,
    alloc: proc() -> ^UI.BarButtonItemAppearance,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.BarButtonItemAppearance {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.BarButtonItemAppearance {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.BarButtonItemAppearance {
