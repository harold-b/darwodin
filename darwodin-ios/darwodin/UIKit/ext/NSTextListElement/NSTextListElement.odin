...
VTable :: struct {
    ...
    initWithParentElement: proc(self: ^UI.NSTextListElement, parent: ^UI.NSTextListElement, textList: ^UI.NSTextList, contents: ^NS.AttributedString, markerAttributes: ^NS.Dictionary, children: ^NS.Array) -> instancetype,
    initWithAttributedString: proc(self: ^UI.NSTextListElement, attributedString: ^NS.AttributedString) -> instancetype,
    textListElementWithContents: proc(contents: ^NS.AttributedString, markerAttributes: ^NS.Dictionary, textList: ^UI.NSTextList, children: ^NS.Array) -> instancetype,
    textListElementWithChildElements: proc(children: ^NS.Array, textList: ^UI.NSTextList, nestingLevel: NS.Integer) -> instancetype,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithParentElement != nil {
        initWithParentElement :: proc "c" (self: ^UI.NSTextListElement, _: SEL, parent: ^UI.NSTextListElement, textList: ^UI.NSTextList, contents: ^NS.AttributedString, markerAttributes: ^NS.Dictionary, children: ^NS.Array) -> instancetype {
    ...
    if vt.initWithAttributedString != nil {
        initWithAttributedString :: proc "c" (self: ^UI.NSTextListElement, _: SEL, attributedString: ^NS.AttributedString) -> instancetype {
    ...
    if vt.textListElementWithContents != nil {
        textListElementWithContents :: proc "c" (self: Class, _: SEL, contents: ^NS.AttributedString, markerAttributes: ^NS.Dictionary, textList: ^UI.NSTextList, children: ^NS.Array) -> instancetype {
    ...
    if vt.textListElementWithChildElements != nil {
        textListElementWithChildElements :: proc "c" (self: Class, _: SEL, children: ^NS.Array, textList: ^UI.NSTextList, nestingLevel: NS.Integer) -> instancetype {
