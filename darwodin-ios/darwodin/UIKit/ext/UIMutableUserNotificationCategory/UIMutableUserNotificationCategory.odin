...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.MutableUserNotificationCategory,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.MutableUserNotificationCategory,
    alloc: proc() -> ^UI.MutableUserNotificationCategory,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.MutableUserNotificationCategory {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.MutableUserNotificationCategory {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.MutableUserNotificationCategory {
