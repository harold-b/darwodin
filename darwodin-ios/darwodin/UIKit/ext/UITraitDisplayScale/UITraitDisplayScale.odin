package darwodin_UITraitDisplayScale_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitDisplayScale,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitDisplayScale,
    alloc: proc() -> ^UI.TraitDisplayScale,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitDisplayScale {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitDisplayScale {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitDisplayScale {
