...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CollectionViewLayoutAttributes,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewLayoutAttributes,
    alloc: proc() -> ^UI.CollectionViewLayoutAttributes,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewLayoutAttributes {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewLayoutAttributes {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewLayoutAttributes {
