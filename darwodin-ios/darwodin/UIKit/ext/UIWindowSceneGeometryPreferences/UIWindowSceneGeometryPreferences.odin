package darwodin_UIWindowSceneGeometryPreferences_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferences,
    alloc: proc() -> ^UI.WindowSceneGeometryPreferences,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferences {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferences {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferences {
