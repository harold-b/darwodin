...
VTable :: struct {
    ...
    new: proc() -> ^UI.WindowSceneGeometryPreferencesIOS,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesIOS,
    alloc: proc() -> ^UI.WindowSceneGeometryPreferencesIOS,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesIOS {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesIOS {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesIOS {
