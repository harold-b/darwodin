...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSDiffableDataSourceTransaction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSDiffableDataSourceTransaction,
    alloc: proc() -> ^UI.NSDiffableDataSourceTransaction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSDiffableDataSourceTransaction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSDiffableDataSourceTransaction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSDiffableDataSourceTransaction {
