...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Nib,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Nib,
    alloc: proc() -> ^UI.Nib,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Nib {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Nib {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Nib {
