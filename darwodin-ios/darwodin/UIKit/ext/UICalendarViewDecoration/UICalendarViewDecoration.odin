...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CalendarViewDecoration,
    alloc: proc() -> ^UI.CalendarViewDecoration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarViewDecoration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CalendarViewDecoration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarViewDecoration {
