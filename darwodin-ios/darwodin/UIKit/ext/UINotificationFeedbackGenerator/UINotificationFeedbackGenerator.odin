...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NotificationFeedbackGenerator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NotificationFeedbackGenerator,
    alloc: proc() -> ^UI.NotificationFeedbackGenerator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NotificationFeedbackGenerator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NotificationFeedbackGenerator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NotificationFeedbackGenerator {
