...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SceneActivationRequestOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SceneActivationRequestOptions,
    alloc: proc() -> ^UI.SceneActivationRequestOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SceneActivationRequestOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SceneActivationRequestOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SceneActivationRequestOptions {
