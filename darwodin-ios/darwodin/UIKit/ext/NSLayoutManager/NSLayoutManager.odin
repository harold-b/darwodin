...
VTable :: struct {
    ...
    enumerateLineFragmentsForGlyphRange: proc(self: ^UI.NSLayoutManager, glyphRange: NS._NSRange, block: proc "c" (rect: CG.Rect, usedRect: CG.Rect, textContainer: ^UI.NSTextContainer, glyphRange: NS._NSRange, stop: ^bool)),
    enumerateEnclosingRectsForGlyphRange: proc(self: ^UI.NSLayoutManager, glyphRange: NS._NSRange, selectedRange: NS._NSRange, textContainer: ^UI.NSTextContainer, block: proc "c" (rect: CG.Rect, stop: ^bool)),
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSLayoutManager,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSLayoutManager,
    alloc: proc() -> ^UI.NSLayoutManager,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.enumerateLineFragmentsForGlyphRange != nil {
        enumerateLineFragmentsForGlyphRange :: proc "c" (self: ^UI.NSLayoutManager, _: SEL, glyphRange: NS._NSRange, block: proc "c" (rect: CG.Rect, usedRect: CG.Rect, textContainer: ^UI.NSTextContainer, glyphRange: NS._NSRange, stop: ^bool)) {
    ...
    if vt.enumerateEnclosingRectsForGlyphRange != nil {
        enumerateEnclosingRectsForGlyphRange :: proc "c" (self: ^UI.NSLayoutManager, _: SEL, glyphRange: NS._NSRange, selectedRange: NS._NSRange, textContainer: ^UI.NSTextContainer, block: proc "c" (rect: CG.Rect, stop: ^bool)) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutManager {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSLayoutManager {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutManager {
