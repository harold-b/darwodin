...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Stepper,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Stepper,
    alloc: proc() -> ^UI.Stepper,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Stepper {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Stepper {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Stepper {
