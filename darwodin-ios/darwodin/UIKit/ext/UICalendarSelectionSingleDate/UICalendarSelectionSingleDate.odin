...
VTable :: struct {
    ...
    new: proc() -> ^UI.CalendarSelectionSingleDate,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CalendarSelectionSingleDate,
    alloc: proc() -> ^UI.CalendarSelectionSingleDate,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelectionSingleDate {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CalendarSelectionSingleDate {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelectionSingleDate {
