...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.WindowSceneActivationRequestOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneActivationRequestOptions,
    alloc: proc() -> ^UI.WindowSceneActivationRequestOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneActivationRequestOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneActivationRequestOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneActivationRequestOptions {
