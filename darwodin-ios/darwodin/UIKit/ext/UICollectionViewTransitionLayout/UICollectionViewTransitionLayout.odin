...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CollectionViewTransitionLayout,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewTransitionLayout,
    alloc: proc() -> ^UI.CollectionViewTransitionLayout,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewTransitionLayout {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewTransitionLayout {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewTransitionLayout {
