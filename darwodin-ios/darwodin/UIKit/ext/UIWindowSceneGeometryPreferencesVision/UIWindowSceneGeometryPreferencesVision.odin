...
VTable :: struct {
    ...
    new: proc() -> ^UI.WindowSceneGeometryPreferencesVision,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesVision,
    alloc: proc() -> ^UI.WindowSceneGeometryPreferencesVision,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesVision {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesVision {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesVision {
