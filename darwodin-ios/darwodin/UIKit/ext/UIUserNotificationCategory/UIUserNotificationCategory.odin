package darwodin_UIUserNotificationCategory_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.UserNotificationCategory,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.UserNotificationCategory,
    alloc: proc() -> ^UI.UserNotificationCategory,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.actionsForContext != nil {
        actionsForContext :: proc "c" (self: ^UI.UserNotificationCategory, _: SEL, _context: UI.UserNotificationActionContext) -> ^NS.Array {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).actionsForContext(self, _context)
        }
    ...
    if vt.identifier != nil {
        identifier :: proc "c" (self: ^UI.UserNotificationCategory, _: SEL) -> ^NS.String {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.UserNotificationCategory {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.UserNotificationCategory {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.UserNotificationCategory {
