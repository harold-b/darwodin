...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Event,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Event,
    alloc: proc() -> ^UI.Event,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Event {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Event {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Event {
