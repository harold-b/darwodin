...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.DocumentViewControllerLaunchOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.DocumentViewControllerLaunchOptions,
    alloc: proc() -> ^UI.DocumentViewControllerLaunchOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentViewControllerLaunchOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.DocumentViewControllerLaunchOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentViewControllerLaunchOptions {
