...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.LargeContentViewerInteraction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.LargeContentViewerInteraction,
    alloc: proc() -> ^UI.LargeContentViewerInteraction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.LargeContentViewerInteraction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.LargeContentViewerInteraction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.LargeContentViewerInteraction {
