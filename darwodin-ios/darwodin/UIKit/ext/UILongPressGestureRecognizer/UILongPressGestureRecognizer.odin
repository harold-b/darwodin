...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.LongPressGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.LongPressGestureRecognizer,
    alloc: proc() -> ^UI.LongPressGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.LongPressGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.LongPressGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.LongPressGestureRecognizer {
