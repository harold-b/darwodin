...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.DocumentInteractionController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.DocumentInteractionController,
    alloc: proc() -> ^UI.DocumentInteractionController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentInteractionController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.DocumentInteractionController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentInteractionController {
