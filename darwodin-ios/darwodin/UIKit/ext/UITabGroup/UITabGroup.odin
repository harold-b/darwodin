...
VTable :: struct {
    ...
    initWithTitle: proc(self: ^UI.TabGroup, title: ^NS.String, image: ^UI.Image, identifier: ^NS.String, children: ^NS.Array, viewControllerProvider: ^Objc_Block(proc "c" (_: ^UI.Tab) -> ^UI.ViewController)) -> instancetype,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithTitle != nil {
        initWithTitle :: proc "c" (self: ^UI.TabGroup, _: SEL, title: ^NS.String, image: ^UI.Image, identifier: ^NS.String, children: ^NS.Array, viewControllerProvider: ^Objc_Block(proc "c" (_: ^UI.Tab) -> ^UI.ViewController)) -> instancetype {
