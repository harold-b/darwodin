...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SimpleTextPrintFormatter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SimpleTextPrintFormatter,
    alloc: proc() -> ^UI.SimpleTextPrintFormatter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SimpleTextPrintFormatter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SimpleTextPrintFormatter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SimpleTextPrintFormatter {
