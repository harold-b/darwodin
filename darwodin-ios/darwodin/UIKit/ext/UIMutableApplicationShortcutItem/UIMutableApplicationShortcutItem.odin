...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.MutableApplicationShortcutItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.MutableApplicationShortcutItem,
    alloc: proc() -> ^UI.MutableApplicationShortcutItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.MutableApplicationShortcutItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.MutableApplicationShortcutItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.MutableApplicationShortcutItem {
