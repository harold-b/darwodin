...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Toolbar,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Toolbar,
    alloc: proc() -> ^UI.Toolbar,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Toolbar {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Toolbar {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Toolbar {
