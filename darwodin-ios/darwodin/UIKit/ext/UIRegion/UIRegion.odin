...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Region,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Region,
    alloc: proc() -> ^UI.Region,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Region {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Region {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Region {
