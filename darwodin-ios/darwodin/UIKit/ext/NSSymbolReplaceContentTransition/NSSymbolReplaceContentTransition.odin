...
VTable :: struct {
    ...
    new: proc() -> ^UI.NSSymbolReplaceContentTransition,
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSSymbolReplaceContentTransition,
    alloc: proc() -> ^UI.NSSymbolReplaceContentTransition,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.magicTransitionWithFallback != nil {
        magicTransitionWithFallback :: proc "c" (self: Class, _: SEL, fallback: ^UI.NSSymbolReplaceContentTransition) -> ^UI.NSSymbolMagicReplaceContentTransition {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolReplaceContentTransition {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSSymbolReplaceContentTransition {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolReplaceContentTransition {
