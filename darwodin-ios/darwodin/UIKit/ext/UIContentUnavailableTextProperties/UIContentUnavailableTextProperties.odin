...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ContentUnavailableTextProperties,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ContentUnavailableTextProperties,
    alloc: proc() -> ^UI.ContentUnavailableTextProperties,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableTextProperties {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ContentUnavailableTextProperties {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableTextProperties {
