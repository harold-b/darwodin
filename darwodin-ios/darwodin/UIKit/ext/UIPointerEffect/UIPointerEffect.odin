package darwodin_UIPointerEffect_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PointerEffect,
    alloc: proc() -> ^UI.PointerEffect,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PointerEffect {
    ...
    if vt.preview != nil {
        preview :: proc "c" (self: ^UI.PointerEffect, _: SEL) -> ^UI.TargetedPreview {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PointerEffect {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PointerEffect {
