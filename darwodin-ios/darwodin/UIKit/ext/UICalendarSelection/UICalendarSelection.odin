package darwodin_UICalendarSelection_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CalendarSelection,
    alloc: proc() -> ^UI.CalendarSelection,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.updateSelectableDates != nil {
        updateSelectableDates :: proc "c" (self: ^UI.CalendarSelection, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).updateSelectableDates(self)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelection {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CalendarSelection {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelection {
