...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.UserNotificationSettings,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.UserNotificationSettings,
    alloc: proc() -> ^UI.UserNotificationSettings,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.UserNotificationSettings {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.UserNotificationSettings {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.UserNotificationSettings {
