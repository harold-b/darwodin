...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.GraphicsPDFRendererContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.GraphicsPDFRendererContext,
    alloc: proc() -> ^UI.GraphicsPDFRendererContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRendererContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.GraphicsPDFRendererContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRendererContext {
