...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSLayoutXAxisAnchor,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSLayoutXAxisAnchor,
    alloc: proc() -> ^UI.NSLayoutXAxisAnchor,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutXAxisAnchor {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSLayoutXAxisAnchor {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutXAxisAnchor {
