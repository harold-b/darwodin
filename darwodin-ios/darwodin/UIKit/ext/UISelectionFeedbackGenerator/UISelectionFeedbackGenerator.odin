...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SelectionFeedbackGenerator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SelectionFeedbackGenerator,
    alloc: proc() -> ^UI.SelectionFeedbackGenerator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SelectionFeedbackGenerator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SelectionFeedbackGenerator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SelectionFeedbackGenerator {
