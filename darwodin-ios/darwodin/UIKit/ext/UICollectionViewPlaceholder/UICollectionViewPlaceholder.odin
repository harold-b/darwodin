package darwodin_UICollectionViewPlaceholder_Ext
...
VTable :: struct {
    ...
    alloc: proc() -> ^UI.CollectionViewPlaceholder,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithInsertionIndexPath != nil {
        initWithInsertionIndexPath :: proc "c" (self: ^UI.CollectionViewPlaceholder, _: SEL, insertionIndexPath: ^NS.IndexPath, reuseIdentifier: ^NS.String) -> ^UI.CollectionViewPlaceholder {
            ...
            return (cast(^VTable)vt_ctx.super_vt).initWithInsertionIndexPath(self, insertionIndexPath, reuseIdentifier)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewPlaceholder {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewPlaceholder {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewPlaceholder {
