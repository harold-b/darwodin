...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.DocumentPickerExtensionViewController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.DocumentPickerExtensionViewController,
    alloc: proc() -> ^UI.DocumentPickerExtensionViewController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentPickerExtensionViewController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.DocumentPickerExtensionViewController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentPickerExtensionViewController {
