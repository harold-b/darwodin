...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.AccessibilityCustomRotorSearchPredicate,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotorSearchPredicate,
    alloc: proc() -> ^UI.AccessibilityCustomRotorSearchPredicate,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotorSearchPredicate {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotorSearchPredicate {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotorSearchPredicate {
