...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TextInputStringTokenizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TextInputStringTokenizer,
    alloc: proc() -> ^UI.TextInputStringTokenizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TextInputStringTokenizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TextInputStringTokenizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TextInputStringTokenizer {
