...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.GraphicsImageRendererFormat,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.GraphicsImageRendererFormat,
    alloc: proc() -> ^UI.GraphicsImageRendererFormat,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsImageRendererFormat {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.GraphicsImageRendererFormat {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsImageRendererFormat {
