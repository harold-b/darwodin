...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ActivityIndicatorView,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ActivityIndicatorView,
    alloc: proc() -> ^UI.ActivityIndicatorView,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ActivityIndicatorView {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ActivityIndicatorView {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ActivityIndicatorView {
