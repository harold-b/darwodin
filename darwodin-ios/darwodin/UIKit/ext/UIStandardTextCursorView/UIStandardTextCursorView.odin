package darwodin_UIStandardTextCursorView_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.StandardTextCursorView,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.StandardTextCursorView,
    alloc: proc() -> ^UI.StandardTextCursorView,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.StandardTextCursorView {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.StandardTextCursorView {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.StandardTextCursorView {
