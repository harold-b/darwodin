...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Device,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Device,
    alloc: proc() -> ^UI.Device,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Device {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Device {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Device {
