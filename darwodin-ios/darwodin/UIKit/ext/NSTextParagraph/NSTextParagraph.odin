...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSTextParagraph,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSTextParagraph,
    alloc: proc() -> ^UI.NSTextParagraph,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.attributedString != nil {
        attributedString :: proc "c" (self: ^UI.NSTextParagraph, _: SEL) -> ^NS.AttributedString {
    ...
    if vt.paragraphContentRange != nil {
        paragraphContentRange :: proc "c" (self: ^UI.NSTextParagraph, _: SEL) -> ^UI.NSTextRange {
    ...
    if vt.paragraphSeparatorRange != nil {
        paragraphSeparatorRange :: proc "c" (self: ^UI.NSTextParagraph, _: SEL) -> ^UI.NSTextRange {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSTextParagraph {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSTextParagraph {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSTextParagraph {
