...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.BarItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.BarItem,
    alloc: proc() -> ^UI.BarItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.BarItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.BarItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.BarItem {
