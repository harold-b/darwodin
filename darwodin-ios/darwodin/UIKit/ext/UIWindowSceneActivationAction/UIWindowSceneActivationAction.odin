...
VTable :: struct {
    ...
    new: proc() -> ^UI.WindowSceneActivationAction,
    captureTextFromCameraActionForResponder: proc(responder: ^UI.Responder, identifier: ^NS.String) -> ^UI.Action,
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneActivationAction,
    alloc: proc() -> ^UI.WindowSceneActivationAction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneActivationAction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneActivationAction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneActivationAction {
