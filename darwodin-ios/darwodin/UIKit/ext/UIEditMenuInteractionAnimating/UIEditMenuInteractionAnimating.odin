...
VTable :: struct {
    addAnimations: proc(self: ^UI.EditMenuInteractionAnimating, animations: proc "c" ()),
    addCompletion: proc(self: ^UI.EditMenuInteractionAnimating, completion: proc "c" ()),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.addAnimations != nil {
        addAnimations :: proc "c" (self: ^UI.EditMenuInteractionAnimating, _: SEL, animations: proc "c" ()) {
    ...
    if vt.addCompletion != nil {
        addCompletion :: proc "c" (self: ^UI.EditMenuInteractionAnimating, _: SEL, completion: proc "c" ()) {
