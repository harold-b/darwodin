package darwodin_UIEditMenuInteractionAnimating_Ext
...
VTable :: struct {
    addAnimations: proc(self: ^UI.EditMenuInteractionAnimating, animations: ^Objc_Block(proc "c" ())),
    addCompletion: proc(self: ^UI.EditMenuInteractionAnimating, completion: ^Objc_Block(proc "c" ())),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.addAnimations != nil {
        addAnimations :: proc "c" (self: ^UI.EditMenuInteractionAnimating, _: SEL, animations: ^Objc_Block(proc "c" ())) {
    ...
    if vt.addCompletion != nil {
        addCompletion :: proc "c" (self: ^UI.EditMenuInteractionAnimating, _: SEL, completion: ^Objc_Block(proc "c" ())) {
