...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSTextList,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSTextList,
    alloc: proc() -> ^UI.NSTextList,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.markerForItemNumber != nil {
        markerForItemNumber :: proc "c" (self: ^UI.NSTextList, _: SEL, itemNumber: NS.Integer) -> ^NS.String {
    ...
    if vt.markerFormat != nil {
        markerFormat :: proc "c" (self: ^UI.NSTextList, _: SEL) -> ^NS.String {
    ...
    if vt.listOptions != nil {
        listOptions :: proc "c" (self: ^UI.NSTextList, _: SEL) -> UI.NSTextListOptions {
    ...
    if vt.startingItemNumber != nil {
        startingItemNumber :: proc "c" (self: ^UI.NSTextList, _: SEL) -> NS.Integer {
    ...
    if vt.setStartingItemNumber != nil {
        setStartingItemNumber :: proc "c" (self: ^UI.NSTextList, _: SEL, startingItemNumber: NS.Integer) {
    ...
    if vt.isOrdered != nil {
        isOrdered :: proc "c" (self: ^UI.NSTextList, _: SEL) -> bool {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSTextList {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSTextList {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSTextList {
