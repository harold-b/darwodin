...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TextDragPreviewRenderer,
    alloc: proc() -> ^UI.TextDragPreviewRenderer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TextDragPreviewRenderer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TextDragPreviewRenderer {
