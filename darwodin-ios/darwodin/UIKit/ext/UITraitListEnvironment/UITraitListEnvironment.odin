package darwodin_UITraitListEnvironment_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitListEnvironment,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitListEnvironment,
    alloc: proc() -> ^UI.TraitListEnvironment,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitListEnvironment {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitListEnvironment {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitListEnvironment {
