...
VTable :: struct {
    ...
    new: proc() -> ^UI.WindowSceneGeometryPreferencesMac,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesMac,
    alloc: proc() -> ^UI.WindowSceneGeometryPreferencesMac,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesMac {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneGeometryPreferencesMac {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneGeometryPreferencesMac {
