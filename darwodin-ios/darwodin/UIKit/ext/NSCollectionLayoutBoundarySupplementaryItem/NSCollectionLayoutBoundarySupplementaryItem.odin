...
VTable :: struct {
    ...
    pinToVisibleBounds: proc(self: ^UI.NSCollectionLayoutBoundarySupplementaryItem) -> bool,
    setPinToVisibleBounds: proc(self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, pinToVisibleBounds: bool),
    alignment: proc(self: ^UI.NSCollectionLayoutBoundarySupplementaryItem) -> UI.NSRectAlignment,
    offset: proc(self: ^UI.NSCollectionLayoutBoundarySupplementaryItem) -> CG.Point,
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSCollectionLayoutBoundarySupplementaryItem,
    alloc: proc() -> ^UI.NSCollectionLayoutBoundarySupplementaryItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSCollectionLayoutBoundarySupplementaryItem {
    ...
    if vt.extendsBoundary != nil {
        extendsBoundary :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL) -> bool {
    ...
    if vt.setExtendsBoundary != nil {
        setExtendsBoundary :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL, extendsBoundary: bool) {
    ...
    if vt.pinToVisibleBounds != nil {
        pinToVisibleBounds :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL) -> bool {
    ...
    if vt.setPinToVisibleBounds != nil {
        setPinToVisibleBounds :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL, pinToVisibleBounds: bool) {
    ...
    if vt.alignment != nil {
        alignment :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL) -> UI.NSRectAlignment {
    ...
    if vt.offset != nil {
        offset :: proc "c" (self: ^UI.NSCollectionLayoutBoundarySupplementaryItem, _: SEL) -> CG.Point {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSCollectionLayoutBoundarySupplementaryItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSCollectionLayoutBoundarySupplementaryItem {
