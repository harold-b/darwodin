package darwodin_UIPointerHighlightEffect_Ext
...
VTable :: struct {
    ...
    new: proc() -> ^UI.PointerHighlightEffect,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PointerHighlightEffect,
    alloc: proc() -> ^UI.PointerHighlightEffect,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithPreview != nil {
        effectWithPreview :: proc "c" (self: Class, _: SEL, preview: ^UI.TargetedPreview) -> ^UI.PointerEffect {
            ...
            return (cast(^VTable)vt_ctx.super_vt).effectWithPreview( preview)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PointerHighlightEffect {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PointerHighlightEffect {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PointerHighlightEffect {
