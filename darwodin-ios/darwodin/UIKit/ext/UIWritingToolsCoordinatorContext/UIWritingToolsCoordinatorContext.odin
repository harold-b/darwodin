package darwodin_UIWritingToolsCoordinatorContext_Ext
...
VTable :: struct {
    ...
    resolvedRange: proc(self: ^UI.WritingToolsCoordinatorContext) -> NS._NSRange,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.attributedString != nil {
        attributedString :: proc "c" (self: ^UI.WritingToolsCoordinatorContext, _: SEL) -> ^NS.AttributedString {
    ...
    if vt.range != nil {
        range :: proc "c" (self: ^UI.WritingToolsCoordinatorContext, _: SEL) -> NS._NSRange {
    ...
    if vt.identifier != nil {
        identifier :: proc "c" (self: ^UI.WritingToolsCoordinatorContext, _: SEL) -> ^NS.UUID {
    ...
    if vt.resolvedRange != nil {
        resolvedRange :: proc "c" (self: ^UI.WritingToolsCoordinatorContext, _: SEL) -> NS._NSRange {
