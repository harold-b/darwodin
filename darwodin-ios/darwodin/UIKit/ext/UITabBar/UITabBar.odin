...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.TabBar,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TabBar,
    alloc: proc() -> ^UI.TabBar,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TabBar {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TabBar {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TabBar {
