package darwodin_UITraitUserInterfaceLevel_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitUserInterfaceLevel,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitUserInterfaceLevel,
    alloc: proc() -> ^UI.TraitUserInterfaceLevel,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitUserInterfaceLevel {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitUserInterfaceLevel {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitUserInterfaceLevel {
