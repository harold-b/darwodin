...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ContentUnavailableButtonProperties,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ContentUnavailableButtonProperties,
    alloc: proc() -> ^UI.ContentUnavailableButtonProperties,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableButtonProperties {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ContentUnavailableButtonProperties {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableButtonProperties {
