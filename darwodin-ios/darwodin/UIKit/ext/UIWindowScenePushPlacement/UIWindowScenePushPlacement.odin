package darwodin_UIWindowScenePushPlacement_Ext
...
VTable :: struct {
    ...
    new: proc() -> ^UI.WindowScenePushPlacement,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowScenePushPlacement,
    alloc: proc() -> ^UI.WindowScenePushPlacement,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.placementTargetingSceneSession != nil {
        placementTargetingSceneSession :: proc "c" (self: Class, _: SEL, targetSceneSession: ^UI.SceneSession) -> ^UI.WindowScenePushPlacement {
            ...
            return (cast(^VTable)vt_ctx.super_vt).placementTargetingSceneSession( targetSceneSession)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowScenePushPlacement {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowScenePushPlacement {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowScenePushPlacement {
