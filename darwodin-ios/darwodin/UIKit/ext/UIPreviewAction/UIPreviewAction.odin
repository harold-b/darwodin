package darwodin_UIPreviewAction_Ext
...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PreviewAction,
    alloc: proc() -> ^UI.PreviewAction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PreviewAction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PreviewAction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PreviewAction {
