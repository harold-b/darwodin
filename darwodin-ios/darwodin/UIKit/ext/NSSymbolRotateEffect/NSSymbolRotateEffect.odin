...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^UI.NSSymbolRotateEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^UI.NSSymbolRotateEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^UI.NSSymbolRotateEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^UI.NSSymbolRotateEffect, _: SEL) -> instancetype {
