package darwodin_UICollectionViewUpdateItem_Ext
...
VTable :: struct {
    ...
    indexPathBeforeUpdate: proc(self: ^UI.CollectionViewUpdateItem) -> ^NS.IndexPath,
    indexPathAfterUpdate: proc(self: ^UI.CollectionViewUpdateItem) -> ^NS.IndexPath,
    updateAction: proc(self: ^UI.CollectionViewUpdateItem) -> UI.CollectionUpdateAction,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CollectionViewUpdateItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewUpdateItem,
    alloc: proc() -> ^UI.CollectionViewUpdateItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.indexPathBeforeUpdate != nil {
        indexPathBeforeUpdate :: proc "c" (self: ^UI.CollectionViewUpdateItem, _: SEL) -> ^NS.IndexPath {
    ...
    if vt.indexPathAfterUpdate != nil {
        indexPathAfterUpdate :: proc "c" (self: ^UI.CollectionViewUpdateItem, _: SEL) -> ^NS.IndexPath {
    ...
    if vt.updateAction != nil {
        updateAction :: proc "c" (self: ^UI.CollectionViewUpdateItem, _: SEL) -> UI.CollectionUpdateAction {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewUpdateItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewUpdateItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewUpdateItem {
