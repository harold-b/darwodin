...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TextCursorDropPositionAnimator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TextCursorDropPositionAnimator,
    alloc: proc() -> ^UI.TextCursorDropPositionAnimator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TextCursorDropPositionAnimator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TextCursorDropPositionAnimator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TextCursorDropPositionAnimator {
