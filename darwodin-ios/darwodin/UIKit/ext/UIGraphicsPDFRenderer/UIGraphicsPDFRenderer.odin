...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.GraphicsPDFRenderer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.GraphicsPDFRenderer,
    alloc: proc() -> ^UI.GraphicsPDFRenderer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRenderer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.GraphicsPDFRenderer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRenderer {
