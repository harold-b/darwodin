...
VTable :: struct {
    ...
    init: proc(self: ^UI.WritingToolsCoordinatorAnimationParameters) -> instancetype,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^UI.WritingToolsCoordinatorAnimationParameters, _: SEL) -> instancetype {
