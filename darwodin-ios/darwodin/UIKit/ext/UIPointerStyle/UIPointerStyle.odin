...
VTable :: struct {
    ...
    styleWithShape_constrainedAxes: proc(shape: ^UI.PointerShape, axes: UI.Axis) -> ^UI.PointerStyle,
    ...
    styleWithShape_: proc(shape: ^UI.Shape) -> ^UI.HoverStyle,
    automaticStyle: proc() -> ^UI.HoverStyle,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PointerStyle,
    alloc: proc() -> ^UI.PointerStyle,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.styleWithShape_constrainedAxes != nil {
        styleWithShape_constrainedAxes :: proc "c" (self: Class, _: SEL, shape: ^UI.PointerShape, axes: UI.Axis) -> ^UI.PointerStyle {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).styleWithShape_constrainedAxes( shape, axes)
        }
    ...
    if vt.styleWithShape_ != nil {
        styleWithShape_ :: proc "c" (self: Class, _: SEL, shape: ^UI.Shape) -> ^UI.HoverStyle {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).styleWithShape_( shape)
        }
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PointerStyle {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PointerStyle {
