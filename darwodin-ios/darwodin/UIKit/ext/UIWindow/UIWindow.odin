...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Window,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Window,
    alloc: proc() -> ^UI.Window,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Window {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Window {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Window {
