package darwodin_UITraitLegibilityWeight_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitLegibilityWeight,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitLegibilityWeight,
    alloc: proc() -> ^UI.TraitLegibilityWeight,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitLegibilityWeight {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitLegibilityWeight {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitLegibilityWeight {
