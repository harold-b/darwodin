...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSDiffableDataSourceSectionTransaction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSDiffableDataSourceSectionTransaction,
    alloc: proc() -> ^UI.NSDiffableDataSourceSectionTransaction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSDiffableDataSourceSectionTransaction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSDiffableDataSourceSectionTransaction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSDiffableDataSourceSectionTransaction {
