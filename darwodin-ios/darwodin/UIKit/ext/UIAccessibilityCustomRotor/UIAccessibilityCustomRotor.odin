...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.AccessibilityCustomRotor,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotor,
    alloc: proc() -> ^UI.AccessibilityCustomRotor,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotor {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotor {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotor {
