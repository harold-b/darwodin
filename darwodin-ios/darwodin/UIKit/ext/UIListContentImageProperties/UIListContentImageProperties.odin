...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ListContentImageProperties,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ListContentImageProperties,
    alloc: proc() -> ^UI.ListContentImageProperties,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ListContentImageProperties {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ListContentImageProperties {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ListContentImageProperties {
