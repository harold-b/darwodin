...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.GraphicsRendererFormat,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.GraphicsRendererFormat,
    alloc: proc() -> ^UI.GraphicsRendererFormat,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsRendererFormat {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.GraphicsRendererFormat {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsRendererFormat {
