package darwodin_UIFocusAnimationCoordinator_Ext
...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.FocusAnimationCoordinator,
    alloc: proc() -> ^UI.FocusAnimationCoordinator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.addCoordinatedAnimations != nil {
        addCoordinatedAnimations :: proc "c" (self: ^UI.FocusAnimationCoordinator, _: SEL, animations: proc "c" (), completion: proc "c" ()) {
            ...
            (cast(^VTable)vt_ctx.super_vt).addCoordinatedAnimations(self, animations, completion)
        }
    ...
    if vt.addCoordinatedFocusingAnimations != nil {
        addCoordinatedFocusingAnimations :: proc "c" (self: ^UI.FocusAnimationCoordinator, _: SEL, animations: proc "c" (animationContext: ^UI.FocusAnimationContext), completion: proc "c" ()) {
            ...
            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).addCoordinatedFocusingAnimations(self, animations, completion)
        }
    ...
    if vt.addCoordinatedUnfocusingAnimations != nil {
        addCoordinatedUnfocusingAnimations :: proc "c" (self: ^UI.FocusAnimationCoordinator, _: SEL, animations: proc "c" (animationContext: ^UI.FocusAnimationContext), completion: proc "c" ()) {
            ...
            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).addCoordinatedUnfocusingAnimations(self, animations, completion)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.FocusAnimationCoordinator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.FocusAnimationCoordinator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.FocusAnimationCoordinator {
