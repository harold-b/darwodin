...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewDiffableDataSourceSectionSnapshotHandlers,
    alloc: proc() -> ^UI.CollectionViewDiffableDataSourceSectionSnapshotHandlers,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewDiffableDataSourceSectionSnapshotHandlers {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewDiffableDataSourceSectionSnapshotHandlers {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewDiffableDataSourceSectionSnapshotHandlers {
