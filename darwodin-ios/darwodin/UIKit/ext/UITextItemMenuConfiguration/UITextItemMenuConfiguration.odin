package darwodin_UITextItemMenuConfiguration_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TextItemMenuConfiguration,
    alloc: proc() -> ^UI.TextItemMenuConfiguration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.configurationWithMenu != nil {
        configurationWithMenu :: proc "c" (self: Class, _: SEL, menu: ^UI.Menu) -> ^UI.TextItemMenuConfiguration {
            ...
            return (cast(^VTable)vt_ctx.super_vt).configurationWithMenu( menu)
        }
    ...
    if vt.configurationWithPreview != nil {
        configurationWithPreview :: proc "c" (self: Class, _: SEL, preview: ^UI.TextItemMenuPreview, menu: ^UI.Menu) -> ^UI.TextItemMenuConfiguration {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).configurationWithPreview( preview, menu)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TextItemMenuConfiguration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TextItemMenuConfiguration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TextItemMenuConfiguration {
