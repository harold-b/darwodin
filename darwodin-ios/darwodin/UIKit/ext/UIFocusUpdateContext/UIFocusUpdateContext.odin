...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.FocusUpdateContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.FocusUpdateContext,
    alloc: proc() -> ^UI.FocusUpdateContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.FocusUpdateContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.FocusUpdateContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.FocusUpdateContext {
