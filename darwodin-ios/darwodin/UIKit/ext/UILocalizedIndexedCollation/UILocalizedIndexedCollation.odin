...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.LocalizedIndexedCollation,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.LocalizedIndexedCollation,
    alloc: proc() -> ^UI.LocalizedIndexedCollation,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.LocalizedIndexedCollation {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.LocalizedIndexedCollation {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.LocalizedIndexedCollation {
