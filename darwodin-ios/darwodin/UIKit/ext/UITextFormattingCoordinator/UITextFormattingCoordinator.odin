...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TextFormattingCoordinator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TextFormattingCoordinator,
    alloc: proc() -> ^UI.TextFormattingCoordinator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TextFormattingCoordinator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TextFormattingCoordinator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TextFormattingCoordinator {
