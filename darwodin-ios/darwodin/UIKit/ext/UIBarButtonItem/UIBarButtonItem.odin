...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.possibleTitles != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("possibleTitles"), auto_cast possibleTitles, "^void@:") do panic("Failed to register objC method.")
    }
    if vt.setPossibleTitles != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("setPossibleTitles:"), auto_cast setPossibleTitles, "v@:^void") do panic("Failed to register objC method.")
    }
