...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TabBarItemAppearance,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TabBarItemAppearance,
    alloc: proc() -> ^UI.TabBarItemAppearance,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TabBarItemAppearance {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TabBarItemAppearance {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TabBarItemAppearance {
