...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.MutableUserNotificationAction,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.MutableUserNotificationAction,
    alloc: proc() -> ^UI.MutableUserNotificationAction,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.MutableUserNotificationAction {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.MutableUserNotificationAction {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.MutableUserNotificationAction {
