...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSFileProviderItemVersion,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSFileProviderItemVersion,
    alloc: proc() -> ^UI.NSFileProviderItemVersion,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSFileProviderItemVersion {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSFileProviderItemVersion {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSFileProviderItemVersion {
