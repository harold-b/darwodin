...
VTable :: struct {
    ...
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.StoryboardPopoverSegue,
    alloc: proc() -> ^UI.StoryboardPopoverSegue,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.StoryboardPopoverSegue {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.StoryboardPopoverSegue {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.StoryboardPopoverSegue {
