...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Label,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Label,
    alloc: proc() -> ^UI.Label,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Label {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Label {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Label {
