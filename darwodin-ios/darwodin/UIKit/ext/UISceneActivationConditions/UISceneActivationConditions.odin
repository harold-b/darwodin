...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SceneActivationConditions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SceneActivationConditions,
    alloc: proc() -> ^UI.SceneActivationConditions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SceneActivationConditions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SceneActivationConditions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SceneActivationConditions {
