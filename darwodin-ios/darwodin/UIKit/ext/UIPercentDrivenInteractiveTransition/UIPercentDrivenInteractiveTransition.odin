...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.PercentDrivenInteractiveTransition,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PercentDrivenInteractiveTransition,
    alloc: proc() -> ^UI.PercentDrivenInteractiveTransition,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PercentDrivenInteractiveTransition {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PercentDrivenInteractiveTransition {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PercentDrivenInteractiveTransition {
