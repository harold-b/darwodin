...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Switch,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Switch,
    alloc: proc() -> ^UI.Switch,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Switch {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Switch {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Switch {
