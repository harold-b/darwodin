package darwodin_UITraitForceTouchCapability_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitForceTouchCapability,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitForceTouchCapability,
    alloc: proc() -> ^UI.TraitForceTouchCapability,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitForceTouchCapability {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitForceTouchCapability {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitForceTouchCapability {
