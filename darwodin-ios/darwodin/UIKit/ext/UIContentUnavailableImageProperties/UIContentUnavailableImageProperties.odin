...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ContentUnavailableImageProperties,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ContentUnavailableImageProperties,
    alloc: proc() -> ^UI.ContentUnavailableImageProperties,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableImageProperties {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ContentUnavailableImageProperties {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ContentUnavailableImageProperties {
