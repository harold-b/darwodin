...
VTable :: struct {
    ...
    initWithTableView: proc(self: ^UI.TableViewDiffableDataSource, tableView: ^UI.TableView, cellProvider: UI.TableViewDiffableDataSourceCellProvider) -> ^UI.TableViewDiffableDataSource,
    init: proc(self: ^UI.TableViewDiffableDataSource) -> ^UI.TableViewDiffableDataSource,
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TableViewDiffableDataSource,
    alloc: proc() -> ^UI.TableViewDiffableDataSource,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithTableView != nil {
        initWithTableView :: proc "c" (self: ^UI.TableViewDiffableDataSource, _: SEL, tableView: ^UI.TableView, cellProvider: UI.TableViewDiffableDataSourceCellProvider) -> ^UI.TableViewDiffableDataSource {
    ...
    if vt.init != nil {
        init :: proc "c" (self: ^UI.TableViewDiffableDataSource, _: SEL) -> ^UI.TableViewDiffableDataSource {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TableViewDiffableDataSource {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TableViewDiffableDataSource {
