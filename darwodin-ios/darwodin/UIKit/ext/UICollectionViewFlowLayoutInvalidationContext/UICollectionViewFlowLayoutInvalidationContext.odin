...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CollectionViewFlowLayoutInvalidationContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CollectionViewFlowLayoutInvalidationContext,
    alloc: proc() -> ^UI.CollectionViewFlowLayoutInvalidationContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewFlowLayoutInvalidationContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CollectionViewFlowLayoutInvalidationContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CollectionViewFlowLayoutInvalidationContext {
