...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.KeyboardLayoutGuide,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.KeyboardLayoutGuide,
    alloc: proc() -> ^UI.KeyboardLayoutGuide,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.KeyboardLayoutGuide {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.KeyboardLayoutGuide {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.KeyboardLayoutGuide {
