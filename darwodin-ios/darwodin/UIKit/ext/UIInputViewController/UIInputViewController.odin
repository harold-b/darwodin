...
VTable :: struct {
    ...
    requestSupplementaryLexiconWithCompletion: proc(self: ^UI.InputViewController, completionHandler: ^Objc_Block(proc "c" ( _0: ^UI.Lexicon ))),
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.requestSupplementaryLexiconWithCompletion != nil {
        requestSupplementaryLexiconWithCompletion :: proc "c" (self: ^UI.InputViewController, _: SEL, completionHandler: ^Objc_Block(proc "c" ( _0: ^UI.Lexicon ))) {
