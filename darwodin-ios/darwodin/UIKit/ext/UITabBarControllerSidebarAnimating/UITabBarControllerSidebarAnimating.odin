...
VTable :: struct {
    addAnimations: proc(self: ^UI.TabBarControllerSidebarAnimating, animations: proc "c" ()),
    addCompletion: proc(self: ^UI.TabBarControllerSidebarAnimating, completion: proc "c" ()),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.addAnimations != nil {
        addAnimations :: proc "c" (self: ^UI.TabBarControllerSidebarAnimating, _: SEL, animations: proc "c" ()) {
    ...
    if vt.addCompletion != nil {
        addCompletion :: proc "c" (self: ^UI.TabBarControllerSidebarAnimating, _: SEL, completion: proc "c" ()) {
