package darwodin_UITabBarControllerSidebarAnimating_Ext
...
VTable :: struct {
    addAnimations: proc(self: ^UI.TabBarControllerSidebarAnimating, animations: ^Objc_Block(proc "c" ())),
    addCompletion: proc(self: ^UI.TabBarControllerSidebarAnimating, completion: ^Objc_Block(proc "c" ())),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.addAnimations != nil {
        addAnimations :: proc "c" (self: ^UI.TabBarControllerSidebarAnimating, _: SEL, animations: ^Objc_Block(proc "c" ())) {
    ...
    if vt.addCompletion != nil {
        addCompletion :: proc "c" (self: ^UI.TabBarControllerSidebarAnimating, _: SEL, completion: ^Objc_Block(proc "c" ())) {
