package darwodin_UICollectionViewDataSourcePrefetching_Ext
...
VTable :: struct {
    collectionView_prefetchItemsAtIndexPaths: proc(self: ^UI.CollectionViewDataSourcePrefetching, collectionView: ^UI.CollectionView, indexPaths: ^NS.Array),
    collectionView_cancelPrefetchingForItemsAtIndexPaths: proc(self: ^UI.CollectionViewDataSourcePrefetching, collectionView: ^UI.CollectionView, indexPaths: ^NS.Array),
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.collectionView_prefetchItemsAtIndexPaths != nil {
        collectionView_prefetchItemsAtIndexPaths :: proc "c" (self: ^UI.CollectionViewDataSourcePrefetching, _: SEL, collectionView: ^UI.CollectionView, indexPaths: ^NS.Array) {
    ...
    if vt.collectionView_cancelPrefetchingForItemsAtIndexPaths != nil {
        collectionView_cancelPrefetchingForItemsAtIndexPaths :: proc "c" (self: ^UI.CollectionViewDataSourcePrefetching, _: SEL, collectionView: ^UI.CollectionView, indexPaths: ^NS.Array) {
