...
VTable :: struct {
    ...
    enumerateEventHandlers: proc(self: ^UI.Control, iterator: proc "c" (actionHandler: ^UI.Action, target: id, action: SEL, controlEvents: UI.ControlEvents, stop: ^bool)),
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.enumerateEventHandlers != nil {
        enumerateEventHandlers :: proc "c" (self: ^UI.Control, _: SEL, iterator: proc "c" (actionHandler: ^UI.Action, target: id, action: SEL, controlEvents: UI.ControlEvents, stop: ^bool)) {
