...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TrackingLayoutGuide,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TrackingLayoutGuide,
    alloc: proc() -> ^UI.TrackingLayoutGuide,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TrackingLayoutGuide {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TrackingLayoutGuide {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TrackingLayoutGuide {
