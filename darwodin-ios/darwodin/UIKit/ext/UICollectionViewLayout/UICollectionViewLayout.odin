...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.invalidationContextForInteractivelyMovingItems != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("invalidationContextForInteractivelyMovingItems:withTargetPosition:previousIndexPaths:previousPosition:"), auto_cast invalidationContextForInteractivelyMovingItems, "@@:^void{CGPoint=dd}^void{CGPoint=dd}") do panic("Failed to register objC method.")
    }
    if vt.invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths:previousIndexPaths:movementCancelled:"), auto_cast invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths, "@@:^void^voidB") do panic("Failed to register objC method.")
    }
}
