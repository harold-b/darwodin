...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.GraphicsPDFRendererFormat,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.GraphicsPDFRendererFormat,
    alloc: proc() -> ^UI.GraphicsPDFRendererFormat,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRendererFormat {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.GraphicsPDFRendererFormat {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.GraphicsPDFRendererFormat {
