...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.InterpolatingMotionEffect,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.InterpolatingMotionEffect,
    alloc: proc() -> ^UI.InterpolatingMotionEffect,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.InterpolatingMotionEffect {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.InterpolatingMotionEffect {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.InterpolatingMotionEffect {
