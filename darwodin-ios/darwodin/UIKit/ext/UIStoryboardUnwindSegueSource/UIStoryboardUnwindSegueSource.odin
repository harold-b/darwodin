package darwodin_UIStoryboardUnwindSegueSource_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.StoryboardUnwindSegueSource,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.StoryboardUnwindSegueSource,
    alloc: proc() -> ^UI.StoryboardUnwindSegueSource,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.sourceViewController != nil {
        sourceViewController :: proc "c" (self: ^UI.StoryboardUnwindSegueSource, _: SEL) -> ^UI.ViewController {
    ...
    if vt.unwindAction != nil {
        unwindAction :: proc "c" (self: ^UI.StoryboardUnwindSegueSource, _: SEL) -> SEL {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).unwindAction(self)
        }
    ...
    if vt.sender != nil {
        sender :: proc "c" (self: ^UI.StoryboardUnwindSegueSource, _: SEL) -> id {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.StoryboardUnwindSegueSource {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.StoryboardUnwindSegueSource {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.StoryboardUnwindSegueSource {
