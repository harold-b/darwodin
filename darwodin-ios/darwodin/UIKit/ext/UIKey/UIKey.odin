...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Key,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Key,
    alloc: proc() -> ^UI.Key,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Key {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Key {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Key {
