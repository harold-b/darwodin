package darwodin_NSSymbolDrawOnEffect_Ext
...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^UI.NSSymbolDrawOnEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^UI.NSSymbolDrawOnEffect) -> instancetype,
    effectWithIndividually: proc(self: ^UI.NSSymbolDrawOnEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^UI.NSSymbolDrawOnEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^UI.NSSymbolDrawOnEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithIndividually != nil {
        effectWithIndividually :: proc "c" (self: ^UI.NSSymbolDrawOnEffect, _: SEL) -> instancetype {
