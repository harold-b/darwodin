...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.UpdateInfo,
    alloc: proc() -> ^UI.UpdateInfo,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.UpdateInfo {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.UpdateInfo {
