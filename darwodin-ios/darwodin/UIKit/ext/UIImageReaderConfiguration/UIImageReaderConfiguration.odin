...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ImageReaderConfiguration,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ImageReaderConfiguration,
    alloc: proc() -> ^UI.ImageReaderConfiguration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ImageReaderConfiguration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ImageReaderConfiguration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ImageReaderConfiguration {
