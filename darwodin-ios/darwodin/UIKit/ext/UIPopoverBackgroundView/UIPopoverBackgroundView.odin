...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.PopoverBackgroundView,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PopoverBackgroundView,
    alloc: proc() -> ^UI.PopoverBackgroundView,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.arrowBase != nil {
        arrowBase :: proc "c" (self: Class, _: SEL) -> CG.Float {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).arrowBase()
        }
    ...
    if vt.contentViewInsets != nil {
        contentViewInsets :: proc "c" (self: Class, _: SEL) -> UI.EdgeInsets {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).contentViewInsets()
        }
    ...
    if vt.arrowHeight != nil {
        arrowHeight :: proc "c" (self: Class, _: SEL) -> CG.Float {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).arrowHeight()
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PopoverBackgroundView {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PopoverBackgroundView {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PopoverBackgroundView {
