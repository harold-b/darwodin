...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NavigationBarAppearance,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NavigationBarAppearance,
    alloc: proc() -> ^UI.NavigationBarAppearance,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NavigationBarAppearance {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NavigationBarAppearance {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NavigationBarAppearance {
