...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.AccessibilityCustomRotorItemResult,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotorItemResult,
    alloc: proc() -> ^UI.AccessibilityCustomRotorItemResult,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotorItemResult {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.AccessibilityCustomRotorItemResult {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.AccessibilityCustomRotorItemResult {
