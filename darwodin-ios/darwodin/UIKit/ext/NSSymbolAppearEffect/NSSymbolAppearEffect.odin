package darwodin_NSSymbolAppearEffect_Ext
...
VTable :: struct {
    ...
    effect: proc() -> ^UI.NSSymbolAppearEffect,
    appearUpEffect: proc() -> ^UI.NSSymbolAppearEffect,
    appearDownEffect: proc() -> ^UI.NSSymbolAppearEffect,
    effectWithByLayer: proc(self: ^UI.NSSymbolAppearEffect) -> ^UI.NSSymbolAppearEffect,
    effectWithWholeSymbol: proc(self: ^UI.NSSymbolAppearEffect) -> ^UI.NSSymbolAppearEffect,
    new: proc() -> ^UI.NSSymbolAppearEffect,
    supportsSecureCoding: proc() -> bool,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSSymbolAppearEffect,
    alloc: proc() -> ^UI.NSSymbolAppearEffect,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effect != nil {
        effect :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolAppearEffect {
    ...
    if vt.appearUpEffect != nil {
        appearUpEffect :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolAppearEffect {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).appearUpEffect()
        }
    ...
    if vt.appearDownEffect != nil {
        appearDownEffect :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolAppearEffect {

            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).appearDownEffect()
        }
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^UI.NSSymbolAppearEffect, _: SEL) -> ^UI.NSSymbolAppearEffect {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^UI.NSSymbolAppearEffect, _: SEL) -> ^UI.NSSymbolAppearEffect {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolAppearEffect {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSSymbolAppearEffect {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSSymbolAppearEffect {
