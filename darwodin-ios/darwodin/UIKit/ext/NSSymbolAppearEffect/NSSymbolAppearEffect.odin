...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^UI.NSSymbolAppearEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^UI.NSSymbolAppearEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^UI.NSSymbolAppearEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^UI.NSSymbolAppearEffect, _: SEL) -> instancetype {
