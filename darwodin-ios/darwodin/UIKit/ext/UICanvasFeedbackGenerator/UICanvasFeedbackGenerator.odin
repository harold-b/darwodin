...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CanvasFeedbackGenerator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CanvasFeedbackGenerator,
    alloc: proc() -> ^UI.CanvasFeedbackGenerator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CanvasFeedbackGenerator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CanvasFeedbackGenerator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CanvasFeedbackGenerator {
