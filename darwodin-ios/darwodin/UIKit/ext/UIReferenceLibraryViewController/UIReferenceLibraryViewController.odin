...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ReferenceLibraryViewController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ReferenceLibraryViewController,
    alloc: proc() -> ^UI.ReferenceLibraryViewController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ReferenceLibraryViewController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ReferenceLibraryViewController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ReferenceLibraryViewController {
