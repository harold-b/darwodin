...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSAdaptiveImageGlyph,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSAdaptiveImageGlyph,
    alloc: proc() -> ^UI.NSAdaptiveImageGlyph,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSAdaptiveImageGlyph {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSAdaptiveImageGlyph {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSAdaptiveImageGlyph {
