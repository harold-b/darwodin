...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ApplicationShortcutItem,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ApplicationShortcutItem,
    alloc: proc() -> ^UI.ApplicationShortcutItem,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ApplicationShortcutItem {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ApplicationShortcutItem {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ApplicationShortcutItem {
