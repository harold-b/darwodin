...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.textDraggableView_itemsForDrag != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("textDraggableView:itemsForDrag:"), auto_cast textDraggableView_itemsForDrag, "^void@:@@") do panic("Failed to register objC method.")
    }
