...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SwipeActionsConfiguration,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SwipeActionsConfiguration,
    alloc: proc() -> ^UI.SwipeActionsConfiguration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SwipeActionsConfiguration {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SwipeActionsConfiguration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SwipeActionsConfiguration {
