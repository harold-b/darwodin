...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.WindowSceneDestructionRequestOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.WindowSceneDestructionRequestOptions,
    alloc: proc() -> ^UI.WindowSceneDestructionRequestOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneDestructionRequestOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.WindowSceneDestructionRequestOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.WindowSceneDestructionRequestOptions {
