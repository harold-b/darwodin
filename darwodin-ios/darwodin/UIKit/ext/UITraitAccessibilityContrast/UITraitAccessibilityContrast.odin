package darwodin_UITraitAccessibilityContrast_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitAccessibilityContrast,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitAccessibilityContrast,
    alloc: proc() -> ^UI.TraitAccessibilityContrast,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitAccessibilityContrast {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitAccessibilityContrast {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitAccessibilityContrast {
