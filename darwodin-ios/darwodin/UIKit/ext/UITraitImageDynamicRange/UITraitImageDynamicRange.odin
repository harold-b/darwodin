package darwodin_UITraitImageDynamicRange_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TraitImageDynamicRange,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TraitImageDynamicRange,
    alloc: proc() -> ^UI.TraitImageDynamicRange,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TraitImageDynamicRange {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TraitImageDynamicRange {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TraitImageDynamicRange {
