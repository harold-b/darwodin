...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.MarkupTextPrintFormatter,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.MarkupTextPrintFormatter,
    alloc: proc() -> ^UI.MarkupTextPrintFormatter,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.MarkupTextPrintFormatter {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.MarkupTextPrintFormatter {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.MarkupTextPrintFormatter {
