...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ScreenEdgePanGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ScreenEdgePanGestureRecognizer,
    alloc: proc() -> ^UI.ScreenEdgePanGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ScreenEdgePanGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ScreenEdgePanGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ScreenEdgePanGestureRecognizer {
