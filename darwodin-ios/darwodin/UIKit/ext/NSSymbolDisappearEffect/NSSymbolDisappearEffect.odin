...
VTable :: struct {
    ...
    effectWithByLayer: proc(self: ^UI.NSSymbolDisappearEffect) -> instancetype,
    effectWithWholeSymbol: proc(self: ^UI.NSSymbolDisappearEffect) -> instancetype,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.effectWithByLayer != nil {
        effectWithByLayer :: proc "c" (self: ^UI.NSSymbolDisappearEffect, _: SEL) -> instancetype {
    ...
    if vt.effectWithWholeSymbol != nil {
        effectWithWholeSymbol :: proc "c" (self: ^UI.NSSymbolDisappearEffect, _: SEL) -> instancetype {
