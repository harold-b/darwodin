...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.BarButtonItemGroup,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.BarButtonItemGroup,
    alloc: proc() -> ^UI.BarButtonItemGroup,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.BarButtonItemGroup {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.BarButtonItemGroup {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.BarButtonItemGroup {
