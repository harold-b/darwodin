...
VTable :: struct {
    ...
    importDocumentAtURL: proc(self: ^UI.DocumentBrowserViewController, documentURL: ^NS.URL, neighbourURL: ^NS.URL, importMode: UI.DocumentBrowserImportMode, completion: ^Objc_Block(proc "c" ( _0: ^NS.URL, _1: ^NS.Error ))),
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.importDocumentAtURL != nil {
        importDocumentAtURL :: proc "c" (self: ^UI.DocumentBrowserViewController, _: SEL, documentURL: ^NS.URL, neighbourURL: ^NS.URL, importMode: UI.DocumentBrowserImportMode, completion: ^Objc_Block(proc "c" ( _0: ^NS.URL, _1: ^NS.Error ))) {
