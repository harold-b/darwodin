package darwodin_UISceneSystemProtectionManager_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SceneSystemProtectionManager,
    alloc: proc() -> ^UI.SceneSystemProtectionManager,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SceneSystemProtectionManager {
    ...
    if vt.isUserAuthenticationEnabled != nil {
        isUserAuthenticationEnabled :: proc "c" (self: ^UI.SceneSystemProtectionManager, _: SEL) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^VTable)vt_ctx.super_vt).isUserAuthenticationEnabled(self)
        }
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SceneSystemProtectionManager {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SceneSystemProtectionManager {
