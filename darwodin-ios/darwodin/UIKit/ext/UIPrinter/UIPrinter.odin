...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Printer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Printer,
    alloc: proc() -> ^UI.Printer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Printer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Printer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Printer {
