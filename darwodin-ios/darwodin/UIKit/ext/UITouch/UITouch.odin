...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Touch,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Touch,
    alloc: proc() -> ^UI.Touch,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Touch {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Touch {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Touch {
