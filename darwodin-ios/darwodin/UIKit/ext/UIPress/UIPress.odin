...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Press,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Press,
    alloc: proc() -> ^UI.Press,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Press {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Press {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Press {
