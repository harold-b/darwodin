...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TabSidebarScrollTarget,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TabSidebarScrollTarget,
    alloc: proc() -> ^UI.TabSidebarScrollTarget,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TabSidebarScrollTarget {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TabSidebarScrollTarget {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TabSidebarScrollTarget {
