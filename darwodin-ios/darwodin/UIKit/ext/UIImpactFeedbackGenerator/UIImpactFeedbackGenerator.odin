...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ImpactFeedbackGenerator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ImpactFeedbackGenerator,
    alloc: proc() -> ^UI.ImpactFeedbackGenerator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ImpactFeedbackGenerator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ImpactFeedbackGenerator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ImpactFeedbackGenerator {
