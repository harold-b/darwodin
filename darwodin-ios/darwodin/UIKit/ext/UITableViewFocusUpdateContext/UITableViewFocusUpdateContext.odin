package darwodin_UITableViewFocusUpdateContext_Ext
...
VTable :: struct {
    ...
    previouslyFocusedIndexPath: proc(self: ^UI.TableViewFocusUpdateContext) -> ^NS.IndexPath,
    nextFocusedIndexPath: proc(self: ^UI.TableViewFocusUpdateContext) -> ^NS.IndexPath,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.TableViewFocusUpdateContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.TableViewFocusUpdateContext,
    alloc: proc() -> ^UI.TableViewFocusUpdateContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.previouslyFocusedIndexPath != nil {
        previouslyFocusedIndexPath :: proc "c" (self: ^UI.TableViewFocusUpdateContext, _: SEL) -> ^NS.IndexPath {
    ...
    if vt.nextFocusedIndexPath != nil {
        nextFocusedIndexPath :: proc "c" (self: ^UI.TableViewFocusUpdateContext, _: SEL) -> ^NS.IndexPath {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.TableViewFocusUpdateContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.TableViewFocusUpdateContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.TableViewFocusUpdateContext {
