package darwodin_UIFocusAnimationContext_Ext
...
VTable :: struct {
    duration: proc(self: ^UI.FocusAnimationContext) -> NS.TimeInterval,
}
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    _=meta
    if vt.duration != nil {
        duration :: proc "c" (self: ^UI.FocusAnimationContext, _: SEL) -> NS.TimeInterval {
