...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.ZoomTransitionInteractionContext,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.ZoomTransitionInteractionContext,
    alloc: proc() -> ^UI.ZoomTransitionInteractionContext,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.ZoomTransitionInteractionContext {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ZoomTransitionInteractionContext {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ZoomTransitionInteractionContext {
