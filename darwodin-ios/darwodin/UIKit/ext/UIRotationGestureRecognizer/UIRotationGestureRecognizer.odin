package darwodin_UIRotationGestureRecognizer_Ext
...
VTable :: struct {
    ...
    rotation: proc(self: ^UI.RotationGestureRecognizer) -> CG.Float,
    setRotation: proc(self: ^UI.RotationGestureRecognizer, rotation: CG.Float),
    velocity: proc(self: ^UI.RotationGestureRecognizer) -> CG.Float,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.RotationGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.RotationGestureRecognizer,
    alloc: proc() -> ^UI.RotationGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.rotation != nil {
        rotation :: proc "c" (self: ^UI.RotationGestureRecognizer, _: SEL) -> CG.Float {
    ...
    if vt.setRotation != nil {
        setRotation :: proc "c" (self: ^UI.RotationGestureRecognizer, _: SEL, rotation: CG.Float) {
    ...
    if vt.velocity != nil {
        velocity :: proc "c" (self: ^UI.RotationGestureRecognizer, _: SEL) -> CG.Float {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.RotationGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.RotationGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.RotationGestureRecognizer {
