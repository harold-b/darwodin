...
VTable :: struct {
    ...
    new: proc() -> ^UI.CalendarSelectionWeekOfYear,
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CalendarSelectionWeekOfYear,
    alloc: proc() -> ^UI.CalendarSelectionWeekOfYear,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelectionWeekOfYear {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CalendarSelectionWeekOfYear {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CalendarSelectionWeekOfYear {
