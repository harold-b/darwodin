...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.SceneOpenExternalURLOptions,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.SceneOpenExternalURLOptions,
    alloc: proc() -> ^UI.SceneOpenExternalURLOptions,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.SceneOpenExternalURLOptions {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.SceneOpenExternalURLOptions {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.SceneOpenExternalURLOptions {
