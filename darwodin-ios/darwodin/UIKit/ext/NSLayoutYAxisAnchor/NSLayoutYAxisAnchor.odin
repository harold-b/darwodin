...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSLayoutYAxisAnchor,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSLayoutYAxisAnchor,
    alloc: proc() -> ^UI.NSLayoutYAxisAnchor,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutYAxisAnchor {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSLayoutYAxisAnchor {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSLayoutYAxisAnchor {
