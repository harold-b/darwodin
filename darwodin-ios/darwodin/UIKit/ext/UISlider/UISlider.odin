...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^UI.Slider,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.Slider,
    alloc: proc() -> ^UI.Slider,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.Slider {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.Slider {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.Slider {
