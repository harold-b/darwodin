package darwodin_UIPencilInteractionTap_Ext
...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.PencilInteractionTap,
    alloc: proc() -> ^UI.PencilInteractionTap,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.PencilInteractionTap {
    ...
    if vt.timestamp != nil {
        timestamp :: proc "c" (self: ^UI.PencilInteractionTap, _: SEL) -> NS.TimeInterval {
    ...
    if vt.hoverPose != nil {
        hoverPose :: proc "c" (self: ^UI.PencilInteractionTap, _: SEL) -> ^UI.PencilHoverPose {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.PencilInteractionTap {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.PencilInteractionTap {
