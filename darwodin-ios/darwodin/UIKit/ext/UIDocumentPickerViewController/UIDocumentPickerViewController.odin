...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.DocumentPickerViewController,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.DocumentPickerViewController,
    alloc: proc() -> ^UI.DocumentPickerViewController,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentPickerViewController {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.DocumentPickerViewController {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.DocumentPickerViewController {
