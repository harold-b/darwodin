...
VTable :: struct {
    ...
    alloc: proc() -> ^UI.ActivityItemsConfiguration,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.ActivityItemsConfiguration {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.ActivityItemsConfiguration {
