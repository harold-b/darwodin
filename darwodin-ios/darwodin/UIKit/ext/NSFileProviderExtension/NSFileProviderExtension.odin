...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.NSFileProviderExtension,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.NSFileProviderExtension,
    alloc: proc() -> ^UI.NSFileProviderExtension,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.NSFileProviderExtension {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.NSFileProviderExtension {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.NSFileProviderExtension {
