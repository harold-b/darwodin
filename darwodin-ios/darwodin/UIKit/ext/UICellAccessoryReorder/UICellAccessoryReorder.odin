...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^UI.CellAccessoryReorder,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^UI.CellAccessoryReorder,
    alloc: proc() -> ^UI.CellAccessoryReorder,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^UI.CellAccessoryReorder {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^UI.CellAccessoryReorder {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^UI.CellAccessoryReorder {
