...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.animatedImageWithImages != nil {
        ...
        if !class_addMethod(meta, intrinsics.objc_find_selector("animatedImageWithImages:duration:"), auto_cast animatedImageWithImages, "@#:^voidd") do panic("Failed to register objC method.")
    }
