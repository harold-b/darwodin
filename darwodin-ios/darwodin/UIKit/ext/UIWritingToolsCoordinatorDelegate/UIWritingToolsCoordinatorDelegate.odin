package darwodin_UIWritingToolsCoordinatorDelegate_Ext
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.writingToolsCoordinator_selectRanges_inContext_completion != nil {
        writingToolsCoordinator_selectRanges_inContext_completion :: proc "c" (self: ^UI.WritingToolsCoordinatorDelegate, _: SEL, writingToolsCoordinator: ^UI.WritingToolsCoordinator, ranges: ^NS.Array, _context: ^UI.WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ())) {
    ...
    if vt.writingToolsCoordinator_prepareForTextAnimation_forRange_inContext_completion != nil {
        writingToolsCoordinator_prepareForTextAnimation_forRange_inContext_completion :: proc "c" (self: ^UI.WritingToolsCoordinatorDelegate, _: SEL, writingToolsCoordinator: ^UI.WritingToolsCoordinator, textAnimation: UI.WritingToolsCoordinatorTextAnimation, range: NS._NSRange, _context: ^UI.WritingToolsCoordinatorContext, completion: ^Objc_Block(proc "c" ())) {
    ...
    if vt.writingToolsCoordinator_willChangeToState_completion != nil {
        writingToolsCoordinator_willChangeToState_completion :: proc "c" (self: ^UI.WritingToolsCoordinatorDelegate, _: SEL, writingToolsCoordinator: ^UI.WritingToolsCoordinator, newState: UI.WritingToolsCoordinatorState, completion: ^Objc_Block(proc "c" ())) {
