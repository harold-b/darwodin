...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.scene_openURLContexts != nil {
        ...
        if !class_addMethod(cls, intrinsics.objc_find_selector("scene:openURLContexts:"), auto_cast scene_openURLContexts, "v@:@^void") do panic("Failed to register objC method.")
    }
