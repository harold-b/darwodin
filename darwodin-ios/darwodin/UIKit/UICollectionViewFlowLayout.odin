...
foreign lib {
    ...
    CollectionViewFlowLayout_itemSize :: proc(self: ^CollectionViewFlowLayout) -> CG.Size ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setItemSize:", objc_name="setItemSize")
    CollectionViewFlowLayout_setItemSize :: proc(self: ^CollectionViewFlowLayout, itemSize: CG.Size) ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="estimatedItemSize", objc_name="estimatedItemSize")
    CollectionViewFlowLayout_estimatedItemSize :: proc(self: ^CollectionViewFlowLayout) -> CG.Size ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setEstimatedItemSize:", objc_name="setEstimatedItemSize")
    CollectionViewFlowLayout_setEstimatedItemSize :: proc(self: ^CollectionViewFlowLayout, estimatedItemSize: CG.Size) ---
    ...
    CollectionViewFlowLayout_headerReferenceSize :: proc(self: ^CollectionViewFlowLayout) -> CG.Size ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setHeaderReferenceSize:", objc_name="setHeaderReferenceSize")
    CollectionViewFlowLayout_setHeaderReferenceSize :: proc(self: ^CollectionViewFlowLayout, headerReferenceSize: CG.Size) ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="footerReferenceSize", objc_name="footerReferenceSize")
    CollectionViewFlowLayout_footerReferenceSize :: proc(self: ^CollectionViewFlowLayout) -> CG.Size ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setFooterReferenceSize:", objc_name="setFooterReferenceSize")
    CollectionViewFlowLayout_setFooterReferenceSize :: proc(self: ^CollectionViewFlowLayout, footerReferenceSize: CG.Size) ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="sectionInset", objc_name="sectionInset")
    CollectionViewFlowLayout_sectionInset :: proc(self: ^CollectionViewFlowLayout) -> EdgeInsets ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setSectionInset:", objc_name="setSectionInset")
    CollectionViewFlowLayout_setSectionInset :: proc(self: ^CollectionViewFlowLayout, sectionInset: EdgeInsets) ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="sectionInsetReference", objc_name="sectionInsetReference")
    CollectionViewFlowLayout_sectionInsetReference :: proc(self: ^CollectionViewFlowLayout) -> CollectionViewFlowLayoutSectionInsetReference ---

    @(objc_type=CollectionViewFlowLayout, objc_selector="setSectionInsetReference:", objc_name="setSectionInsetReference")
    CollectionViewFlowLayout_setSectionInsetReference :: proc(self: ^CollectionViewFlowLayout, sectionInsetReference: CollectionViewFlowLayoutSectionInsetReference) ---
