...
foreign lib {
    ...
    SpringTimingParameters_init :: proc(self: ^SpringTimingParameters) -> instancetype ---

    @(objc_type=SpringTimingParameters, objc_selector="initWithCoder:", objc_name="initWithCoder")
    SpringTimingParameters_initWithCoder :: proc(self: ^SpringTimingParameters, coder: ^NS.Coder) -> instancetype ---
    ...
    SpringTimingParameters_initWithDampingRatio_initialVelocity :: proc(self: ^SpringTimingParameters, ratio: CG.Float, velocity: CG.Vector) -> instancetype ---

    @(objc_type=SpringTimingParameters, objc_selector="initWithMass:stiffness:damping:initialVelocity:", objc_name="initWithMass")
    SpringTimingParameters_initWithMass :: proc(self: ^SpringTimingParameters, mass: CG.Float, stiffness: CG.Float, damping: CG.Float, velocity: CG.Vector) -> instancetype ---

    @(objc_type=SpringTimingParameters, objc_selector="initWithDampingRatio:", objc_name="initWithDampingRatio_")
    SpringTimingParameters_initWithDampingRatio_ :: proc(self: ^SpringTimingParameters, ratio: CG.Float) -> instancetype ---
    ...
    SpringTimingParameters_initWithDuration_bounce_initialVelocity :: proc(self: ^SpringTimingParameters, duration: NS.TimeInterval, bounce: CG.Float, velocity: CG.Vector) -> instancetype ---

    @(objc_type=SpringTimingParameters, objc_selector="initWithDuration:bounce:", objc_name="initWithDuration_bounce")
    SpringTimingParameters_initWithDuration_bounce :: proc(self: ^SpringTimingParameters, duration: NS.TimeInterval, bounce: CG.Float) -> instancetype ---
