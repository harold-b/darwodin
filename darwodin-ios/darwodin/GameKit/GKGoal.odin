...
foreign lib {
    ...
    Goal_goalToFleeAgent :: proc(agent: ^Agent) -> instancetype ---
    ...
    Goal_goalToAvoidObstacles :: proc(obstacles: ^NS.Array, maxPredictionTime: NS.TimeInterval) -> instancetype ---

    @(objc_type=Goal, objc_selector="goalToAvoidAgents:maxPredictionTime:", objc_name="goalToAvoidAgents", objc_is_class_method=true)
    Goal_goalToAvoidAgents :: proc(agents: ^NS.Array, maxPredictionTime: NS.TimeInterval) -> instancetype ---
    ...
    Goal_goalToSeparateFromAgents :: proc(agents: ^NS.Array, maxDistance: cffi.float, maxAngle: cffi.float) -> instancetype ---
    ...
    Goal_goalToAlignWithAgents :: proc(agents: ^NS.Array, maxDistance: cffi.float, maxAngle: cffi.float) -> instancetype ---
    ...
    Goal_goalToCohereWithAgents :: proc(agents: ^NS.Array, maxDistance: cffi.float, maxAngle: cffi.float) -> instancetype ---

    @(objc_type=Goal, objc_selector="goalToReachTargetSpeed:", objc_name="goalToReachTargetSpeed", objc_is_class_method=true)
    Goal_goalToReachTargetSpeed :: proc(targetSpeed: cffi.float) -> instancetype ---

    @(objc_type=Goal, objc_selector="goalToWander:", objc_name="goalToWander", objc_is_class_method=true)
    Goal_goalToWander :: proc(speed: cffi.float) -> instancetype ---
    ...
    Goal_goalToInterceptAgent :: proc(target: ^Agent, maxPredictionTime: NS.TimeInterval) -> instancetype ---
    ...
    Goal_goalToFollowPath :: proc(path: ^Path, maxPredictionTime: NS.TimeInterval, forward: bool) -> instancetype ---
