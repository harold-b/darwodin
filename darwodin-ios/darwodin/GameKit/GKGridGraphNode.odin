...
foreign lib {
    ...
    GridGraphNode_nodeWithGridPosition :: proc(#by_ptr gridPosition: [2]cffi.int) -> ^GridGraphNode ---

    @(objc_type=GridGraphNode, objc_selector="initWithGridPosition:", objc_name="initWithGridPosition")
    GridGraphNode_initWithGridPosition :: proc(self: ^GridGraphNode, #by_ptr gridPosition: [2]cffi.int) -> ^GridGraphNode ---
