...
foreign lib {
    ...
    Octree_addElement_withPoint :: proc(self: ^Octree, element: id, #by_ptr point: vector_float3) -> ^OctreeNode ---
    ...
    Octree_elementsAtPoint :: proc(self: ^Octree, #by_ptr point: vector_float3) -> ^NS.Array ---
