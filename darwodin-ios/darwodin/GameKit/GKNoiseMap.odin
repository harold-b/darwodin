...
foreign lib {
    ...
    NoiseMap_noiseMapWithNoise_size_origin_sampleCount_seamless :: proc(noise: ^Noise, size: #by_ptr vector_double2, origin: #by_ptr vector_double2, sampleCount: #by_ptr [2]cffi.int, seamless: bool) -> ^NoiseMap ---
    ...
    NoiseMap_initWithNoise_size_origin_sampleCount_seamless :: proc(self: ^NoiseMap, noise: ^Noise, size: #by_ptr vector_double2, origin: #by_ptr vector_double2, sampleCount: #by_ptr [2]cffi.int, seamless: bool) -> ^NoiseMap ---

    @(objc_type=NoiseMap, objc_selector="valueAtPosition:", objc_name="valueAtPosition")
    NoiseMap_valueAtPosition :: proc(self: ^NoiseMap, position: #by_ptr [2]cffi.int) -> cffi.float ---

    @(objc_type=NoiseMap, objc_selector="interpolatedValueAtPosition:", objc_name="interpolatedValueAtPosition")
    NoiseMap_interpolatedValueAtPosition :: proc(self: ^NoiseMap, position: #by_ptr vector_float2) -> cffi.float ---

    @(objc_type=NoiseMap, objc_selector="setValue:atPosition:", objc_name="setValue")
    NoiseMap_setValue :: proc(self: ^NoiseMap, value: cffi.float, position: #by_ptr [2]cffi.int) ---
