...
foreign lib {
    ...
    Path_initWithPoints :: proc(self: ^Path, points: ^^vector_float2, count: cffi.size_t, radius: cffi.float, cyclical: bool) -> instancetype ---
    ...
    Path_pathWithFloat3Points :: proc(points: ^^vector_float3, count: cffi.size_t, radius: cffi.float, cyclical: bool) -> instancetype ---

    @(objc_type=Path, objc_selector="initWithFloat3Points:count:radius:cyclical:", objc_name="initWithFloat3Points")
    Path_initWithFloat3Points :: proc(self: ^Path, points: ^^vector_float3, count: cffi.size_t, radius: cffi.float, cyclical: bool) -> instancetype ---

    @(objc_type=Path, objc_selector="pathWithGraphNodes:radius:", objc_name="pathWithGraphNodes", objc_is_class_method=true)
    Path_pathWithGraphNodes :: proc(graphNodes: ^NS.Array, radius: cffi.float) -> instancetype ---

    @(objc_type=Path, objc_selector="initWithGraphNodes:radius:", objc_name="initWithGraphNodes")
    Path_initWithGraphNodes :: proc(self: ^Path, graphNodes: ^NS.Array, radius: cffi.float) -> instancetype ---
