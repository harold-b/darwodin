...
@(objc_type=TurnBasedMatchmakerViewController, objc_name="attemptRotationToDeviceOrientation", objc_is_class_method=true)
TurnBasedMatchmakerViewController_attemptRotationToDeviceOrientation :: #force_inline proc "c" () {
    msgSend(nil, TurnBasedMatchmakerViewController, "attemptRotationToDeviceOrientation")
}
@(objc_type=TurnBasedMatchmakerViewController, objc_name="clearTextInputContextIdentifier", objc_is_class_method=true)
TurnBasedMatchmakerViewController_clearTextInputContextIdentifier :: #force_inline proc "c" (identifier: ^NS.String) {
    msgSend(nil, TurnBasedMatchmakerViewController, "clearTextInputContextIdentifier:", identifier)
}
