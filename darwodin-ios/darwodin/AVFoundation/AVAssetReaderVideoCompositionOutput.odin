...
foreign lib {
    ...
    AssetReaderVideoCompositionOutput_assetReaderVideoCompositionOutputWithVideoTracks :: proc(videoTracks: ^NS.Array, videoSettings: ^NS.Dictionary) -> instancetype ---
    ...
    AssetReaderVideoCompositionOutput_initWithVideoTracks :: proc(self: ^AssetReaderVideoCompositionOutput, videoTracks: ^NS.Array, videoSettings: ^NS.Dictionary) -> instancetype ---
