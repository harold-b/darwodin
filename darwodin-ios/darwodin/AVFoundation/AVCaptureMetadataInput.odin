...
foreign lib {
    ...
    CaptureMetadataInput_metadataInputWithFormatDescription :: proc(desc: CM.MetadataFormatDescriptionRef, clock: CM.ClockRef) -> instancetype ---

    @(objc_type=CaptureMetadataInput, objc_selector="initWithFormatDescription:clock:", objc_name="initWithFormatDescription")
    CaptureMetadataInput_initWithFormatDescription :: proc(self: ^CaptureMetadataInput, desc: CM.MetadataFormatDescriptionRef, clock: CM.ClockRef) -> instancetype ---
