...
foreign lib {
    ...
    AudioUnit_instantiateWithComponentDescription :: proc(audioComponentDescription: AT.ComponentDescription, options: AT.ComponentInstantiationOptions, completionHandler: ^Objc_Block(proc "c" ( audioUnit: ^AudioUnit, error: ^NS.Error ))) ---
    ...
    AudioUnit_audioComponentDescription :: proc(self: ^AudioUnit) -> AT.ComponentDescription ---

    @(objc_type=AudioUnit, objc_selector="audioUnit", objc_name="audioUnit")
    AudioUnit_audioUnit :: proc(self: ^AudioUnit) -> AT.Unit ---

    @(objc_type=AudioUnit, objc_selector="AUAudioUnit", objc_name="AUAudioUnit")
    AudioUnit_AUAudioUnit :: proc(self: ^AudioUnit) -> ^AT.AUAudioUnit ---
