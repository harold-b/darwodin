...
foreign lib {
    ...
    LocationSortDescriptor_initWithKey :: proc(self: ^LocationSortDescriptor, key: ^NS.String, relativeLocation: ^CLLocation) -> instancetype ---

    @(objc_type=LocationSortDescriptor, objc_selector="initWithCoder:", objc_name="initWithCoder")
    LocationSortDescriptor_initWithCoder :: proc(self: ^LocationSortDescriptor, aDecoder: ^NS.Coder) -> instancetype ---
