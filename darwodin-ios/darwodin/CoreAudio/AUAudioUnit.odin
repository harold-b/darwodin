...
/// AUAudioUnit
///
@(objc_class="AUAudioUnit", objc_superclass=NSObject)
AUAudioUnit :: struct { using _: NSObject, }
...
foreign lib {
    ...
    AUAudioUnit_initWithComponentDescription_options_error :: proc(self: ^AUAudioUnit, componentDescription: ComponentDescription, options: ComponentInstantiationOptions, outError: ^^NSError) -> instancetype ---

    @(objc_type=AUAudioUnit, objc_selector="initWithComponentDescription:error:", objc_name="initWithComponentDescription_error")
    AUAudioUnit_initWithComponentDescription_error :: proc(self: ^AUAudioUnit, componentDescription: ComponentDescription, outError: ^^NSError) -> instancetype ---
    ...
    AUAudioUnit_instantiateWithComponentDescription :: proc(componentDescription: ComponentDescription, options: ComponentInstantiationOptions, completionHandler: ^Objc_Block(proc "c" ( audioUnit: ^AUAudioUnit, error: ^NSError ))) ---
    ...
    AUAudioUnit_allocateRenderResourcesAndReturnError :: proc(self: ^AUAudioUnit, outError: ^^NSError) -> bool ---
    ...
    AUAudioUnit_tokenByAddingRenderObserver :: proc(self: ^AUAudioUnit, observer: AURenderObserver) -> NSInteger ---

    @(objc_type=AUAudioUnit, objc_selector="removeRenderObserver:", objc_name="removeRenderObserver")
    AUAudioUnit_removeRenderObserver :: proc(self: ^AUAudioUnit, token: NSInteger) ---

    @(objc_type=AUAudioUnit, objc_selector="parametersForOverviewWithCount:", objc_name="parametersForOverviewWithCount")
    AUAudioUnit_parametersForOverviewWithCount :: proc(self: ^AUAudioUnit, count: NSInteger) -> ^NSArray ---

    @(objc_type=AUAudioUnit, objc_selector="saveUserPreset:error:", objc_name="saveUserPreset")
    AUAudioUnit_saveUserPreset :: proc(self: ^AUAudioUnit, userPreset: ^AUAudioUnitPreset, outError: ^^NSError) -> bool ---

    @(objc_type=AUAudioUnit, objc_selector="deleteUserPreset:error:", objc_name="deleteUserPreset")
    AUAudioUnit_deleteUserPreset :: proc(self: ^AUAudioUnit, userPreset: ^AUAudioUnitPreset, outError: ^^NSError) -> bool ---

    @(objc_type=AUAudioUnit, objc_selector="presetStateFor:error:", objc_name="presetStateFor")
    AUAudioUnit_presetStateFor :: proc(self: ^AUAudioUnit, userPreset: ^AUAudioUnitPreset, outError: ^^NSError) -> ^NSDictionary ---
    ...
    AUAudioUnit_enableProfile :: proc(self: ^AUAudioUnit, profile: ^MIDICIProfile, cable: cffi.uint8_t, channel: MIDIChannelNumber, outError: ^^NSError) -> bool ---

    @(objc_type=AUAudioUnit, objc_selector="disableProfile:cable:onChannel:error:", objc_name="disableProfile")
    AUAudioUnit_disableProfile :: proc(self: ^AUAudioUnit, profile: ^MIDICIProfile, cable: cffi.uint8_t, channel: MIDIChannelNumber, outError: ^^NSError) -> bool ---

    @(objc_type=AUAudioUnit, objc_selector="messageChannelFor:", objc_name="messageChannelFor")
    AUAudioUnit_messageChannelFor :: proc(self: ^AUAudioUnit, channelName: ^NSString) -> ^AUMessageChannel ---
    ...
    AUAudioUnit_virtualMIDICableCount :: proc(self: ^AUAudioUnit) -> NSInteger ---
    ...
    AUAudioUnit_MIDIOutputNames :: proc(self: ^AUAudioUnit) -> ^NSArray ---
    ...
    AUAudioUnit_latency :: proc(self: ^AUAudioUnit) -> NSTimeInterval ---

    @(objc_type=AUAudioUnit, objc_selector="tailTime", objc_name="tailTime")
    AUAudioUnit_tailTime :: proc(self: ^AUAudioUnit) -> NSTimeInterval ---

    @(objc_type=AUAudioUnit, objc_selector="renderQuality", objc_name="renderQuality")
    AUAudioUnit_renderQuality :: proc(self: ^AUAudioUnit) -> NSInteger ---

    @(objc_type=AUAudioUnit, objc_selector="setRenderQuality:", objc_name="setRenderQuality")
    AUAudioUnit_setRenderQuality :: proc(self: ^AUAudioUnit, renderQuality: NSInteger) ---
    ...
    AUAudioUnit_channelCapabilities :: proc(self: ^AUAudioUnit) -> ^NSArray ---
    ...
    AUAudioUnit_contextName :: proc(self: ^AUAudioUnit) -> ^NSString ---

    @(objc_type=AUAudioUnit, objc_selector="setContextName:", objc_name="setContextName")
    AUAudioUnit_setContextName :: proc(self: ^AUAudioUnit, contextName: ^NSString) ---

    @(objc_type=AUAudioUnit, objc_selector="migrateFromPlugin", objc_name="migrateFromPlugin")
    AUAudioUnit_migrateFromPlugin :: proc(self: ^AUAudioUnit) -> ^NSArray ---
    ...
    AUAudioUnit_channelMap :: proc(self: ^AUAudioUnit) -> ^NSArray ---

    @(objc_type=AUAudioUnit, objc_selector="setChannelMap:", objc_name="setChannelMap")
    AUAudioUnit_setChannelMap :: proc(self: ^AUAudioUnit, channelMap: ^NSArray) ---
    ...
    AUAudioUnit_startHardwareAndReturnError :: proc(self: ^AUAudioUnit, outError: ^^NSError) -> bool ---
    ...
    AUAudioUnit_registerSubclass :: proc(cls: Class, componentDescription: ComponentDescription, name: ^NSString, version: CF.UInt32) ---
    ...
    AUAudioUnit_MIDIOutputBufferSizeHint :: proc(self: ^AUAudioUnit) -> NSInteger ---

    @(objc_type=AUAudioUnit, objc_selector="setMIDIOutputBufferSizeHint:", objc_name="setMIDIOutputBufferSizeHint")
    AUAudioUnit_setMIDIOutputBufferSizeHint :: proc(self: ^AUAudioUnit, MIDIOutputBufferSizeHint: NSInteger) ---
}
