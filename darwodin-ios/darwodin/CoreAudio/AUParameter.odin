...
foreign lib {
    ...
    AUParameter_stringFromValue :: proc(self: ^AUParameter, value: ^AUValue) -> ^NSString ---

    @(objc_type=AUParameter, objc_selector="valueFromString:", objc_name="valueFromString")
    AUParameter_valueFromString :: proc(self: ^AUParameter, string: ^NSString) -> AUValue ---
    ...
    AUParameter_unitName :: proc(self: ^AUParameter) -> ^NSString ---
    ...
    AUParameter_valueStrings :: proc(self: ^AUParameter) -> ^NSArray ---

    @(objc_type=AUParameter, objc_selector="dependentParameters", objc_name="dependentParameters")
    AUParameter_dependentParameters :: proc(self: ^AUParameter) -> ^NSArray ---
