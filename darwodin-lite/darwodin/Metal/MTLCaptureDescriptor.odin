...
@(objc_type=CaptureDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
CaptureDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, CaptureDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=CaptureDescriptor, objc_name="setKeys", objc_is_class_method=true)
CaptureDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, CaptureDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
