...
@(objc_type=RenderPassSampleBufferAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassSampleBufferAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassSampleBufferAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassSampleBufferAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPassSampleBufferAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassSampleBufferAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
