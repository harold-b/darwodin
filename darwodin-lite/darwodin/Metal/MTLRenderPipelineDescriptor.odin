...
@(objc_type=RenderPipelineDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPipelineDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPipelineDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPipelineDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPipelineDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPipelineDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
