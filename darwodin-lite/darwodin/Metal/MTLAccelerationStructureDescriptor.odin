...
@(objc_type=AccelerationStructureDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructureDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructureDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructureDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructureDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructureDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
