...
@(objc_type=GamepadSnapshot, objc_name="poseAsClass", objc_is_class_method=true)
GamepadSnapshot_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GamepadSnapshot, "poseAsClass:", aClass)
}
...
@(objc_type=GamepadSnapshot, objc_name="setKeys", objc_is_class_method=true)
GamepadSnapshot_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GamepadSnapshot, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=GamepadSnapshot, objc_name="exposeBinding", objc_is_class_method=true)
GamepadSnapshot_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GamepadSnapshot, "exposeBinding:", binding)
}
@(objc_type=GamepadSnapshot, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GamepadSnapshot_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GamepadSnapshot, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GamepadSnapshot, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GamepadSnapshot_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GamepadSnapshot, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
