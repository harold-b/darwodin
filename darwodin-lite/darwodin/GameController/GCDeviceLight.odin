...
@(objc_type=DeviceLight, objc_name="poseAsClass", objc_is_class_method=true)
DeviceLight_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DeviceLight, "poseAsClass:", aClass)
}
...
@(objc_type=DeviceLight, objc_name="setKeys", objc_is_class_method=true)
DeviceLight_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DeviceLight, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=DeviceLight, objc_name="exposeBinding", objc_is_class_method=true)
DeviceLight_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, DeviceLight, "exposeBinding:", binding)
}
@(objc_type=DeviceLight, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
DeviceLight_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, DeviceLight, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=DeviceLight, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
DeviceLight_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, DeviceLight, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
