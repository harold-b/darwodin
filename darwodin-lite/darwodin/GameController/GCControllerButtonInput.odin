...
@(objc_type=ControllerButtonInput, objc_name="poseAsClass", objc_is_class_method=true)
ControllerButtonInput_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerButtonInput, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerButtonInput, objc_name="setKeys", objc_is_class_method=true)
ControllerButtonInput_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerButtonInput, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerButtonInput, objc_name="exposeBinding", objc_is_class_method=true)
ControllerButtonInput_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerButtonInput, "exposeBinding:", binding)
}
@(objc_type=ControllerButtonInput, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerButtonInput_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerButtonInput, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerButtonInput, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerButtonInput_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerButtonInput, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
