...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^CA.Layer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.Layer,
    alloc: proc() -> ^CA.Layer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.Layer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.Layer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.Layer {
