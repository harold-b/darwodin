...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^CA.MetalDisplayLinkUpdate,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^CA.MetalDisplayLinkUpdate,
    alloc: proc() -> ^CA.MetalDisplayLinkUpdate,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^CA.MetalDisplayLinkUpdate {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^CA.MetalDisplayLinkUpdate {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^CA.MetalDisplayLinkUpdate {
