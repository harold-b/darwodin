...
@(objc_type=FetchRecordZoneChangesConfiguration, objc_name="poseAsClass", objc_is_class_method=true)
FetchRecordZoneChangesConfiguration_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchRecordZoneChangesConfiguration, "poseAsClass:", aClass)
}
...
@(objc_type=FetchRecordZoneChangesConfiguration, objc_name="setKeys", objc_is_class_method=true)
FetchRecordZoneChangesConfiguration_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchRecordZoneChangesConfiguration, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
