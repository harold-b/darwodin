...
@(objc_type=SyncEngineFetchedZoneDeletion, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineFetchedZoneDeletion_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineFetchedZoneDeletion, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineFetchedZoneDeletion, objc_name="setKeys", objc_is_class_method=true)
SyncEngineFetchedZoneDeletion_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineFetchedZoneDeletion, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
