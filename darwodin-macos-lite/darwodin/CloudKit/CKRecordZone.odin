...
@(objc_type=RecordZone, objc_name="poseAsClass", objc_is_class_method=true)
RecordZone_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RecordZone, "poseAsClass:", aClass)
}
...
@(objc_type=RecordZone, objc_name="setKeys", objc_is_class_method=true)
RecordZone_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RecordZone, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
