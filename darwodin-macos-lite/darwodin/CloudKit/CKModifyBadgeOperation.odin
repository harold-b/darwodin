...
@(objc_type=ModifyBadgeOperation, objc_name="poseAsClass", objc_is_class_method=true)
ModifyBadgeOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ModifyBadgeOperation, "poseAsClass:", aClass)
}
...
@(objc_type=ModifyBadgeOperation, objc_name="setKeys", objc_is_class_method=true)
ModifyBadgeOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ModifyBadgeOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
