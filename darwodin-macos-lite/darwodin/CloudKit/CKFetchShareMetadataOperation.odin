...
@(objc_type=FetchShareMetadataOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchShareMetadataOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchShareMetadataOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchShareMetadataOperation, objc_name="setKeys", objc_is_class_method=true)
FetchShareMetadataOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchShareMetadataOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
