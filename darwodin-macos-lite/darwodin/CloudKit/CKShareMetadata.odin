...
@(objc_type=ShareMetadata, objc_name="poseAsClass", objc_is_class_method=true)
ShareMetadata_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ShareMetadata, "poseAsClass:", aClass)
}
...
@(objc_type=ShareMetadata, objc_name="setKeys", objc_is_class_method=true)
ShareMetadata_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ShareMetadata, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
