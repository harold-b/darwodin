...
@(objc_type=FetchRecordZoneChangesOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchRecordZoneChangesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchRecordZoneChangesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchRecordZoneChangesOperation, objc_name="setKeys", objc_is_class_method=true)
FetchRecordZoneChangesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchRecordZoneChangesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
