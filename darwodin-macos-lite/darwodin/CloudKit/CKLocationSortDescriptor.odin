...
@(objc_type=LocationSortDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
LocationSortDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, LocationSortDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=LocationSortDescriptor, objc_name="setKeys", objc_is_class_method=true)
LocationSortDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, LocationSortDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
