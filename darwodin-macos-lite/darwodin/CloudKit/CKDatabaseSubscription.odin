...
@(objc_type=DatabaseSubscription, objc_name="poseAsClass", objc_is_class_method=true)
DatabaseSubscription_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DatabaseSubscription, "poseAsClass:", aClass)
}
...
@(objc_type=DatabaseSubscription, objc_name="setKeys", objc_is_class_method=true)
DatabaseSubscription_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DatabaseSubscription, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
