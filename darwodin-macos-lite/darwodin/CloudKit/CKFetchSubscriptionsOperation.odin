...
@(objc_type=FetchSubscriptionsOperation, objc_name="poseAsClass", objc_is_class_method=true)
FetchSubscriptionsOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FetchSubscriptionsOperation, "poseAsClass:", aClass)
}
...
@(objc_type=FetchSubscriptionsOperation, objc_name="setKeys", objc_is_class_method=true)
FetchSubscriptionsOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FetchSubscriptionsOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
