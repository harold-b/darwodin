...
@(objc_type=OperationGroup, objc_name="poseAsClass", objc_is_class_method=true)
OperationGroup_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, OperationGroup, "poseAsClass:", aClass)
}
...
@(objc_type=OperationGroup, objc_name="setKeys", objc_is_class_method=true)
OperationGroup_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, OperationGroup, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
