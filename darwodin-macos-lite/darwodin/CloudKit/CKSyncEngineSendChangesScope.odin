...
@(objc_type=SyncEngineSendChangesScope, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineSendChangesScope_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineSendChangesScope, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineSendChangesScope, objc_name="setKeys", objc_is_class_method=true)
SyncEngineSendChangesScope_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineSendChangesScope, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
