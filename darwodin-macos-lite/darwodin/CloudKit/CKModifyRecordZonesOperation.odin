...
@(objc_type=ModifyRecordZonesOperation, objc_name="poseAsClass", objc_is_class_method=true)
ModifyRecordZonesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ModifyRecordZonesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=ModifyRecordZonesOperation, objc_name="setKeys", objc_is_class_method=true)
ModifyRecordZonesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ModifyRecordZonesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
