...
@(objc_type=SyncEnginePendingDatabaseChange, objc_name="poseAsClass", objc_is_class_method=true)
SyncEnginePendingDatabaseChange_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEnginePendingDatabaseChange, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEnginePendingDatabaseChange, objc_name="setKeys", objc_is_class_method=true)
SyncEnginePendingDatabaseChange_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEnginePendingDatabaseChange, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
