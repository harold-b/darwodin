...
@(objc_type=Record, objc_name="poseAsClass", objc_is_class_method=true)
Record_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Record, "poseAsClass:", aClass)
}
...
@(objc_type=Record, objc_name="setKeys", objc_is_class_method=true)
Record_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Record, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
