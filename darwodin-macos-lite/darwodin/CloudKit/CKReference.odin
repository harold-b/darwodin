...
@(objc_type=Reference, objc_name="poseAsClass", objc_is_class_method=true)
Reference_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Reference, "poseAsClass:", aClass)
}
...
@(objc_type=Reference, objc_name="setKeys", objc_is_class_method=true)
Reference_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Reference, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
