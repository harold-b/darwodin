...
@(objc_type=SyncEngineSentDatabaseChangesEvent, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineSentDatabaseChangesEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineSentDatabaseChangesEvent, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineSentDatabaseChangesEvent, objc_name="setKeys", objc_is_class_method=true)
SyncEngineSentDatabaseChangesEvent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineSentDatabaseChangesEvent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
