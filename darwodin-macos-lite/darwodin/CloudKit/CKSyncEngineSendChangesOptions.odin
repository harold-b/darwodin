...
@(objc_type=SyncEngineSendChangesOptions, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineSendChangesOptions_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineSendChangesOptions, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineSendChangesOptions, objc_name="setKeys", objc_is_class_method=true)
SyncEngineSendChangesOptions_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineSendChangesOptions, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
