...
@(objc_type=SyncEngineDidFetchChangesEvent, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineDidFetchChangesEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineDidFetchChangesEvent, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineDidFetchChangesEvent, objc_name="setKeys", objc_is_class_method=true)
SyncEngineDidFetchChangesEvent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineDidFetchChangesEvent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
