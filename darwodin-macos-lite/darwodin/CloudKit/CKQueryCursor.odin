...
@(objc_type=QueryCursor, objc_name="poseAsClass", objc_is_class_method=true)
QueryCursor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, QueryCursor, "poseAsClass:", aClass)
}
...
@(objc_type=QueryCursor, objc_name="setKeys", objc_is_class_method=true)
QueryCursor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, QueryCursor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
