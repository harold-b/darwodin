...
@(objc_type=UserIdentity, objc_name="poseAsClass", objc_is_class_method=true)
UserIdentity_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, UserIdentity, "poseAsClass:", aClass)
}
...
@(objc_type=UserIdentity, objc_name="setKeys", objc_is_class_method=true)
UserIdentity_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, UserIdentity, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
