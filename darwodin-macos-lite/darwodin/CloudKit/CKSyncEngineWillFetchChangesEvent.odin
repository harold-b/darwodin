...
@(objc_type=SyncEngineWillFetchChangesEvent, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineWillFetchChangesEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineWillFetchChangesEvent, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineWillFetchChangesEvent, objc_name="setKeys", objc_is_class_method=true)
SyncEngineWillFetchChangesEvent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineWillFetchChangesEvent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
