...
@(objc_type=SyncEngineDidFetchRecordZoneChangesEvent, objc_name="poseAsClass", objc_is_class_method=true)
SyncEngineDidFetchRecordZoneChangesEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SyncEngineDidFetchRecordZoneChangesEvent, "poseAsClass:", aClass)
}
...
@(objc_type=SyncEngineDidFetchRecordZoneChangesEvent, objc_name="setKeys", objc_is_class_method=true)
SyncEngineDidFetchRecordZoneChangesEvent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SyncEngineDidFetchRecordZoneChangesEvent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
