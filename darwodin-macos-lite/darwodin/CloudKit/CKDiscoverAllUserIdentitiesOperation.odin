...
@(objc_type=DiscoverAllUserIdentitiesOperation, objc_name="poseAsClass", objc_is_class_method=true)
DiscoverAllUserIdentitiesOperation_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DiscoverAllUserIdentitiesOperation, "poseAsClass:", aClass)
}
...
@(objc_type=DiscoverAllUserIdentitiesOperation, objc_name="setKeys", objc_is_class_method=true)
DiscoverAllUserIdentitiesOperation_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DiscoverAllUserIdentitiesOperation, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
