...
@(objc_type=Camera, objc_name="poseAsClass", objc_is_class_method=true)
Camera_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Camera, "poseAsClass:", aClass)
}
...
@(objc_type=Camera, objc_name="setKeys", objc_is_class_method=true)
Camera_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Camera, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
