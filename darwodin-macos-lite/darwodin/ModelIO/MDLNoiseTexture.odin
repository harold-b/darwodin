...
NoiseTexture_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NoiseTexture, "poseAsClass:", aClass)
}
...
NoiseTexture_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NoiseTexture, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
