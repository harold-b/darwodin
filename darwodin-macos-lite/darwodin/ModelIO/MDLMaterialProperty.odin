...
@(objc_type=MaterialProperty, objc_name="poseAsClass", objc_is_class_method=true)
MaterialProperty_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MaterialProperty, "poseAsClass:", aClass)
}
...
@(objc_type=MaterialProperty, objc_name="setKeys", objc_is_class_method=true)
MaterialProperty_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MaterialProperty, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
