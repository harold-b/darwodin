...
foreign lib {
    ...
    MaterialProperty_initWithName_semantic_float2 :: proc(self: ^MaterialProperty, name: ^NS.String, semantic: MaterialSemantic, #by_ptr value: vector_float2) -> ^MaterialProperty ---

    @(objc_type=MaterialProperty, objc_selector="initWithName:semantic:float3:", objc_name="initWithName_semantic_float3")
    MaterialProperty_initWithName_semantic_float3 :: proc(self: ^MaterialProperty, name: ^NS.String, semantic: MaterialSemantic, #by_ptr value: vector_float3) -> ^MaterialProperty ---

    @(objc_type=MaterialProperty, objc_selector="initWithName:semantic:float4:", objc_name="initWithName_semantic_float4")
    MaterialProperty_initWithName_semantic_float4 :: proc(self: ^MaterialProperty, name: ^NS.String, semantic: MaterialSemantic, #by_ptr value: vector_float4) -> ^MaterialProperty ---
    ...
    MaterialProperty_setFloat2Value :: proc(self: ^MaterialProperty, #by_ptr float2Value: vector_float2) ---
    ...
    MaterialProperty_setFloat3Value :: proc(self: ^MaterialProperty, #by_ptr float3Value: vector_float3) ---
    ...
    MaterialProperty_setFloat4Value :: proc(self: ^MaterialProperty, #by_ptr float4Value: vector_float4) ---
