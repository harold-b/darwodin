...
@(objc_type=PathAssetResolver, objc_name="poseAsClass", objc_is_class_method=true)
PathAssetResolver_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PathAssetResolver, "poseAsClass:", aClass)
}
...
@(objc_type=PathAssetResolver, objc_name="setKeys", objc_is_class_method=true)
PathAssetResolver_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PathAssetResolver, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
