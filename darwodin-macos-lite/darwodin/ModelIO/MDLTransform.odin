...
Transform_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Transform, "poseAsClass:", aClass)
}
...
Transform_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Transform, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
