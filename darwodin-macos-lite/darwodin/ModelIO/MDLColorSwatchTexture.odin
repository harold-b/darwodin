...
@(objc_type=ColorSwatchTexture, objc_name="poseAsClass", objc_is_class_method=true)
ColorSwatchTexture_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ColorSwatchTexture, "poseAsClass:", aClass)
}
...
@(objc_type=ColorSwatchTexture, objc_name="setKeys", objc_is_class_method=true)
ColorSwatchTexture_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ColorSwatchTexture, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
