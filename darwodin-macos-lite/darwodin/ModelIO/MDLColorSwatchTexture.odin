...
foreign lib {
    ...
    ColorSwatchTexture_initWithColorTemperatureGradientFrom :: proc(self: ^ColorSwatchTexture, colorTemperature1: cffi.float, colorTemperature2: cffi.float, name: ^NS.String, #by_ptr textureDimensions: [2]cffi.int) -> ^ColorSwatchTexture ---
    ...
    ColorSwatchTexture_initWithColorGradientFrom :: proc(self: ^ColorSwatchTexture, color1: CG.ColorRef, color2: CG.ColorRef, name: ^NS.String, #by_ptr textureDimensions: [2]cffi.int) -> ^ColorSwatchTexture ---
}
