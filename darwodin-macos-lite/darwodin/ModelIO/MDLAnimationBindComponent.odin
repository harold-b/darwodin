...
@(objc_type=AnimationBindComponent, objc_name="poseAsClass", objc_is_class_method=true)
AnimationBindComponent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AnimationBindComponent, "poseAsClass:", aClass)
}
...
@(objc_type=AnimationBindComponent, objc_name="setKeys", objc_is_class_method=true)
AnimationBindComponent_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AnimationBindComponent, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
