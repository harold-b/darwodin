...
TransformStack_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TransformStack, "poseAsClass:", aClass)
}
...
TransformStack_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TransformStack, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
