...
LightProbe_generateSphericalHarmonicsFromIrradiance :: #force_inline proc "c" (self: ^LightProbe, sphericalHarmonicsLevel: cffi.ulong) {
...
LightProbe_sphericalHarmonicsLevel :: #force_inline proc "c" (self: ^LightProbe) -> cffi.ulong {
...
LightProbe_lightProbeWithTextureSize :: #force_inline proc "c" (textureSize: cffi.long, transform: ^Transform, lightsToConsider: ^NS.Array, objectsToConsider: ^NS.Array, reflectiveCubemap: ^Texture, irradianceCubemap: ^Texture) -> ^LightProbe {
...
LightProbe_instancesRespondToSelector :: #force_inline proc "c" (aSelector: SEL) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "instancesRespondToSelector:", aSelector)
}
@(objc_type=LightProbe, objc_name="conformsToProtocol", objc_is_class_method=true)
LightProbe_conformsToProtocol :: #force_inline proc "c" (protocol: ^Protocol) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "conformsToProtocol:", protocol)
}
@(objc_type=LightProbe, objc_name="instanceMethodForSelector", objc_is_class_method=true)
LightProbe_instanceMethodForSelector :: #force_inline proc "c" (aSelector: SEL) -> proc "c" (aSelector: SEL) {
    return msgSend(proc "c" (aSelector: SEL), LightProbe, "instanceMethodForSelector:", aSelector)
}
...
LightProbe_isSubclassOfClass :: #force_inline proc "c" (aClass: Class) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "isSubclassOfClass:", aClass)
}
@(objc_type=LightProbe, objc_name="resolveClassMethod", objc_is_class_method=true)
LightProbe_resolveClassMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "resolveClassMethod:", sel)
}
@(objc_type=LightProbe, objc_name="resolveInstanceMethod", objc_is_class_method=true)
LightProbe_resolveInstanceMethod :: #force_inline proc "c" (sel: SEL) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "resolveInstanceMethod:", sel)
}
@(objc_type=LightProbe, objc_name="hash", objc_is_class_method=true)
LightProbe_hash :: #force_inline proc "c" () -> cffi.ulong {
    return msgSend(cffi.ulong, LightProbe, "hash")
}
...
LightProbe_version :: #force_inline proc "c" () -> cffi.long {
    return msgSend(cffi.long, LightProbe, "version")
}
@(objc_type=LightProbe, objc_name="setVersion", objc_is_class_method=true)
LightProbe_setVersion :: #force_inline proc "c" (aVersion: cffi.long) {
...
LightProbe_accessInstanceVariablesDirectly :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "accessInstanceVariablesDirectly")
}
@(objc_type=LightProbe, objc_name="useStoredAccessor", objc_is_class_method=true)
LightProbe_useStoredAccessor :: #force_inline proc "c" () -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "useStoredAccessor")
}
...
LightProbe_automaticallyNotifiesObserversForKey :: #force_inline proc "c" (key: ^NS.String) -> cffi.bool {
    return msgSend(cffi.bool, LightProbe, "automaticallyNotifiesObserversForKey:", key)
}
