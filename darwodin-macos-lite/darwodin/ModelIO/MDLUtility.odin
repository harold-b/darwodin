...
@(objc_type=Utility, objc_name="poseAsClass", objc_is_class_method=true)
Utility_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Utility, "poseAsClass:", aClass)
}
...
@(objc_type=Utility, objc_name="setKeys", objc_is_class_method=true)
Utility_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Utility, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
