...
TransformScaleOp_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, TransformScaleOp, "poseAsClass:", aClass)
}
...
TransformScaleOp_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, TransformScaleOp, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
