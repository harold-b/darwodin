...
@(objc_type=SpatialScalerDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
SpatialScalerDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, SpatialScalerDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=SpatialScalerDescriptor, objc_name="setKeys", objc_is_class_method=true)
SpatialScalerDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, SpatialScalerDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
