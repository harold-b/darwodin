...
@(objc_type=EnvironmentMechanismUserPassword, objc_name="poseAsClass", objc_is_class_method=true)
EnvironmentMechanismUserPassword_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, EnvironmentMechanismUserPassword, "poseAsClass:", aClass)
}
...
@(objc_type=EnvironmentMechanismUserPassword, objc_name="setKeys", objc_is_class_method=true)
EnvironmentMechanismUserPassword_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, EnvironmentMechanismUserPassword, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
