...
@(objc_type=DomainStateCompanion, objc_name="poseAsClass", objc_is_class_method=true)
DomainStateCompanion_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DomainStateCompanion, "poseAsClass:", aClass)
}
...
@(objc_type=DomainStateCompanion, objc_name="setKeys", objc_is_class_method=true)
DomainStateCompanion_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DomainStateCompanion, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
