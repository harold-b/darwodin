...
@(objc_type=EnvironmentMechanismBiometry, objc_name="poseAsClass", objc_is_class_method=true)
EnvironmentMechanismBiometry_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, EnvironmentMechanismBiometry, "poseAsClass:", aClass)
}
...
@(objc_type=EnvironmentMechanismBiometry, objc_name="setKeys", objc_is_class_method=true)
EnvironmentMechanismBiometry_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, EnvironmentMechanismBiometry, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
