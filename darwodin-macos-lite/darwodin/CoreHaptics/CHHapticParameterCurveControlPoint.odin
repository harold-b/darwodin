...
@(objc_type=HapticParameterCurveControlPoint, objc_name="poseAsClass", objc_is_class_method=true)
HapticParameterCurveControlPoint_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, HapticParameterCurveControlPoint, "poseAsClass:", aClass)
}
