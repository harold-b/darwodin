...
@(objc_type=HapticEvent, objc_name="poseAsClass", objc_is_class_method=true)
HapticEvent_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, HapticEvent, "poseAsClass:", aClass)
}
