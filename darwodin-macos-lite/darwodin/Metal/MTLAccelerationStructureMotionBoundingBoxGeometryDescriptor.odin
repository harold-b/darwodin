...
@(objc_type=AccelerationStructureMotionBoundingBoxGeometryDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructureMotionBoundingBoxGeometryDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructureMotionBoundingBoxGeometryDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructureMotionBoundingBoxGeometryDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructureMotionBoundingBoxGeometryDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructureMotionBoundingBoxGeometryDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
