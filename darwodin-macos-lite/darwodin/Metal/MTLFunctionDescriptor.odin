...
@(objc_type=FunctionDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
FunctionDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionDescriptor, objc_name="setKeys", objc_is_class_method=true)
FunctionDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
