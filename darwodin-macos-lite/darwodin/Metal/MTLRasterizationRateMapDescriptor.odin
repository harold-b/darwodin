...
@(objc_type=RasterizationRateMapDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RasterizationRateMapDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RasterizationRateMapDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RasterizationRateMapDescriptor, objc_name="setKeys", objc_is_class_method=true)
RasterizationRateMapDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RasterizationRateMapDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
