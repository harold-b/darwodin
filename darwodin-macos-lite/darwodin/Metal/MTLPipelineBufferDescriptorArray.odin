...
@(objc_type=PipelineBufferDescriptorArray, objc_name="poseAsClass", objc_is_class_method=true)
PipelineBufferDescriptorArray_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PipelineBufferDescriptorArray, "poseAsClass:", aClass)
}
...
@(objc_type=PipelineBufferDescriptorArray, objc_name="setKeys", objc_is_class_method=true)
PipelineBufferDescriptorArray_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PipelineBufferDescriptorArray, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
