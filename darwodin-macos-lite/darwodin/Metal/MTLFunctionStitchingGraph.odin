...
@(objc_type=FunctionStitchingGraph, objc_name="poseAsClass", objc_is_class_method=true)
FunctionStitchingGraph_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionStitchingGraph, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionStitchingGraph, objc_name="setKeys", objc_is_class_method=true)
FunctionStitchingGraph_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionStitchingGraph, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
