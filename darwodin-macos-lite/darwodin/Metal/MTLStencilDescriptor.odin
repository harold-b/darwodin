...
@(objc_type=StencilDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
StencilDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, StencilDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=StencilDescriptor, objc_name="setKeys", objc_is_class_method=true)
StencilDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, StencilDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
