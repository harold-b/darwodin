...
@(objc_type=ResourceStatePassSampleBufferAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
ResourceStatePassSampleBufferAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ResourceStatePassSampleBufferAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=ResourceStatePassSampleBufferAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
ResourceStatePassSampleBufferAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ResourceStatePassSampleBufferAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
