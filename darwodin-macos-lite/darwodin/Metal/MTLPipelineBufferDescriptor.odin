...
@(objc_type=PipelineBufferDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
PipelineBufferDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PipelineBufferDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=PipelineBufferDescriptor, objc_name="setKeys", objc_is_class_method=true)
PipelineBufferDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PipelineBufferDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
