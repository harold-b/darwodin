...
@(objc_type=MeshRenderPipelineDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
MeshRenderPipelineDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshRenderPipelineDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=MeshRenderPipelineDescriptor, objc_name="setKeys", objc_is_class_method=true)
MeshRenderPipelineDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshRenderPipelineDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
