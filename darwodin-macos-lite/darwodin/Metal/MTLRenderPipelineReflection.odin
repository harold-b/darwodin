...
@(objc_type=RenderPipelineReflection, objc_name="poseAsClass", objc_is_class_method=true)
RenderPipelineReflection_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPipelineReflection, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPipelineReflection, objc_name="setKeys", objc_is_class_method=true)
RenderPipelineReflection_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPipelineReflection, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
