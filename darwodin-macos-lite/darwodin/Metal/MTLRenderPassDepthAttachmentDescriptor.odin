...
@(objc_type=RenderPassDepthAttachmentDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
RenderPassDepthAttachmentDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RenderPassDepthAttachmentDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=RenderPassDepthAttachmentDescriptor, objc_name="setKeys", objc_is_class_method=true)
RenderPassDepthAttachmentDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RenderPassDepthAttachmentDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
