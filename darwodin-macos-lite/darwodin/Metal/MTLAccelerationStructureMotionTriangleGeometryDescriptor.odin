...
@(objc_type=AccelerationStructureMotionTriangleGeometryDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
AccelerationStructureMotionTriangleGeometryDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccelerationStructureMotionTriangleGeometryDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=AccelerationStructureMotionTriangleGeometryDescriptor, objc_name="setKeys", objc_is_class_method=true)
AccelerationStructureMotionTriangleGeometryDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccelerationStructureMotionTriangleGeometryDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
