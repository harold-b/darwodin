...
@(objc_type=FunctionConstantValues, objc_name="poseAsClass", objc_is_class_method=true)
FunctionConstantValues_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, FunctionConstantValues, "poseAsClass:", aClass)
}
...
@(objc_type=FunctionConstantValues, objc_name="setKeys", objc_is_class_method=true)
FunctionConstantValues_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, FunctionConstantValues, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
