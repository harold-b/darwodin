...
@(objc_type=IndirectCommandBufferDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
IndirectCommandBufferDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, IndirectCommandBufferDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=IndirectCommandBufferDescriptor, objc_name="setKeys", objc_is_class_method=true)
IndirectCommandBufferDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, IndirectCommandBufferDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
