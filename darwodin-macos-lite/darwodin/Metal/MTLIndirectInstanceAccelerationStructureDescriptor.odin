...
@(objc_type=IndirectInstanceAccelerationStructureDescriptor, objc_name="poseAsClass", objc_is_class_method=true)
IndirectInstanceAccelerationStructureDescriptor_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, IndirectInstanceAccelerationStructureDescriptor, "poseAsClass:", aClass)
}
...
@(objc_type=IndirectInstanceAccelerationStructureDescriptor, objc_name="setKeys", objc_is_class_method=true)
IndirectInstanceAccelerationStructureDescriptor_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, IndirectInstanceAccelerationStructureDescriptor, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
