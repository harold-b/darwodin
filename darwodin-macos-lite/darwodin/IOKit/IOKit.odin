...
foreign lib {
    ...
    DispatchCalloutFromMessage :: proc(unused: rawptr, msg: ^mach_msg_header_t, reference: rawptr) ---
    ...
    ServiceWaitQuiet :: proc(service: io_service_t, waitTime: ^mach_timespec_t) -> CF.kern_return_t ---
    ...
    KitWaitQuietWithOptions :: proc(mainPort: CF.mach_port_t, waitTime: ^mach_timespec_t, options: OptionBits) -> CF.kern_return_t ---

    @(link_name="IOKitWaitQuiet")
    KitWaitQuiet :: proc(mainPort: CF.mach_port_t, waitTime: ^mach_timespec_t) -> CF.kern_return_t ---
