...
@(objc_type=PhysicalInputElementCollection, objc_name="poseAsClass", objc_is_class_method=true)
PhysicalInputElementCollection_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PhysicalInputElementCollection, "poseAsClass:", aClass)
}
...
@(objc_type=PhysicalInputElementCollection, objc_name="setKeys", objc_is_class_method=true)
PhysicalInputElementCollection_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PhysicalInputElementCollection, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=PhysicalInputElementCollection, objc_name="exposeBinding", objc_is_class_method=true)
PhysicalInputElementCollection_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, PhysicalInputElementCollection, "exposeBinding:", binding)
}
@(objc_type=PhysicalInputElementCollection, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
PhysicalInputElementCollection_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, PhysicalInputElementCollection, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=PhysicalInputElementCollection, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
PhysicalInputElementCollection_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, PhysicalInputElementCollection, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
