...
@(objc_type=ControllerElement, objc_name="poseAsClass", objc_is_class_method=true)
ControllerElement_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerElement, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerElement, objc_name="setKeys", objc_is_class_method=true)
ControllerElement_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerElement, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerElement, objc_name="exposeBinding", objc_is_class_method=true)
ControllerElement_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerElement, "exposeBinding:", binding)
}
@(objc_type=ControllerElement, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerElement_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerElement, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerElement, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerElement_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerElement, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
