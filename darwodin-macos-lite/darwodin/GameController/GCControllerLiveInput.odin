...
@(objc_type=ControllerLiveInput, objc_name="poseAsClass", objc_is_class_method=true)
ControllerLiveInput_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerLiveInput, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerLiveInput, objc_name="setKeys", objc_is_class_method=true)
ControllerLiveInput_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerLiveInput, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerLiveInput, objc_name="exposeBinding", objc_is_class_method=true)
ControllerLiveInput_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerLiveInput, "exposeBinding:", binding)
}
@(objc_type=ControllerLiveInput, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerLiveInput_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerLiveInput, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerLiveInput, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerLiveInput_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerLiveInput, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
