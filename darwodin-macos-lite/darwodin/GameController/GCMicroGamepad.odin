...
@(objc_type=MicroGamepad, objc_name="poseAsClass", objc_is_class_method=true)
MicroGamepad_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MicroGamepad, "poseAsClass:", aClass)
}
...
@(objc_type=MicroGamepad, objc_name="setKeys", objc_is_class_method=true)
MicroGamepad_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MicroGamepad, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=MicroGamepad, objc_name="exposeBinding", objc_is_class_method=true)
MicroGamepad_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, MicroGamepad, "exposeBinding:", binding)
}
@(objc_type=MicroGamepad, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
MicroGamepad_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, MicroGamepad, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=MicroGamepad, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
MicroGamepad_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, MicroGamepad, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
