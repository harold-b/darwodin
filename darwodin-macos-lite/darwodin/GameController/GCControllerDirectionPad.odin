...
@(objc_type=ControllerDirectionPad, objc_name="poseAsClass", objc_is_class_method=true)
ControllerDirectionPad_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ControllerDirectionPad, "poseAsClass:", aClass)
}
...
@(objc_type=ControllerDirectionPad, objc_name="setKeys", objc_is_class_method=true)
ControllerDirectionPad_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ControllerDirectionPad, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ControllerDirectionPad, objc_name="exposeBinding", objc_is_class_method=true)
ControllerDirectionPad_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ControllerDirectionPad, "exposeBinding:", binding)
}
@(objc_type=ControllerDirectionPad, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ControllerDirectionPad_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ControllerDirectionPad, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ControllerDirectionPad, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ControllerDirectionPad_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ControllerDirectionPad, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
