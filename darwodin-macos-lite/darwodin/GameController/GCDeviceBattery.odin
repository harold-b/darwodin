...
@(objc_type=DeviceBattery, objc_name="poseAsClass", objc_is_class_method=true)
DeviceBattery_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DeviceBattery, "poseAsClass:", aClass)
}
...
@(objc_type=DeviceBattery, objc_name="setKeys", objc_is_class_method=true)
DeviceBattery_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DeviceBattery, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=DeviceBattery, objc_name="exposeBinding", objc_is_class_method=true)
DeviceBattery_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, DeviceBattery, "exposeBinding:", binding)
}
@(objc_type=DeviceBattery, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
DeviceBattery_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, DeviceBattery, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=DeviceBattery, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
DeviceBattery_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, DeviceBattery, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
