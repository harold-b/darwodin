...
@(objc_type=Keyboard, objc_name="poseAsClass", objc_is_class_method=true)
Keyboard_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Keyboard, "poseAsClass:", aClass)
}
...
@(objc_type=Keyboard, objc_name="setKeys", objc_is_class_method=true)
Keyboard_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Keyboard, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Keyboard, objc_name="exposeBinding", objc_is_class_method=true)
Keyboard_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Keyboard, "exposeBinding:", binding)
}
@(objc_type=Keyboard, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Keyboard_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Keyboard, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Keyboard, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Keyboard_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Keyboard, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
