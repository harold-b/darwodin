...
@(objc_type=Controller, objc_name="supportsHIDDevice", objc_is_class_method=true)
Controller_supportsHIDDevice :: #force_inline proc "c" (device: IOHIDDeviceRef) -> bool {
    return msgSend(bool, Controller, "supportsHIDDevice:", device)
}
