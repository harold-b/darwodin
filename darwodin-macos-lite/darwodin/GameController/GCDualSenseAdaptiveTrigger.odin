...
@(objc_type=DualSenseAdaptiveTrigger, objc_name="poseAsClass", objc_is_class_method=true)
DualSenseAdaptiveTrigger_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, DualSenseAdaptiveTrigger, "poseAsClass:", aClass)
}
...
@(objc_type=DualSenseAdaptiveTrigger, objc_name="setKeys", objc_is_class_method=true)
DualSenseAdaptiveTrigger_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, DualSenseAdaptiveTrigger, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=DualSenseAdaptiveTrigger, objc_name="exposeBinding", objc_is_class_method=true)
DualSenseAdaptiveTrigger_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, DualSenseAdaptiveTrigger, "exposeBinding:", binding)
}
@(objc_type=DualSenseAdaptiveTrigger, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
DualSenseAdaptiveTrigger_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, DualSenseAdaptiveTrigger, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=DualSenseAdaptiveTrigger, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
DualSenseAdaptiveTrigger_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, DualSenseAdaptiveTrigger, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
