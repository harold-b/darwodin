...
@(objc_type=Gamepad, objc_name="poseAsClass", objc_is_class_method=true)
Gamepad_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Gamepad, "poseAsClass:", aClass)
}
...
@(objc_type=Gamepad, objc_name="setKeys", objc_is_class_method=true)
Gamepad_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Gamepad, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Gamepad, objc_name="exposeBinding", objc_is_class_method=true)
Gamepad_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Gamepad, "exposeBinding:", binding)
}
@(objc_type=Gamepad, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Gamepad_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Gamepad, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Gamepad, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Gamepad_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Gamepad, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
