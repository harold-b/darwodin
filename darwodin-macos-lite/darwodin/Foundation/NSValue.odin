...
@(objc_type=Value, objc_name="valueWithPoint", objc_is_class_method=true)
Value_valueWithPoint :: #force_inline proc "c" (point: CG.Point) -> ^Value {
    return msgSend(^Value, Value, "valueWithPoint:", point)
}
@(objc_type=Value, objc_name="valueWithSize", objc_is_class_method=true)
Value_valueWithSize :: #force_inline proc "c" (size: Size) -> ^Value {
    return msgSend(^Value, Value, "valueWithSize:", size)
}
@(objc_type=Value, objc_name="valueWithRect", objc_is_class_method=true)
Value_valueWithRect :: #force_inline proc "c" (rect: Rect) -> ^Value {
    return msgSend(^Value, Value, "valueWithRect:", rect)
}
@(objc_type=Value, objc_name="valueWithEdgeInsets", objc_is_class_method=true)
Value_valueWithEdgeInsets :: #force_inline proc "c" (insets: EdgeInsets) -> ^Value {
    return msgSend(^Value, Value, "valueWithEdgeInsets:", insets)
}
@(objc_type=Value, objc_name="pointValue")
Value_pointValue :: #force_inline proc "c" (self: ^Value) -> CG.Point {
    return msgSend(CG.Point, self, "pointValue")
}
@(objc_type=Value, objc_name="sizeValue")
Value_sizeValue :: #force_inline proc "c" (self: ^Value) -> Size {
    return msgSend(Size, self, "sizeValue")
}
@(objc_type=Value, objc_name="rectValue")
Value_rectValue :: #force_inline proc "c" (self: ^Value) -> Rect {
    return msgSend(Rect, self, "rectValue")
}
@(objc_type=Value, objc_name="edgeInsetsValue")
Value_edgeInsetsValue :: #force_inline proc "c" (self: ^Value) -> EdgeInsets {
    return msgSend(EdgeInsets, self, "edgeInsetsValue")
}
...
@(objc_type=Value, objc_name="poseAsClass", objc_is_class_method=true)
Value_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Value, "poseAsClass:", aClass)
}
...
@(objc_type=Value, objc_name="setKeys", objc_is_class_method=true)
Value_setKeys :: #force_inline proc "c" (keys: ^Array, dependentKey: ^String) {
    msgSend(nil, Value, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
Value_VTable :: struct {
    ...
    pointValue: proc(self: ^Value) -> CG.Point,
    sizeValue: proc(self: ^Value) -> Size,
    rectValue: proc(self: ^Value) -> Rect,
    edgeInsetsValue: proc(self: ^Value) -> EdgeInsets,
...
Value_odin_extend :: proc(cls: Class, vt: ^Value_VTable) {
    ...
    if vt.valueWithPoint != nil {
        valueWithPoint :: proc "c" (self: Class, _: SEL, point: CG.Point) -> ^Value {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).valueWithPoint( point)
        }
    ...
    if vt.valueWithSize != nil {
        valueWithSize :: proc "c" (self: Class, _: SEL, size: Size) -> ^Value {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).valueWithSize( size)
        }
    ...
    if vt.valueWithRect != nil {
        valueWithRect :: proc "c" (self: Class, _: SEL, rect: Rect) -> ^Value {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).valueWithRect( rect)
        }
    ...
    if vt.valueWithEdgeInsets != nil {
        valueWithEdgeInsets :: proc "c" (self: Class, _: SEL, insets: EdgeInsets) -> ^Value {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).valueWithEdgeInsets( insets)
        }
    ...
    if vt.pointValue != nil {
        pointValue :: proc "c" (self: ^Value, _: SEL) -> CG.Point {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).pointValue(self)
        }
    ...
    if vt.sizeValue != nil {
        sizeValue :: proc "c" (self: ^Value, _: SEL) -> Size {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).sizeValue(self)
        }
    ...
    if vt.rectValue != nil {
        rectValue :: proc "c" (self: ^Value, _: SEL) -> Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).rectValue(self)
        }
    ...
    if vt.edgeInsetsValue != nil {
        edgeInsetsValue :: proc "c" (self: ^Value, _: SEL) -> EdgeInsets {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Value_VTable)vt_ctx.super_vt).edgeInsetsValue(self)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Value_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Value_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
