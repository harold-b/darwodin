...
Coder_VTable :: struct {
    ...
    encodePropertyList: proc(self: ^Coder, aPropertyList: id),
    decodePropertyList: proc(self: ^Coder) -> id,
    ...
    encodeNXObject: proc(self: ^Coder, object: id),
    decodeNXObject: proc(self: ^Coder) -> id,
    decodeValueOfObjCType_at: proc(self: ^Coder, type: cstring, data: rawptr),
    encodePoint_: proc(self: ^Coder, point: CG.Point),
    decodePoint: proc(self: ^Coder) -> CG.Point,
    encodeSize_: proc(self: ^Coder, size: Size),
    decodeSize: proc(self: ^Coder) -> Size,
    encodeRect_: proc(self: ^Coder, rect: Rect),
    decodeRect: proc(self: ^Coder) -> Rect,
    encodePoint_forKey: proc(self: ^Coder, point: CG.Point, key: ^String),
    encodeSize_forKey: proc(self: ^Coder, size: Size, key: ^String),
    encodeRect_forKey: proc(self: ^Coder, rect: Rect, key: ^String),
    decodePointForKey: proc(self: ^Coder, key: ^String) -> CG.Point,
    decodeSizeForKey: proc(self: ^Coder, key: ^String) -> Size,
    decodeRectForKey: proc(self: ^Coder, key: ^String) -> Rect,
    load: proc(),
    initialize: proc(),
    new: proc() -> ^Coder,
...
Coder_odin_extend :: proc(cls: Class, vt: ^Coder_VTable) {
    ...
    if vt.encodePropertyList != nil {
        encodePropertyList :: proc "c" (self: ^Coder, _: SEL, aPropertyList: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodePropertyList(self, aPropertyList)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodePropertyList:"), auto_cast encodePropertyList, "v@:@") do panic("Failed to register objC method.")
    }
    if vt.decodePropertyList != nil {
        decodePropertyList :: proc "c" (self: ^Coder, _: SEL) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodePropertyList(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodePropertyList"), auto_cast decodePropertyList, "@@:") do panic("Failed to register objC method.")
    }
    ...
    if vt.encodeNXObject != nil {
        encodeNXObject :: proc "c" (self: ^Coder, _: SEL, object: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodeNXObject(self, object)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodeNXObject:"), auto_cast encodeNXObject, "v@:@") do panic("Failed to register objC method.")
    }
    if vt.decodeNXObject != nil {
        decodeNXObject :: proc "c" (self: ^Coder, _: SEL) -> id {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodeNXObject(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodeNXObject"), auto_cast decodeNXObject, "@@:") do panic("Failed to register objC method.")
    }
    ...
    if vt.encodePoint_ != nil {
        encodePoint_ :: proc "c" (self: ^Coder, _: SEL, point: CG.Point) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodePoint_(self, point)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodePoint:"), auto_cast encodePoint_, "v@:{CGPoint=dd}") do panic("Failed to register objC method.")
    }
    if vt.decodePoint != nil {
        decodePoint :: proc "c" (self: ^Coder, _: SEL) -> CG.Point {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodePoint(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodePoint"), auto_cast decodePoint, "{CGPoint=dd}@:") do panic("Failed to register objC method.")
    }
    if vt.encodeSize_ != nil {
        encodeSize_ :: proc "c" (self: ^Coder, _: SEL, size: Size) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodeSize_(self, size)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodeSize:"), auto_cast encodeSize_, "v@:{CGSize=dd}") do panic("Failed to register objC method.")
    }
    if vt.decodeSize != nil {
        decodeSize :: proc "c" (self: ^Coder, _: SEL) -> Size {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodeSize(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodeSize"), auto_cast decodeSize, "{CGSize=dd}@:") do panic("Failed to register objC method.")
    }
    if vt.encodeRect_ != nil {
        encodeRect_ :: proc "c" (self: ^Coder, _: SEL, rect: Rect) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodeRect_(self, rect)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodeRect:"), auto_cast encodeRect_, "v@:{CGRect={CGPoint=dd}{CGSize=dd}}") do panic("Failed to register objC method.")
    }
    if vt.decodeRect != nil {
        decodeRect :: proc "c" (self: ^Coder, _: SEL) -> Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodeRect(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodeRect"), auto_cast decodeRect, "{CGRect={CGPoint=dd}{CGSize=dd}}@:") do panic("Failed to register objC method.")
    }
    if vt.encodePoint_forKey != nil {
        encodePoint_forKey :: proc "c" (self: ^Coder, _: SEL, point: CG.Point, key: ^String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodePoint_forKey(self, point, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodePoint:forKey:"), auto_cast encodePoint_forKey, "v@:{CGPoint=dd}@") do panic("Failed to register objC method.")
    }
    if vt.encodeSize_forKey != nil {
        encodeSize_forKey :: proc "c" (self: ^Coder, _: SEL, size: Size, key: ^String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodeSize_forKey(self, size, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodeSize:forKey:"), auto_cast encodeSize_forKey, "v@:{CGSize=dd}@") do panic("Failed to register objC method.")
    }
    if vt.encodeRect_forKey != nil {
        encodeRect_forKey :: proc "c" (self: ^Coder, _: SEL, rect: Rect, key: ^String) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).encodeRect_forKey(self, rect, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("encodeRect:forKey:"), auto_cast encodeRect_forKey, "v@:{CGRect={CGPoint=dd}{CGSize=dd}}@") do panic("Failed to register objC method.")
    }
    if vt.decodePointForKey != nil {
        decodePointForKey :: proc "c" (self: ^Coder, _: SEL, key: ^String) -> CG.Point {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodePointForKey(self, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodePointForKey:"), auto_cast decodePointForKey, "{CGPoint=dd}@:@") do panic("Failed to register objC method.")
    }
    if vt.decodeSizeForKey != nil {
        decodeSizeForKey :: proc "c" (self: ^Coder, _: SEL, key: ^String) -> Size {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodeSizeForKey(self, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodeSizeForKey:"), auto_cast decodeSizeForKey, "{CGSize=dd}@:@") do panic("Failed to register objC method.")
    }
    if vt.decodeRectForKey != nil {
        decodeRectForKey :: proc "c" (self: ^Coder, _: SEL, key: ^String) -> Rect {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^Coder_VTable)vt_ctx.super_vt).decodeRectForKey(self, key)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("decodeRectForKey:"), auto_cast decodeRectForKey, "{CGRect={CGPoint=dd}{CGSize=dd}}@:@") do panic("Failed to register objC method.")
    }
    if vt.load != nil {
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^Coder_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
