...
RunLoop_VTable :: struct {
    ...
    run: proc(self: ^RunLoop),
    runUntilDate: proc(self: ^RunLoop, limitDate: ^Date),
    runMode: proc(self: ^RunLoop, mode: ^String, limitDate: ^Date) -> bool,
    configureAsServer: proc(self: ^RunLoop),
    performInModes: proc(self: ^RunLoop, modes: ^Array, block: proc "c" ()),
    performBlock: proc(self: ^RunLoop, block: proc "c" ()),
    performSelector: proc(self: ^RunLoop, aSelector: SEL, target: id, arg: id, order: UInteger, modes: ^Array),
    cancelPerformSelector: proc(self: ^RunLoop, aSelector: SEL, target: id, arg: id),
    cancelPerformSelectorsWithTarget: proc(self: ^RunLoop, target: id),
    load: proc(),
    initialize: proc(),
    new: proc() -> ^RunLoop,
...
RunLoop_odin_extend :: proc(cls: Class, vt: ^RunLoop_VTable) {
    ...
    if vt.run != nil {
        run :: proc "c" (self: ^RunLoop, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).run(self)
        }
    ...
    if vt.runUntilDate != nil {
        runUntilDate :: proc "c" (self: ^RunLoop, _: SEL, limitDate: ^Date) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).runUntilDate(self, limitDate)
        }
    ...
    if vt.runMode != nil {
        runMode :: proc "c" (self: ^RunLoop, _: SEL, mode: ^String, limitDate: ^Date) -> bool {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).runMode(self, mode, limitDate)
        }
    ...
    if vt.configureAsServer != nil {
        configureAsServer :: proc "c" (self: ^RunLoop, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).configureAsServer(self)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("configureAsServer"), auto_cast configureAsServer, "v@:") do panic("Failed to register objC method.")
    }
    if vt.performInModes != nil {
        performInModes :: proc "c" (self: ^RunLoop, _: SEL, modes: ^Array, block: proc "c" ()) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).performInModes(self, modes, block)
        }
    ...
    if vt.performBlock != nil {
        performBlock :: proc "c" (self: ^RunLoop, _: SEL, block: proc "c" ()) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).performBlock(self, block)
        }
    ...
    if vt.performSelector != nil {
        performSelector :: proc "c" (self: ^RunLoop, _: SEL, aSelector: SEL, target: id, arg: id, order: UInteger, modes: ^Array) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).performSelector(self, aSelector, target, arg, order, modes)
        }

        if !class_addMethod(cls, intrinsics.objc_find_selector("performSelector:target:argument:order:modes:"), auto_cast performSelector, "v@::@@L@") do panic("Failed to register objC method.")
    }
    if vt.cancelPerformSelector != nil {
        cancelPerformSelector :: proc "c" (self: ^RunLoop, _: SEL, aSelector: SEL, target: id, arg: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).cancelPerformSelector(self, aSelector, target, arg)
        }
    ...
    if vt.cancelPerformSelectorsWithTarget != nil {
        cancelPerformSelectorsWithTarget :: proc "c" (self: ^RunLoop, _: SEL, target: id) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).cancelPerformSelectorsWithTarget(self, target)
        }
    ...
    if vt.version != nil {
        version :: proc "c" (self: Class, _: SEL) -> Integer {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).version()
        }
    ...
    if vt.setVersion != nil {
        setVersion :: proc "c" (self: Class, _: SEL, aVersion: Integer) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).setVersion( aVersion)
        }
    ...
    if vt.poseAsClass != nil {
        poseAsClass :: proc "c" (self: Class, _: SEL, aClass: Class) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).poseAsClass( aClass)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_selector_object != nil {
        cancelPreviousPerformRequestsWithTarget_selector_object :: proc "c" (self: Class, _: SEL, aTarget: id, aSelector: SEL, anArgument: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_selector_object( aTarget, aSelector, anArgument)
        }
    ...
    if vt.cancelPreviousPerformRequestsWithTarget_ != nil {
        cancelPreviousPerformRequestsWithTarget_ :: proc "c" (self: Class, _: SEL, aTarget: id) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).cancelPreviousPerformRequestsWithTarget_( aTarget)
        }
    ...
    if vt.accessInstanceVariablesDirectly != nil {
        accessInstanceVariablesDirectly :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).accessInstanceVariablesDirectly()
        }
    ...
    if vt.useStoredAccessor != nil {
        useStoredAccessor :: proc "c" (self: Class, _: SEL) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).useStoredAccessor()
        }
    ...
    if vt.keyPathsForValuesAffectingValueForKey != nil {
        keyPathsForValuesAffectingValueForKey :: proc "c" (self: Class, _: SEL, key: ^String) -> ^Set {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).keyPathsForValuesAffectingValueForKey( key)
        }
    ...
    if vt.automaticallyNotifiesObserversForKey != nil {
        automaticallyNotifiesObserversForKey :: proc "c" (self: Class, _: SEL, key: ^String) -> bool {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).automaticallyNotifiesObserversForKey( key)
        }
    ...
    if vt.setKeys != nil {
        setKeys :: proc "c" (self: Class, _: SEL, keys: ^Array, dependentKey: ^String) {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^RunLoop_VTable)vt_ctx.super_vt).setKeys( keys, dependentKey)
        }
    ...
    if vt.classFallbacksForKeyedArchiver != nil {
        classFallbacksForKeyedArchiver :: proc "c" (self: Class, _: SEL) -> ^Array {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).classFallbacksForKeyedArchiver()
        }
    ...
    if vt.classForKeyedUnarchiver != nil {
        classForKeyedUnarchiver :: proc "c" (self: Class, _: SEL) -> Class {
            ...
            vt_ctx := ObjC.class_get_vtable_info(self)
            context = vt_ctx._context
            return (cast(^RunLoop_VTable)vt_ctx.super_vt).classForKeyedUnarchiver()
        }
