...
VTable :: struct {
    ...
    initWithOptions: proc(self: ^NS.HashTable, options: NS.PointerFunctionsOptions, initialCapacity: NS.UInteger) -> ^NS.HashTable,
    initWithPointerFunctions: proc(self: ^NS.HashTable, functions: ^NS.PointerFunctions, initialCapacity: NS.UInteger) -> ^NS.HashTable,
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.HashTable,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.HashTable,
    alloc: proc() -> ^NS.HashTable,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.initWithOptions != nil {
        initWithOptions :: proc "c" (self: ^NS.HashTable, _: SEL, options: NS.PointerFunctionsOptions, initialCapacity: NS.UInteger) -> ^NS.HashTable {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.HashTable {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.HashTable {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.HashTable {
