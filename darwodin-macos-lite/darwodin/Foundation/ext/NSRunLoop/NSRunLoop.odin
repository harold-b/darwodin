...
VTable :: struct {
    ...
    configureAsServer: proc(self: ^NS.RunLoop),
    ...
    initialize: proc(),
    new: proc() -> ^NS.RunLoop,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.RunLoop,
    alloc: proc() -> ^NS.RunLoop,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.configureAsServer != nil {
        configureAsServer :: proc "c" (self: ^NS.RunLoop, _: SEL) {

            vt_ctx := ObjC.object_get_vtable_info(self)
            context = vt_ctx._context
            (cast(^VTable)vt_ctx.super_vt).configureAsServer(self)
        }
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.RunLoop {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.RunLoop {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.RunLoop {
