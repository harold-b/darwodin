...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^NS.DirectoryEnumerator,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^NS.DirectoryEnumerator,
    alloc: proc() -> ^NS.DirectoryEnumerator,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^NS.DirectoryEnumerator {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^NS.DirectoryEnumerator {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^NS.DirectoryEnumerator {
