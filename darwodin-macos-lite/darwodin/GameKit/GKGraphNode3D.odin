...
foreign lib {
    ...
    GraphNode3D_nodeWithPoint :: proc(point: #by_ptr vector_float3) -> ^GraphNode3D ---

    @(objc_type=GraphNode3D, objc_selector="initWithPoint:", objc_name="initWithPoint")
    GraphNode3D_initWithPoint :: proc(self: ^GraphNode3D, point: #by_ptr vector_float3) -> ^GraphNode3D ---
    ...
    GraphNode3D_setPosition :: proc(self: ^GraphNode3D, position: #by_ptr vector_float3) ---
}
