...
@(objc_type=GraphNode2D, objc_name="poseAsClass", objc_is_class_method=true)
GraphNode2D_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GraphNode2D, "poseAsClass:", aClass)
}
...
@(objc_type=GraphNode2D, objc_name="setKeys", objc_is_class_method=true)
GraphNode2D_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GraphNode2D, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=GraphNode2D, objc_name="exposeBinding", objc_is_class_method=true)
GraphNode2D_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GraphNode2D, "exposeBinding:", binding)
}
@(objc_type=GraphNode2D, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GraphNode2D_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GraphNode2D, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GraphNode2D, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GraphNode2D_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GraphNode2D, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
