...
@(objc_type=ChallengeEventHandler, objc_name="poseAsClass", objc_is_class_method=true)
ChallengeEventHandler_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ChallengeEventHandler, "poseAsClass:", aClass)
}
...
@(objc_type=ChallengeEventHandler, objc_name="setKeys", objc_is_class_method=true)
ChallengeEventHandler_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ChallengeEventHandler, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ChallengeEventHandler, objc_name="exposeBinding", objc_is_class_method=true)
ChallengeEventHandler_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ChallengeEventHandler, "exposeBinding:", binding)
}
@(objc_type=ChallengeEventHandler, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ChallengeEventHandler_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ChallengeEventHandler, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ChallengeEventHandler, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ChallengeEventHandler_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ChallengeEventHandler, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
