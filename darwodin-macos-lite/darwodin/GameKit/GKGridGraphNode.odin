...
@(objc_type=GridGraphNode, objc_name="poseAsClass", objc_is_class_method=true)
GridGraphNode_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, GridGraphNode, "poseAsClass:", aClass)
}
...
@(objc_type=GridGraphNode, objc_name="setKeys", objc_is_class_method=true)
GridGraphNode_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, GridGraphNode, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=GridGraphNode, objc_name="exposeBinding", objc_is_class_method=true)
GridGraphNode_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, GridGraphNode, "exposeBinding:", binding)
}
@(objc_type=GridGraphNode, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
GridGraphNode_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, GridGraphNode, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=GridGraphNode, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
GridGraphNode_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, GridGraphNode, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
