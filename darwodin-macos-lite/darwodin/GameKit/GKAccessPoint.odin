...
AccessPoint_setParentWindow :: #force_inline proc "c" (self: ^AccessPoint, parentWindow: ^AK.Window) {
...
@(objc_type=AccessPoint, objc_name="poseAsClass", objc_is_class_method=true)
AccessPoint_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, AccessPoint, "poseAsClass:", aClass)
}
...
@(objc_type=AccessPoint, objc_name="setKeys", objc_is_class_method=true)
AccessPoint_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, AccessPoint, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=AccessPoint, objc_name="exposeBinding", objc_is_class_method=true)
AccessPoint_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, AccessPoint, "exposeBinding:", binding)
}
@(objc_type=AccessPoint, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
AccessPoint_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, AccessPoint, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=AccessPoint, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
AccessPoint_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, AccessPoint, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
