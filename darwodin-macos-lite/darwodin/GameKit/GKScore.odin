...
Score_challengeComposeControllerWithMessage_players_completionHandler :: #force_inline proc "c" (self: ^Score, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeCompletionBlock) -> ^AK.ViewController {
...
Score_challengeComposeControllerWithMessage_players_completion :: #force_inline proc "c" (self: ^Score, message: ^NS.String, players: ^NS.Array, completionHandler: ChallengeComposeHandler) -> ^AK.ViewController {
...
@(objc_type=Score, objc_name="poseAsClass", objc_is_class_method=true)
Score_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Score, "poseAsClass:", aClass)
}
...
@(objc_type=Score, objc_name="setKeys", objc_is_class_method=true)
Score_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Score, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Score, objc_name="exposeBinding", objc_is_class_method=true)
Score_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Score, "exposeBinding:", binding)
}
@(objc_type=Score, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Score_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Score, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Score, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Score_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Score, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
