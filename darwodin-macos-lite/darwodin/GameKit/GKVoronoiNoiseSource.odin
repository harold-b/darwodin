...
@(objc_type=VoronoiNoiseSource, objc_name="poseAsClass", objc_is_class_method=true)
VoronoiNoiseSource_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, VoronoiNoiseSource, "poseAsClass:", aClass)
}
...
@(objc_type=VoronoiNoiseSource, objc_name="setKeys", objc_is_class_method=true)
VoronoiNoiseSource_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, VoronoiNoiseSource, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=VoronoiNoiseSource, objc_name="exposeBinding", objc_is_class_method=true)
VoronoiNoiseSource_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, VoronoiNoiseSource, "exposeBinding:", binding)
}
@(objc_type=VoronoiNoiseSource, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
VoronoiNoiseSource_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, VoronoiNoiseSource, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=VoronoiNoiseSource, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
VoronoiNoiseSource_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, VoronoiNoiseSource, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
