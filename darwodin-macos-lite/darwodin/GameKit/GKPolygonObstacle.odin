...
@(objc_type=PolygonObstacle, objc_name="poseAsClass", objc_is_class_method=true)
PolygonObstacle_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, PolygonObstacle, "poseAsClass:", aClass)
}
...
@(objc_type=PolygonObstacle, objc_name="setKeys", objc_is_class_method=true)
PolygonObstacle_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, PolygonObstacle, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=PolygonObstacle, objc_name="exposeBinding", objc_is_class_method=true)
PolygonObstacle_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, PolygonObstacle, "exposeBinding:", binding)
}
@(objc_type=PolygonObstacle, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
PolygonObstacle_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, PolygonObstacle, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=PolygonObstacle, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
PolygonObstacle_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, PolygonObstacle, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
