...
@(objc_type=Scene, objc_name="poseAsClass", objc_is_class_method=true)
Scene_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, Scene, "poseAsClass:", aClass)
}
...
@(objc_type=Scene, objc_name="setKeys", objc_is_class_method=true)
Scene_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, Scene, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=Scene, objc_name="exposeBinding", objc_is_class_method=true)
Scene_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, Scene, "exposeBinding:", binding)
}
@(objc_type=Scene, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
Scene_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, Scene, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=Scene, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
Scene_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, Scene, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
