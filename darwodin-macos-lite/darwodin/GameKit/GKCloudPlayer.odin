...
@(objc_type=CloudPlayer, objc_name="poseAsClass", objc_is_class_method=true)
CloudPlayer_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, CloudPlayer, "poseAsClass:", aClass)
}
...
@(objc_type=CloudPlayer, objc_name="setKeys", objc_is_class_method=true)
CloudPlayer_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, CloudPlayer, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=CloudPlayer, objc_name="exposeBinding", objc_is_class_method=true)
CloudPlayer_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, CloudPlayer, "exposeBinding:", binding)
}
@(objc_type=CloudPlayer, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
CloudPlayer_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, CloudPlayer, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=CloudPlayer, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
CloudPlayer_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, CloudPlayer, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
