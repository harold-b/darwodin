...
@(objc_type=ShuffledDistribution, objc_name="poseAsClass", objc_is_class_method=true)
ShuffledDistribution_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, ShuffledDistribution, "poseAsClass:", aClass)
}
...
@(objc_type=ShuffledDistribution, objc_name="setKeys", objc_is_class_method=true)
ShuffledDistribution_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, ShuffledDistribution, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=ShuffledDistribution, objc_name="exposeBinding", objc_is_class_method=true)
ShuffledDistribution_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, ShuffledDistribution, "exposeBinding:", binding)
}
@(objc_type=ShuffledDistribution, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
ShuffledDistribution_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, ShuffledDistribution, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=ShuffledDistribution, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
ShuffledDistribution_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, ShuffledDistribution, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
