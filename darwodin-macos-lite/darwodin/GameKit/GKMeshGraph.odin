...
@(objc_type=MeshGraph, objc_name="poseAsClass", objc_is_class_method=true)
MeshGraph_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, MeshGraph, "poseAsClass:", aClass)
}
...
@(objc_type=MeshGraph, objc_name="setKeys", objc_is_class_method=true)
MeshGraph_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, MeshGraph, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=MeshGraph, objc_name="exposeBinding", objc_is_class_method=true)
MeshGraph_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, MeshGraph, "exposeBinding:", binding)
}
@(objc_type=MeshGraph, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
MeshGraph_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, MeshGraph, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=MeshGraph, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
MeshGraph_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, MeshGraph, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
