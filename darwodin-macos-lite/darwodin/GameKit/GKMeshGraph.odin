...
foreign lib {
    ...
    MeshGraph_graphWithBufferRadius_minCoordinate_maxCoordinate_nodeClass :: proc(bufferRadius: cffi.float, #by_ptr min: vector_float2, #by_ptr max: vector_float2, nodeClass: Class) -> instancetype ---
    ...
    MeshGraph_initWithBufferRadius_minCoordinate_maxCoordinate_nodeClass :: proc(self: ^MeshGraph, bufferRadius: cffi.float, #by_ptr min: vector_float2, #by_ptr max: vector_float2, nodeClass: Class) -> instancetype ---
    ...
    MeshGraph_graphWithBufferRadius_minCoordinate_maxCoordinate :: proc(bufferRadius: cffi.float, #by_ptr min: vector_float2, #by_ptr max: vector_float2) -> instancetype ---
    ...
    MeshGraph_initWithBufferRadius_minCoordinate_maxCoordinate :: proc(self: ^MeshGraph, bufferRadius: cffi.float, #by_ptr min: vector_float2, #by_ptr max: vector_float2) -> instancetype ---
