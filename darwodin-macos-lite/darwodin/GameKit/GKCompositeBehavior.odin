...
@(objc_type=CompositeBehavior, objc_name="poseAsClass", objc_is_class_method=true)
CompositeBehavior_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, CompositeBehavior, "poseAsClass:", aClass)
}
...
@(objc_type=CompositeBehavior, objc_name="setKeys", objc_is_class_method=true)
CompositeBehavior_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, CompositeBehavior, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=CompositeBehavior, objc_name="exposeBinding", objc_is_class_method=true)
CompositeBehavior_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, CompositeBehavior, "exposeBinding:", binding)
}
@(objc_type=CompositeBehavior, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
CompositeBehavior_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, CompositeBehavior, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=CompositeBehavior, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
CompositeBehavior_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, CompositeBehavior, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
