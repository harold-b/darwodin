...
@(objc_type=QuadtreeNode, objc_name="poseAsClass", objc_is_class_method=true)
QuadtreeNode_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, QuadtreeNode, "poseAsClass:", aClass)
}
...
@(objc_type=QuadtreeNode, objc_name="setKeys", objc_is_class_method=true)
QuadtreeNode_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, QuadtreeNode, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=QuadtreeNode, objc_name="exposeBinding", objc_is_class_method=true)
QuadtreeNode_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, QuadtreeNode, "exposeBinding:", binding)
}
@(objc_type=QuadtreeNode, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
QuadtreeNode_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, QuadtreeNode, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=QuadtreeNode, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
QuadtreeNode_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, QuadtreeNode, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
