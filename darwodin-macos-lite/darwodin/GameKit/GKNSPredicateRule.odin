...
@(objc_type=NSPredicateRule, objc_name="poseAsClass", objc_is_class_method=true)
NSPredicateRule_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NSPredicateRule, "poseAsClass:", aClass)
}
...
@(objc_type=NSPredicateRule, objc_name="setKeys", objc_is_class_method=true)
NSPredicateRule_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NSPredicateRule, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=NSPredicateRule, objc_name="exposeBinding", objc_is_class_method=true)
NSPredicateRule_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, NSPredicateRule, "exposeBinding:", binding)
}
@(objc_type=NSPredicateRule, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
NSPredicateRule_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, NSPredicateRule, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=NSPredicateRule, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
NSPredicateRule_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, NSPredicateRule, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
