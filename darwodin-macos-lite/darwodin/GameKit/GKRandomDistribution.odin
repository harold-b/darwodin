...
@(objc_type=RandomDistribution, objc_name="poseAsClass", objc_is_class_method=true)
RandomDistribution_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RandomDistribution, "poseAsClass:", aClass)
}
...
@(objc_type=RandomDistribution, objc_name="setKeys", objc_is_class_method=true)
RandomDistribution_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RandomDistribution, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=RandomDistribution, objc_name="exposeBinding", objc_is_class_method=true)
RandomDistribution_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, RandomDistribution, "exposeBinding:", binding)
}
@(objc_type=RandomDistribution, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
RandomDistribution_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, RandomDistribution, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=RandomDistribution, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
RandomDistribution_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, RandomDistribution, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
