...
@(objc_type=RTree, objc_name="poseAsClass", objc_is_class_method=true)
RTree_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, RTree, "poseAsClass:", aClass)
}
...
@(objc_type=RTree, objc_name="setKeys", objc_is_class_method=true)
RTree_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, RTree, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=RTree, objc_name="exposeBinding", objc_is_class_method=true)
RTree_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, RTree, "exposeBinding:", binding)
}
@(objc_type=RTree, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
RTree_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, RTree, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=RTree, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
RTree_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, RTree, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
