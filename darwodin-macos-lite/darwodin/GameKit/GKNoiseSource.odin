...
@(objc_type=NoiseSource, objc_name="poseAsClass", objc_is_class_method=true)
NoiseSource_poseAsClass :: #force_inline proc "c" (aClass: Class) {
    msgSend(nil, NoiseSource, "poseAsClass:", aClass)
}
...
@(objc_type=NoiseSource, objc_name="setKeys", objc_is_class_method=true)
NoiseSource_setKeys :: #force_inline proc "c" (keys: ^NS.Array, dependentKey: ^NS.String) {
    msgSend(nil, NoiseSource, "setKeys:triggerChangeNotificationsForDependentKey:", keys, dependentKey)
}
...
@(objc_type=NoiseSource, objc_name="exposeBinding", objc_is_class_method=true)
NoiseSource_exposeBinding :: #force_inline proc "c" (binding: ^NS.String) {
    msgSend(nil, NoiseSource, "exposeBinding:", binding)
}
@(objc_type=NoiseSource, objc_name="setDefaultPlaceholder", objc_is_class_method=true)
NoiseSource_setDefaultPlaceholder :: #force_inline proc "c" (placeholder: id, marker: id, binding: ^NS.String) {
    msgSend(nil, NoiseSource, "setDefaultPlaceholder:forMarker:withBinding:", placeholder, marker, binding)
}
@(objc_type=NoiseSource, objc_name="defaultPlaceholderForMarker", objc_is_class_method=true)
NoiseSource_defaultPlaceholderForMarker :: #force_inline proc "c" (marker: id, binding: ^NS.String) -> id {
    return msgSend(id, NoiseSource, "defaultPlaceholderForMarker:withBinding:", marker, binding)
}
