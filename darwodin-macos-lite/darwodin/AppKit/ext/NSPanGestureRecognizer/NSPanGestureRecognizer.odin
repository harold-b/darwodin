...
VTable :: struct {
    ...
    load: proc(),
    initialize: proc(),
    new: proc() -> ^AK.PanGestureRecognizer,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.PanGestureRecognizer,
    alloc: proc() -> ^AK.PanGestureRecognizer,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.PanGestureRecognizer {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.PanGestureRecognizer {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.PanGestureRecognizer {
