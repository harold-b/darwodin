...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.View,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.View,
    alloc: proc() -> ^AK.View,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.View {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.View {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.View {
