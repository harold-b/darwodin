...
VTable :: struct {
    ...
    initialize: proc(),
    new: proc() -> ^AK.Touch,
    allocWithZone: proc(zone: ^NS._NSZone) -> ^AK.Touch,
    alloc: proc() -> ^AK.Touch,
...
extend :: proc(cls: Class, vt: ^VTable) {
    ...
    if vt.new != nil {
        new :: proc "c" (self: Class, _: SEL) -> ^AK.Touch {
    ...
    if vt.allocWithZone != nil {
        allocWithZone :: proc "c" (self: Class, _: SEL, zone: ^NS._NSZone) -> ^AK.Touch {
    ...
    if vt.alloc != nil {
        alloc :: proc "c" (self: Class, _: SEL) -> ^AK.Touch {
